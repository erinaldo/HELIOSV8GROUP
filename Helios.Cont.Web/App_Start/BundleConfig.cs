         ...
         //   System.Web.Optimization.BundleTable.EnableOptimizations = false;
             ...
             bundles.Add(new ScriptBundle("~/bundles/sps").Include(
                "~/Scripts/JiuniScript/jquery-1.10.2.js",
                  "~/Scripts/JiuniScript/jquery-ui.js",
                   ...
                   "~/Scripts/JiuniScript/myScripts.js",
                   "~/Scripts/JiuniScript/ScriptOrders.js",
                   "~/Scripts/JiuniScript/stringformat-1.16.1.js",
                   "~/Scripts/sweetalert/sweetalert.js",
                   "~/Scripts/Logistic/jLogistic.js"));
           ...
           // .Include("~/Content/adminlte/css/AdminLTE.min.css")
            bundles.Add(new StyleBundle("~/Content/css")
                ...
                .Include("~/Content/JiuniBundle/jquery-ui.css")
                .Include("~/Content/JiuniBundle/jquery-ui-1.10.4.custom.min.css")

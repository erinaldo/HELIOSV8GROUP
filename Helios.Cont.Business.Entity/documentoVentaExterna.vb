...
Partial Public Class documentoVentaExterna
    ...
    Public Overridable Property documentoVentaExternaDetalle As ICollection(Of documentoVentaExternaDetalle) = New HashSet(Of documentoVentaExternaDetalle)

...
Partial Public Class documentoAportesDetalle
    ...
    Public Property idAdquisicion As String
    Public Property descripcionAdqui As String
    ...
    Public Property almacenRef As String

...
Partial Public Class otrasSalidas
    ...
    Public Overridable Property otrasSalidasDetalle As ICollection(Of otrasSalidasDetalle) = New HashSet(Of otrasSalidasDetalle)

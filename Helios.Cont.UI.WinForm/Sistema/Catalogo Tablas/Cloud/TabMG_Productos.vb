...
#Region "Constructors"
    Public Sub New()
        ...
        OrdenamientoGrid(GridProductos, False)
    End Sub
#End Region

#Region "MEthods"

    Private Sub GetProductosConInactivos()
        Dim lista = itemSA.GetExistenciasByEstablecimiento(GEstableciento.IdEstablecimiento) '.Where(Function(o) o.estado = "A").ToList
        ...
        For Each i In lista.OrderBy(Function(o) o.descripcionItem).ToList
...
If(i.customMarca IsNot Nothing, i.customMarca.descripcion, String.Empty))
    ...
    Public Sub GetProductos()
        Dim lista = itemSA.GetExistenciasByEstablecimiento(GEstableciento.IdEstablecimiento) '.Where(Function(o) o.estado = "A").ToList


        Dim ListaAct = (From i In lista
                        Where i.estado = "A").ToList
        ...
        'For Each i In lista.OrderBy(Function(o) o.descripcionItem).ToList
        For Each i In ListaAct.OrderBy(Function(o) o.descripcionItem).ToList
            dt.Rows.Add(i.codigodetalle, i.codigo, i.descripcionItem, i.unidad1, If(i.item IsNot Nothing, i.item.descripcion, String.Empty), i.tipoExistencia, i.origenProducto,
                        If(i.estado = "A", "Activo", "Inactivo"), True,
If(i.customMarca IsNot Nothing, i.customMarca.descripcion, String.Empty))
        Next
    ...
    Private Sub ToolStripButton2_Click(sender As Object, e As EventArgs) Handles ToolStripButton2.Click
        ...
        If AutorizacionRolSA.TienePermiso(AsegurablesSistemaPOS.EDITAR_PRODUCTO_Botón___, AutorizacionRolList) Then
            ...
            If r IsNot Nothing Then
                'Dim f As New frmNuevaExistencia(Val(r.GetValue("codigo")))
                Dim f As New FormNuevoCalzado(Val(r.GetValue("codigo")))
    ...
    Private Sub EliminarProductoSinInventario(r As Record)
        ...
        Try
            ...
            'articuloSA.EliminarProductoSinInventario(New detalleitems With {.codigodetalle = r.GetValue("codigo")})
            'r.Delete()

...
Public Class frmPantallaVendedorPOSv2
...
#End Region
    ...
    Private Sub ButtonAdv5_Click(sender As Object, e As EventArgs) Handles ButtonAdv5.Click
        ...
        Try
            Dim f As New FormVentaNuevoPosTipoID
    ...
    Private Sub ButtonAdv7_Click(sender As Object, e As EventArgs) Handles ButtonAdv7.Click
        Gempresas.IDProducto = "38"
        frmComprasMaestro = New frmComprasMaestro
        frmComprasMaestro.StartPosition = FormStartPosition.CenterParent
        frmComprasMaestro.ShowDialog()
    End Sub

...
Public Class tabLIstaVentaElectronicasXItemvb
...
#Region "METODOS"
    Private Sub GetListaVentasPorPeriodo(listaUsuario As List(Of Integer), listIDCajas As List(Of Integer), FechaLaboral As Date)
        ...
        For Each i As documentoCajaDetalle In documentocajaSA.DocCajaXItemVentasElectronicas(DocumentoBE, listaUsuario)

...
Public Class tabListaOtrasSalidas
...
#Region "METODOS"
    Private Sub GetListaVentasPorPeriodo(listaUsuario As List(Of Integer), listIDCajas As List(Of Integer), FechaLaboral As Date)
        ...
        DocumentoBE.movimientoCaja = "OSC"
        ...
        For Each i As documentoCaja In documentocajaSA.DocCajaUnitXDocumento(DocumentoBE, listaUsuario)
            ...
            If (i.tipoPersona = "TR") Then
                dr(5) = personaSA.ObtenerPersonaNumDoc(Gempresas.IdEmpresaRuc, i.idPersonal).nombreCompleto
            Else
                dr(5) = entidadSA.GetUbicarEntPorID(Gempresas.IdEmpresaRuc, i.idPersonal).nombreCompleto
            End If

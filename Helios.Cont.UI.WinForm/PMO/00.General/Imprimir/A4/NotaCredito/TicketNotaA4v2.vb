...
#Region "variables"
    ...
    Public lineaEspacio As Integer = 90
...
#Region "DATOS DEL CLIENTE"
    ...
    Private Sub DibujaLaSubCabeceraIzquierda()
        ...
        For Each Cabecera As String In LineasDeEncabezadoIzquierda
            ...
            'se crea un rectangulo para manipular texto dentro del rectangulo
            Dim R3 As New RectangleF(26, 48, 180, 21)
            ...
            gfx.DrawString(":", FuenteImpresaEncabezado, ColorDeLaFuente, 25, 48, New StringFormat())
            gfx.DrawString(CadenaPorEscribirEnLinea, FuenteImpresaEncabezado, Brushes.Black, R3, StringFormat)

            'se crea un rectangulo para manipular texto dentro del rectangulo
            Dim R4 As New RectangleF(26, 52, 180, 21)
            'documkentop
            ...
            gfx.DrawString(":", FuenteImpresaEncabezado, ColorDeLaFuente, 25, 52, New StringFormat())
            gfx.DrawString(CadenaPorEscribirEnLinea, FuenteImpresaEncabezado, Brushes.Black, R4, StringFormat)

            'se crea un rectangulo para manipular texto dentro del rectangulo
            Dim R5 As New RectangleF(26, 56, 180, 21)
            'direccioon
            ...
            'se crea un rectangulo para manipular texto dentro del rectangulo
            Dim R7 As New RectangleF(26, 60, 180, 21)
            CadenaPorEscribirEnLinea = ordTot.Obtenermoneda(Cabecera)
            gfx.DrawString(":", FuenteImpresaEncabezado, ColorDeLaFuente, 25, 60, New StringFormat())
            gfx.DrawString("TIPO MONEDA", FuenteImpresaEncabezado, ColorDeLaFuente, 6, 60, New StringFormat())
            gfx.DrawString(CadenaPorEscribirEnLinea, FuenteImpresaEncabezado, Brushes.Black, R7, StringFormat)

            'se crea un rectangulo para manipular texto dentro del rectangulo
            Dim R8 As New RectangleF(150, 60, 180, 21)
            CadenaPorEscribirEnLinea = ordTot.ObtenerTelefono(Cabecera)
            gfx.DrawString("TIENDA: " & CadenaPorEscribirEnLinea, FuenteImpresaEncabezado, Brushes.Black, R8, StringFormat)
...
#Region "DATOS COMPLEMEMTARIOS"
    ...
    Private Sub DibujaDatosComplemnetarios()
        ...
        StringFormat.Alignment = StringAlignment.Center
        '//TIPO DE COMPROBANTE
        Dim StringFormatComprobante As New StringFormat
        StringFormatComprobante.Alignment = StringAlignment.Near
        '//LLAMA EL ENCABEZADO DE LA IMPRESION
        Dim ordTot As OrdernarDatosNota = New OrdernarDatosNota()
        'FUENTE DE LA IMPRESION Y TAMAÑO
        Dim FuenteImpresaEncabezado = New Font("Segoe UI", 7, FontStyle.Regular)
        ...
        For Each Cabecera As String In LineasDeDatosComplementarios
            '//SE CREA UN RECTANGULO
            Dim R1 As New RectangleF(162, 75, 35, 3)
            ...
            '//SE CREA UN RECTANGULO
            Dim R3 As New RectangleF(6, 75, 35, 3)
            ...
            '//SE CREA UN RECTANGULO
            Dim R5 As New RectangleF(45, 75, 35, 3)
            ...
            '//SE CREA UN RECTANGULO
            Dim R7 As New RectangleF(84, 75, 35, 3)
            CadenaPorEscribirEnLinea = ordTot.ObtenerMotivoEmision(Cabecera)
            gfx.DrawString(CadenaPorEscribirEnLinea, FuenteImpresaEncabezado, Brushes.Black, R7, StringFormat)

            ' '//SE CREA UN RECTANGULO
            Dim R8 As New RectangleF(122, 74, 38, 3)
            CadenaPorEscribirEnLinea = ordTot.ObtenerDocumento(Cabecera)
            gfx.DrawString("Tipo: " & CadenaPorEscribirEnLinea, FuenteImpresaEncabezado, Brushes.Black, R8, StringFormatComprobante)

            ' '//SE CREA UN RECTANGULO
            Dim R9 As New RectangleF(122, 77, 38, 3)
            CadenaPorEscribirEnLinea = ordTot.ObtenerNumeroDocumento(Cabecera)
            gfx.DrawString("N° Doc.: " & CadenaPorEscribirEnLinea, FuenteImpresaEncabezado, Brushes.Black, R9, StringFormatComprobante)

        Next

        '//TITULO DE LOS DATOS COMPLEMENTARIO
        Dim FuenteImpresaComplemeneto = New Font("Segoe UI", 7, FontStyle.Bold)
        gfx.DrawString("           Orden de Compra                           Guía de Remisión                           Motivo de Emisión                      Datos del Documento                    Fecha del Documento", FuenteImpresaComplemeneto, ColorDeLaFuente, 5, 65, New StringFormat())
        gfx.DrawString("                                                                                                                                                                                       que modifica                                       que modifica", FuenteImpresaComplemeneto, ColorDeLaFuente, 5, 69, New StringFormat())

        '//SE DIBUJA TODA LAS LINEAS DE LOS DATOS COMPLEMENTARIOS
        gfx.DrawRectangle(blackPen, 5, 65, 197, 8)
        gfx.DrawRectangle(blackPen, 5, 65, 39, 16)
        gfx.DrawRectangle(blackPen, 44, 65, 39, 16)
        gfx.DrawRectangle(blackPen, 83, 65, 39, 16)
        gfx.DrawRectangle(blackPen, 122, 65, 39, 16)
        gfx.DrawRectangle(blackPen, 161, 65, 41, 16)
...
#Region "DATOS DETALLE DE VENTA"
    ...
    Private Sub DibujaElementosFactura(i As ArrayList)
        ...
        gfx.DrawString("    Cantidad                                                       Descripciòn                                                              UM      Precio Unit.           Valor Total", FuenteImpresaEncabezado, ColorDeLaFuente, 6, 84, New StringFormat())

        '//SE CREA EL CUADRO O TABLAS DE LOS DETALLES
        'crear rectangulo d e la cabecera
        gfx.DrawRectangle(blackPen, 5, 82, 197, 7)

        'crear la fila codigo
        gfx.DrawRectangle(blackPen, 5, 82, 20, 145)
        'crear la fila descrpcion
        gfx.DrawRectangle(blackPen, 25, 82, 118, 145)
        'crear la fila um
        gfx.DrawRectangle(blackPen, 143, 82, 10, 145)
        ''crear la fila Venta Total
        gfx.DrawRectangle(blackPen, 153, 82, 24, 145)
        ''crear la fila Venta Total
        gfx.DrawRectangle(blackPen, 177, 82, 25, 145)
...
#Region "DATOS DETALLE TOTALES"
    ...
    Private Sub DibujaTotalFactura()
        ...
        gfx.DrawRectangle(blackPen, 139, 228, 63, 56)
        'gfx.DrawRectangle(blackPen, 140, 261, 65, 20)

        'Encabezados de los importes Generales
        CadenaPorEscribirEnLinea = "OP. GRATUITAS"
        gfx.DrawString(CadenaPorEscribirEnLinea, FuenteImpresaEncabezadoTexto, ColorDeLaFuente, 140, contadorGeneral + 230, New StringFormat())

        CadenaPorEscribirEnLinea = "OP. EXONERADAS"
        gfx.DrawString(CadenaPorEscribirEnLinea, FuenteImpresaEncabezadoTexto, ColorDeLaFuente, 140, contadorGeneral + 234, New StringFormat())
        ...
        CadenaPorEscribirEnLinea = "I.C.B.P.E.R."
        ...
        For Each Elemento As String In LineasTotalFactura
            ...
            CadenaPorEscribirEnLinea = AlineaTextoaLaDerecha(CadenaPorEscribirEnLinea.Length) + CadenaPorEscribirEnLinea
            gfx.DrawString(CadenaPorEscribirEnLinea, FuenteImpresaEncabezadoTexto, ColorDeLaFuente, 155, contadorGeneral + 230, New StringFormat())

            CadenaPorEscribirEnLinea = "0.00"
            CadenaPorEscribirEnLinea = AlineaTextoaLaDerecha(CadenaPorEscribirEnLinea.Length) + CadenaPorEscribirEnLinea
            gfx.DrawString(CadenaPorEscribirEnLinea, FuenteImpresaEncabezado, ColorDeLaFuente, 174, contadorGeneral + 230, New StringFormat())
            contadorGeneral += 4
...
#Region "DATOS FINALES DE LA FACTURA"
    ...
    Private Sub DibujaDatosGenerales(Paginacion As String)
        ...
        Dim ordTot As OrdernarDatosComplentarias = New OrdernarDatosComplentarias()
        'Fuente de la impresion
        Dim FuenteImpresaTitulo = New Font("Segoe UI", 7, FontStyle.Bold)
        Dim FuenteImpresaEncabezado = New Font("Segoe UI", 7, FontStyle.Regular)
        ...
        gfx.DrawRectangle(blackPen, 5, 248, 133, 5)

        'crear rectangulo con esta el codigo qr
        gfx.DrawRectangle(blackPen, 5, 228, 133, 19)

        'crear rectangulo con esta el codigo qr
        gfx.DrawRectangle(blackPen, 5, 254, 133, 30)

        'LINEA DE RECIBIR 
        gfx.DrawLine(blackPen, 105, 260, 138, 260)

        gfx.DrawLine(blackPen, 105, 280, 138, 280)
        'linea de la fimar
        gfx.DrawLine(blackPen, 105, 255, 105, 284)
        ...
        For Each Elemento As String In LineasDatosComplementaria
            ...
            If (ordTot.ObtenerTotalNroCuentaSoles(Elemento) <> "") Then
                '//TITULO
            ...
            If (ordTot.ObtenerTotalNroCuentaSoles(Elemento) <> "") Then
                ...
                gfx.DrawString(CadenaPorEscribirEnLinea, FuenteImpresaTitulo, ColorDeLaFuente, 40, contadorDatos + 268, New StringFormat())
                ...
                gfx.DrawString(CadenaPorEscribirEnLinea, FuenteImpresaEncabezadoNroCuenta, ColorDeLaFuente, 40, 275, New StringFormat())

            End If

            CadenaPorEscribirEnLinea = (ordTot.ObtenerTotalDescripcion(Elemento))
            gfx.DrawString(CadenaPorEscribirEnLinea, FuenteImpresaEncabezadoNroCuenta, ColorDeLaFuente, 5, 280, New StringFormat())
        ...
        If (tipoComprobante = "2") Then
            ...
            CadenaPorEscribirEnLinea = "Consulte su documento electronico en " & "http://facturador.softpack.com.pe/helioslogin"
...
#Region "DATOS NOTA DE CREDITO"
    '*****************************************************************************
    '****************************** NOMBRE importes TOTALES ******************
    'Se declara el array para la Factura parte izquierda - datos generales
    Public LineasDatosNotaCredito As ArrayList = New ArrayList()

    'Linea para capturar el ruc y numeroComprobante de la Factura
    Public Sub AnadirLineaNotaCredito(ByVal tituloCredito As String, ByVal nombreCredito As String)
        Dim ordTot As OrdernarDescripcionNota = New OrdernarDescripcionNota()
        LineasDatosNotaCredito.Add(ordTot.GenerarTotal(tituloCredito, nombreCredito))
    End Sub

    'Dibuja `parte de la derecha de la factura
    'Dibuja `parte de la derecha de la factura
    Private Sub DibujaNotaCredito()
        ...
        For Each Elemento As String In LineasDatosNotaCredito
            'Dim R1 As New RectangleF(6, 228, 60, 3)
            'CadenaPorEscribirEnLinea = ordTot.ObtenerTituloCredito(Elemento)
            'gfx.DrawString(CadenaPorEscribirEnLinea, FuenteImpresaTitulo, ColorDeLaFuente, R1, New StringFormat())

            Dim R2 As New RectangleF(6, 228, 130, 17)
            CadenaPorEscribirEnLinea = ordTot.ObtenerDescripcionNota(Elemento)
            gfx.DrawString(CadenaPorEscribirEnLinea, FuenteImpresaEncabezado, ColorDeLaFuente, R2, New StringFormat())

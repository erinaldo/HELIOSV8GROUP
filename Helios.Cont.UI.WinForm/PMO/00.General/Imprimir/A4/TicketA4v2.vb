...
#Region "DATOS DETALLE DE VENTA"
    ...
    Private Sub DibujaElementosFactura(i As ArrayList)
        ...
        gfx.DrawString("    Cantidad                                                       Descripciòn                                                              UM      Precio Unit.           Valor Total", FuenteImpresaEncabezado, ColorDeLaFuente, 6, 88, New StringFormat())
        ...
        gfx.DrawRectangle(blackPen, 25, 87, 118, 155)
        'crear la fila um
        gfx.DrawRectangle(blackPen, 143, 87, 10, 155)
        ''crear la fila Venta Total
        gfx.DrawRectangle(blackPen, 153, 87, 24, 155)
        ''crear la fila Venta Total

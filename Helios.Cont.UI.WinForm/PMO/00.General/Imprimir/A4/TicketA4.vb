...
#Region "DATOS DEL CLIENTE"
    ...
    Private Sub DibujaLaSubCabeceraIzquierda()
        ...
        For Each Cabecera As String In LineasDeEncabezadoIzquierda
            ...
            Dim R2 As New RectangleF(26, 44, 180, 25)
            ...
            'se crea un rectangulo para manipular texto dentro del rectangulo
            Dim R3 As New RectangleF(26, 48, 180, 25)
            ...
            'se crea un rectangulo para manipular texto dentro del rectangulo
            Dim R4 As New RectangleF(26, 52, 180, 25)
            'documkentop
            ...
            'se crea un rectangulo para manipular texto dentro del rectangulo
            Dim R5 As New RectangleF(26, 56, 180, 25)
            'direccioon
...
#Region "DATOS COMPLEMEMTARIOS"
    ...
    Private Sub DibujaDatosComplemnetarios()
        ...
        gfx.DrawString("                     N° Pedido                             Orden de Compra                           Guía de Remisión                             Forma de Pago                                Tipo de Venta", FuenteImpresaComplemeneto, ColorDeLaFuente, 5, 69, New StringFormat())
...
#Region "DATOS DETALLE DE VENTA"
    ...
    '    gfx.DrawString("    Numero                                                 Descripción                                               UM           Cant.           Precio Unit.        Valor Total", FuenteImpresaEncabezado, ColorDeLaFuente, 6, 88, New StringFormat())
    ...
    Private Sub DibujaElementosFactura(i As ArrayList)
        ...
        Dim blackPen As New Pen(Color.Black, 0)
        '//TEXTO DEL ENCABEZADO
        gfx.DrawString(" Item                                                 Descripción                                                      UM           Cant.           Precio Unit.        Valor Total", FuenteImpresaEncabezado, ColorDeLaFuente, 6, 88, New StringFormat())

        '//SE CREA EL CUADRO O TABLAS DE LOS DETALLES
        gfx.DrawRectangle(blackPen, 5, 87, 195, 7)
        'crear la fila codigo
        gfx.DrawRectangle(blackPen, 5, 87, 10, 155)
        'crear la fila descrpcion
        gfx.DrawRectangle(blackPen, 15, 87, 118, 155)
        'crear la fila um
        gfx.DrawRectangle(blackPen, 123, 87, 10, 155)
        'crear la fila cantidad
        gfx.DrawRectangle(blackPen, 133, 87, 18, 155)
        ...
        For Each Item As String In i
            ...
            '//CODIGO DEL LA DESCRIPCION DEL PRODCUTO
            'se crea un rectangulo para manipular texto dentro del rectangulo
            Dim R3 As New RectangleF(16, lineaEspacio, 110, 130)
            Dim total As Integer
            Dim nombreArticlo As String
            'Dim enviarNombre As String
            nombreArticlo = ordTot.ObtenerDescripcion(Item)
...
#Region "DATOS DETALLE TOTALES"
    ...
    Private Sub DibujaTotalFactura()
        ...
        gfx.DrawRectangle(blackPen, 139, 244, 61, 41)
        ...
        For Each Elemento As String In LineasTotalFactura
            ...
            CadenaPorEscribirEnLinea = AlineaTextoaLaDerecha(CadenaPorEscribirEnLinea.Length) + CadenaPorEscribirEnLinea
            gfx.DrawString(CadenaPorEscribirEnLinea, FuenteImpresaEncabezado, ColorDeLaFuente, 173, contadorGeneral + 245, New StringFormat())
            contadorGeneral += 4

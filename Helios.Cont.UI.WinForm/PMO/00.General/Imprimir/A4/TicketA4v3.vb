...
#Region "DATOS COMPLEMEMTARIOS"
    ...
    Private Sub DibujaDatosComplemnetarios()
        ...
        For Each Cabecera As String In LineasDeDatosComplementarios
            ...
            '//SE CREA UN RECTANGULO
            Dim R3 As New RectangleF(6, 75, 65, 3)
            ...
            '//SE CREA UN RECTANGULO
            'Dim R5 As New RectangleF(70, 75, 65, 3)
            ...
            '//SE CREA UN RECTANGULO
            Dim R7 As New RectangleF(95, 73, 105, 3)
            CadenaPorEscribirEnLinea = ordTot.ObtenerFormaPago(Cabecera)
            gfx.DrawString(CadenaPorEscribirEnLinea, FuenteImpresaEncabezado, Brushes.Black, R7, StringFormat)

            ' '//SE CREA UN RECTANGULO
            Dim R8 As New RectangleF(95, 77, 105, 3)
        ...
        gfx.DrawString("                                                   Orden de Compra                                                                                                 Operación Sujeta a Detracción", FuenteImpresaComplemeneto, ColorDeLaFuente, 5, 66, New StringFormat())

        '//SE DIBUJA TODA LAS LINEAS DE LOS DATOS COMPLEMENTARIOS
        gfx.DrawRectangle(blackPen, 5, 65, 197, 6)
        gfx.DrawRectangle(blackPen, 5, 65, 90, 16)
        'gfx.DrawRectangle(blackPen, 50, 67, 45, 19)
        'gfx.DrawRectangle(blackPen, 70, 65, 65, 16)
        'gfx.DrawRectangle(blackPen, 122, 69, 39, 17)
        gfx.DrawRectangle(blackPen, 95, 65, 107, 16)
...
#Region "DATOS FINALES DE LA FACTURA"
    ...
    Private Sub DibujaDatosGenerales(Paginacion As String)
        ...
        If (tipoComprobante = "2") Then
            ...
            CadenaPorEscribirEnLinea = "Consulte su documento electronico en " & "http://www.spk.com.pe"
            gfx.DrawString(CadenaPorEscribirEnLinea, FuenteImpresaEncabezado, ColorDeLaFuente, 6, contadorDatos + 284, New StringFormat())

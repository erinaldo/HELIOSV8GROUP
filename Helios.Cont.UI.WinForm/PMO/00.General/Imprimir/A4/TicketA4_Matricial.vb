...
Public Class TicketA4_Matricial
...
#Region "DATOS DE EMPRESA"
        ...
        Select Case PosicionLogo
            ...
            Case Else
                ...
                For Each Item As String In LineasDatosEmpresa
                    ...
                    '//se crea un rectangulo para manipular texto dentro del rectangulo
                    Dim R1 As New RectangleF(6, lineaEspacioDatosEmpresa, 130, 7)
                    '//STRING FORMAT DEL TEXTO PARA LA POSICION
                    Dim StringFormatNombrecomercial As New StringFormat
                    StringFormatNombrecomercial.Alignment = StringAlignment.Center
                    CadenaPorEscribirEnLinea = ordTot.ObtenerNombreComercial(Item)
                    ...
                    '//se crea un rectangulo para manipular texto dentro del rectangulo
                    Dim R2 As New RectangleF(6, lineaEspacioDatosEmpresa, 130, 7)
                    '//STRING FORMAT DEL TEXTO PARA LA POSICION
                    Dim StringFormatDireccion As New StringFormat
                    StringFormat.Alignment = StringAlignment.Near
                    CadenaPorEscribirEnLinea = ordTot.ObtenerDireccionPrincipal(Item)
                    ...
                    '//FUENTE DE IMPRESION
                    '//se crea un rectangulo para manipular texto dentro del rectangulo
                    Dim R3 As New RectangleF(6, lineaEspacioDatosEmpresa, 130, 7)
                    '//STRING FORMAT DEL TEXTO PARA LA POSICION
                    'Dim StringFormatDireccion As New StringFormat
                    'StringFormatDireccion.Alignment = StringAlignment.Near
                    CadenaPorEscribirEnLinea = ordTot.ObtenerDireccionAnexo(Item)
                    ...
                    '//FUENTE DE IMPRESION
                    '//se crea un rectangulo para manipular texto dentro del rectangulo
                    Dim R4 As New RectangleF(6, lineaEspacioDatosEmpresa, 130, 7)
                    '//STRING FORMAT DEL TEXTO PARA LA POSICION
                    CadenaPorEscribirEnLinea = ordTot.ObtenerTelefono(Item)
                    gfx.DrawString(CadenaPorEscribirEnLinea, FuenteImpresionDireccion, Brushes.Black, R4, StringFormatDireccion)
    ...
    Private Sub DibujaLaCabeceraDerecha()
        ...
        DrawRoundedRectangle(gfx, 134, 8, 66, 32, 10)
...
#Region "DATOS DEL CLIENTE"
    ...
    Private Sub DibujaLaSubCabeceraIzquierda()
        ...
        Dim FuenteImpresaEncabezado = New Font("Segoe UI", 8, FontStyle.Regular)
        ...
        For Each Cabecera As String In LineasDeEncabezadoIzquierda
            ...
            Dim R2 As New RectangleF(32, 44, 180, 25)
            ...
            gfx.DrawString(":", FuenteImpresaEncabezado, ColorDeLaFuente, 30, 44, New StringFormat())
            gfx.DrawString(CadenaPorEscribirEnLinea, FuenteImpresaEncabezado, Brushes.Black, R2, StringFormat)
            ...
            'se crea un rectangulo para manipular texto dentro del rectangulo
            Dim R3 As New RectangleF(32, 48, 180, 25)
            CadenaPorEscribirEnLinea = NuevoCaracter
            gfx.DrawString("CLIENTE", FuenteImpresaEncabezado, ColorDeLaFuente, 6, 48, New StringFormat())
            gfx.DrawString(":", FuenteImpresaEncabezado, ColorDeLaFuente, 30, 48, New StringFormat())
            gfx.DrawString(CadenaPorEscribirEnLinea, FuenteImpresaEncabezado, Brushes.Black, R3, StringFormat)

            'se crea un rectangulo para manipular texto dentro del rectangulo
            Dim R4 As New RectangleF(32, 52, 180, 25)
            'documkentop
            CadenaPorEscribirEnLinea = ordTot.ObtenerdocIdentidad(Cabecera)
            gfx.DrawString("DOC. IDENTIDAD", FuenteImpresaEncabezado, ColorDeLaFuente, 6, 52, New StringFormat())
            gfx.DrawString(":", FuenteImpresaEncabezado, ColorDeLaFuente, 30, 52, New StringFormat())
            gfx.DrawString(CadenaPorEscribirEnLinea, FuenteImpresaEncabezado, Brushes.Black, R4, StringFormat)

            'se crea un rectangulo para manipular texto dentro del rectangulo
            Dim R5 As New RectangleF(32, 56, 180, 25)
            'direccioon
            NuevoCaracter = ordTot.Obtenerdireccion(Cabecera)

            CadenaPorEscribirEnLinea = ordTot.Obtenerdireccion(Cabecera)
            gfx.DrawString("DIRECCION", FuenteImpresaEncabezado, ColorDeLaFuente, 6, 56, New StringFormat())
            gfx.DrawString(":", FuenteImpresaEncabezado, ColorDeLaFuente, 30, 56, New StringFormat())
            gfx.DrawString(CadenaPorEscribirEnLinea, FuenteImpresaEncabezado, Brushes.Black, R5, StringFormat)

            'se crea un rectangulo para manipular texto dentro del rectangulo
            Dim R6 As New RectangleF(32, 60, 180, 25)
            NuevoCaracter = ordTot.ObtenerdireccionEntrega(Cabecera)
            CadenaPorEscribirEnLinea = NuevoCaracter
            gfx.DrawString(":", FuenteImpresaEncabezado, ColorDeLaFuente, 30, 60, New StringFormat())
            gfx.DrawString("COMPRADOR", FuenteImpresaEncabezado, ColorDeLaFuente, 6, 60, New StringFormat())
            gfx.DrawString(CadenaPorEscribirEnLinea, FuenteImpresaEncabezado, Brushes.Black, R6, StringFormat)

            'se crea un rectangulo para manipular texto dentro del rectangulo
            Dim R7 As New RectangleF(32, 64, 180, 25)
            CadenaPorEscribirEnLinea = ordTot.Obtenermoneda(Cabecera)
            gfx.DrawString(":", FuenteImpresaEncabezado, ColorDeLaFuente, 30, 64, New StringFormat())
            gfx.DrawString("TIPO MONEDA", FuenteImpresaEncabezado, ColorDeLaFuente, 6, 64, New StringFormat())
...
#Region "DATOS COMPLEMEMTARIOS"
    ...
    Private Sub DibujaDatosComplemnetarios()
        ...
        For Each Cabecera As String In LineasDeDatosComplementarios
            '//SE CREA UN RECTANGULO
            Dim R1 As New RectangleF(6, 80, 35, 4)
            ...
            '//SE CREA UN RECTANGULO
            Dim R3 As New RectangleF(45, 80, 35, 4)
            ...
            '//SE CREA UN RECTANGULO
            Dim R5 As New RectangleF(84, 80, 35, 4)
            ...
            '//SE CREA UN RECTANGULO
            Dim R7 As New RectangleF(122, 80, 35, 4)
            CadenaPorEscribirEnLinea = ordTot.ObtenerFormaPago(Cabecera)
            gfx.DrawString(CadenaPorEscribirEnLinea, FuenteImpresaEncabezado, Brushes.Black, R7, StringFormat)

            ' '//SE CREA UN RECTANGULO
            Dim R8 As New RectangleF(162, 80, 38, 4)
        ...
        Dim FuenteImpresaComplemeneto = New Font("Segoe UI", 10, FontStyle.Regular)
        gfx.DrawString("            N° Pedido                Orden de Compra           Guía de Remisión             Forma de Pago           Tipo de Venta", FuenteImpresaComplemeneto, ColorDeLaFuente, 5, 71, New StringFormat())
        'gfx.DrawString("                 Fecha                                             Fecha                                               Fecha", FuenteImpresaComplemeneto, ColorDeLaFuente, 5, 73, New StringFormat())

        '//SE DIBUJA TODA LAS LINEAS DE LOS DATOS COMPLEMENTARIOS
        gfx.DrawRectangle(blackPen, 5, 69, 195, 8)
        gfx.DrawRectangle(blackPen, 5, 69, 39, 17)
        gfx.DrawRectangle(blackPen, 44, 69, 39, 17)
        gfx.DrawRectangle(blackPen, 83, 69, 39, 17)
        gfx.DrawRectangle(blackPen, 122, 69, 39, 17)
        gfx.DrawRectangle(blackPen, 161, 69, 39, 17)
...
#Region "DATOS DETALLE DE VENTA"
    ...
    Private Sub DibujaElementosFactura(i As ArrayList)
        ...
        Dim FuenteImpresaDetalle = New Font("Segoe UI", 9, FontStyle.Regular)
        Dim FuenteImpresaEncabezado = New Font("Segoe UI", 10, FontStyle.Bold)
        '//COLOR DE LA IMPRESION
        Dim blackPen As New Pen(Color.Black, 0)
        '//TEXTO DEL ENCABEZADO
        gfx.DrawString(" Numero                                          Descripción                                           UM        Cant.             P.U.                 Total", FuenteImpresaEncabezado, ColorDeLaFuente, 6, 88, New StringFormat())

        '//SE CREA EL CUADRO O TABLAS DE LOS DETALLES
        gfx.DrawRectangle(blackPen, 5, 87, 195, 7)
        'crear la fila codigo
        gfx.DrawRectangle(blackPen, 5, 87, 20, 155)
        'crear la fila descrpcion
        gfx.DrawRectangle(blackPen, 25, 87, 98, 155)
        'crear la fila um
        gfx.DrawRectangle(blackPen, 123, 87, 10, 155)
        'crear la fila cantidad
        gfx.DrawRectangle(blackPen, 133, 87, 18, 155)
        ''crear la fila PRECIO UNITARIO
        gfx.DrawRectangle(blackPen, 151, 87, 24, 155)
        ''crear la fila Venta Total
        gfx.DrawRectangle(blackPen, 175, 87, 25, 155)
        ...
        For Each Item As String In i
            ...
            'se crea un rectangulo para manipular texto dentro del rectangulo
            Dim R1 As New RectangleF(5, lineaEspacio, 20, 130)
            Codigo = 0.0
            ...
            '//CODIGO DEL UM
            'se crea un rectangulo para manipular texto dentro del rectangulo
            Dim R4 As New RectangleF(124, lineaEspacio, 10, 130)
            'Colocar la cantidad a la derecha.
            ...
            'se crea un rectangulo para manipular texto dentro del rectangulo
            Dim R3 As New RectangleF(26, lineaEspacio, 100, 130)
...
#Region "DATOS DETALLE TOTALES"
    ...
    Private Sub DibujaTotalFactura()
        ...
        gfx.DrawRectangle(blackPen, 139, 243, 61, 35)
        ...
        gfx.DrawString(CadenaPorEscribirEnLinea, FuenteImpresaEncabezadoTexto, ColorDeLaFuente, 140, contadorGeneral + 249, New StringFormat())

        CadenaPorEscribirEnLinea = "OP. INAFECTO"
        gfx.DrawString(CadenaPorEscribirEnLinea, FuenteImpresaEncabezadoTexto, ColorDeLaFuente, 140, contadorGeneral + 253, New StringFormat())

        CadenaPorEscribirEnLinea = "OP. GRAVADA"
        gfx.DrawString(CadenaPorEscribirEnLinea, FuenteImpresaEncabezadoTexto, ColorDeLaFuente, 140, contadorGeneral + 257, New StringFormat())

        CadenaPorEscribirEnLinea = "TOTL DSCTO."
        gfx.DrawString(CadenaPorEscribirEnLinea, FuenteImpresaEncabezadoTexto, ColorDeLaFuente, 140, contadorGeneral + 261, New StringFormat())
        ...
        gfx.DrawString(CadenaPorEscribirEnLinea, FuenteImpresaEncabezadoTexto, ColorDeLaFuente, 140, contadorGeneral + 269, New StringFormat())

        CadenaPorEscribirEnLinea = "ICBPER"
        gfx.DrawString(CadenaPorEscribirEnLinea, FuenteImpresaEncabezadoTexto, ColorDeLaFuente, 140, contadorGeneral + 273, New StringFormat())

        CadenaPorEscribirEnLinea = "IMPORTE TOTAL"
        gfx.DrawString(CadenaPorEscribirEnLinea, FuenteImpresaEncabezadoTexto, ColorDeLaFuente, 140, contadorGeneral + 277, New StringFormat())
        ...
        For Each Elemento As String In LineasTotalFactura
            ...
            CadenaPorEscribirEnLinea = AlineaTextoaLaDerecha(CadenaPorEscribirEnLinea.Length) + CadenaPorEscribirEnLinea
            gfx.DrawString(CadenaPorEscribirEnLinea, FuenteImpresaEncabezadoTexto, ColorDeLaFuente, 157, contadorGeneral + 243, New StringFormat())

            CadenaPorEscribirEnLinea = "0.00"
            CadenaPorEscribirEnLinea = AlineaTextoaLaDerecha(CadenaPorEscribirEnLinea.Length) + CadenaPorEscribirEnLinea
            gfx.DrawString(CadenaPorEscribirEnLinea, FuenteImpresaEncabezado, ColorDeLaFuente, 169, contadorGeneral + 243, New StringFormat())
            contadorGeneral += 4
...
#Region "DATOS FINALES DE LA FACTURA"
    ...
    Private Sub DibujaDatosGenerales(Paginacion As String)
        ...
        Dim ordTot As OrdernarDatosComplentarias = New OrdernarDatosComplentarias()
        'Fuente de la impresion
        Dim FuenteImpresaTitulo = New Font("Segoe UI", 9, FontStyle.Bold)
        Dim FuenteImpresaEncabezado = New Font("Segoe UI", 9, FontStyle.Regular)
        ...
        gfx.DrawRectangle(blackPen, 5, 243, 133, 7)
        'crear rectangulo con esta el codigo qr
        gfx.DrawRectangle(blackPen, 5, 251, 133, 27)


        gfx.DrawLine(blackPen, 105, 257, 138, 257)
        'linea de la fimar
        gfx.DrawLine(blackPen, 105, 251, 105, 278)
        'crear la fila cantidad

        ''//TITULO
        CadenaPorEscribirEnLinea = "CUENTA EN SOLES:"
        gfx.DrawString(CadenaPorEscribirEnLinea, FuenteImpresaTitulo, ColorDeLaFuente, 40, contadorDatos + 252, New StringFormat())

        CadenaPorEscribirEnLinea = "CUENTA EN DOLARES:"
        gfx.DrawString(CadenaPorEscribirEnLinea, FuenteImpresaTitulo, ColorDeLaFuente, 40, contadorDatos + 265, New StringFormat())
        ...
        For Each Elemento As String In LineasDatosComplementaria
            ...
            gfx.DrawString(conver & " SOLES", FuenteImpresaEncabezado, ColorDeLaFuente, 11, 244, New StringFormat())

            CadenaPorEscribirEnLinea = ordTot.ObtenerTotalNroCuentaSoles(Elemento)
            gfx.DrawString(CadenaPorEscribirEnLinea, FuenteImpresaEncabezadoNroCuenta, ColorDeLaFuente, 40, 255, New StringFormat())

            CadenaPorEscribirEnLinea = ordTot.ObtenerTotalNroCuentaSoles2(Elemento)
            gfx.DrawString(CadenaPorEscribirEnLinea, FuenteImpresaEncabezadoNroCuenta, ColorDeLaFuente, 40, 259, New StringFormat())

            CadenaPorEscribirEnLinea = (ordTot.ObtenerTotalNroCuentaDolares(Elemento))
            gfx.DrawString(CadenaPorEscribirEnLinea, FuenteImpresaEncabezadoNroCuenta, ColorDeLaFuente, 40, 268, New StringFormat())

            CadenaPorEscribirEnLinea = (ordTot.ObtenerTotalNroCuentaDolares2(Elemento))
            gfx.DrawString(CadenaPorEscribirEnLinea, FuenteImpresaEncabezadoNroCuenta, ColorDeLaFuente, 40, 272, New StringFormat())
        ...
        gfx.DrawString(CadenaPorEscribirEnLinea, FuenteImpresaEncabezado, ColorDeLaFuente, 106, contadorDatos + 253, New StringFormat())

        CadenaPorEscribirEnLinea = "Firma"
        gfx.DrawString(CadenaPorEscribirEnLinea, FuenteImpresaEncabezado, ColorDeLaFuente, 116, contadorDatos + 273, New StringFormat())

        If (tipoComprobante = "2") Then

            CadenaPorEscribirEnLinea = "Consulte su documento electronico en " & "http://www.softpack.com.pe"
            gfx.DrawString(CadenaPorEscribirEnLinea, FuenteImpresaEncabezado, ColorDeLaFuente, 6, contadorDatos + 278, New StringFormat())

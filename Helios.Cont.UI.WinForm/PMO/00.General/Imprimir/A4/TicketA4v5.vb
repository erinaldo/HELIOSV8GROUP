...
#Region "DATOS DEL CLIENTE"
    ...
    Private Sub DibujaLaSubCabeceraIzquierda()
        ...
        Dim blackPen As New Pen(Color.Black, 0)
        gfx.DrawRectangle(blackPen, 5, 43, 197, 23)
        ...
        For Each Cabecera As String In LineasDeEncabezadoIzquierda
            ...
            'se crea un rectangulo para manipular texto dentro del rectangulo
            Dim R7 As New RectangleF(26, 60, 180, 25)
...
#Region "DATOS DETALLE DE VENTA"
    ...
    Private Sub DibujaElementosFactura(i As ArrayList)
        ...
        gfx.DrawString(" Cantidad                                                     Descripciòn                                            UM       Precio Unit.      Descuento      Valor Total", FuenteImpresaEncabezado, ColorDeLaFuente, 6, 88, New StringFormat())

        '//SE CREA EL CUADRO O TABLAS DE LOS DETALLES
        'crear rectangulo d e la cabecera
        gfx.DrawRectangle(blackPen, 5, 87, 197, 7)

        'crear la fila codigo
        gfx.DrawRectangle(blackPen, 5, 87, 18, 155)
        'crear la fila descrpcion
        gfx.DrawRectangle(blackPen, 23, 87, 100, 155)
        'crear la fila um
        gfx.DrawRectangle(blackPen, 123, 87, 10, 155)
        ''crear la fila Venta Total
        gfx.DrawRectangle(blackPen, 133, 87, 24, 155)
        ''crear la fila Venta Total
        gfx.DrawRectangle(blackPen, 157, 87, 20, 155)
        ''crear la fila Venta Total
        gfx.DrawRectangle(blackPen, 177, 87, 25, 155)
        ...
        For Each Item As String In i
            ...
            'se crea un rectangulo para manipular texto dentro del rectangulo
            Dim R1 As New RectangleF(3, lineaEspacio, 20, 130)
            Codigo = 0.0
            ...
            'se crea un rectangulo para manipular texto dentro del rectangulo
            Dim R5 As New RectangleF(133, lineaEspacio, 24, 130)
            'Colocar la cantidad a la derecha.
            ...
            '//CODIGO DEL PRECIO UNITARIO
            'se crea un rectangulo para manipular texto dentro del rectangulo
            Dim R10 As New RectangleF(157, lineaEspacio, 20, 130)
            'Colocar la cantidad a la derecha.
            Dim StringFormatDescuento As New StringFormat
            StringFormatPrecioUnit.Alignment = StringAlignment.Far
            Descuento = 0.0
            Descuento = FormatNumber(ordTot.OptenerCodigo(Item), 2)
            CadenaPorEscribirEnLinea = Descuento
            gfx.DrawString(CadenaPorEscribirEnLinea, FuenteImpresaDetalle, Brushes.Black, R10, StringFormatPrecioUnit)
            ...
            'se crea un rectangulo para manipular texto dentro del rectangulo
            Dim R3 As New RectangleF(26, lineaEspacio, 90, 130)
...
#Region "DATOS DETALLE TOTALES"
    ...
    Private Sub DibujaTotalFactura()
        ...
        For Each Elemento As String In LineasTotalFactura
            ...
            CadenaPorEscribirEnLinea = "0.00"
            CadenaPorEscribirEnLinea = AlineaTextoaLaDerecha(CadenaPorEscribirEnLinea.Length) + CadenaPorEscribirEnLinea
            gfx.DrawString(CadenaPorEscribirEnLinea, FuenteImpresaEncabezado, ColorDeLaFuente, 174, contadorGeneral + 245, New StringFormat())
            contadorGeneral += 4

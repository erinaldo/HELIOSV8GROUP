Public Class OrdenarElementoFacturaTicketv2
    ...
    Public Function GenerarImprimir(ByVal cantidad As String, ByVal Descripcion As String,
                                                   ByVal UM As String, ByVal PrecioVenta As String, ByVal Descuento As String, ByVal VentaTotal As String) As String

        GenerarImprimir = cantidad + delimitador(0) + Descripcion + delimitador(0) + UM + delimitador(0) +
                    PrecioVenta + delimitador(0) + Descuento + delimitador(0) + VentaTotal
    End Function
End Class

Public Class OrdernarTotalFactura
    ...
    Public Function ObtenerTotalNombre(ByVal totalItem As String) As String
        ...
        Return delimitado(0)
    End Function
    Public Function ObtenerTotalImporte(ByVal TotalImporte As String) As String
        Dim delimitado() As String = TotalImporte.Split(delimitador)
        Return delimitado(1)
    End Function

...
Public Class FormImpresionCaja
    ...
    Sub cargarCajas()
        ...
        ComboCaja.DisplayMember = "IDUsuario"
        ComboCaja.ValueMember = "NombrePersona"
    ...
    Private Sub FormImpresionCaja_Load(sender As Object, e As EventArgs) Handles MyBase.Load

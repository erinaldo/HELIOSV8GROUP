...
Public Class TicketFormatoA5Transporte
    ...
    Public lineaEspacio As Integer = 81
            ...
            Select Case tipoLogo
                Case "CR"
                    If (tipoImagen = True) Then
                        If (Not IsNothing(headerImagep.Width)) Then
                            If (headerImagep.Width <> 0) Then
                                Dim destRect As New Rectangle(35, 5, 45, 15)
                    ...
                    ElseIf (tipoImagen = False) Then
                        If (Not IsNothing(headerImagep.Width)) Then
                            If (headerImagep.Width <> 0) Then
                                Dim destRect As New Rectangle(25, 5, 65, 15)
                ...
                Case "IZ"
                    If (tipoImagen = True) Then
                        If (Not IsNothing(headerImagep.Width)) Then
                            If (headerImagep.Width <> 0) Then
                                Dim destRect As New Rectangle(5, 5, 50, 10)
                    ...
                    ElseIf (tipoImagen = False) Then
                        If (Not IsNothing(headerImagep.Width)) Then
                            If (headerImagep.Width <> 0) Then
                                Dim destRect As New Rectangle(5, 5, 65, 10)
    ...
    Private Sub DibujaLaCabecera()
        ...
        Dim FuenteImpresaEncabezadoIzquierda = New Font("Tahoma", 7, FontStyle.Regular)
    ...
    Private Sub DibujaLaCabeceraDerecha()
        ...
        gfx.DrawRectangle(blackPen, 110, 5, 92, 35)
        ...
        For Each Cabecera As String In LineasDeEncabezadoDerecha
            ...
            Dim R1 As New RectangleF(110, 8, 92, 40)
            ...
            Dim R2 As New RectangleF(110, 20, 92, 40)
            ...
            Dim R3 As New RectangleF(110, 32, 92, 40)
    ...
    Private Sub DibujaLaSubCabeceraIzquierda()
        ...
        For Each Cabecera As String In LineasDeEncabezadoIzquierda
            ...
            gfx.DrawString("REMITENTE              : " & CadenaPorEscribirEnLinea, FuenteImpresaEncabezado, Brushes.Black, R3, StringFormat)
            '    contador += 1
            '    CadenaPorEscribirEnLinea = ""
            '    gfx.DrawString("                           " & CadenaPorEscribirEnLinea, FuenteImpresaEncabezado, ColorDeLaFuente, 6, 34, New StringFormat())
            ...
            gfx.DrawString("DOC. IDENTIDAD  : " & CadenaPorEscribirEnLinea, FuenteImpresaEncabezado, Brushes.Black, R4, StringFormat)
            ...
            gfx.DrawString("CONSIGNADO          : " & CadenaPorEscribirEnLinea, FuenteImpresaEncabezado, Brushes.Black, R5, StringFormat)
            '    contador += 1
            '    CadenaPorEscribirEnLinea = ""
            '    gfx.DrawString("                     " & CadenaPorEscribirEnLinea, FuenteImpresaEncabezado, ColorDeLaFuente, 6, 44, New StringFormat())
            'End If
            ...
            '    NuevoMaxCaracter = MaximoCaracter / 2
            CadenaPorEscribirEnLinea = NuevoCaracter
            gfx.DrawString("DOC. IDENTIDAD        : " & CadenaPorEscribirEnLinea, FuenteImpresaEncabezado, Brushes.Black, R6, StringFormat)


            'se crea un rectangulo para manipular texto dentro del rectangulo
            Dim R7 As New RectangleF(100, 64, 197, 25)
            'documkentop
            CadenaPorEscribirEnLinea = ordTot.Obtenermoneda(Cabecera)
            gfx.DrawString("TIPO MONEDA     : " & CadenaPorEscribirEnLinea, FuenteImpresaEncabezado, Brushes.Black, R7, StringFormat)

            'se crea un rectangulo para manipular texto dentro del rectangulo
            Dim R8 As New RectangleF(5, 64, 197, 25)
            'documkentop
            CadenaPorEscribirEnLinea = ordTot.ObtenerTelefono(Cabecera)
            gfx.DrawString("AGENCIA           : " & CadenaPorEscribirEnLinea, FuenteImpresaEncabezado, Brushes.Black, R8, StringFormat)
    ...
    Private Sub DibujaElementosFactura(i As ArrayList)
        ...
        gfx.DrawString("    N°           Còdigo                                                Descripciòn                                       UM           Cant.            Precio Unit.           Valor Total", FuenteImpresaEncabezado, ColorDeLaFuente, 6, 74, New StringFormat())
        'gfx.DrawString("                                                                                                                                                                           Vta. Unit.", FuenteImpresaEncabezado, ColorDeLaFuente, 6, 76, New StringFormat())
        'crear rectangulo d e la cabecera
        gfx.DrawRectangle(blackPen, 5, 70, 197, 10)
        'crear la fila numero
        gfx.DrawRectangle(blackPen, 5, 70, 10, 46)
        'crear la fila 4
        gfx.DrawRectangle(blackPen, 15, 70, 20, 46)
        'crear la fila descrpcion
        gfx.DrawRectangle(blackPen, 35, 70, 88, 46)
        'crear la fila um
        gfx.DrawRectangle(blackPen, 123, 70, 10, 46)
        'crear la fila cantidad
        gfx.DrawRectangle(blackPen, 133, 70, 20, 46)
        ''crear la fila Venta Total
        gfx.DrawRectangle(blackPen, 153, 70, 24, 46)
        ''crear la fila Venta Total
        gfx.DrawRectangle(blackPen, 177, 70, 25, 46)
    ...
    Private Sub DibujaTotalFactura()
        ...
        Dim FuenteImpresaEncabezadoTexto = New Font("Tahoma", 8, FontStyle.Regular)
        'Se dibuja uin rectangulo parte derecha
        ' DIRECCION A  LA IZQUIERDA, ESPACIO PARA ABAJO, ANCHO DEL RECTANGULO, LARGO DEL RTECTRANGULO
        Dim blackPen As New Pen(Color.Black, 0)
        ...
        gfx.DrawRectangle(blackPen, 139, 117, 63, 27)
        ...
        gfx.DrawString(CadenaPorEscribirEnLinea, FuenteImpresaEncabezadoTexto, ColorDeLaFuente, 140, contadorGeneral + 130, New StringFormat())

        CadenaPorEscribirEnLinea = "I.S.C."
        gfx.DrawString(CadenaPorEscribirEnLinea, FuenteImpresaEncabezadoTexto, ColorDeLaFuente, 140, contadorGeneral + 133, New StringFormat())

        CadenaPorEscribirEnLinea = "I.G.V."
        gfx.DrawString(CadenaPorEscribirEnLinea, FuenteImpresaEncabezadoTexto, ColorDeLaFuente, 140, contadorGeneral + 136, New StringFormat())

        CadenaPorEscribirEnLinea = "IMPORTE TOTAL"
        gfx.DrawString(CadenaPorEscribirEnLinea, FuenteImpresaEncabezadoTexto, ColorDeLaFuente, 140, contadorGeneral + 139, New StringFormat())
        ...
        For Each Elemento As String In LineasTotalFactura
            ...
            CadenaPorEscribirEnLinea = AlineaTextoaLaDerecha(CadenaPorEscribirEnLinea.Length) + CadenaPorEscribirEnLinea
            gfx.DrawString(CadenaPorEscribirEnLinea, FuenteImpresaEncabezadoTexto, ColorDeLaFuente, 155, contadorGeneral + 118, New StringFormat())

            CadenaPorEscribirEnLinea = FormatNumber(ordTot.ObtenerTotalImporte(Elemento), 2)
            CadenaPorEscribirEnLinea = AlineaTextoaLaDerecha(CadenaPorEscribirEnLinea.Length) + CadenaPorEscribirEnLinea
            gfx.DrawString(CadenaPorEscribirEnLinea, FuenteImpresaEncabezado, ColorDeLaFuente, 174, contadorGeneral + 118, New StringFormat())
            contadorGeneral += 3
    ...
    Private Sub DibujaDatosGenerales(Paginacion As String)
        ...
        gfx.DrawRectangle(blackPen, 5, 117, 133, 5)
        'crear la fila cantidad
        gfx.DrawRectangle(blackPen, 5, 123, 133, 21)

        'gfx.DrawLine(blackPen, 104, 123, 104, 144)
        'gfx.DrawLine(blackPen, 137, 127, 104, 127)
        ''linea de la firma
        'gfx.DrawLine(blackPen, 105, 140, 135, 140)
        ''crear la fila cantidad
        ...
        For Each Elemento As String In LineasDatosComplementaria
            ...
            gfx.DrawString(conver & " SOLES", FuenteImpresaEncabezado, ColorDeLaFuente, 11, contadorDatos + 118, New StringFormat())
        Next
        ...
        'gfx.DrawString(CadenaPorEscribirEnLinea, FuenteImpresaEncabezado, ColorDeLaFuente, 108, contadorDatos + 123, New StringFormat())
        ...
        'gfx.DrawString(CadenaPorEscribirEnLinea, FuenteImpresaEncabezado, ColorDeLaFuente, 116, contadorDatos + 141, New StringFormat())

        If (tipoComprobante = "2") Then
            CadenaPorEscribirEnLinea = "CONDICIONES DE TRANSPORTE DE ENCOMIENDA"
            gfx.DrawString(CadenaPorEscribirEnLinea, FuenteImpresaEncabezado, ColorDeLaFuente, 40, contadorDatos + 124, New StringFormat())

            CadenaPorEscribirEnLinea = "1. La empresa no se responsabiliza por deterioro o mermas por mal enbalaje"
            gfx.DrawString(CadenaPorEscribirEnLinea, FuenteImpresaEncabezado, ColorDeLaFuente, 40, contadorDatos + 127, New StringFormat())

            CadenaPorEscribirEnLinea = "o desconposiciòn de viveres frutas (D.S. 24-83-TC)"
            gfx.DrawString(CadenaPorEscribirEnLinea, FuenteImpresaEncabezado, ColorDeLaFuente, 40, contadorDatos + 130, New StringFormat())

            CadenaPorEscribirEnLinea = "2. La empresa no se hace responsable de objetos y/o articulos no declarados."
            gfx.DrawString(CadenaPorEscribirEnLinea, FuenteImpresaEncabezado, ColorDeLaFuente, 40, contadorDatos + 133, New StringFormat())

            CadenaPorEscribirEnLinea = "3. El pago por la perdida de un bulto se hara de acuerdo a la ley de ferrocarriles"
            gfx.DrawString(CadenaPorEscribirEnLinea, FuenteImpresaEncabezado, ColorDeLaFuente, 40, contadorDatos + 136, New StringFormat())

            CadenaPorEscribirEnLinea = "Art. 8 10 veces el valor del flete pagado."
            gfx.DrawString(CadenaPorEscribirEnLinea, FuenteImpresaEncabezado, ColorDeLaFuente, 40, contadorDatos + 139, New StringFormat())
            ...
            gfx.DrawString(CadenaPorEscribirEnLinea, FuenteImpresaEncabezado, ColorDeLaFuente, 5, contadorDatos + 144, New StringFormat())

            'CadenaPorEscribirEnLinea = "http://www.spk.com.pe/"
            'gfx.DrawString(CadenaPorEscribirEnLinea, FuenteImpresaEncabezado, ColorDeLaFuente, 40, contadorDatos + 144, New StringFormat())
    ...
    Private Sub DibujaDatosEmpresa()
        ...
        If (tipoLogo = "CR") Then
            FuenteImpresaEncabezado = New Font("Tahoma", 7, FontStyle.Italic)
            ...
            For Each Elemento As String In LineasDatosEmpresa
                ...
                ElseIf (NumTotalNombre >= 65) Then
                    If (tipoLogo = "CR") Then
                        FuenteImpresaEncabezado2 = New Font("Tahoma", 7, FontStyle.Italic)
                    Else
                        FuenteImpresaEncabezado2 = New Font("Tahoma", 12, FontStyle.Italic)
                    End If
        ...
        ElseIf (tipoLogo = "IZ") Then
            FuenteImpresaEncabezado = New Font("Tahoma", 10, FontStyle.Italic)
            'llama a la clase OrdernarEncabezadoFactura para importar los datos de Ruc y numeroComprobante
            Dim ordTot As OrdernarEmpresa = New OrdernarEmpresa()
            ' DIRECCION A  LA IZQUIERDA, ESPACIO PARA ABAJO, ANCHO DEL RECTANGULO, LARGO DEL RTECTRANGULO
            Dim blackPen As New Pen(Color.Black, 0)
            ...
            For Each Elemento As String In LineasDatosEmpresa
                ...
                ElseIf (NumTotalNombre >= 65) Then
                    If (tipoLogo = "IZ") Then
                        FuenteImpresaEncabezado2 = New Font("Tahoma", 8, FontStyle.Italic)
                    Else
                        FuenteImpresaEncabezado2 = New Font("Tahoma", 12, FontStyle.Italic)
                    End If
    ...
    Private Sub DibujaDatosNombrePropietario()
        ...
        Select Case tipoLogo
            Case "CR"
                FuenteImpresaEncabezado = New Font("Tahoma", 7, FontStyle.Regular)
                ...
                End If
            Case "IZ"
                FuenteImpresaEncabezado = New Font("Tahoma", 8, FontStyle.Regular)

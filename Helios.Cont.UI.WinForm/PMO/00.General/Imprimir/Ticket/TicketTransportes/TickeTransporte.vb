...
Public Class TickeTransporte
    ...
    Private Sub DibujaLaSubCabeceraIzquierda()
        ...
        For Each Cabecera As String In LineasDeEncabezadoIzquierda
            ...
            Dim R10 As New RectangleF(1, lineaEspacio, 60, 3)
            gfx.DrawString("AG. ORIGEN: " & CadenaPorEscribirEnLinea, FuenteImpresaEncabezado, Brushes.Black, R10, StringFormat)

            lineaEspacio += 3
            CadenaPorEscribirEnLinea = ordTot.ObtenerTelefono(Cabecera)
            Dim R11 As New RectangleF(1, lineaEspacio, 60, 3)
            gfx.DrawString("AG. DESTINO: " & CadenaPorEscribirEnLinea, FuenteImpresaEncabezado, Brushes.Black, R11, StringFormat)
            ...
            If (nombreArticlo.Length > 50) Then
                ...
                gfx.DrawString("COSIGNADO: " & CadenaPorEscribirEnLinea, FuenteImpresaEncabezado, Brushes.Black, R5, StringFormat)

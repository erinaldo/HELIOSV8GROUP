...
Public Class TickeNuevoFormato
        ...
        Try
            ...
            If (Not IsNothing(headerImageQR.Width)) Then
                If (headerImageQR.Width <> 0) Then
                    Dim destRect As New Rectangle(20, lineaEspacio + 5, 30, 30)
    ...
    Private Sub DibujaLaCabecera()
        ...
        Dim FuenteImpresaEncabezadoIzquierda = New Font("Tahoma", 6, FontStyle.Regular)
        ...
        Dim R3 As New RectangleF(1, lineaEspacio - 1, 65, 60)
        gfx.DrawString("--------------------------------------------------------------------------------", FuenteImpresaEncabezadoIzquierda, Brushes.Black, R3, StringFormatLinea)
    ...
    Private Sub DibujaLaSubCabeceraIzquierda()
        ...
        For Each Cabecera As String In LineasDeEncabezadoIzquierda
            ...
            gfx.DrawString("TIPO: " & CadenaPorEscribirEnLinea, FuenteImpresaEncabezado, Brushes.Black, R1, StringFormat)
            ...
            If (nombreArticlo.Length > 50) Then
                ...
                ''Else
                'gfx.DrawString("COMPRADOR: " & CadenaPorEscribirEnLinea, FuenteImpresaEncabezado, Brushes.Black, R5, StringFormat)
                ''End If

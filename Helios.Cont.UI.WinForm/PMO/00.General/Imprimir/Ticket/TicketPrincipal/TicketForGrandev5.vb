...
Public Class TicketForGrandev5
    ...
    Private Sub DibujaElementosFactura()
        ...
        For Each Item As String In LineasElementosFactura
            ...
            'se crea un rectangulo para manipular texto dentro del rectangulo
            Dim R3 As New RectangleF(15, lineaEspacio, 50, +10)
            Dim total As Integer
            Dim nombreArticlo As String
            'Dim enviarNombre As String
            ...
            If (total <= 39) Then
                saltodeLineaNombre = saltodeLineaNombre * 3
                Dim R15 As New RectangleF(12, lineaEspacio, 50, saltodeLineaNombre)
                'se captura NumeroRuc del Array
                gfx.DrawString(CadenaPorEscribirEnLinea, FuenteImpresaEncabezado, Brushes.Black, R15, StringFormatItem)
                lineaEspacio += 1
            ElseIf (total >= 40 And total <= 70) Then
                saltodeLineaNombre = 2 * 3
                Dim R15 As New RectangleF(12, lineaEspacio, 50, saltodeLineaNombre)
                'se captura NumeroRuc del Array
                gfx.DrawString(CadenaPorEscribirEnLinea, FuenteImpresaEncabezado, Brushes.Black, R15, StringFormatItem)
                lineaEspacio += 3
            ElseIf (total >= 71 And total <= 100) Then
                saltodeLineaNombre = 3 * 3
                Dim R15 As New RectangleF(12, lineaEspacio, 50, saltodeLineaNombre)
                'se captura NumeroRuc del Array
                gfx.DrawString(CadenaPorEscribirEnLinea, FuenteImpresaEncabezado, Brushes.Black, R15, StringFormatItem)
                lineaEspacio += 6
            ElseIf (total >= 101 And total <= 130) Then
                saltodeLineaNombre = 3 * 4
                Dim R15 As New RectangleF(12, lineaEspacio, 50, saltodeLineaNombre)
                'se captura NumeroRuc del Array
                gfx.DrawString(CadenaPorEscribirEnLinea, FuenteImpresaEncabezado, Brushes.Black, R15, StringFormatItem)
                lineaEspacio += 9
            ElseIf (total >= 131 And total <= 160) Then
                saltodeLineaNombre = 3 * 5
                Dim R15 As New RectangleF(12, lineaEspacio, 50, saltodeLineaNombre)
                'se captura NumeroRuc del Array
                gfx.DrawString(CadenaPorEscribirEnLinea, FuenteImpresaEncabezado, Brushes.Black, R15, StringFormatItem)
                lineaEspacio += 12
            ElseIf (total >= 161 And total <= 190) Then
                saltodeLineaNombre = 3 * 6
                Dim R15 As New RectangleF(12, lineaEspacio, 50, saltodeLineaNombre)
                'se captura NumeroRuc del Array
                gfx.DrawString(CadenaPorEscribirEnLinea, FuenteImpresaEncabezado, Brushes.Black, R15, StringFormatItem)
                lineaEspacio += 15
            ElseIf (total >= 191) Then

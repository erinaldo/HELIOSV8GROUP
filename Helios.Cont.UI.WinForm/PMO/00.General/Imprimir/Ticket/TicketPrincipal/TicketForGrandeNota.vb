...
Public Class TicketForGrandeNota
    ...
    Private Sub DibujaLaSubCabeceraIzquierda()
        ...
        For Each Cabecera As String In LineasDeEncabezadoIzquierda
            ...
            'se crea un rectangulo para manipular texto dentro del rectangulo
            Dim R12 As New RectangleF(1, lineaEspacio, 60, 3)
            'se captura NumeroRuc del Array
            CadenaPorEscribirEnLinea = ordTot.ObtenerdireccionEntrega(Cabecera)

            gfx.DrawString("FECHA DOC. ORIGEN: " & CadenaPorEscribirEnLinea, FuenteImpresaEncabezado, Brushes.Black, R12, StringFormat)
            lineaEspacio += 3
    ...
    Private Sub DibujaElementosFactura()
        ...
        gfx.DrawString("CANT        │ ARTICULO  │ UM │   P.U.   │ IMPORTE", FuenteImpresaEncabezado, Brushes.Black, REncabezado, StringFormatLinea)
        lineaEspacio += 3
        ...
        For Each Item As String In LineasElementosFactura
            'se crea un rectangulo para manipular texto dentro del rectangulo
            Dim R0 As New RectangleF(1, lineaEspacio, 15, +5)
            'con 7 de tamaño
            ...
            ''se crea un rectangulo para manipular texto dentro del rectangulo
            'Dim R3 As New RectangleF(16, lineaEspacio, 50, +10)
            Dim total As Integer
            Dim nombreArticlo As String
            ''Dim enviarNombre As String
            ...
            'se crea un rectangulo para manipular texto dentro del rectangulo
            Dim R4 As New RectangleF(28, lineaEspacio + 3, 10, +5)
            'Colocar la cantidad a la derecha.
            ...
            'se crea un rectangulo para manipular texto dentro del rectangulo
            Dim R5 As New RectangleF(32, lineaEspacio + 3, 15, +5)
            'Colocar la cantidad a la derecha.

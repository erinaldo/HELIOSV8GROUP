...
Public Class TicketForGrandetRest
    ...
    Private Sub DibujaLaSubCabeceraIzquierda()
        ...
        For Each Cabecera As String In LineasDeEncabezadoIzquierda
            ...
            ''gfx.DrawString("FECHA PEDIDO: " & CadenaPorEscribirEnLinea, FuenteImpresaEncabezado, Brushes.Black, R1, StringFormat)
            ''lineaEspacio += 3
            ...
            'Dim R20 As New RectangleF(1, lineaEspacio, 60, 25)
            ''se captura NumeroRuc del Array
            'CadenaPorEscribirEnLinea = ordTot.Obtenermoneda(Cabecera)

            'gfx.DrawString("INFRA: " & CadenaPorEscribirEnLinea, FuenteImpresaEncabezado, Brushes.Black, R20, StringFormat)
            'lineaEspacio += 3
            ...
            'If (CadenaPorEscribirEnLinea.Length > 22) Then

            '    Dim R13 As New RectangleF(1, lineaEspacio, 60, 9)

            '    gfx.DrawString("MOTIVO: " & CadenaPorEscribirEnLinea, FuenteImpresaEncabezado, Brushes.Black, R13, StringFormat)

            '    lineaEspacio += 6
            'Else
            '    Dim R13 As New RectangleF(1, lineaEspacio, 60, 3)
            '    gfx.DrawString("MOTIVO: " & CadenaPorEscribirEnLinea, FuenteImpresaEncabezado, Brushes.Black, R13, StringFormat)
            '    lineaEspacio += 3
            'End If

            ''se crea un rectangulo para manipular texto dentro del rectangulo
            'Dim R14 As New RectangleF(1, lineaEspacio, 60, 3)
            ''se captura NumeroRuc del Array
            'CadenaPorEscribirEnLinea = ordTot.Obtenermoneda(Cabecera)

            'gfx.DrawString("MONEDA: " & CadenaPorEscribirEnLinea, FuenteImpresaEncabezado, Brushes.Black, R14, StringFormat)
            'lineaEspacio += 3

            ''se captura NumeroRuc del Array
            'CadenaPorEscribirEnLinea = ordTot.ObtenerLugar(Cabecera)

            'If (CadenaPorEscribirEnLinea.Length > 15) Then

            '    Dim R1 As New RectangleF(1, lineaEspacio, 60, 9)

            '    gfx.DrawString("DOC. MODIFICA: " & CadenaPorEscribirEnLinea, FuenteImpresaEncabezado, Brushes.Black, R1, StringFormat)

            '    lineaEspacio += 6
            'Else
            '    Dim R1 As New RectangleF(1, lineaEspacio, 60, 3)
            '    gfx.DrawString("DOC AFECTADO: " & CadenaPorEscribirEnLinea, FuenteImpresaEncabezado, Brushes.Black, R1, StringFormat)
            ...
            '    Dim R3 As New RectangleF(1, lineaEspacio, 60, 9)
            '    CadenaPorEscribirEnLinea = nombreArticlo
            '    gfx.DrawString("CLIENTE: " & CadenaPorEscribirEnLinea, FuenteImpresaEncabezado, Brushes.Black, R3, StringFormat)

            '    lineaEspacio += 9

            '    CadenaPorEscribirEnLinea = ordTot.Obtenerdireccion(Cabecera)
            '    Dim R5 As New RectangleF(1, lineaEspacio, 60, 9)
            '    'If (CadenaPorEscribirEnLinea.Length >= 30) Then
            '    '    gfx.DrawString("COMPRADOR: " & CadenaPorEscribirEnLinea.Substring(0, 30), FuenteImpresaEncabezado, Brushes.Black, R5, StringFormat)
            '    'Else
            '    gfx.DrawString("DIRECCION: " & CadenaPorEscribirEnLinea, FuenteImpresaEncabezado, Brushes.Black, R5, StringFormat)
            '    'End If
            '    lineaEspacio += 3
            '    'lineaEspacio += 6
            'Else
            ...
            '    'CadenaPorEscribirEnLinea = ordTot.Obtenerdireccion(Cabecera)
            '    'If (CadenaPorEscribirEnLinea.Length = 0) Then
            ...
            '    '    gfx.DrawString("DIRECCION: " & CadenaPorEscribirEnLinea, FuenteImpresaEncabezado, Brushes.Black, R5, StringFormat)
            '    '    'End If
            '    'ElseIf (CadenaPorEscribirEnLinea.Length <= 28) Then
            '    '    Dim R5 As New RectangleF(1, lineaEspacio, 60, 3)
            '    '    'If (CadenaPorEscribirEnLinea.Length >= 30) Then
            '    '    '    gfx.DrawString("COMPRADOR: " & CadenaPorEscribirEnLinea.Substring(0, 30), FuenteImpresaEncabezado, Brushes.Black, R5, StringFormat)
            '    '    'Else
            ...
            '    'Else
            '    '    Dim R5 As New RectangleF(1, lineaEspacio, 60, 6)
            '    '    'If (CadenaPorEscribirEnLinea.Length >= 30) Then
            '    '    '    gfx.DrawString("COMPRADOR: " & CadenaPorEscribirEnLinea.Substring(0, 30), FuenteImpresaEncabezado, Brushes.Black, R5, StringFormat)
            '    '    'Else
            '    '    gfx.DrawString("DIRECCION: " & CadenaPorEscribirEnLinea, FuenteImpresaEncabezado, Brushes.Black, R5, StringFormat)
            ...
            'CadenaPorEscribirEnLinea = "COMPRADOR: " & ordTot.ObtenerdireccionEntrega(Cabecera)
            'total = CadenaPorEscribirEnLinea.Length
            'Dim saltodeLinea As Integer = 1
            'If (total <= 30) Then
            '    saltodeLinea = saltodeLinea * 3
            '    Dim R12 As New RectangleF(1, lineaEspacio, 60, saltodeLinea)
            '    'se captura NumeroRuc del Array
            '    gfx.DrawString(CadenaPorEscribirEnLinea, FuenteImpresaEncabezado, Brushes.Black, R12, StringFormat)

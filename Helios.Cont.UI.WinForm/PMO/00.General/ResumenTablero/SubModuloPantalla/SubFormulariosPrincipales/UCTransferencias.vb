...
#Region "Constructors"
    Public Sub New()
        ...
        FormatoGridAvanzado(dgvcompras, False, False, 8.0F)
        FormatoGridPrincipal(dgvcompras)
    End Sub
...
#Region "Events"
    ...
    Private Sub dgvcompras_TableControlCellClick(sender As Object, e As Grouping.GridTableControlCellClickEventArgs)

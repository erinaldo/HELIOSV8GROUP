...
Public Class FormTablaPrincipalPOS
...
#Region "Constructors"
    Public Sub New()
        ...
        UCProformasByUsuario = New UCProformasByUsuario With {.Dock = DockStyle.Fill, .Visible = True}
        UCPreVentasByUsuario = New UCPreVentasByUsuario With {.Dock = DockStyle.Fill, .Visible = False}
    ...
    Private Sub LinkLabel1_LinkClicked(sender As Object, e As LinkLabelLinkClickedEventArgs) Handles LinkLabel1.LinkClicked
        Dim f As New FormVentaNueva("PRE VENTA", "1")
    ...
    Private Sub LinkLabel2_LinkClicked(sender As Object, e As LinkLabelLinkClickedEventArgs) Handles LinkLabel2.LinkClicked
        Dim f As New FormVentaNueva("COTIZACION", "1")
        f.ComboComprobante.Enabled = False
        f.ComboComprobante.Text = "COTIZACION"
        f.StartPosition = FormStartPosition.CenterParent
        f.Show(Me)
    End Sub
    ...
    Private Sub TreeViewMenu_NodeMouseDoubleClick(sender As Object, e As TreeNodeMouseClickEventArgs) Handles TreeViewMenu.NodeMouseDoubleClick
        ...
        If TreeViewMenu.SelectedNode IsNot Nothing Then
            Select Case TreeViewMenu.SelectedNode.Text
                ...
                Case "Precios"
                    Dim FormPrecios = New FormExistenciaPreciosEquivalencia

...
Public Class frmBusquedaPersonaXCaja

#Region "Attributes"
    Public Property ListadoProveedores As New List(Of cajaUsuario)
    ...
    Public Property lista As New List(Of cajaUsuario)
#End Region
...
#Region "Constructors"
    Public Sub New()
        ...
        ListadoProveedores = New List(Of cajaUsuario)
        ListadoProveedores = UsuarioSA.ListadoCajaXEstado(UsuarioBE)
        TextBoxExt1.Focus()
        TextBoxExt1.Select()
        columnas()
    End Sub
...
#Region "Methods"
    Sub columnas()
        ...
        lsvListadoItems.Columns.Add("ID", 80, HorizontalAlignment.Left)
    ...
    Sub LlenarLSV(lista As List(Of cajaUsuario))
...
#Region "Events"
    Private Sub txtProveedor_KeyDown(sender As Object, e As KeyEventArgs) Handles txtPersona.KeyDown
        ...
        Else
            Dim con = (ListadoProveedores.Where(Function(s) s.NombrePersona.StartsWith(txtPersona.Text))).ToList()
            If con.Count > 0 Then
                LlenarLSV(con)
            End If
        End If
    ...
    Private Sub TextBoxExt1_KeyDown(sender As Object, e As KeyEventArgs) Handles TextBoxExt1.KeyDown
        ...
        If e.KeyCode = Keys.Enter Then
            ...
            Dim con = (ListadoProveedores.Where(Function(s) s.NombrePersona.StartsWith(TextBoxExt1.Text))).ToList()
            If (con.Count > 0) Then
    ...
    Public Sub ButtonAdv1_Click(sender As Object, e As EventArgs) Handles ButtonAdv1.Click
        ...
        For Each item As ListViewItem In lsvListadoItems.Items
            ...
            If item.Checked = True Then
                ...
                Dim usuarioID As New cajaUsuario

                With usuarioID
                    .idcajaUsuario = item.SubItems(0).Text
                    .NombrePersona = item.SubItems(2).Text
                    .numeroDocumento = item.SubItems(1).Text
                End With

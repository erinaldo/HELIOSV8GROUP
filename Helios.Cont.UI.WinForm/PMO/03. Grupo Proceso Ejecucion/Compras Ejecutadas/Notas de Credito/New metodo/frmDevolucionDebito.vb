...
Public Class frmDevolucionDebito
    Inherits frmMaster
...
#Region "Metodos"
    ...
    Sub AsientoNotaCreditoNormal(ListaExistencias As List(Of documentocompradetalle))
        ...
        If SumaCliente.totalMN.GetValueOrDefault > 0 Then
            ...
            nAsiento.tipoAsiento = ASIENTO_CONTABLE.Compra_AnulacionFinanciera
    ...
    Sub AsientoNotaCredito(consultaAsiento As List(Of documentocompradetalle))
        ...
        nMovimiento.tipo = "H"
        nMovimiento.monto = TotalesXcanbeceras.BaseMN
        nMovimiento.montoUSD = TotalesXcanbeceras.BaseME
        nMovimiento.usuarioActualizacion = usuario.IDUsuario
        nMovimiento.fechaActualizacion = DateTime.Now
        nAsiento.movimiento.Add(nMovimiento)
    ...
    Sub Grabar()
        ...
        With nDocumentoCompra
            ...
            .destino = TIPO_COMPRA.NOTA_DEBITO_DEVOLUCION
            .glosa = txtGlosa.Text.Trim
            ...
            .tipoCompra = TIPO_COMPRA.NOTA_DEBITO_DEVOLUCION
            .situacion = "ALTF"
        ...
        Dim consultaAsiento As List(Of documentocompradetalle) = (From i In ListaDetalle
        ...
        Dim xcod As Integer = CompraSA.SaveCompraNotaDevolucionGasto(ndocumento, DocCaja, Nothing)
    ...
    Private Sub MostrarColumnsByMoneda(strMoneda As String)
        ...
        dgvMov.TableDescriptor.Columns("canDev").Width = 0
        dgvMov.TableDescriptor.Columns("cantidad").Width = 0
    ...
    Public Sub UbicarDetalleByItemDirecto(intIdDocumento As Integer)
        ...
        Try
            ...
            For Each k In ListaSecuencia
                ...
                detalle = detalleSA.SumaNotasFinancierasDefault(k.secuencia)
                ...
                cTotalActmn = detalle.ImporteDBMN - detalle.importe
                cTotalActme = detalle.ImporteDBME - detalle.importeUS
                ...
                Me.dgvMov.Table.CurrentRecord.SetValue("kardexAct", detalle.montokardexDB)
                Me.dgvMov.Table.CurrentRecord.SetValue("kardexActME", detalle.montokardexDBUS)
    ...
    Public Sub UbicarDetalleByItem(intSecuenciaItem As Integer, intIdDocumento As Integer)
        ...
        Try
            ...
            detalle = detalleSA.SumaNotasFinancierasDefault(intSecuenciaItem)
            'detalle = detalleSA.SumaNotasXidPadreItemOpcionDefault(intSecuenciaItem)
...
#End Region
    ...
    Private Sub dgvCompra_TableControlCurrentCellControlDoubleClick(sender As Object, e As GridTableControlControlEventArgs) Handles dgvCompra.TableControlCurrentCellControlDoubleClick
        ...
        Else
            'Dim r As Record = dgv
            'Dim f As New frmNotaValidaAlmacen(New totalesAlmacen With {.idEmpresa = Gempresas.IdEmpresaRuc , .idEstablecimiento = GEstableciento.IdEstablecimiento, _
            '                                                           .idItem  = })
    ...
    Private Sub dgvCompraDetalle_TableControlCellDoubleClick(sender As Object, e As GridTableControlCellClickEventArgs) Handles dgvCompraDetalle.TableControlCellDoubleClick
        Me.Cursor = Cursors.WaitCursor
        Dim DocumentoCompraSA As New DocumentoCompraDetalleSA
        Try
            If e.Inner.RowIndex > -1 Then

                Dim r As Record = dgvCompraDetalle.Table.CurrentRecord
                If Not IsNothing(r) Then
                    ...
                    Else
                        ...
                        If Not IsNothing(r) Then
                            ...
                            UbicarDetalleByItem(dgvCompraDetalle.Table.CurrentRecord.GetValue("secuencia"), dgvCompra.Table.CurrentRecord.GetValue("idDocumento"))
                        End If
    ...
    Private Sub dgvCompra_TableControlCellClick_1(sender As Object, e As GridTableControlCellClickEventArgs) Handles dgvCompra.TableControlCellClick
        Me.Cursor = Cursors.WaitCursor
            ...
            If el IsNot Nothing Then
                ...
                If rec IsNot Nothing Then
                    ...
                    Else
                        ...
                        If rec.GetValue("cuotas") = 0 Then

                            UbicarCompraDetalle(CInt(rec.GetValue("idDocumento")))
                        Else
                            MessageBox.Show("El documento Tiene Cuotas Programadas debe eliminar cuotas programadas!", "Atención!", MessageBoxButtons.OK, MessageBoxIcon.Error)
                        End If
    ...
    Private Sub PictureBox1_Click(sender As Object, e As EventArgs) Handles PictureBox1.Click
        If Not IsNothing(Me.dgvCompra.Table.CurrentRecord) Then
            If dgvCompra.Table.SelectedRecords.Count > 0 Then


                If dgvCompra.Table.CurrentRecord.GetValue("cuotas") > 0 Then
                    ...
                    f.UbicarDocumentoDetalleCobros(dgvCompra.Table.CurrentRecord.GetValue("idDocumento"))
                    f.lblIdDocumento.Text = dgvCompra.Table.CurrentRecord.GetValue("idDocumento")
                    f.txtProveedor.Text = txtProveedor.Text
                    f.txtProveedor.Tag = txtProveedor.Tag
                    f.txtSerie.Text = dgvCompra.Table.CurrentRecord.GetValue("Serie")
                    f.txtNumero.Text = dgvCompra.Table.CurrentRecord.GetValue("Numero")
                    f.StartPosition = FormStartPosition.CenterParent
                    f.ShowDialog()
	...
	Private Sub dgvCompraDetalle_TableControlCurrentCellActivateFailed(sender As Object, e As GridTableControlCurrentCellActivateFailedEventArgs) Handles dgvCompraDetalle.TableControlCurrentCellActivateFailed

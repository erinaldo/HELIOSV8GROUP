...
Public Class frmViewNotaDebito
    Inherits frmMaster
    ...
    Public Sub UbicarDocumento(ByVal intIdDocumento As Integer)
        ...
        Try
            ...
            For Each i In objDocCompraDet.UbicarDocumentoCompraDetalle(intIdDocumento)
                ...
                With n.SubItems.Add(tablaSA.GetUbicarTablaID(12, i.operacionNota).descripcion)
                    .Font = New Font("Segoe UI Semibold", 7.5, Drawing.FontStyle.Regular Or Drawing.FontStyle.Italic)
                    .ForeColor = Color.Black
                End With
...
#End Region
    ...
    Private Sub frmViewNotaDebito_FormClosing(sender As Object, e As FormClosingEventArgs) Handles Me.FormClosing
        Dispose()
    End Sub

    Private Sub frmViewNotaDebito_Load(sender As Object, e As EventArgs) Handles MyBase.Load

...
Public Class frmCompraCreditoConRecepcion
    Inherits frmMaster
...
#End Region
    ...
    Public Sub New()
        ...
        configuracionModulo(Gempresas.IdEmpresaRuc, "C4", Me.Text)
...
#Region "Métodos DGV"
    ...
    Private Function GlosaCompra() As String
        ...
        Not String.IsNullOrEmpty(txtProveedor.Text) Then
            Return String.Concat("Por compras", Space(1), "según/ ", Space(1), cboTipoDoc.Text, Space(1), "Nro.", Space(1), txtSerie.Text, "-", txtNumero.Text)
        Else
            Return False
        End If
    End Function
...
#Region "Manipulación Data"
    ...
    Public Sub UbicarDocumento(ByVal intIdDocumento As Integer)
        ...
        Dim objAlmacenAnterior As New List(Of totalesAlmacen)
        Try
            ...
            Next
            '   txtAlmacen.Text = almacenSA.GetUbicar_almacenPorID(txtAlmacen.ValueMember).descripcionAlmacen
            'IdAlmacenBack = txtAlmacen.ValueMember
    ...
    '    objCaja.tipoMovimiento = TIPO_COMPRA.PAGO.PENDIENTE_PAGO
    ...
    '    objCaja.monedaObligacion = IIf(cboMoneda.SelectedValue = 1, "1", "2")
    ...
    '        objCajaDetalle.montoItf = 0
    '        objCajaDetalle.montoItfusd = 0
    ...
    '                .valcompraSinIgvMN = Math.Round(NIVAvalorVentaMN, 2)
    '                .valcompraSinIgvME = Math.Round(NIVAvalorVentaMN / TC, 2)
    ...
    '                .valorVentaMN = Math.Round(NIVAvalorVentaMN + (NIVAvalorVentaMN * IGV), 2)
    ...
    Sub Grabar()
        ...
        With nDocumentoCompra
            ...
            .destino = TIPO_COMPRA.COMPRA_AL_CREDITO_CON_RECEPCION
            ...
            .tipoCompra = TIPO_COMPRA.COMPRA_AL_CREDITO_CON_RECEPCION
        ...
        For Each i As DataGridViewRow In dgvCompra.Rows
            ...
            objDocumentoCompraDet.tipoCompra = TIPO_COMPRA.COMPRA_AL_CREDITO_CON_RECEPCION
        ...
        'listadoDePrecios = listaPrecioConIVA()
        'DocCaja = ComprobanteCaja()

        Dim xcod As Integer = CompraSA.SaveCompraAlCreditoConRecep(ndocumento, ListaTotales, listadoDePrecios, documentoTributo)
    ...
    Sub UpdateCompra()
        ...
        For Each i As DataGridViewRow In dgvCompra.Rows
            ...
            objDocumentoCompraDet.situacion = TIPO_SITUACION.ALMACEN_FISICO
            objDocumentoCompraDet.usuarioModificacion = "Jiu"
            objDocumentoCompraDet.fechaModificacion = DateTime.Now
        ...
        CompraSA.UpdateCompraAlCreditoCnRecep(ndocumento, ListaTotales, ListaDeleteEO)
...
#Region "VERIFICAR RUC"
    Private Function LeftC(ByVal str As String, ByVal Length As Integer) As String
    ...
    Private Function RightC(ByVal str As String, ByVal Length As Integer) As String
        Dim LenT As Integer = str.Length
        If LenT <= Length Then
            Return str
        Else
    ...
    Private Function VAL_RUC(ByVal RUC As String) As Boolean
        ...
        '20 persona juridica.
        '17 o 15 extranjeros
        Dim VAL_DIGIT() As String = {"10", "20", "17", "15"}
...
#End Region
    ...
    Private Sub txtTipoExistencia_TextChanged(sender As System.Object, e As System.EventArgs)

    End Sub

    Private Sub Label29_Click(sender As System.Object, e As System.EventArgs)
    ...
    Private Sub lsvProveedor_KeyDown(sender As Object, e As KeyEventArgs) Handles lsvProveedor.KeyDown
    ...
    Private Sub dgvCompra_CurrentCellDirtyStateChanged(sender As Object, e As EventArgs) Handles dgvCompra.CurrentCellDirtyStateChanged
        Try
    ...
    Private Sub dgvCompra_RowPostPaint(sender As Object, e As DataGridViewRowPostPaintEventArgs) Handles dgvCompra.RowPostPaint
    ...
    Private Sub dgvCompra_CellContentClick_1(sender As Object, e As DataGridViewCellEventArgs) Handles dgvCompra.CellContentClick
    ...
    Private Sub txtFechaComprobante_KeyPress(sender As Object, e As KeyPressEventArgs) Handles txtFechaComprobante.KeyPress
    ...
    Private Sub cboCuentas_Click(sender As Object, e As EventArgs) Handles cboCuentas.Click

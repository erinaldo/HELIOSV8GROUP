...
#End Region
    ...
    Public Sub New()
        ...
        configuracionModulo(Gempresas.IdEmpresaRuc, "C1", Me.Text)
...
#End Region
    ...
    '        locationX = (Cursor.Position.X + Me.rmGestionEntidad.Width / 8)
    '        If locationX + Me.rmGestionEntidad.Width > Screen.PrimaryScreen.Bounds.Width Then
    '            locationX = Screen.PrimaryScreen.Bounds.Width - Me.rmGestionEntidad.Width
    '        End If
    '        locationY = Cursor.Position.Y - Me.rmGestionEntidad.Height / 2
    '        If locationY + Me.rmGestionEntidad.Height > Screen.PrimaryScreen.Bounds.Height Then
    '            locationY = Screen.PrimaryScreen.Bounds.Height - Me.rmGestionEntidad.Height
    '        End If
    '        Dim location As New Point(locationX, locationY)
    '        Me.rmGestionEntidad.ShowRadialMenu(location)
    '        Me.rmGestionEntidad.PopupHost.Location = location
    '        If Me.rmGestionEntidad.PopupHost.Location.Y < 0 Then
    '            Me.rmGestionEntidad.PopupHost.Location = New Point(Me.rmGestionEntidad.PopupHost.Location.X, 0)
    '        End If
    '    End Sub

    '    Sub InitializeRAdial()
    '        rmGestionEntidad.Icon = My.Resources.configuration_13194
    '        rmGestionEntidad.MenuIcon = My.Resources.configuration_13194

    '        Me.rmGestionEntidad.ParentControl = Label11
    '        '    Me.rmGestionEntidad.MenuVisibility = True
    '        Me.rmGestionEntidad.OuterRimThickness = 10
    '        '     Me.MinimumSize = Me.Size
    '        Me.rmGestionEntidad.DisplayStyle = Syncfusion.Windows.Forms.Tools.DisplayStyle.Image
    ...
    '        rmGestionEntidad.ImageList = ImageList1
    '        rmNuevaEntidad.ImageIndex = 0
    '        rmEditarEntidad.ImageIndex = 1
    '        rmEliminar.ImageIndex = 2
    '        Me.rmGestionEntidad.RimBackground = Color.FromArgb(177, 245, 247) '("#FFFFD2")
...
#Region "Manipulación Data"
    ...
    Sub Grabar()
        ...
        For Each i As DataGridViewRow In dgvCompra.Rows
            ...
            objDocumentoCompraDet.tipoCompra = TIPO_COMPRA.COMPRA_AL_CREDITO
            ...
            Select Case dgvCompra.Rows(i.Index).Cells(21).Value()
                ...
                Case Else
                    If dgvCompra.Rows(i.Index).Cells(20).Value() <> Business.Entity.BaseBE.EntityAction.DELETE Then
                        ...
                        objTotalesDet.precioVenta = 0
                        objTotalesDet.precioVentaUS = 0
                        objTotalesDet.usuarioActualizacion = "Jiuni"
                        objTotalesDet.fechaActualizacion = Date.Now
                        ListaTotales.Add(objTotalesDet)
                    End If
...
#End Region
    ...
    Private Sub dropDownBtn_Click_1(sender As System.Object, e As System.EventArgs) Handles dropDownBtn.Click
        Me.popupControlContainer1.Font = New Font("Tahoma", 8)
    ...
    Private Sub txtNumeroGuia_SizeChanged(sender As Object, e As System.EventArgs) Handles txtNumeroGuia.SizeChanged
    ...
    Private Sub dgvCompra_CellEndEdit(sender As System.Object, e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dgvCompra.CellEndEdit
    ...
    Private Sub lsvListadoItems_MouseDoubleClick(sender As Object, e As System.Windows.Forms.MouseEventArgs) Handles lsvListadoItems.MouseDoubleClick
        ...
        If lsvListadoItems.SelectedItems.Count > 0 Then
            ...
            'If Not CInt(lsvListadoItems.SelectedItems(0).SubItems(2).Text) = CInt(dgvCompra.Item(2, dgvCompra.CurrentRow.Index).Value) Then
    ...
    Private Sub lsvServicios_MouseDoubleClick(sender As System.Object, e As System.Windows.Forms.MouseEventArgs) Handles lsvServicios.MouseDoubleClick
    ...
    Private Sub txtProveedor_MouseMove(sender As Object, e As System.Windows.Forms.MouseEventArgs) Handles txtProveedor.MouseMove
    ...
    'Private Sub Label11_MouseClick(sender As System.Object, e As System.Windows.Forms.MouseEventArgs) Handles Label11.MouseClick
    '    'If txtProveedor.Text.Trim.Length > 0 Then

    '    Me.rmGestionEntidad.ParentControl = Me.Label11
    '    setRadialMenuLocation()
    '    Me.rmGestionEntidad.CenterCircleRadiusFactor = New System.Drawing.Size(34, 34)
    '    'Else
    '    'Me.rmGestionEntidad.ParentControl = Me.txtProveedor
    '    'setRadialMenuLocation()
    '    'Me.rmGestionEntidad.CenterCircleRadiusFactor = New System.Drawing.Size(34, 34)
    '    'End If
    'End Sub
    ...
    Private Sub GradientPanel1_Paint(sender As System.Object, e As System.Windows.Forms.PaintEventArgs) Handles GradientPanel1.Paint
    ...
    Private Sub popupControlContainer1_Popup(sender As Object, e As EventArgs) Handles popupControlContainer1.Popup
        ...
        If lsvProveedor.Items.Count > 0 Then
            ...
            lsvProveedor.Items(0).Focused = True
            lsvProveedor.FocusedItem.EnsureVisible()
        End If
    End Sub
    ...
    Private Sub pcClasificacion_BeforeCloseUp(sender As Object, e As System.ComponentModel.CancelEventArgs) Handles pcClasificacion.BeforeCloseUp

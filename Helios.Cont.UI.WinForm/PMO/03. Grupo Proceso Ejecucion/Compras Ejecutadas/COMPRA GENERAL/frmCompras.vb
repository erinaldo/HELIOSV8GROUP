...
#Region "Fields"
    ...
    Public Property listaTipoExistencia As List(Of tabladetalle)
...
#Region "Constructors"
    ...
    Public Sub New(codigoLote As Integer, compradet As List(Of documentocompradetalle))
...
#Region "Background Controls"
    Public Sub GetCombos()
        ...
        Dim consultaExistencia = (From n In listaTipoExistencia
                                  Where Not listaNoExistencias.Contains(n.codigoDetalle)).ToList

        listaTipoExistencia = consultaExistencia
...
#Region "Métodos"
    ...
    Sub TipoCambio()
        For Each r As Record In dgvCompra.Table.Records
            ...
            ValidandoMontoTotalCuadre(r, VC, VCme, Igv, IgvME)
    ...
    Private Sub ListaMercaderias(strTipoEx As String, strBusqueda As String)
        ...
        Dim consulta = existenciaSA.GetItemsByDescripcion(New Business.Entity.detalleitems With {.descripcionItem = strBusqueda}) _
        .Where(Function(o) o.estado = "A" And o.tipoExistencia = strTipoEx).ToList


        'For Each i In existenciaSA.GetUbicarProductoXdescripcion2(Gempresas.IdEmpresaRuc, GEstableciento.IdEstablecimiento, Nothing, strTipoEx, strBusqueda).Where(Function(o) o.estado = "A").ToList
        For Each i In consulta
            Dim n As New ListViewItem(i.codigodetalle)
            '   n.SubItems.Add(i.descripcionItem)
...
#Region "Events"
    Private Sub frmCompras_FormClosing(sender As Object, e As FormClosingEventArgs) Handles MyBase.FormClosing
                ...
                If txtTipoCambio.DecimalValue > 0 Then
                    If MessageBoxAdv.Show("Desea agregar el producto a la canasta de compras?", "tención", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = vbYes Then
                        If datos(0).Cuenta = "Grabado" Then
                            '  If lsvListadoItems.SelectedItems.Count > 0 Then
                            'String.Format("{0}-{1}", i.descripcionItem, i.NomMarca)
                            With objInsumo.InvocarProductoID(CInt(datos(0).ID))
                                ...
                                Me.dgvCompra.Table.CurrentRecord.SetValue("item", String.Format("{0}-{1}", .descripcionItem, datos(0).NomEvento))
                                ...
                                Me.dgvCompra.Table.CurrentRecord.SetValue("chBonif", False)
                                Me.dgvCompra.Table.CurrentRecord.SetValue("valBonif", "N")
                                If txtSerie.Text.Trim.Length > 0 AndAlso txtNumero.Text.Trim.Length > 0 Then
                                    Me.dgvCompra.Table.CurrentRecord.SetValue("lote", txtSerie.Text & "-" & txtNumero.Text)
                                Else
                                    Me.dgvCompra.Table.CurrentRecord.SetValue("lote", Nothing)
                                End If
    ...
    Private Sub lsvListadoItems_MouseDown(sender As Object, e As MouseEventArgs) Handles lsvListadoItems.MouseDown
    ...
    Private Sub dgvCompra_NavigationBarRecordChanged(sender As Object, e As CurrentRecordEventArgs) Handles dgvCompra.NavigationBarRecordChanged
    ...
    Private Sub ValidandoMontoTotalCuadre(r As Record, ByRef VC As Decimal, ByRef VCme As Decimal, Igv As Decimal, IgvME As Decimal)
        Select Case cboMoneda.SelectedValue
            ...
            Case 2 'cuando el moneda extranjera
                ...
                ColTotalRecord = Math.Round(ColTotalRecord, 2)
                If ColTotalRecord > CDec(r.GetValue("totalme")) Then
    ...
    Private Sub cboMoneda_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cboMoneda.SelectedIndexChanged
        If Not IsNothing(TotalesXcanbeceras) Then
            If cboMoneda.SelectedValue = 2 Then
                ...
                dgvCompra.TableDescriptor.Columns("igvme").Width = 65
                dgvCompra.TableDescriptor.Columns("totalme").Width = 70
                dgvCompra.TableDescriptor.Columns("percepcionME").Width = 0 ' 70
                dgvCompra.TableDescriptor.Columns("tipoExistencia").Width = 50
                '   cboMoneda.SelectedValue = 2
            ...
            ElseIf cboMoneda.SelectedValue = 1 Then
                ...
                dgvCompra.TableDescriptor.Columns("igvmn").Width = 65
                dgvCompra.TableDescriptor.Columns("totalmn").Width = 70
                dgvCompra.TableDescriptor.Columns("percepcionMN").Width = 0 '70
                dgvCompra.TableDescriptor.Columns("tipoExistencia").Width = 50

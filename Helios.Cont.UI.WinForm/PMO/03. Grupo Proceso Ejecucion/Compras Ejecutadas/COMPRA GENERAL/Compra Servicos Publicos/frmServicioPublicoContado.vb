...
Public Class frmServicioPublicoContado
    Inherits frmMaster
...
#End Region
    ...
    Private Sub btGrabar_Click(sender As Object, e As EventArgs) Handles btGrabar.Click
        ...
        Try
            ...
            If Not txtFecVcto.Value.Date >= txtFecha.Value.Date Then
    ...
    Private Sub frmServicioPublicoContado_KeyDown(sender As Object, e As KeyEventArgs) Handles MyBase.KeyDown
        Me.Cursor = Cursors.WaitCursor
        Try

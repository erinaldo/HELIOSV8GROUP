...
#Region "Métodos"
    ...
    Public Sub UbicarPorID(intCodigo As Integer)
        ...
        With entidadSA.GetUbicar_estadosFinancierosPorID(intCodigo)
            Select Case .tipo
                ...
                Case "BC"
                    cboTipoCuenta.Text = "Cuenta Bancaria"'"Banco"
                Case "TC"
    ...
    Public Function GetDocumento() As documento
        ...
        With ndocumento
            ...
            .idCentroCosto = IdUnidOrg 'GEstableciento.IdEstablecimiento
        ...
        With ndocumentoCaja
            ...
            .idEmpresa = Gempresas.IdEmpresaRuc
            .idEstablecimiento = IdUnidOrg ' GEstableciento.IdEstablecimiento
    ...
    Public Sub AsientoContableCaja()
        ...
        asientoBL.idCentroCostos = IdUnidOrg '= GEstableciento.IdEstablecimiento
    ...
    Public Sub Grabar()
        ...
        With entidad
            ...
            .nroCtaInterbancaria = txtNroCuentaInterbancaria.Text
            .modalidadCuenta = cboModalidadCtaBancaria.Text
            .tipocambio = 1
    ...
    Private Sub cboTipoCuenta_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cboTipoCuenta.SelectedIndexChanged
        Select Case cboTipoCuenta.Text
            Case "Caja", "Caja Pos"
                ...
                txtNroCuentaInterbancaria.Visible = False
                Label8.Visible = False
                txtCodigoCuenta.Text = "101"
                cboModalidadCtaBancaria.Visible = False
            Case "Tarjeta de Crédito"
            ...
            Case "Cuenta Bancaria" '"Banco"
                ...
                txtNroCuentaInterbancaria.Visible = True
                Label8.Visible = True
                txtCodigoCuenta.Text = "104"
                cboModalidadCtaBancaria.Visible = True
        End Select
    End Sub

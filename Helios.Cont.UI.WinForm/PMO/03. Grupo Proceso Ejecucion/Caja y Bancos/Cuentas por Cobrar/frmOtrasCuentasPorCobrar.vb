...
Public Class frmOtrasCuentasPorCobrar
...
#Region "Métodos"
    ...
    Public Sub UbicarDocumentosPorCliente(strCliente As String, strPeriodo As String)
        ...
        lsvDocs.Items.Clear()
        For Each i As documentoCajaDetalle In docCajaSA.SumaCobroPorModulo(GEstableciento.IdEstablecimiento, strCliente, strPeriodo, TIPO_VENTA.INGRESO_CAJA_OTROS_CONCEPTOS)
    ...
    Sub ProveedoresShows()
        ...
        '    If cboEntidad.Text = "Proveedor" Then
        '        .lblTipo.Text = TIPO_ENTIDAD.PROVEEDOR
        '    ElseIf cboEntidad.Text = "Cliente" Then
...
#End Region
    ...
    Private Sub cboEntidad_KeyPress(sender As Object, e As System.Windows.Forms.KeyPressEventArgs) Handles cboEntidad.KeyPress
        e.Handled = True
    End Sub

    Private Sub cboEntidad_TextChanged(sender As System.Object, e As System.EventArgs) Handles cboEntidad.TextChanged
    ...
    Private Sub ToolStripComboBox1_SelectedIndexChanged(sender As Object, e As System.EventArgs) Handles ToolStripComboBox1.SelectedIndexChanged
        ...
        ElseIf ToolStripComboBox1.Text = "POR ENTIDAD" Then
    ...
    Private Sub frmOtrasCuentasPorCobrar_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        TabPage2.Parent = TabControl1
        TabPage1.Parent = Nothing
        ToolStripComboBox1.Text = "POR ENTIDAD"
    End Sub
End Class
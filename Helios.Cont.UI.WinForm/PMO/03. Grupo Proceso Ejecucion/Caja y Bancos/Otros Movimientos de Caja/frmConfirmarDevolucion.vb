...
Public Class frmConfirmarDevolucion
    Inherits frmMaster
...
#End Region
    ...
    Public Sub GetCuentasFinancieras(tipo As String, descripcion As String)
        ...
        For Each i In estadosFinancierosSA.GetCuentasFinancierasEmpresaXtipoFecha(New Business.Entity.estadosFinancieros With {.idEmpresa = Gempresas.IdEmpresaRuc, .tipo = tipo, .fechaBalance = New DateTime(txtAnioCompra.Text, CInt(cboMesCompra.SelectedValue), txtDia.Value.Day, Date.Now.Hour, Date.Now.Minute, Date.Now.Second)})
    ...
    Public Function Glosa() As String
        Return "Por movimientos " & "de devolución de anticipo" & " con fecha " & New DateTime(CInt(txtAnioCompra.Text), CInt(cboMesCompra.SelectedValue), txtDia.Value.Day, Date.Now.Hour, Date.Now.Minute, Date.Now.Second)
    End Function
    ...
    Public Sub GrabarOtrosMovimientos()
        ...
        With ndocumentoCaja
                ...
                Case "OSC"
                    ...
                    Select Case tipoEntidad
                        Case TIPO_ENTIDAD.CLIENTE
                            .tipoOperacion = StatusTipoOperacion.DEVOLUCION_DE_ANTICIPO_A_CLIENTE
                        Case TIPO_ENTIDAD.PROVEEDOR
                            .tipoOperacion = StatusTipoOperacion.DEVOLUCION_DE_ANTICIPO_A_PROVEEDOR
                        Case TIPO_ENTIDAD.PERSONA_GENERAL
                            .tipoOperacion = StatusTipoOperacion.DEVOLUCION_DE_ANTICIPO_A_TRABAJADOR
                    End Select
            ...
            If (DigitalGauge2.Value = txtFondoMN.Value) Then
                .estado = "D"
                .tipo = TIPO_ESTADO_cAJA.USADO_TOTAL
            ElseIf (txtFondoMN.Value < digitalGauge2.Value) Then
                .estado = "D"
                .tipo = TIPO_ESTADO_cAJA.USADO_PARCIAL
            End If
            .idcosto = Nothing

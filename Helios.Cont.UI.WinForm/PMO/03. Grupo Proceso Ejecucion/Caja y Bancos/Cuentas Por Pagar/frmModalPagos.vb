...
#Region "Métodos"
    ...
    Public Sub UbicarDocumento(intIdDocumento As Integer, importeMN As Decimal, importeUS As Decimal)
        ...
        Try
            ...
            With documentoCajaSA.ObtenerCajaDetallePorId(intIdDocumento)
                ...
                TxtDia.Text = .fechaProceso.Value.Day
                cboAnio.Text = .fechaProceso.Value.Year
                ...
                With alEFSA.GetUbicar_estadosFinancierosPorID(.entidadFinanciera)
                    ...
                    'cargarDatosCuenta(txtCF_name.tag)
    ...
    Sub CalculoGRID()
        ...
        If (txtCF_moneda.Tag = 1 And tb19.ToggleState = ToggleButton2.ToggleButtonState.ON) Then
        ...
        ElseIf (txtCF_moneda.Tag = 2 And tb19.ToggleState = ToggleButton2.ToggleButtonState.OFF) Then
...
#Region "Manipulación data"
    ...
    Public Function AS_DebeCaja(Cuenta As String, cDescripcion As String, cMonto As Decimal, cMontoUS As Decimal) As movimiento
        ...
        nMovimiento = New movimiento With {
              ...
              .montoUSD = cMontoUS,
              .fechaActualizacion = DateTime.Now,
              .usuarioActualizacion = txtCF_name.tag}
        Return nMovimiento
    End Function
        ...
        For Each i As DataGridViewRow In dgvDetalleItems.Rows
            If CDec(dgvDetalleItems.Rows(i.Index).Cells(6).Value()) > 0 Then
                ...
                Select Case txtCF_moneda.Tag
                    Case 1
                        If (txtCF_moneda.Tag = 1 And tb19.ToggleState = ToggleButton2.ToggleButtonState.OFF) Then
                            ...
                            Else
                                ...
                                nAsiento.movimiento.Add(AS_DebeCaja(cuentaFinacieraSA.GetUbicar_estadosFinancierosPorID(txtCF_name.tag).cuenta, dgvDetalleItems.Rows(i.Index).Cells(1).Value(), dgvDetalleItems.Rows(i.Index).Cells(6).Value(), dgvDetalleItems.Rows(i.Index).Cells(7).Value()))
                            End If
                    ...
                    Select Case tb19.ToggleState
                        ...
                        Case ToggleButton2.ToggleButtonState.ON 'soles
                            If (CDec(r.GetValue("difMNCajaMN") > 0)) Then
                                ...
                                'cuentas Maykol de tratamiento de caja
                                nAsiento.movimiento.Add(AS_HaberCajaDiferencia(sumaAsientocajaMN, 0.0, ASIENTO_CONTABLE.UBICACION.DEBE, txtCF_cuentaContable.Text, txtCF_name.Text))
                                nAsiento.movimiento.Add(AS_DebeCajaDiferencia("776", "Por la utlidad de las diferencias de tipo de cambio", sumaAsientocajaMN, 0.0, ASIENTO_CONTABLE.UBICACION.HABER))
                            ElseIf (CDec(r.GetValue("difMNCajaMN") < 0)) Then
                                sumaAsientocajaMN = CDec((r.GetValue("difMNCajaMN")) * -1)
                                nAsiento.movimiento.Add(AS_DebeCajaDiferencia("676", "Por la pérdida por la diferencias de tipo de cambio ", sumaAsientocajaMN, 0.0, ASIENTO_CONTABLE.UBICACION.DEBE))
                                nAsiento.movimiento.Add(AS_HaberCajaDiferencia(sumaAsientocajaMN, 0.0, ASIENTO_CONTABLE.UBICACION.HABER, txtCF_cuentaContable.Text, txtCF_name.Text))
                            End If
                    End Select
    ...
    Public Sub GrabarReclamacion()
        ...
        With ndocumentoCaja
            ...
            If cboTipoDoc.SelectedValue = "001" Then
                ...
                .fechaProceso = New DateTime(CInt(cboAnio.Text), CInt(cboMesCompra.SelectedValue), TxtDia.Text, Date.Now.Hour, Date.Now.Minute, Date.Now.Second)
                .fechaCobro = New DateTime(CInt(cboAnio.Text), CInt(cboMesCompra.SelectedValue), TxtDia.Text, Date.Now.Hour, Date.Now.Minute, Date.Now.Second)
                .entregado = "SI"
            ...
            .glosa = Glosa()
            .usuarioModificacion = txtCF_name.Tag
        ...
        ndocumento.documentoCaja = ndocumentoCaja
            ...
            If CDec(dgvDetalleItems.Rows(i.Index).Cells(6).Value()) > 0 Then
                ...
                ndocumentoCajaDetalle.usuarioModificacion = CStr(txtCF_name.tag)
        ...
        'ListadocumentoCajaDetalle2 = ndocumentoCajaDetalleSA.ConsultaMovimientoME(txtCF_name.tag)
    ...
    Public Sub Grabar()
        ...
        With ndocumentoCaja
            .movimientoCaja = MovimientoCaja.PagoProveedor
            .estado = "1"
            .codigoLibro = "1"
            .tipoOperacion = "9907"
            .periodo = String.Format("{0:00}", txtPeriodo.Value.Month) & "/" & txtPeriodo.Value.Year
        ...
        For Each i As DataGridViewRow In dgvDetalleItems.Rows
            If CDec(dgvDetalleItems.Rows(i.Index).Cells(6).Value()) > 0 Then
                ...
                ndocumentoCajaDetalle.documentoAfectado = lblIdDocumento.Text
                ndocumentoCajaDetalle.usuarioModificacion = usuario.IDUsuario  'CStr(txtCF_name.tag)
    ...
    Function Glosa() As String
        ...
        strGlosa = "Por pagos con comprobante, en " & cboTipoDoc.Text & " con fecha: " & New DateTime(CInt(cboAnio.Text), CInt(cboMesCompra.SelectedValue), TxtDia.Text, Date.Now.Hour, Date.Now.Minute, Date.Now.Second)
        Return strGlosa
    End Function
    Function GlosaReclamacion() As String
        Dim strGlosa As String = Nothing
        strGlosa = "Por pagos de reclamación, en " & cboTipoDoc.Text & " con fecha: " & New DateTime(CInt(cboAnio.Text), CInt(cboMesCompra.SelectedValue), TxtDia.Text, Date.Now.Hour, Date.Now.Minute, Date.Now.Second)
        Return strGlosa
    End Function
#End Region
    ...
    Function GetSaldoEF() As GFichaUsuario
        ...
        EF = EFSA.GetEstadoSaldoEF(New estadosFinancieros With {.idestado = txtCF_name.tag})
            ...
            Select Case txtCF_moneda.tag
                Case 1
                    If (txtPagoMN.Value <= SaldoEFMN.DoubleValue) Then
                        ...
                        For Each i As documentoCajaDetalle In documentoCajaEtalleSA.ObtenerCajaDetalleME(txtPagoMN.Value, txtCF_name.tag)
                ...
                Case 2
                    If (txtPagoME.Value <= SaldoEFME.DoubleValue) Then
                        ...
                        For Each i As documentoCajaDetalle In documentoCajaEtalleSA.ObtenerCajaDetalleME(txtPagoME.Value, txtCF_name.tag)
                            Dim n As New ListViewItem(i.idDocumento)
                            n.SubItems.Add(CDec(i.diferTipoCambio))
                            n.SubItems.Add(CDec(i.montoUsd).ToString("N2"))
                            n.SubItems.Add(CDec(i.montoSoles).ToString("N2"))
    ...
    Public Sub CargarDiferenciasdeImporte()
        ...
        If (txtCF_moneda.tag = 2 And tb19.ToggleState = ToggleButton2.ToggleButtonState.OFF) Then
            ListadocumentoCajaEtalle = documentoCajaEtalleSA.ObtenerCajaDetalleME(txtPagoME.Value, txtCF_name.tag)
    ...
    Private Sub LinkLabel1_LinkClicked(sender As Object, e As LinkLabelLinkClickedEventArgs) Handles LinkLabel1.LinkClicked
        ...
        Else
            estado = estadoSA.GetUbicar_estadosFinancierosPorID(txtCF_name.tag)

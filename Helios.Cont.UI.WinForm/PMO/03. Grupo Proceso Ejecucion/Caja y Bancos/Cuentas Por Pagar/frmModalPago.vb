...
#Region "Métodos"
        ...
        Try
            ...
            With documentoCajaSA.GetUbicar_documentoCajaPorID(intIdDocumento)
                ...
                With entidadSA.UbicarEntidadPorID(.codigoProveedor).First
                    lblNomProveedor.Text = .nombreCompleto
                    lblIdProveedor.Text = .idEntidad
                    lblCuentaProveedor.Text = .cuentaAsiento
                End With
    ...
    Public Function AS_HaberCliente(cMonto As Decimal, cMontoUS As Decimal) As movimiento
        Dim nMovimiento As New movimiento
        nMovimiento = New movimiento With {
      .cuenta = lblCuentaProveedor.Text,
      .descripcion = lblNomProveedor.Text,
    ...
    Function asientoCaja() As asiento
        ...
        nAsiento.idEntidad = lblIdProveedor.Text
        nAsiento.nombreEntidad = lblNomProveedor.Text
    ...
    Function Glosa() As String
        ...
        With frmCuentasPorPagar
            If .TabControl1.SelectedTab Is .TabPage2 Then
                strGlosa = "Por pago de la compra, doc/: " & .txtIdComprobante.Text & _
         " número: " & .txtNumDoc.Text

            ElseIf .TabControl1.SelectedTab Is .TabPage1 Then
                With .lsvDocs.SelectedItems(0)
                    strGlosa = "Por pago de la compra, doc/: " & .SubItems(1).Text & _

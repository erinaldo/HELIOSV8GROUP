...
Public Class frmReporteMovimientoCaja
    Inherits frmMaster
    ...
    Public Sub ConsultaReporteTotalesPorPeriodo(strPeriodo As String)
        Dim totalesAlmacenSA As New documentoCajaRPTSA
        Dim totalUtilidad As Decimal = 0
        Dim totalUtilidadme As Decimal = 0
        Dim totalVentas As Decimal = 0
        Me.reportName = "Helios.Cont.Presentation.WinForm.ReporteMovimientoCaja.rdlc"
        Me.reportData = totalesAlmacenSA.GetListarMvimientosCajaPorPeriodoReporte(Gempresas.IdEmpresaRuc, GEstableciento.IdEstablecimiento, strPeriodo)
    ...
    Public Sub ConsultaReporteTotalesPorDia()
        ...
        Dim totalVentas As Decimal = 0
        Me.reportName = "Helios.Cont.Presentation.WinForm.ReporteMovimientoCaja.rdlc"
        Me.reportData = totalesAlmacenSA.GetListarMvimientosCajaPorDiaReporte(Gempresas.IdEmpresaRuc, GEstableciento.IdEstablecimiento)
        Me.nombreMainDS = "DSCaja"
        Dim reporte As New ReportDataSource(nombreMainDS, reportData)
        rptAportes.KeepSessionAlive = True
        rptAportes.Reset()

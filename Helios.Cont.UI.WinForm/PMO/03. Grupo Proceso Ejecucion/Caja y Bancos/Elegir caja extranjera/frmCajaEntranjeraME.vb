...
Public Class frmCajaEntranjeraME
    ...
    Public Sub New(be As estadosFinancieros, venta As documentoventaAbarrotes)
        ...
        TextMonedaObligacion.Text = If(_venta.moneda = "1", "SOLES", "MON.EXTRANJERA")
    End Sub
...
#Region "Events"
        ...
        Try
            ...
            Select Case _venta.moneda
                ...
                Case "2"
                    If cboPago.Text = "NACIONAL" Then
                        If TxtMontoDesembolso.DoubleValue > 0 Then
                            Dim limiteSoles = Math.Round(txtDeuda.DoubleValue * txtTipoCambio.DoubleValue, 2)
                            TxtMontoDesembolso.MaxValue = limiteSoles
                    ...
                    Else
                        If TxtMontoDesembolso.DoubleValue > 0 Then
                            Dim limiteDolares = txtDeuda.DoubleValue
                            TxtMontoDesembolso.MaxValue = limiteDolares
    ...
    Private Sub frmCajaEntranjeraME_Load(sender As Object, e As EventArgs) Handles Me.Load

...
Public Class frmPrestamoRecibido
    ...
    Public Sub New()
        ...
        configuracionModuloV2(Gempresas.IdEmpresaRuc, "PTR", Me.Text, GEstableciento.IdEstablecimiento)
...
#Region "metodos"
    ...
    Sub ConfiguracionInicio()
        ...
        DockingManager1.DockControlInAutoHideMode(GradientPanel3, Syncfusion.Windows.Forms.Tools.DockingStyle.Left, 400)
        ...
        DockingManager1.SetDockLabel(GradientPanel3, "Cuentas")
    ...
    Sub ListaTipoPrestamos()
        ...
        cboTipoPR.DataSource = tablaSA.ListaConceptosPrestamo("PR", "PR")
    ...
    Public Sub GrabarToDocumentoPrestamo()
        ...
        Try
            ...
            With prestamoEO
                ...
                .tipoPrestamo = "PRC" ' Prestamo recibido
                                ...
                                For Each i As Record In dgvConceptos2.Table.Records
                                    If i.GetValue("descripcion") = "INTERES" Then
                                        If txtInteresMN.Value > 0 Then
                                            ...
                                            Me.dgvPrestamoRO.Table.AddNewRecord.EndEdit()
                                            'ultimo
                                        ElseIf txtInteresMN.Value = 0 Then
                                            Me.dgvPrestamoRO.Table.AddNewRecord.SetCurrent()
                                            Me.dgvPrestamoRO.Table.AddNewRecord.BeginEdit()
                                            Me.dgvPrestamoRO.Table.CurrentRecord.SetValue("idCuota", cuota)
                                            Me.dgvPrestamoRO.Table.CurrentRecord.SetValue("cuota", cuota)
                                            Me.dgvPrestamoRO.Table.CurrentRecord.SetValue("descripcion", "INTERES")
                                            Me.dgvPrestamoRO.Table.CurrentRecord.SetValue("montomn", Format(Math.Round(CDec(0.0), 2), "#,###,###,#0.00"))
                                            Me.dgvPrestamoRO.Table.CurrentRecord.SetValue("montome", Format(Math.Round(CDec(0.0), 2), "#,###,###,#0.00"))
                                            Me.dgvPrestamoRO.Table.CurrentRecord.SetValue("FechaVct", fechaModo)
                                            Me.dgvPrestamoRO.Table.CurrentRecord.SetValue("FechaPlazo", fechaAux)
                                            Me.dgvPrestamoRO.Table.CurrentRecord.SetValue("cuenta", i.GetValue("cuenta"))
                                            Me.dgvPrestamoRO.Table.CurrentRecord.SetValue("cuentaH", i.GetValue("cuentaH"))
...
#End Region
    ...
    Private Sub frmPrestamoRecibido_FormClosing(sender As Object, e As FormClosingEventArgs) Handles Me.FormClosing
        Dispose()
    End Sub
    ...
    '    dgvPrestamos.TableDescriptor.Columns("colInteresSoles").Width = 0
    '    dgvPrestamos.TableDescriptor.Columns("Seguro").Width = 0
    '    dgvPrestamos.TableDescriptor.Columns("Otro").Width = 0
    '    dgvPrestamos.TableDescriptor.Columns("Portes").Width = 0
    '    dgvPrestamos.TableDescriptor.Columns("EnvioCuenta").Width = 0
    '    dgvPrestamos.TableDescriptor.Columns("colTotalSoles").Width = 0

    '    dgvPrestamos.TableDescriptor.Columns("colcapitalUSD").Width = 75
    '    dgvPrestamos.TableDescriptor.Columns("colInteresUSD").Width = 75
    '    dgvPrestamos.TableDescriptor.Columns("SeguroME").Width = 75
    '    dgvPrestamos.TableDescriptor.Columns("otroME").Width = 75
    '    dgvPrestamos.TableDescriptor.Columns("PortesME").Width = 75
    '    dgvPrestamos.TableDescriptor.Columns("EnvCuentaME").Width = 75
    '    dgvPrestamos.TableDescriptor.Columns("colTotalUSD").Width = 75
    ...
    '    dgvPrestamos.TableDescriptor.Columns("colInteresSoles").Width = 75
    '    dgvPrestamos.TableDescriptor.Columns("Seguro").Width = 75
    '    dgvPrestamos.TableDescriptor.Columns("Otro").Width = 75
    '    dgvPrestamos.TableDescriptor.Columns("Portes").Width = 75
    '    dgvPrestamos.TableDescriptor.Columns("EnvioCuenta").Width = 75
    '    dgvPrestamos.TableDescriptor.Columns("colTotalSoles").Width = 75

    '    dgvPrestamos.TableDescriptor.Columns("colcapitalUSD").Width = 0
    '    dgvPrestamos.TableDescriptor.Columns("colInteresUSD").Width = 0
    '    dgvPrestamos.TableDescriptor.Columns("SeguroME").Width = 0
    '    dgvPrestamos.TableDescriptor.Columns("otroME").Width = 0
    '    dgvPrestamos.TableDescriptor.Columns("PortesME").Width = 0
    '    dgvPrestamos.TableDescriptor.Columns("EnvCuentaME").Width = 0
    '    dgvPrestamos.TableDescriptor.Columns("colTotalUSD").Width = 0
    ...
    Private Sub dgvPrestamos_TableControlCellClick(sender As Object, e As GridTableControlCellClickEventArgs)

    End Sub

    Private Sub dgvPrestamos_TableControlCurrentCellEditingComplete(sender As Object, e As GridTableControlEventArgs)
        ...
        '            colCapitalME = Math.Round(CDec(Me.dgvPrestamos.Table.CurrentRecord.GetValue("colcapital")) / CDec(txtTipoCambio.Value), 2)
        '            Me.dgvPrestamos.Table.CurrentRecord.SetValue("colcapitalUSD", colCapitalME)


        '            Dim totalSoles As Decimal = 0
        '            totalSoles = Math.Round(CDec(Me.dgvPrestamos.Table.CurrentRecord.GetValue("colcapital")), 2) + Math.Round(CDec(Me.dgvPrestamos.Table.CurrentRecord.GetValue("colInteresSoles")), 2) +
        '                         Math.Round(CDec(Me.dgvPrestamos.Table.CurrentRecord.GetValue("Seguro")), 2) + Math.Round(CDec(Me.dgvPrestamos.Table.CurrentRecord.GetValue("Otro")), 2) +
        '                         Math.Round(CDec(Me.dgvPrestamos.Table.CurrentRecord.GetValue("Portes")), 2) + Math.Round(CDec(Me.dgvPrestamos.Table.CurrentRecord.GetValue("EnvioCuenta")), 2)

        '            Me.dgvPrestamos.Table.CurrentRecord.SetValue("colTotalSoles", totalSoles)


        '            Dim totalSolesME As Decimal = 0
        '            totalSolesME = Math.Round(CDec(Me.dgvPrestamos.Table.CurrentRecord.GetValue("colcapitalUSD")), 2) + Math.Round(CDec(Me.dgvPrestamos.Table.CurrentRecord.GetValue("colInteresUSD")), 2) +
        '                           Math.Round(CDec(Me.dgvPrestamos.Table.CurrentRecord.GetValue("SeguroME")), 2) + Math.Round(CDec(Me.dgvPrestamos.Table.CurrentRecord.GetValue("otroME")), 2) +
        '                           Math.Round(CDec(Me.dgvPrestamos.Table.CurrentRecord.GetValue("PortesME")), 2) + Math.Round(CDec(Me.dgvPrestamos.Table.CurrentRecord.GetValue("EnvCuentaME")), 2)

        '            Me.dgvPrestamos.Table.CurrentRecord.SetValue("colTotalUSD", totalSolesME)

        '            Dim cap As Decimal
        '            cap = 0
        '            For Each i As Record In dgvPrestamos.Table.Records
        '                cap += i.GetValue("colcapital")
        '            Next

        '            If cap > txtImporteCompramn.Value Then
        '                Me.dgvPrestamos.Table.CurrentRecord.SetValue("colcapital", 0)
        '                MessageBox.Show("Ingrese un monto menor")
        '                Exit Sub
        '            End If
        ...
        '            Dim colCapitalME As Decimal = 0
        '            colCapitalME = Math.Round(CDec(Me.dgvPrestamos.Table.CurrentRecord.GetValue("colInteresSoles")) / CDec(txtTipoCambio.Value), 2)
        '            Me.dgvPrestamos.Table.CurrentRecord.SetValue("colInteresUSD", colCapitalME)
        ...
        '            Dim colCapitalME As Decimal = 0
        '            colCapitalME = Math.Round(CDec(Me.dgvPrestamos.Table.CurrentRecord.GetValue("Seguro")) / CDec(txtTipoCambio.Value), 2)
        '            Me.dgvPrestamos.Table.CurrentRecord.SetValue("SeguroME", colCapitalME)
        ...
        '            Dim colCapitalME As Decimal = 0
        '            colCapitalME = Math.Round(CDec(Me.dgvPrestamos.Table.CurrentRecord.GetValue("Otro")) / CDec(txtTipoCambio.Value), 2)
        '            Me.dgvPrestamos.Table.CurrentRecord.SetValue("otroME", colCapitalME)
        ...
        '            Dim colCapitalME As Decimal = 0
        '            colCapitalME = Math.Round(CDec(Me.dgvPrestamos.Table.CurrentRecord.GetValue("Portes")) / CDec(txtTipoCambio.Value), 2)
        '            Me.dgvPrestamos.Table.CurrentRecord.SetValue("PortesME", colCapitalME)
        ...
        '            Dim colCapitalME As Decimal = 0
        '            colCapitalME = Math.Round(CDec(Me.dgvPrestamos.Table.CurrentRecord.GetValue("EnvioCuenta")) / CDec(txtTipoCambio.Value), 2)
        '            Me.dgvPrestamos.Table.CurrentRecord.SetValue("EnvCuentaME", colCapitalME)
    ...
    Private Sub btGrabar_Click(sender As Object, e As EventArgs) Handles btGrabar.Click
        ...
        If Not cap = txtImporteCompramn.Value Then
            MessageBox.Show("El monto capital debe ser igual al monto importe")
            Exit Sub
        End If
    ...
    Private Sub frmPrestamoRecibido_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub PictureBox2_Click(sender As Object, e As EventArgs) Handles PictureBox2.Click
        ...
        '    Me.cboTipoPR.SelectedValue = datos(0).IdProceso
        'End If
        ''ListarConceptosPrestamos("CON")
    ...
    Private Sub PictureBox1_Click(sender As Object, e As EventArgs) Handles PictureBox1.Click
        ...
        '        f.txtObservaciones.Visible = False
        '        f.txtServicioNew.ReadOnly = True
        '        'f.txtCuenta.Text = txtCuentaTipo.Text
        '        'f.txtCuenta.Tag = txtCuentaTipo.Text
        '        f.Label2.Visible = False
        '        f.ShowDialog()
    ...
    Private Sub PictureBox3_Click(sender As Object, e As EventArgs) Handles PictureBox3.Click
        ...
        '    f.Tag = ENTITY_ACTIONS.UPDATE
        '    f.lblidconcepto.Text = txtDevengado.Tag
        '    f.txtDescripcion.Text = "DEVENGADO"
        '    f.txtDescripcion.ReadOnly = True
    ...
    'Private Sub dgvConceptos_TableControlCellClick(sender As Object, e As GridTableControlCellClickEventArgs)

    'End Sub

    Private chk As Boolean, check As Boolean = False
    Private ht As New ArrayList()
    'Private Sub dgvConceptos_TableControlCheckBoxClick(sender As Object, e As GridTableControlCellClickEventArgs)
    ...
    '    Dim el As Element = Me.dgvConceptos.Table.GetInnerMostCurrentElement()
    ...
    '                    Dim column As Integer = Me.dgvConceptos.TableModel.NameToColIndex("check")

    '                    If style.Enabled AndAlso style.TableCellIdentity.TableCellType = GridTableCellType.ColumnHeaderCell Then
    '                        chk = CBool(Me.dgvConceptos.TableModel(style.TableCellIdentity.RowIndex, column).CellValue)
    ...
    '                            Me.dgvConceptos.TableModel(RowIndex, 6).CellValue = "N"
    ...
    '                            Me.dgvConceptos.TableModel(RowIndex, 6).CellValue = "S"

    '                            If Me.dgvConceptos.TableModel(RowIndex, 2).CellValue = "INTERES" Then
    '                                txtPorcIneteres.Value = Me.dgvConceptos.TableModel(RowIndex, 4).CellValue

    '                            ElseIf Me.dgvConceptos.TableModel(RowIndex, 2).CellValue = "SEGURO" Then
    '                                txtporcseg.Value = Me.dgvConceptos.TableModel(RowIndex, 4).CellValue
    '                            End If
    ...
    '        Me.dgvConceptos.TableControl.Refresh()
    ...
    'Private Sub dgvConceptos_TableControlCurrentCellEditingComplete(sender As Object, e As GridTableControlEventArgs)
    '    Dim ColIndex As Integer = DirectCast(sender, Syncfusion.Windows.Forms.Grid.Grouping.GridGroupingControl).TableControl.CurrentCell.ColIndex
    '    If Not IsNothing(Me.dgvConceptos.Table.CurrentRecord) Then
    '        Select Case ColIndex
    '            Case 4 ' cantidad
    ...
    '                If Me.dgvConceptos.Table.CurrentRecord.GetValue("descripcion") = "INTERES" Then
    '                    txtPorcIneteres.Value = CDec(Me.dgvConceptos.Table.CurrentRecord.GetValue("valor"))
    '                    Cuotas()


    '                ElseIf Me.dgvConceptos.Table.CurrentRecord.GetValue("descripcion") = "SEGURO" Then
    '                    txtporcseg.Value = CDec(Me.dgvConceptos.Table.CurrentRecord.GetValue("valor"))
    '                    Cuotas()
    ...
    'Private Sub dgvPrestamoRO_TableControlCellClick(sender As Object, e As GridTableControlCellClickEventArgs)

    'End Sub

    'Private Sub dgvPrestamoRO_TableControlCurrentCellEditingComplete(sender As Object, e As GridTableControlEventArgs)
    '    Dim ColIndex As Integer = DirectCast(sender, Syncfusion.Windows.Forms.Grid.Grouping.GridGroupingControl).TableControl.CurrentCell.ColIndex
    '    If Not IsNothing(Me.dgvPrestamoRO.Table.CurrentRecord) Then
    '        Select Case ColIndex
    '            Case 6 ' capital
    ...
    Private Sub dgvConceptos2_TableControlCellClick(sender As Object, e As GridTableControlCellClickEventArgs) Handles dgvConceptos2.TableControlCellClick
    ...
    Private Sub CheckBox1_CheckedChanged(sender As Object, e As EventArgs) Handles CheckBox1.CheckedChanged
        If CheckBox1.Checked = True Then
            ...
            dgvPrestamoRO.TableDescriptor.Columns("montome").ReadOnly = False
        ...
        If Not IsNothing(Me.dgvPrestamoRO.Table.CurrentRecord) Then
            Select Case ColIndex
                ...
                Case 7 ' capital
                    ...
                    Dim colCapitalME As Decimal = 0
                    colCapitalME = Math.Round(CDec(Me.dgvPrestamoRO.Table.CurrentRecord.GetValue("montome")) * CDec(txtTipoCambio.Value), 2)
                    Me.dgvPrestamoRO.Table.CurrentRecord.SetValue("montomn", colCapitalME)

...
Public Class frmIngresoPrestamo
...
#Region "Métodos"
    ...
    Public Sub listamontos(ByVal iddocumento As Integer)
        ...
        'Dim listaMonto As New documentoPrestamoDetalle
        'Dim envio As Decimal = CDec(0.0)
        'Dim enviome As Decimal = CDec(0.0)
        'Dim portes As Decimal = CDec(0.0)
        'Dim portesme As Decimal = CDec(0.0)
        'Dim seguro As Decimal = CDec(0.0)
        'Dim segurome As Decimal = CDec(0.0)
        'Dim interes As Decimal = CDec(0.0)
        'Dim interesme As Decimal = CDec(0.0)
        'Dim capital As Decimal = CDec(0.0)
        'Dim capitalme As Decimal = CDec(0.0)
        'Dim otro As Decimal = CDec(0.0)
        'Dim otrome As Decimal = CDec(0.0)
    ...
    '    Dim objLista As New documentoPrestamoSA
    '    For Each i As documentoPrestamos In objLista.ListadoFechasCuotas(intIdDocumento)
...
#Region "Manipulación Data"
        ...
        If ListaAsientosConceptos.Count > 0 Then
            ...
            For Each i In ListaAsientosConceptos
                ...
                If i.descripcion = "CAPITAL" Then
                    ...
                    asientoBL.glosa = "Por Prestamos Recibidos"
                ...
                Else
                    ...
                    asientoBL.importeMN = CDec(i.montoSoles)
                    asientoBL.importeME = CDec(i.montoUsd)
                    asientoBL.glosa = "Por Prestamso Recibidos"
    ...
    Public Sub AsientoIntereses2()
        ...
        If txtTipo.Text = "ACC./SOCIOS/DIREC./PERSONAL" Then
            ...
            If txtInteresMN.Value > 0 Then
                ...
                nMovimiento.descripcion = "PRÉSTAMOS"
                nMovimiento.tipo = "H"
                nMovimiento.monto = CDec(txtInteresMN.Value)
                nMovimiento.montoUSD = CDec(txtInteresME.Value)
                nMovimiento.usuarioActualizacion = usuario.IDUsuario
                nMovimiento.fechaActualizacion = DateTime.Now
                asientoBL.movimiento.Add(nMovimiento)
                ...
                asientoBL.movimiento.Add(nMovimiento)
            End If
            If txtSeguroMN.Value > 0 Then
                nMovimiento = New movimiento
                nMovimiento.cuenta = "4411"
                nMovimiento.descripcion = "PRÉSTAMOS"
                nMovimiento.tipo = "H"
                nMovimiento.monto = CDec(txtSeguroMN.Value)
                nMovimiento.montoUSD = CDec(txtSeguroME.Value)
                nMovimiento.usuarioActualizacion = usuario.IDUsuario
                nMovimiento.fechaActualizacion = DateTime.Now
                asientoBL.movimiento.Add(nMovimiento)

                nMovimiento = New movimiento
                nMovimiento.cuenta = "182"
                ' nMovimiento.descripcion = txtCajaOrigen.Text
                nMovimiento.descripcion = "SEGUROS"
                nMovimiento.tipo = "D"
                nMovimiento.monto = CDec(txtSeguroMN.Value)
                nMovimiento.montoUSD = CDec(txtSeguroME.Value)
                nMovimiento.usuarioActualizacion = usuario.IDUsuario
            ...
            End If
            If txtPortesMN.Value > 0 Then
                nMovimiento = New movimiento
                nMovimiento.cuenta = "4411"
                nMovimiento.descripcion = "PRÉSTAMOS"
                nMovimiento.tipo = "H"
                nMovimiento.monto = CDec(txtPortesMN.Value)
                nMovimiento.montoUSD = CDec(txtPortesME.Value)
                nMovimiento.usuarioActualizacion = usuario.IDUsuario
                nMovimiento.fechaActualizacion = DateTime.Now
                asientoBL.movimiento.Add(nMovimiento)

                nMovimiento = New movimiento
                nMovimiento.cuenta = "189"
                ' nMovimiento.descripcion = txtCajaOrigen.Text
                nMovimiento.descripcion = "COSTOS FINANCIEROS"
                nMovimiento.tipo = "D"
                nMovimiento.monto = CDec(txtPortesMN.Value)
                nMovimiento.montoUSD = CDec(txtPortesME.Value)
                nMovimiento.usuarioActualizacion = usuario.IDUsuario
            ...
            If txtOtroMN.Value > 0 Then
                nMovimiento = New movimiento
                nMovimiento.cuenta = "4411"
                nMovimiento.descripcion = "PRÉSTAMOS"
                nMovimiento.tipo = "H"
                nMovimiento.monto = CDec(txtOtroMN.Value)
                nMovimiento.montoUSD = CDec(txtOtroME.Value)
                nMovimiento.usuarioActualizacion = usuario.IDUsuario
                nMovimiento.fechaActualizacion = DateTime.Now
                asientoBL.movimiento.Add(nMovimiento)
            ...
            If txtEnvMN.Value > 0 Then
                nMovimiento = New movimiento
                nMovimiento.cuenta = "4411"
                nMovimiento.descripcion = "PRÉSTAMOS"
                nMovimiento.tipo = "H"
                nMovimiento.monto = CDec(txtEnvMN.Value)
                nMovimiento.montoUSD = CDec(txtEnvME.Value)
                nMovimiento.usuarioActualizacion = usuario.IDUsuario
                nMovimiento.fechaActualizacion = DateTime.Now
                asientoBL.movimiento.Add(nMovimiento)
    ...
    Public Sub GrabarOtrosMovimientos()
        ...
        Dim xCodigoDoc As Integer = documentoCajaSA.SaveIngresoDesembolso(ndocumento, objDocumentoEO)
...
#End Region
    ...
    Private Sub frmIngresoPrestamo_FormClosing(sender As Object, e As FormClosingEventArgs) Handles Me.FormClosing
        Dispose()
    End Sub



    Private Sub frmIngresoPrestamo_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub txtFechaTrans_ValueChanged(sender As Object, e As EventArgs) Handles txtFechaTrans.ValueChanged

    End Sub

    Private Sub btGrabar_Click(sender As Object, e As EventArgs) Handles btGrabar.Click
        'If Not txtNumeroCompr.Text.Trim.Length > 0 Then
        '    lblEstado.Text = "Escriba un numero de doc"
        '    Timer1.Enabled = True
        '    PanelError.Visible = True
        '    TiempoEjecutar(10)
        '    cboDepositoHijo.Select()
        ...
        'If Not cboMoneda.SelectedValue = 1 Then
        '    lblEstado.Text = "Seleccione una caja moneda nacional"
        '    Timer1.Enabled = True
        '    PanelError.Visible = True
        '    TiempoEjecutar(10)
        '    cboDepositoHijo.Select()

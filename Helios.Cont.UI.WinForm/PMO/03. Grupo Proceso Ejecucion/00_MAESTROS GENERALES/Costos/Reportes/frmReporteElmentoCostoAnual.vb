...
Public Class frmReporteElmentoCostoAnual
    Inherits frmMaster
...
#Region "métodos"
    ...
    Public Sub ConsultaReporteCosto(intIdCosto As Integer)
        ...
        Me.reportName = "Helios.Cont.Presentation.WinForm.rpvResumenElementosCostoAnual.rdlc"
        Me.reportData = costoSA.GetReporteElmentoCostoAnual(New recursoCosto With {.idCosto = intIdCosto, .Anio = AnioGeneral})

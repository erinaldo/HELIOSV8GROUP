...
Public Class frmGridProyectos
    Inherits frmMaster
    'formulario para produccion
    Public Sub New()
...
#Region "Métodos"
    ...
    Public Sub GetProyectosGeneral(idProyectoGeneral As Integer, subtipo As String)
        ...
        For Each i In recursoSA.GetListaProyectosBySubTipo(New recursoCosto With {.tipo = "HC", .idpadre = idProyectoGeneral, .subtipo = subtipo, .status = StatusProductosTerminados.Pendiente})
...
#End Region
    ...
    Private Sub frmGridProyectos_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub ButtonAdv5_Click(sender As Object, e As EventArgs) Handles ButtonAdv5.Click
        ...
        Dim costosa As New recursoCostoSA
        If Not IsNothing(r) Then
            costosa.GetCulminarProduccion(New recursoCosto With {.idCosto = r.GetValue("id"), .status = CInt(StatusProductosTerminados.Entregado)})
            MessageBox.Show("Sub proyecto culminado", "Hecho", MessageBoxButtons.OK, MessageBoxIcon.Information)
            GetProyectosGeneral(ProyectoGeneralSel.idCosto, TipoCosto.OP_CONTINUA_DE_BIENES)
        End If

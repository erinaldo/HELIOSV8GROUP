                        ...
                        Case "HG"
                            ...
                            Select Case i.GetValue("TipoDoc")
                                ...
                                Case Else
                                        ...
                                        objAsiento.importeMN = CDec(i.GetValue("montouso"))
                                        objAsiento.importeME = CDec(0.0)
                                        objAsiento.glosa = "Por Consumo de Gastos" & " " & txtEntregable.Text
                                        objAsiento.usuarioActualizacion = usuario.IDUsuario
                                        objAsiento.fechaActualizacion = Date.Now
                                        listaAsiento.Add(objAsiento)

                                        objMovimiento = New movimiento
                                        objMovimiento.cuenta = i.GetValue("cuenta")
                                        objMovimiento.descripcion = i.GetValue("descripcion")
                                        objMovimiento.tipo = "D"
                                        objMovimiento.monto = CDec(i.GetValue("montouso"))
                                        objMovimiento.montoUSD = CDec(0.0)
                                        objMovimiento.usuarioActualizacion = usuario.IDUsuario
                                        ...
                                        objMovimiento = New movimiento
                                        objMovimiento.cuenta = txtCuentaCosto.text
                                        objMovimiento.descripcion = txtidEntregable.Text
                                        objMovimiento.tipo = "D"
                                        objMovimiento.monto = CDec(i.GetValue("montouso"))
                                        objMovimiento.montoUSD = CDec(0.0)
                                        objMovimiento.usuarioActualizacion = usuario.IDUsuario
...
#End Region
    ...
    Private Sub frmCosteoCompras_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Dim ggcStyle As GridTableCellStyleInfo = dgvItemsNoasignados.TableDescriptor.Columns(20).Appearance.AnyRecordFieldCell
        ggcStyle.CellType = "ComboBox"
        ggcStyle.DataSource = Me.comboTableP
        ggcStyle.ValueMember = "cuenta"
        ggcStyle.DisplayMember = "descripcion"
        ggcStyle.DropDownStyle = GridDropDownStyle.Exclusive
        dgvItemsNoasignados.ActivateCurrentCellBehavior = GridCellActivateAction.DblClickOnCell
        dgvItemsNoasignados.ShowRowHeaders = False
    ...
    Private Sub dgvItemsNoasignados_TableControlCurrentCellCloseDropDown(sender As Object, e As GridTableControlPopupClosedEventArgs) Handles dgvItemsNoasignados.TableControlCurrentCellCloseDropDown

...
Public Class frmEntradasProductoTerminado
    Inherits frmMaster
...
#Region "metodos"
    ...
    'Public Sub MoverProductosTerminados(idItem As Integer, idEntregable As Integer)
    ...
    Sub GrabarDefault()
        ...
        If dgvMov.Table.Records IsNot Nothing AndAlso dgvMov.Table.Records.Count > 0 Then
            For Each r As Record In dgvMov.Table.Records
                ...
                'nuevo por entregables /////
                'objDocumentoCompraDet.idCosto = cboEntregable.SelectedValue
        ...
        If dgvMov.Table.Records IsNot Nothing AndAlso dgvMov.Table.Records.Count > 0 Then
            For Each r As Record In dgvMov.Table.Records
                ...
                If r.GetValue("estado") <> Business.Entity.BaseBE.EntityAction.DELETE Then
                    ...
                    objTotalesDet.Modulo = "N"
                    objTotalesDet.idEstablecimiento = almacensa.GetUbicar_almacenPorID(cboAlmacen.SelectedValue).idEstablecimiento   ' almacensa.GetUbicar_almacenPorID(CInt(i.Cells(30).Value())).idEstablecimiento
                    objTotalesDet.idAlmacen = cboAlmacen.SelectedValue
                    objTotalesDet.origenRecaudo = r.GetValue("grav")
...
#End Region
    ...
    Private Sub btGrabar_Click(sender As Object, e As EventArgs) Handles btGrabar.Click
        ...
        Try
            ...
            '    lblEstado.Text = "Los Monto Total debe ser igual Al Costo Total!"
            '    PanelError.Visible = True
            '    Timer1.Enabled = True
            '    TiempoEjecutar(5)
            '    Me.Cursor = Cursors.Arrow

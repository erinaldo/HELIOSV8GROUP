...
Public Class frmFinanzaCuentasPagar
...
#Region "Métodos"
        ...
        With FrmPagosConAnticipo
            ...
            Select Case strMoneda
                Case "NAC"
                    ...
                    .lblIdProveedor = txtBuscarProveedorPago.Tag
                    .lblNomProveedor = txtBuscarProveedorPago.Text
                    .lblCuentaProveedor = "4212"
                    .lblIdDocumento.Text = IDDocumentoCompra
                    .txtProveedor.Text = txtBuscarProveedorPago.Text
                    .txtProveedor.Tag = txtBuscarProveedorPago.Tag
                    ...
                    .txtNumeroCompr.Text = CStr(dgvPagosVarios.Table.CurrentRecord.GetValue("numero"))
                    .txtSerieCompr.Text = CStr(dgvPagosVarios.Table.CurrentRecord.GetValue("serie"))
                    .txtTipoCambio.Value = CDec(dgvPagosVarios.Table.CurrentRecord.GetValue("tipoCambio"))
                    .lblTipoCambio.Text = CStr(dgvPagosVarios.Table.CurrentRecord.GetValue("tipoCambio"))
                    .txtFechaComprobante.Text = CStr(dgvPagosVarios.Table.CurrentRecord.GetValue("fecha"))
                ...
                Case "EXT"
                    'If TabPagoProveedor Is TabCuentasPagar.SelectedTab Then
                    .lblIdProveedor = CStr(txtBuscarProveedorPago.Tag)
                    .lblNomProveedor = txtBuscarProveedorPago.Text
                    .lblCuentaProveedor = "4212"
            ...
            Else
                ...
                .getTableAnticiposPorTipoProveedor(txtBuscarProveedorPago.Tag)
    ...
    Private Sub GetCuentasXPagarProveedoresPeriodo(intMoneda As String)
        ...
        '.fechaContable = strPeriodo,
        documentoVenta = documentoVentaSA.GetConsultaCuentasPorpagarTodosProveedores(
...
#Region "Events"
    ...
    Private Sub ToolStripButton4_Click(sender As Object, e As EventArgs) Handles ToolStripButton4.Click
        If Not IsNothing(Me.dgvPagosVarios.Table.CurrentRecord) Then
            ...
            If dgvPagosVarios.Table.SelectedRecords.Count > 0 Then
                'If dgvPagosVarios.Table.CurrentRecord.GetValue("montoProg") = 0 Then
    ...
    Private Sub ToolStripButton6_Click(sender As Object, e As EventArgs) Handles ToolStripButton6.Click
        If Not IsNothing(Me.dgvPagosVarios.Table.CurrentRecord) Then
            ...
            f.txtProveedor.Text = txtBuscarProveedorPago.Text
            f.txtProveedor.Tag = txtBuscarProveedorPago.Tag
            f.StartPosition = FormStartPosition.CenterParent
            f.ShowDialog()
            Me.Cursor = Cursors.Arrow
        Else
    ...
    Private Sub ToolStripButton1_Click(sender As Object, e As EventArgs) Handles ToolStripButton1.Click
        If Not IsNothing(Me.dgvPagosVarios.Table.CurrentRecord) Then
            ...
            If dgvPagosVarios.Table.CurrentRecord.GetValue("estadoPago") = "Pendiente" Then

                If dgvPagosVarios.Table.CurrentRecord.GetValue("moneda") = "NAC" Then

                    With frmModalCompensacion
                        .txtProveedor.Text = txtBuscarProveedorPago.Text
                        .txtProveedor.Tag = txtBuscarProveedorPago.Tag
                        .txtRuc.Text = txtRucPago.Text
                        .lblTipoEntidad.Text = "PR"
                        .Label8.Text = "ANTICIPOS"
                        '.txtPeriodo.Value = txtPeriodo.Value
                        ' sdgfsdgsdg
                        ...
                        .txtNumeroCompr.Text = CStr(dgvPagosVarios.Table.CurrentRecord.GetValue("numero"))
                        .txtSerieCompr.Text = CStr(dgvPagosVarios.Table.CurrentRecord.GetValue("serie"))
                        .txtTipoCambio.Text = CDec(dgvPagosVarios.Table.CurrentRecord.GetValue("tipoCambio"))

                        .txtFechaComprobante.Text = CStr(dgvPagosVarios.Table.CurrentRecord.GetValue("fecha"))

                        .lblIdDocumento.Text = dgvPagosVarios.Table.CurrentRecord.GetValue("idDocumento")

                        .txtImporteMN.Text = CDec(dgvPagosVarios.Table.CurrentRecord.GetValue("importeMN") - dgvPagosVarios.Table.CurrentRecord.GetValue("abonoMN"))
                        .txtImporteME.Text = CDec(dgvPagosVarios.Table.CurrentRecord.GetValue("importeME") - dgvPagosVarios.Table.CurrentRecord.GetValue("abonoME"))
                        .txtMoneda.Text = CStr(dgvPagosVarios.Table.CurrentRecord.GetValue("moneda"))

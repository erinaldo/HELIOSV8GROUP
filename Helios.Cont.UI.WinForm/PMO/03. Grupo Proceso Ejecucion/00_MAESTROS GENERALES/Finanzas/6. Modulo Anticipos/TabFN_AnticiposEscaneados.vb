...
Public Class TabFN_AnticiposEscaneados
...
#Region "Constructors"
    Public Sub New(form As FormMaestroModuloAnticipos, status As String)
...
#Region "Class LinkLabel"
    ...
    Private Sub TabLG_Escaneadas_Load(sender As Object, e As EventArgs) Handles Me.Load
...
#Region "Methods"
    Private Sub GetEscaneadas(status As String)
        ...
        For Each i In anticipoSA.GetEscaneadasAnticiposList(New Business.Entity.documentoAnticipo With
                                                       {
        ...
        Select Case status
            Case "30"
                ToolStripLabel1.Text = "Anticipos Escaneados 0 - 30 días"
            Case "60"
                ToolStripLabel1.Text = "Anticipos Escaneados 31 - 60 días"
            Case "61"
                ToolStripLabel1.Text = "Anticipos Escaneados 61 a mas"
        End Select
    End Sub
#End Region

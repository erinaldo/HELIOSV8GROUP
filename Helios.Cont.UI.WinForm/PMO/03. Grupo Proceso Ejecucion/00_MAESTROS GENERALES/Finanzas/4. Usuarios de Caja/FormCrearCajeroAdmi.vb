...
Public Class FormCrearCajeroAdmi
#Region "Attributes"
...
#Region "Methods"
    ...
    Public Sub GrabarCajaxUsuario()
        ...
        Try
            ...
            With objCaja
                .IDRol = txtIdRol.Tag
                .tipoCaja = Tipo_Caja.ADMINISTRATIVO
                .namepc = shostname
    ...
    Public Sub Grabar()
        ...
        Try
            ...
            objCaja.cajaUsuariodetalle = ListaUserDetalle
            If ListaUserDetalle.Count = 0 Then Exit Sub
            Dim codigoUsuarioClave = documentoCajaSA.SaveGroupCajaGeneralApertura(Nothing, objCaja, Nothing)
            ListaCajasActivas = cajaSA.ListadoCajaXEstado(New cajaUsuario With {
                                                             .idEmpresa = Gempresas.IdEmpresaRuc,
                                                             .idEstablecimiento = GEstableciento.IdEstablecimiento,
                                                             .estadoCaja = "A"
...
#Region "Events"
    Private Sub RoundButton21_Click(sender As Object, e As EventArgs) Handles RoundButton21.Click
        If dgvCuentas.Table.Records.Count > 0 Then
            ...
            End If
        Else
            MessageBox.Show("No hay Cajas Configuradas!", "Atención", MessageBoxButtons.OK, MessageBoxIcon.Warning)
        End If
    End Sub

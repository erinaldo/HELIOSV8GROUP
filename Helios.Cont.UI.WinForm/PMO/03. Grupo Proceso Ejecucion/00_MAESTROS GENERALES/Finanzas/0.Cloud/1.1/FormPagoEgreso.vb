...
#Region "Methods"
    ...
    Private Sub GetCombos()
        ...
        configuracionModuloV2(Gempresas.IdEmpresaRuc, "OSS", Me.Text, GEstableciento.IdEstablecimiento)
    End Sub
    ...
    Public Sub configuracionModuloV2(strIDEmpresa As String, strIdModulo As String, strNomModulo As String, intIdEstablecimiento As Integer)
        Try
            ...
            Dim RecuperacionNumeracion = numeracionSA.NumeracionBoletasSelV2(GEstableciento.IdEstablecimiento, "OSD", "9903", usuario.IDRol)
    ...
    Sub Calculo()
        ...
        If txtFondoMN.Value > SaldoEFMN.DoubleValue Then
            txtFondoMN.Value = 0
            Throw New Exception("El importe ingresado es mayor al disponible")
        End If
...
#Region "Manipulacion data"
    ...
    Public Sub Grabar()
        ...
        ElseIf usuario.tipoCaja = Tipo_Caja.PUNTO_DE_VENTA Then
            ...
            cajaActiva = ListaCajasActivas.Where(Function(o) o.idPersona = Vendedor.IDUsuario And o.IDRol = usuario.IDRol).SingleOrDefault
    ...
    Private Function GetDocumentoCaja(idNumeracion As Integer, IDCajaUsuario_Login As Integer, tipoEntidad As String) As documentoCaja
        ...
        Select Case txtCF_tipo.Tag
            Case "EF"
                ...
                .codigoProveedor = Integer.Parse(TextPersona.Tag),
                .idPersonal = Integer.Parse(TextPersona.Tag),
                ...
                .fechaProcesoDestino = New DateTime(txtAnioCompra.Text, CInt(cboMesCompra.SelectedValue), TxtDia.Text, CInt(txtHora.Value.Hour), CInt(txtHora.Value.Minute), CInt(txtHora.Value.Second))
                }
            Case "BC"
                Return New documentoCaja With
                {
            ...
            Case "EP"
                ...
                .montoUsd = txtFondoME.Value,
                .idCajaUsuario = IDCajaUsuario_Login,
                .glosa = TextGlosa.Text.Trim,'.tipoEntidadFinanciera = txtCF_tipo.Tag,
                .estado = "N",
                .idcosto = Nothing,
                .usuarioModificacion = usuario.IDUsuario,
                .fechaModificacion = DateTime.Now
...
#Region "Events"
    ...
    Private Sub TextDNI_KeyDown(sender As Object, e As KeyEventArgs) Handles TextDNI.KeyDown
        ...
        End Try
    End Sub
    Private Sub FormPagoEgreso_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        txtAnioCompra.BorderColor = Color.FromArgb(255, 88, 51)
        txtHora.BorderColor = Color.FromArgb(255, 88, 51)
    End Sub
    ...
    Private Sub LinkLabel1_LinkClicked(sender As Object, e As LinkLabelLinkClickedEventArgs) Handles LinkLabel1.LinkClicked
        ...
        Else
            MessageBox.Show("No tiene Caja Activa")
        End If
    ...
    Private Sub txtFondoMN_ValueChanged(sender As Object, e As EventArgs) Handles txtFondoMN.ValueChanged
        Try
            ...
            End Select
        Catch ex As Exception
            MsgBox(ex.Message, MsgBoxStyle.Exclamation, "Verificar importe")
        End Try
    End Sub
    ...
    Private Sub FormPagoEgreso_FormClosing(sender As Object, e As FormClosingEventArgs) Handles Me.FormClosing

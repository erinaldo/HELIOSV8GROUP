...
Public Class TabFN_MovimientoCuentas
...
#Region "Constructors"
    Public Sub New()
        ...
        FormatoGridAvanzado(dgvKardex2, True, False)
...
#Region "Events"
    ...
    Private Sub TabFN_MovimientoCuentas_Load(sender As Object, e As EventArgs) Handles Me.Load

...
Public Class TabFN_OtrosIngresos
...
#Region "Methods"
    ...
    Private Sub GetMovimientosDia(intIdEstablecimiento As Integer, strPeriodo As String, strMovimiento As String)
        Dim listaDocCaja As List(Of documentoCaja) = Nothing
        Dim listaEstado As New List(Of String)
        Dim dt As New DataTable("Ingresos - del día " & txtFecha.Value.Date & " ")
        Dim documentoCajaSA As New DocumentoCajaSA
        dt.Columns.Add(New DataColumn("idDocumento", GetType(Integer)))
        dt.Columns.Add(New DataColumn("movimiento", GetType(String)))
        dt.Columns.Add(New DataColumn("tipoDocPago", GetType(String)))
        ...
        listaDocCaja = documentoCajaSA.ObtenerMovimientosPorPeriodoFinanzas(Gempresas.IdEmpresaRuc, GEstableciento.IdEstablecimiento, strPeriodo, strMovimiento).Where(Function(o) o.estado = "1" _
                                                                                                                                                                                        And TruncateTime(o.fechaCobro) >= txtFecha.Value.Date).ToList
...
#Region "Events"
    ...
    Private Sub ButtonAdv1_Click(sender As Object, e As EventArgs) Handles ButtonAdv1.Click
        ...
        GetMovimientosPeriodo(GEstableciento.IdEstablecimiento, periodoG, "OEC")
    ...
    Private Sub ToolStripButton5_Click(sender As Object, e As EventArgs) Handles ToolStripButton5.Click
        ...
        '    End If
        'End If
        If AutorizacionRolSA.TienePermiso(AsegurablesSistemaPOS.EDITAR_INGRESO_Botón___, AutorizacionRolList) Then
            If Not IsNothing(Me.dgvOtrosMov.Table.CurrentRecord) Then
    ...
    Private Sub ToolStripButton1_Click(sender As Object, e As EventArgs) Handles ToolStripButton1.Click
        ...
        If Not IsNothing(Me.dgvOtrosMov.Table.CurrentRecord) Then
            ...
            If (dgvOtrosMov.Table.CurrentRecord.GetValue("saldoMN") > 0) Then
                ...
                End If
            Else
                MessageBox.Show("El saldo debe ser mayor a 0!", "Atención", MessageBoxButtons.OK, MessageBoxIcon.Warning)
            End If
        Else
    ...
    Private Sub Panel1_Click(sender As Object, e As EventArgs) Handles Panel1.Click
        Cursor = Cursors.WaitCursor
        Dim periodoG As String = cboMesCompra.SelectedValue & "/" & cboAnio.Text
        GetMovimientosPeriodoFull(GEstableciento.IdEstablecimiento, periodoG, "OEC")
        Cursor = Cursors.Default
    End Sub
    ...
    Private Sub cboTipoConsulta_Click(sender As Object, e As EventArgs) Handles cboTipoConsulta.Click

    End Sub

    Private Sub cboTipoConsulta_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cboTipoConsulta.SelectedIndexChanged
        If cboTipoConsulta.Text.Trim.Length > 0 Then
            If cboTipoConsulta.Text = "Consultar mes" Then
                PanelConsultasPeriodo.Visible = True
                PanelConsultasDia.Visible = False
            Else
                PanelConsultasPeriodo.Visible = False
                PanelConsultasDia.Visible = True
            End If
        End If
    End Sub

    Private Sub TabFN_OtrosIngresos_Load(sender As Object, e As EventArgs) Handles Me.Load
    ...
    Private Sub ButtonAdv2_Click(sender As Object, e As EventArgs) Handles ButtonAdv2.Click
        Cursor = Cursors.WaitCursor
        Dim periodoG As String = cboMesCompra.SelectedValue & "/" & cboAnio.Text
        GetMovimientosDia(GEstableciento.IdEstablecimiento, periodoG, "OEC")
        Cursor = Cursors.Default
    End Sub

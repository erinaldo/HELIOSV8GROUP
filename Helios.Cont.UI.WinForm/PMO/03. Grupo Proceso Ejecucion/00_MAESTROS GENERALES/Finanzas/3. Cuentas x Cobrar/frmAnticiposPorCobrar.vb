...
Public Class frmAnticiposPorCobrar
#Region "Attributes"
...
#Region "Methods"
    ...
    Private Sub UbicarFull()
        ...
        documentoVenta = documentoVentaSA.UbicarCompraPorProveedorXperiodoAntFull(Gempresas.IdEmpresaRuc, GEstableciento.IdEstablecimiento, strPeriodo, "CVO")
        documentoAnticipo = documentoAnticipoSA.ObtenerOtrosAportesXFinanzasFull(Gempresas.IdEmpresaRuc, GEstableciento.IdEstablecimiento, strPeriodo, "AO")
        Dim str As String
    ...
    Private Sub UbicarVentaNroSerieAntPago(RucCliente As Integer)
        ...
        documentoVenta = documentoVentaSA.UbicarPorProveedorXperiodo(Gempresas.IdEmpresaRuc, GEstableciento.IdEstablecimiento, RucCliente, strPeriodo, "CVO")
    ...
    Private Sub UbicarVentaNroSerieAntPagoXFinanzas(RucCliente As Integer)
        ...
        documentoAnticipo = documentoAnticipoSA.ObtenerOtrosAportesXFinanzas(Gempresas.IdEmpresaRuc, GEstableciento.IdEstablecimiento, RucCliente, strPeriodo, "AO")
        Dim str As String
        If Not IsNothing(documentoAnticipo) Then
            For Each i In documentoAnticipo
                Dim dr As DataRow = dt.NewRow()
...
#Region "Events"
    ...
    Private Sub ButtonAdv16_Click(sender As Object, e As EventArgs) Handles ButtonAdv16.Click
        ...
        If txtCliente2.Text.Trim.Length > 0 Then
            ...
            ElseIf (cboTipoConsulta.Text = "POR COMPRAS") Then
                dgvPagosVarios2.Table.Records.DeleteAll()

...
Public Class frmFinanzasCuentasPorCobrar
...
#End Region
    ...
    Private Sub btnNuevoPagoReconocimiento(strMoneda As String, IDDocumentoCompra As Integer)
        ...
        With frmCobrosModal
            ...
            Select Case strMoneda
                Case "NAC"
                    ...
                    For Each i As documentoCajaDetalle In objLista.ObtenerCuentasPorCobrarPorDetailsREC(IDDocumentoCompra)
...
#Region "Events"
    ...
    Private Sub ToolStripButton13_Click(sender As Object, e As EventArgs) Handles ToolStripButton13.Click
        Try
            If dgvCobranzaCli.Table.SelectedRecords.Count > 0 Then
                ...
                If dgvCobranzaCli.Table.CurrentRecord.GetValue("tipoVenta") = "VREC" Then
                    btnNuevoPagoReconocimiento(dgvCobranzaCli.Table.CurrentRecord.GetValue("moneda"), dgvCobranzaCli.Table.CurrentRecord.GetValue("idDocumento"))
                Else
    ...
    Private Sub ToolStripButton17_Click(sender As Object, e As EventArgs) Handles ToolStripButton17.Click
        ...
        If Not IsNothing(Me.dgvCobranzaCli.Table.CurrentRecord) Then
            ...
            If dgvCobranzaCli.Table.CurrentRecord.GetValue("estadoPago") = "Pendiente" Then

                If dgvCobranzaCli.Table.CurrentRecord.GetValue("moneda") = "NAC" Then
                    ...
                    With frmCompensacionDeDocumentos
                        ...
                        .txtComprobante.Text = tablaBL.descripcion
                        .txtComprobante.Tag = tablaBL.codigoDetalle
                        .txtNumeroCompr.Text = CStr(dgvCobranzaCli.Table.CurrentRecord.GetValue("numero"))
                        .txtSerieCompr.Text = CStr(dgvCobranzaCli.Table.CurrentRecord.GetValue("serie"))
                        .txtTipoCambio.Text = CDec(dgvCobranzaCli.Table.CurrentRecord.GetValue("tipoCambio"))

                        .txtFechaComprobante.Text = CStr(dgvCobranzaCli.Table.CurrentRecord.GetValue("fecha"))
                        .lblIdDocumento.Text = dgvCobranzaCli.Table.CurrentRecord.GetValue("idDocumento")

                        .txtImporteMN.Text = CDec(dgvCobranzaCli.Table.CurrentRecord.GetValue("importeMN") - dgvCobranzaCli.Table.CurrentRecord.GetValue("abonoMN"))
                        .txtImporteME.Text = CDec(dgvCobranzaCli.Table.CurrentRecord.GetValue("importeME") - dgvCobranzaCli.Table.CurrentRecord.GetValue("abonoME"))
                        .txtMoneda.Text = CStr(dgvCobranzaCli.Table.CurrentRecord.GetValue("moneda"))
        ...
        If Not IsNothing(Me.dgvCobranzaCli.Table.CurrentRecord) Then
            ...
            If dgvCobranzaCli.Table.CurrentRecord.GetValue("estadoPago") = "Pendiente" Then
                ...
                If dgvCobranzaCli.Table.CurrentRecord.GetValue("moneda") = "NAC" Then
                    ...
                    Dim f As New frmRetencionNew(CInt(dgvCobranzaCli.Table.CurrentRecord.GetValue("idDocumento")))
                    f.lblPerido.Text = PeriodoGeneral
                    f.txtFecha.Value = DateTime.Now
                    ...
                    'btnNuevoPagoAnticipoPagos(dgvPagosVarios.Table.CurrentRecord.GetValue("moneda"), dgvPagosVarios.Table.CurrentRecord.GetValue("idDocumento"))
                Else
                    MessageBox.Show("Solo  Documentos en Soles")
                End If
            ...
            End If
        Else
            MessageBox.Show("Seleccione uan venta")
        End If

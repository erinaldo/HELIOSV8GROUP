...
Public Class frmModalCompensacion
    Inherits frmMaster

    Public Property listaCompensatorio As New List(Of documentoCajaDetalle)
    'Public Property objetoCaja As New documentoCaja
    Public Property ListaAsientonTransito As New List(Of asiento)
    Public Property objetoGeneralCompesatorio As documento
...
#Region "Metodos"
    ...
    Private Function GeneraraAsientoOtorgado() As asiento
        ...
        Dim estadosFinaciero As New EstadosFinancierosSA
        Dim estadoFin As New estadosFinancieros

        estadoFin = estadosFinaciero.GetUbicar_estadosFinancierosPorID(objetoGeneralCompesatorio.documentoCaja.entidadFinanciera)
        ...
        Try
            ...
            nAsiento.idEntidad = txtProveedor.Tag  'txtCliente2.Tag
            nAsiento.nombreEntidad = txtProveedor.Text ' txtCliente2.Text
            ...
            nAsiento.importeMN = txttotalcomp.Text
            nAsiento.importeME = txttotalcomp.Text * TmpTipoCambio
            ...
            movimiento = New movimiento With {
                       ...
                       .monto = txttotalcomp.Text,
                       .montoUSD = txttotalcomp.Text * TmpTipoCambio,
                       .fechaActualizacion = DateTime.Now,
                       .usuarioActualizacion = usuario.IDUsuario}
            nAsiento.movimiento.Add(movimiento)
            '.cuenta = "122"= txtCuenta.Text,
            movimiento = New movimiento With {
                    .cuenta = estadoFin.cuenta,
                    .descripcion = estadoFin.descripcion,
    ...
    Function asientoCompraAnticipo() As asiento
        Dim cuentaFinacieraSA As New EstadosFinancierosSA
        Dim nAsiento As New asiento
        Dim nDebe As New movimiento
        Dim nHaber As New movimiento
        ...
        For Each i As Record In dgvDetCompensacion.Table.Records
            ...
            If CDec(i.GetValue("importemn")) > 0 Then
                ...
                nAsiento.movimiento.Add(AS_HaberCompAnt(i.GetValue("importemn"), i.GetValue("importeme")))
            End If
        Next
    ...
    Public Function AS_HaberCompAnt(cMonto As Decimal, cMontoUS As Decimal) As movimiento
    ...
    Function asientoCaja(strPeriodo As String) As asiento
        Dim cuentaFinacieraSA As New EstadosFinancierosSA
        Dim nAsiento As New asiento
        Dim nDebe As New movimiento
        Dim nHaber As New movimiento
        ...
        Dim montoTotalME As Decimal = 0

        nAsiento = New asiento
        nAsiento.periodo = strPeriodo
        nAsiento.idDocumento = 0
        nAsiento.idEmpresa = Gempresas.IdEmpresaRuc
        nAsiento.idCentroCostos = GEstableciento.IdEstablecimiento
        nAsiento.idEntidad = txtProveedor.Tag  'txtCliente2.Tag
        ...
        For Each i As Record In dgvCompensacion.Table.Records
            ...
            If CDec(i.GetValue("pago")) > 0 Then
                montoTotal += i.GetValue("pago")
                montoTotalME += i.GetValue("pagome")
        ...
        nAsiento.movimiento.Add(AS_HaberCliente(montoTotal, montoTotalME))

        nAsiento.movimiento.Add(AS_HaberCompAnt(montoTotal, montoTotalME))
    ...
    Sub GrabarCompraAnticipo(strPeriodo As String)
        ...
        With nDocumentoCompra
            ...
            .idEmpresa = Gempresas.IdEmpresaRuc
            .idCentroCosto = GEstableciento.IdEstablecimiento
            .fechaDoc = New DateTime(CInt(txtAnioCompra.Text), CInt(cboMesCompra.SelectedValue), txtDia.Value.Day, CInt(txtHora.Value.Hour), CInt(txtHora.Value.Minute), CInt(txtHora.Value.Second))
            .fechaLaboral = New DateTime(DiaLaboral.Year, DiaLaboral.Month, DiaLaboral.Day, DiaLaboral.Hour, DiaLaboral.Minute, DiaLaboral.Second)
            ...
            .monedaDoc = "1"
            .tasaIgv = TmpIGV     ' IIf(IsNothing(nudIgv.Value) Or String.IsNullOrEmpty(nudIgv.Value) Or String.IsNullOrWhiteSpace(nudIgv.Value), Nothing, Trim(nudIgv.Value))
            ...
            ' .DocumentoSustentado = "S"
            .usuarioActualizacion = usuario.IDUsuario
            .fechaActualizacion = New DateTime(CInt(txtAnioCompra.Text), CInt(cboMesCompra.SelectedValue), txtDia.Value.Day, CInt(txtHora.Value.Hour), CInt(txtHora.Value.Minute), CInt(txtHora.Value.Second))
            .sustentado = "01" 'strTipoNota
            .aprobado = "S"
            .CajaSeleccionada = Nothing
        ...
        For Each r As Record In dgvCompensacion.Table.Records
            ...
            objDocumentoCompraDet.FechaDoc = New DateTime(CInt(txtAnioCompra.Text), CInt(cboMesCompra.SelectedValue), txtDia.Value.Day, CInt(txtHora.Value.Hour), CInt(txtHora.Value.Minute), CInt(txtHora.Value.Second))
            ...
            objDocumentoCompraDet.TipoOperacion = "22"
            objDocumentoCompraDet.operacionNota = "22"
            ...
            objDocumentoCompraDet.fechaModificacion = New DateTime(CInt(txtAnioCompra.Text), CInt(cboMesCompra.SelectedValue), txtDia.Value.Day, CInt(txtHora.Value.Hour), CInt(txtHora.Value.Minute), CInt(txtHora.Value.Second))
        ...
        asiento = asientoCaja(strPeriodo)
        ListaAsiento.Add(asiento)
        ndocumento.asiento = ListaAsiento
        ...
        With ndocumentoComp
            ...
            .idOrden = Nothing
            .moneda = "1"
            .idEntidad = txtProveedor.Tag  'usuario.IDUsuario
            .entidad = txtProveedor.Text   'usuario.CustomUsuario.Full_Name
        ...
        With nDocumentoCaja
            ...
            .idDocumento = objetoGeneralCompesatorio.documentoCaja.idDocumento
            .periodo = strPeriodo
            .idEmpresa = Gempresas.IdEmpresaRuc
            .idEstablecimiento = GEstableciento.IdEstablecimiento
            .TipoDocumentoPago = "9908"
            .formapago = objetoGeneralCompesatorio.documentoCaja.formapago
            .codigoProveedor = txtProveedor.Tag    'txtPersona.ValueMember
            .idPersonal = txtProveedor.Tag
            .codigoLibro = "1"
            .tipoDocPago = "9908"
            ...
            .movimientoCaja = "AC"
            .entidadFinanciera = objetoGeneralCompesatorio.documentoCaja.entidadFinanciera
            .tipoPersona = "PR"



            If objetoGeneralCompesatorio.documentoCaja.formapago = "001" Then
                .numeroOperacion = objetoGeneralCompesatorio.documentoCaja.numeroOperacion
                .ctaCorrienteDeposito = objetoGeneralCompesatorio.documentoCaja.ctaCorrienteDeposito
                .ctaIntebancaria = Nothing
                .bancoEntidad = objetoGeneralCompesatorio.documentoCaja.bancoEntidad
                .fechaProceso = New DateTime(CInt(txtAnioCompra.Text), CInt(cboMesCompra.SelectedValue), txtDia.Value.Day, CInt(txtHora.Value.Hour), CInt(txtHora.Value.Minute), CInt(txtHora.Value.Second))
            ...
            ElseIf objetoGeneralCompesatorio.documentoCaja.formapago = "007" Then ' cheques
                .numeroOperacion = objetoGeneralCompesatorio.documentoCaja.numeroOperacion
                .ctaCorrienteDeposito = objetoGeneralCompesatorio.documentoCaja.ctaCorrienteDeposito
                .ctaIntebancaria = Nothing
                ...
                .fechaCobro = New DateTime(CInt(txtAnioCompra.Text), CInt(cboMesCompra.SelectedValue), txtDia.Value.Day, CInt(txtHora.Value.Hour), CInt(txtHora.Value.Minute), CInt(txtHora.Value.Second))
                .entregado = "NO"
            ElseIf objetoGeneralCompesatorio.documentoCaja.formapago = "111" Then
                .numeroOperacion = objetoGeneralCompesatorio.documentoCaja.numeroOperacion
                .ctaCorrienteDeposito = objetoGeneralCompesatorio.documentoCaja.ctaCorrienteDeposito
                .ctaIntebancaria = Nothing
                .bancoEntidad = Nothing
                ...
                .fechaCobro = New DateTime(CInt(txtAnioCompra.Text), CInt(cboMesCompra.SelectedValue), txtDia.Value.Day, CInt(txtHora.Value.Hour), CInt(txtHora.Value.Minute), CInt(txtHora.Value.Second))
                .entregado = "NO"
            ElseIf objetoGeneralCompesatorio.documentoCaja.formapago = "109" Then
                .numeroOperacion = objetoGeneralCompesatorio.documentoCaja.numeroOperacion
                .ctaCorrienteDeposito = objetoGeneralCompesatorio.documentoCaja.ctaCorrienteDeposito
                .ctaIntebancaria = Nothing
                .bancoEntidad = Nothing
            ...
            .montoSoles = txttotalcomp2.Text
            .montoUsd = txttotalcomp2.Text * TmpTipoCambio
            .idCajaUsuario = objetoGeneralCompesatorio.documentoCaja.idCajaUsuario
            .glosa = "Por Compensacion"
            .estado = "N"
            .idcosto = Nothing
        ...
        End With
        ndocumentoComp.documentoCaja = nDocumentoCaja
        ...
        ndocumentoCajaDetalle.DetalleItem = "Compensacion de Anticipo"
        ndocumentoCajaDetalle.montoSoles = txttotalcomp2.Text
        ndocumentoCajaDetalle.montoSolesTransacc = txttotalcomp2.Text
        ndocumentoCajaDetalle.montoUsd = txttotalcomp2me.Text
        ndocumentoCajaDetalle.montoUsdTransacc = txttotalcomp2me.Text
        ...
        ndocumentoCajaDetalle.idCajaUsuario = objetoGeneralCompesatorio.documentoCaja.idCajaUsuario
        ...
        ndocumentoCajaDetalle.idCajaPadre = objetoGeneralCompesatorio.documentoCaja.idDocumento
        'ListadocumentoCajaDetalle.Add(ndocumentoCajaDetalle)


        ListaDetalleComp.Add(ndocumentoCajaDetalle)
        '   End If
        'Next
        '---------------------------------------------------------------------------------
        ndocumentoComp.documentoCaja.tipoOperacion = "21"

        'AGREGAR ASIENTO ´PARA 



        'asiento2 = asientoCompraAnticipo()
        'ListaAsiento2.Add(asiento2)
        ...
        ndocumentoComp.documentoCaja.documentoCajaDetalle = ListaDetalleComp




        Dim xcod As Integer = CompraSA.CompensacionDocCompraAnticipo(ndocumento, ndocumentoComp)
        lblEstado.Text = "Compensacion Realizada!"
        Dispose()
    End Sub
    ...
    '    With nDocumentoCompraComp
    '        .idPadre = lblIdDocumentoComp.Text
    '        .idDocumento = lblIdDocumentoComp.Text
    '        .codigoLibro = "8"
    '        .tipoDoc = "9901"
    '        .idEmpresa = Gempresas.IdEmpresaRuc
    '        .idCentroCosto = GEstableciento.IdEstablecimiento
    ...
    Sub CompensarConAnticipos()
        ...
        For Each j In objetoGeneralCompesatorio.documentoCaja.documentoCajaDetalle
    ...
    Public Sub UbicarDetalleAnticipo(intIddocumento As Integer)
        ...
        Try
            ...
            With compraSA.GetUbicar_documentoAnticipoPorID(intIddocumento)
                ...
                txtIva.Text = 0.00
                txtImpFacmn.DecimalValue = .montoSoles
                txtImpFacme.DecimalValue = .montoUsd


                Dim tablaSA As New tablaDetalleSA

                txtTipoDoc.Text = tablaSA.GetUbicarTablaID(CInt(10), .tipoDocPago).descripcion
                TipoDocGobal = .tipoDocPago
                TextBoxExt4.Text = " "
            ...
            For Each i As documentoCajaDetalle In objLista.ObtenerAnticipoDetails(intIddocumento)
                ...
                '    cTotalmn = 0
                'End If
                listacomp.ImporteNacional = i.montoSoles
                'dr(7) = 0
                'If cTotalme < 0 Then
                '    listacomp.ImporteExtranjero = 0
                'End If
                listacomp.ImporteExtranjero = i.montoUsd
                'listacomp.TipoExistencia = i.TipoExistencia
...
#End Region
    ...
    Private Sub PictureBox4_Click(sender As Object, e As EventArgs) Handles PictureBox4.Click
        ...
        ElseIf Label8.Text = "ANTICIPOS" Then

            UbicarAnticiposProveedor(txtRuc.Text, strPeriodo)
        End If
        Me.Cursor = Cursors.Arrow
        'Me.Cursor = Cursors.WaitCursor
    ...
    Private Sub dgvCompra_TableControlCurrentCellControlDoubleClick(sender As Object, e As GridTableControlControlEventArgs) Handles dgvCompra.TableControlCurrentCellControlDoubleClick
        ...
        ElseIf Label8.Text = "ANTICIPOS" Then
            ...
            UbicarDetalleAnticipo(dgvCompra.Table.CurrentRecord.GetValue("idDocumento"))

        End If
        'End If

        Dim montocompe As Decimal = CDec(0.0)
        Dim montocompeme As Decimal = CDec(0.0)

        For Each rx As Record In dgvDetCompensacion.Table.Records
            montocompe += CDec(rx.GetValue("importemn"))

        Next
        montocompeme = montocompe * TmpTipoCambio
        Me.Cursor = Cursors.Arrow
    End Sub
    ...
    Private Sub btGrabar_Click(sender As Object, e As EventArgs) Handles btGrabar.Click
        ...
        Dim strPeriodo As String = String.Concat(cboMesCompra.SelectedValue, "/", txtAnioCompra.Text)
        Dim fechaPeriodo As DateTime = New DateTime(CInt(txtAnioCompra.Text), CInt(cboMesCompra.SelectedValue), txtDia.Value.Day, CInt(txtHora.Value.Hour), CInt(txtHora.Value.Minute), CInt(txtHora.Value.Second))
        Dim fechaCompesatorio As DateTime = txtFechaDocComp.Value

        Try



            If Not lblMontoSeleccionado.Text > 0 Then

                lblEstado.Text = "Seleccione un Documento para Compensar"
                Timer1.Enabled = True
                PanelError.Visible = True
                TiempoEjecutar(10)
                Timer1.Enabled = True
            ...
            If Not fechaPeriodo > fechaCompesatorio Then

                lblEstado.Text = "La Fecha de TransAcccion Debe ser mayor ala fecha del Documento " & lblDocumentoSeleccionado.Text
                Timer1.Enabled = True
                PanelError.Visible = True
                TiempoEjecutar(10)
                Timer1.Enabled = True
            ...
            If dgvDetCompensacion.Table.Records.Count > 0 Then
                ...
                '    GrabarCompraAnticipo()
                'End If

                If lblDocumentoSeleccionado.Text = "ANTICIPO" Then
                    GrabarCompraAnticipo(strPeriodo)
                End If
    ...
    Private Sub ToolStripButton1_Click(sender As Object, e As EventArgs) Handles ToolStripButton1.Click
        'Dim f As New frmCajaSelect

        'f.txtAnioCompra.Text = CInt(AnioGeneral)
        'f.txtPeriodo.Value = New Date(CInt(AnioGeneral), CInt(MesGeneral), 1)
        'f.lblMovimiento.Tag = "AO"
        'f.lblMovimiento.Text = "ANTICIPOS OTORGADOS"
        'f.CaptionLabels(0).Text = "ANTICIPOS OTORGADOS"
        'f.ManipulacionEstado = ENTITY_ACTIONS.INSERT

        'f.cboMesCompra.SelectedValue = MesGeneral
        'f.cboMesCompra.Enabled = True
        'f.Label72.Text = "Buscar Poveedor"
        'f.ObtenerTablaGenerales("104")
        'f.txtDia.Value = New Date(CInt(AnioGeneral), CInt(MesGeneral), DiaLaboral.Day)
    ...
    Private Sub ButtonAdv5_Click(sender As Object, e As EventArgs) Handles ButtonAdv5.Click
        ...
        'End If
        Dim f As New frmSelectDocCompensar

        f.txtBuscarProveedorPago.Text = txtProveedor.Text
        f.txtBuscarProveedorPago.Tag = txtProveedor.Tag
        f.txtRucPago.Text = txtRuc.Text
        f.txtPeriodo.Value = txtPeriodoCompras.Value
        f.txtMontoXComp.Value = txtImporteMN.Text
        f.StartPosition = FormStartPosition.CenterScreen
        f.ShowDialog()

        If f.objetoDocCompensacion IsNot Nothing Then
            objetoGeneralCompesatorio = New documento
            objetoGeneralCompesatorio = f.objetoDocCompensacion


            lblDocumentoSeleccionado.Text = objetoGeneralCompesatorio.tipoDoc
            lblSerieSeleccionado.Text = objetoGeneralCompesatorio.documentoCaja.SerieCompra
            lblNumeroSeleccionado.Text = objetoGeneralCompesatorio.documentoCaja.numeroCompra
            lblMontoSeleccionado.Text = objetoGeneralCompesatorio.documentoCaja.montoSoles


            txtDia.Value = objetoGeneralCompesatorio.documentoCaja.fechaProceso
            cboMesCompra.SelectedValue = String.Format("{0:00}", objetoGeneralCompesatorio.documentoCaja.fechaProceso.Value.Month)
            txtAnioCompra.Text = objetoGeneralCompesatorio.documentoCaja.fechaProceso.Value.Year
            txtHora.Value = objetoGeneralCompesatorio.documentoCaja.fechaProceso

            txtFechaDocComp.Value = objetoGeneralCompesatorio.documentoCaja.fechaProceso

            CompensarConAnticipos()

        Else
            MessageBox.Show("No ha Seleccioando Ningun Documento")
        End If
    End Sub

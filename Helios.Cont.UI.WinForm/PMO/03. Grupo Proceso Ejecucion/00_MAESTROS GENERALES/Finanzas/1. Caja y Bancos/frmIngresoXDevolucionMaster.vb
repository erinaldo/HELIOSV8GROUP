...
Public Class frmIngresoXDevolucionMaster
...
#Region "Methods"
    ...
    Private Function GetMovimientosPeriodo(intIdEstablecimiento As Integer, strPeriodo As String, strMovimiento As String) As DataTable
        ...
        dt.Columns.Add(New DataColumn("nombreMov", GetType(String)))
        'lower case p
        ...
        'GridGroupingControl2.Table.TableDescriptor.Columns("idDocumento").Width = 0
        'GridGroupingControl2.Table.TableDescriptor.Columns("tipoDocPago").Width = 0
        ...
        For Each i As documentoCaja In listaDocCaja
            ...
            Select Case i.tipoOperacion
                Case "9912"
                    dr(2) = "INGRESO DINERO POR NOTA CREDITO"
                Case "9909"
                    dr(2) = "OTRAS ENTRADAS DE DINERO"
                Case "9910"
                    dr(2) = "OTRAS SALIDAS DE DINERO"
                Case "9911"
                    dr(2) = "TRANFERENCIA ENTRE CAJAS"
                Case "9907"
                    dr(2) = "PAGO A PROVEEDOR"
                Case "9908"
                    dr(2) = "COBRO A CLIENTES"
                Case "02" ' COMPRAS
                    dr(2) = "COMPRA"
                Case "105" 'APERTURA DE CAJAS
                    dr(2) = "APERTURA DE CAJA"
                Case "01" 'VENTAS
                    dr(2) = "VENTA"
                Case "12.1"
                    dr(2) = "VENTA TICKET BOLETA"
                Case "12.2"
                    dr(2) = "VENTA TICKET FACTURA"
                Case "17"
                    dr(2) = "APORTES"
                Case "103"
                    dr(2) = "ANTICIPOS RECIBIDOS"
                Case "104"
                    dr(2) = "ANTICIPOS OTORGADOS"
                Case "21"
                    dr(2) = "PAGO POR COMPENSACION"
                Case "9927"
                    dr(2) = "DEVOLUCION DE ANTICIPO A CLIENTE"
                Case "9928"
                    dr(2) = "DEVOLUCION DE ANTICIPO A PROVEEDOR"
                Case "9926"
                    dr(2) = "REVERSIONES"
            End Select

            dr(3) = "COMPROBANTE DE CAJA"
            dr(4) = str
            dr(5) = i.numeroDoc
            Select Case i.moneda
                ...
                Case 2
                    dr(6) = "EXTRANJERA"
            End Select
            dr(7) = CDec(i.montoSoles).ToString("N2")
            dr(8) = i.MontoEgresosMN
            dr(9) = CDec(i.montoSoles - i.MontoEgresosMN)
    ...
    Private Function GetMovimientosChildrem(anio As Integer, mes As Integer) As DataTable
        ...
        'dt.Columns(8).ColumnMapping = MappingType.

        Dim str As String
        'GridGroupingControl2.Table.TableDescriptor.Columns("idDocumento").Width = 0
        'GridGroupingControl2.Table.TableDescriptor.Columns("idPadre").Width = 0
        'GridGroupingControl2.Table.TableDescriptor.Columns("tipoDocPago").Width = 0
        'listaEstado.Add("N")
        listaEstado.Add("D")

...
Public Class frmReversionMaster
...
#Region "Methods"
    ...
    Private Function GetMovimientosPeriodo(intIdEstablecimiento As Integer, strPeriodo As String, strMovimiento As String) As DataTable
        ...
        listaDocCaja = documentoCajaSA.ObtenerHistorialReversion(Gempresas.IdEmpresaRuc, GEstableciento.IdEstablecimiento, strPeriodo, strMovimiento, listaEstado)
    ...
    Private Function GetMovimientosChildrem(anio As Integer, mes As Integer) As DataTable
        ...
        listaDocCaja = documentoCajaSA.ObtenerMovCajaReversion(Gempresas.IdEmpresaRuc, anio, mes)
...
#Region "Events"
    ...
    Private Sub ButtonAdv1_Click(sender As Object, e As EventArgs) Handles ButtonAdv1.Click
        ...
        parentTable = GetMovimientosPeriodo(GEstableciento.IdEstablecimiento, periodoG, "RV")
        childTable = GetMovimientosChildrem(cboAnio.Text, cboMesCompra.SelectedValue)

        parentToChildRelationDescriptor.ChildTableName = "Reversión"
        ...
        Me.GridGroupingControl2.Engine.SourceListSet.Add("Documento Principal", parentTable)
        Me.GridGroupingControl2.Engine.SourceListSet.Add("Reversión", childTable)

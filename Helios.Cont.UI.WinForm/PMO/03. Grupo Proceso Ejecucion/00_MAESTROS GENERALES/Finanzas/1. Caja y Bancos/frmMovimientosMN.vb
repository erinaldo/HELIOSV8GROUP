    ...
    Private Sub GetTableXperiodo(intIdEntidad As Integer, Periodo As String)
        ...
        Select Case txtMonedaKardex.Text
            ...
            Case "NACIONAL"
                ...
                ImporteSaldoME = 0
                'canSaldo = 0
                listaDocCaja = documentoCajaSA.ObtenerCajaOnline(Gempresas.IdEmpresaRuc, CInt(GEstableciento.IdEstablecimiento), String.Format("{0:00}", CInt(txtPeriodoAFC.Value.Month)), CStr(txtPeriodoAFC.Value.Year), CStr(intIdEntidad))
...
#Region "Events"
    ...
    Private Sub frmMovimientosMN_Load(sender As Object, e As EventArgs) Handles MyBase.Load

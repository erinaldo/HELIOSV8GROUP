...
#Region "Events"
    ...
    Private Sub ButtonAdv2_Click(sender As Object, e As EventArgs) Handles ButtonAdv2.Click
        ...
        With frmAporte
            ...
            .lblMovimiento.Tag = "AP"
            .lblMovimiento.Text = "APORTES"
            .ManipulacionEstado = ENTITY_ACTIONS.INSERT
            .txtTipoCambio.Value = TmpTipoCambio
            .cboMesCompra.SelectedValue = cboMesCompra.SelectedValue
            .cboMesCompra.Enabled = True
            .txtDia.Value = New Date(AnioGeneral, CInt(cboMesCompra.SelectedValue), DiaLaboral.Day)
            .StartPosition = FormStartPosition.CenterParent
            .ShowDialog()
        End With
    End Sub
    ...
    Private Sub ButtonAdv1_Click(sender As Object, e As EventArgs) Handles ButtonAdv1.Click
        Cursor = Cursors.WaitCursor
        Dim periodoG As String = cboMesCompra.SelectedValue & "/" & AnioGeneral
        GetMovimientosPeriodo(GEstableciento.IdEstablecimiento, periodoG, "AP")
        Cursor = Cursors.Default
    End Sub
...
#End Region
    ...
    Private Sub ButtonAdv8_Click(sender As Object, e As EventArgs) Handles ButtonAdv8.Click
        ...
        If Not IsNothing(Me.dgvOtrosMov.Table.CurrentRecord) Then
            ...
            If (TIPO_ESTADO_cAJA.ANULADO = Me.dgvOtrosMov.Table.CurrentRecord.GetValue("estado")) Then

                Dim cajaUsuario = cajaUsuarioSA.UbicarCajaAsignadaUser(usuario.IDUsuario, "A", "S", Nothing)
                If Not IsNothing(cajaUsuario) Then
                    GetGlobalMappingCajaUsuario(cajaUsuario, usuario.IDUsuario, usuario.CustomUsuario.Full_Name)

                    Dim f As New frmConfirmarDevolucion(StatusTipoOperacion.APORTES)

...
Public Class frmBoletasElectronicas
...
#Region "Constructor"
    Sub New()
        ...
        configuracionModuloV2(strIDEmpresa, "RSD", "", GEstableciento.IdEstablecimiento)
    End Sub
#End Region
...
#Region "Metodos"
    ...
    Private Sub CrearResumenDiario()
        ...
        Try
            ...
            ActualizarBoletas(listaActEstado, IIf(IsNothing(GConfiguracion.ConfigComprobante), 0, GConfiguracion.ConfigComprobante), enviarResumenResponse.NroTicket)
    ...
    Public Sub ActualizarEnvioSunat()
        ...
        Try
            ...
            documentoventasa.ListaEnvioSunat(listaDocs)
...
#End Region
    ...
    Private Sub frmBoletasElectronicas_Load(sender As Object, e As EventArgs) Handles MyBase.Load

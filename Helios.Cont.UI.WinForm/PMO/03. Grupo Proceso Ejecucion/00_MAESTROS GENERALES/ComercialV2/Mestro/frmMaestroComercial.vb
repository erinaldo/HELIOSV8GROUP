...
Public Class frmMaestroComercial

#Region "Attributes"
    Property Model As New MDIPrincipalModelComercial
...
#Region "Methods"
    Private Sub ConfiguracionInicio()
        ...
        lblEmpresa.Text = Space(15) & "Gestión Comercial - Business" '  & Gempresas.IdEmpresaRuc & ", " & Gempresas.NomEmpresa

...
Public Class FormVentaGeneralFE
...
#Region "Methods"
    ...
    Public Sub UbicarDocumentoPegado()
        ...
        Try
            ...
            txtSerie.Text = ClipBoardDocumento.documentoventaAbarrotes.serieVenta
            txtNumero.Text = ClipBoardDocumento.documentoventaAbarrotes.numeroVenta

            'CABECERA COMPROBANT
            'cboMesCompra.SelectedValue = String.Format("{0:00}", ClipBoardDocumento.documentoventaAbarrotes.fechaDoc.Value.Month)
            'TxtDia.Text = ClipBoardDocumento.documentoventaAbarrotes.fechaDoc.Value.Day
            'cboAnio.Text = ClipBoardDocumento.documentoventaAbarrotes.fechaDoc.Value.Year
            txtFecha.Value = ClipBoardDocumento.documentoventaAbarrotes.fechaDoc
            cboTipoDoc.SelectedValue = ClipBoardDocumento.documentoventaAbarrotes.tipoDocumento
            txtSerie.Text = ClipBoardDocumento.documentoventaAbarrotes.serieVenta
            txtNumero.Text = ClipBoardDocumento.documentoventaAbarrotes.numeroVenta
            'cboMoneda.SelectedValue = ClipBoardDocumento.documentoventaAbarrotes.monedaDoc
            ...
            nEntidad = objEntidad.UbicarEntidadPorID(ClipBoardDocumento.documentoventaAbarrotes.idClientePedido).First()
            txtruc.Text = nEntidad.nrodoc
            TXTcOMPRADOR.Tag = nEntidad.idEntidad
            TXTcOMPRADOR.Text = nEntidad.nombreCompleto

            'txtTipoCambio.DecimalValue = ClipBoardDocumento.documentoventaAbarrotes.tipoCambio
            'txtIva.DoubleValue = ClipBoardDocumento.documentoventaAbarrotes.tasaIgv
            txtGlosa.Text = ClipBoardDocumento.documentoventaAbarrotes.glosa
            ...
            For Each i In ClipBoardDocumento.documentoventaAbarrotes.documentoventaAbarrotesDet.ToList
                ...
                Dim cantidad As Decimal = i.monto1
                Dim valPUmn As Decimal = 0
                Dim valPUme As Decimal = 0

                valPUmn = i.precioUnitario 'productoBE.PMprecioMN
                valPUme = i.precioUnitarioUS ' productoBE.PMprecioME
                ...
                Dim existeEnCanasta = VerificarItemDuplicadoV2(CDec(cantidad), i.codigoLote, i.idItem)
                If existeEnCanasta Then
                    ...
                    Dim cantidadDisponible = i.monto1  'cantidad
                    Dim colPrecUnitAlmacen = i.importeMN / i.monto1
                    Dim colPrecUnitUSAlmacen = i.importeME / i.monto1
                    Dim colPrecUnit = valPUmn
                        Dim colPrecUnitme = valPUme
                    Dim colDestinoGravado = i.destino  'origenRecaudo
                    ...
                    With dgvCompra.Table
                        ...
                        .CurrentRecord.SetValue("item", i.nombreItem)
                        .CurrentRecord.SetValue("um", i.unidad1)
                        .CurrentRecord.SetValue("cantidad", cantidad)
                        .CurrentRecord.SetValue("canDisponible", i.monto1)
                        ...
                        .CurrentRecord.SetValue("puKardex", i.importeMN / i.monto1)
                        .CurrentRecord.SetValue("pukardeme", i.importeME / i.monto1)
                        ...
                        .CurrentRecord.SetValue("cboprecio", 1) 'Integer.Parse(productoBE.tipoConfiguracion))
                ...
                'Me.dgvCompra.Table.CurrentRecord.SetValue("vcmn", Math.Round(i.montokardex, 2))
                'Me.dgvCompra.Table.CurrentRecord.SetValue("totalmn", Math.Round(i.importeMN, 2))
                ...
                'Me.dgvCompra.Table.CurrentRecord.SetValue("totalme", i.importeME, 2)
                'Me.dgvCompra.Table.CurrentRecord.SetValue("igvmn", i.montoIgv, 2)
                'Me.dgvCompra.Table.CurrentRecord.SetValue("igvme", i.montoIgvUS, 2)
                'Me.dgvCompra.Table.CurrentRecord.SetValue("tipoExistencia", TipoExistencia.Mercaderia)
                'Me.dgvCompra.Table.CurrentRecord.SetValue("marca", i.Marca) 'Susuentado y no sustentado
                ...
                'Me.dgvCompra.Table.CurrentRecord.SetValue("puKardex", i.importeSoles / i.cantidad)
                'Me.dgvCompra.Table.CurrentRecord.SetValue("pukardeme", i.importeDolares / i.cantidad)
                ...
                'Me.dgvCompra.Table.CurrentRecord.SetValue("presentacion", i.NomAlmacen)
                ...
                'Me.dgvCompra.Table.CurrentRecord.SetValue("tipoPrecio", i.tipoConfiguracion)
                'Me.dgvCompra.Table.CurrentRecord.SetValue("cboprecio", Integer.Parse(i.tipoConfiguracion))
                'Me.dgvCompra.Table.CurrentRecord.SetValue("cat", StatusCategoriaVenta.Productos)
                'Me.dgvCompra.Table.CurrentRecord.SetValue("codigoLote", i.codigoLote)
                'Me.dgvCompra.Table.CurrentRecord.SetValue("codBarra", i.CodigoBarra)
                'Me.dgvCompra.Table.CurrentRecord.SetValue("empresa", Gempresas.IdEmpresaRuc)
                'Me.dgvCompra.Table.CurrentRecord.SetValue("tipoventa", "V")
    ...
    Private Sub GetImpresionTicketsEspecialNota(be As documento)
        Dim ventaSA As New documentoVentaAbarrotesSA
        ...
        'Dim f As New FormImpresionNuevo(be) ' frmVentaNuevoFormato
        'f.DocumentoID = be.idDocumento
        'f.StartPosition = FormStartPosition.CenterScreen
        '' f.ManipulacionEstado = ENTITY_ACTIONS.INSERT
        'f.Show(Me)

        ventaSA.GetActualizarImpresion(New documentoventaAbarrotes With {.idDocumento = be.idDocumento})
        'End If
    End Sub

...
Public Class FormVentaGeneralSinInventario
    Implements IForm, IPrecio, IListaInventario, IProductoConsignado,
        IOferta, ICommitOperacionMKT
...
#Region "Fields"
    ...
    Public Property frmCanastaInventary As FormCanastaTotalesServVer2
...
#Region "Constructors"
    Public Sub New()
        ...
        frmCanastaInventary = New FormCanastaTotalesServVer2()
        ConfiguracionInicio()
        'CalculoGridCeldas()
        GetTableGrid()
...
#Region "Methods"
    ...
    Sub GrabarVentaCasoEspecial(documento As documento)
        Dim ListProductosVendidos As New List(Of documentoventaAbarrotesDet)
        objPleaseWait = New FeedbackForm()
        objPleaseWait.StartPosition = FormStartPosition.CenterScreen
        objPleaseWait.Show()
    ...
    Private Function GetDetalleVenta(documento As documento) As List(Of documentoventaAbarrotesDet)
        Dim TipoEntrega = TipoEntregado.Entregado
        Dim objDocumentoVentaDet As documentoventaAbarrotesDet
        GetDetalleVenta = New List(Of documentoventaAbarrotesDet)
        For Each r As Record In dgvCompra.Table.Records
            ...
            objDocumentoVentaDet.IdEmpresa = documento.idEmpresa ' Gempresas.IdEmpresaRuc
            objDocumentoVentaDet.IdEstablecimiento = documento.idCentroCosto ' GEstableciento.IdEstablecimiento ' almacenSA.GetUbicar_almacenPorID(i.Cells(24).Value()).idEstablecimiento
            objDocumentoVentaDet.FechaDoc = documento.fechaProceso ' txtFecha.Value
            objDocumentoVentaDet.Serie = documento.documentoventaAbarrotes.serieVenta ' conf.Serie
            objDocumentoVentaDet.NumDoc = documento.documentoventaAbarrotes.numeroVenta ' conf.Serie
            objDocumentoVentaDet.TipoDoc = documento.documentoventaAbarrotes.tipoDocumento ' conf.TipoComprobante
            If r.GetValue("tipoExistencia") = "GS" Then
                objDocumentoVentaDet.idAlmacenOrigen = Nothing
                objDocumentoVentaDet.tipoVenta = r.GetValue("tipoPrecio")
            ElseIf r.GetValue("tipoExistencia") = "OF" Then
            ...
            Else
                ...
                objDocumentoVentaDet.tipoVenta = r.GetValue("tipoPrecio")
            End If
            objDocumentoVentaDet.establecimientoOrigen = documento.idCentroCosto ' GEstableciento.IdEstablecimiento
            objDocumentoVentaDet.cuentaOrigen = Nothing
            objDocumentoVentaDet.idItem = r.GetValue("idProducto")
            objDocumentoVentaDet.DetalleItem = r.GetValue("item")
            objDocumentoVentaDet.nombreItem = r.GetValue("item")
            ...
            objDocumentoVentaDet.importeMNK = 0 ' CDec(r.GetValue("puKardex"))
            objDocumentoVentaDet.importeMEK = 0 ' CDec(r.GetValue("pukardeme"))
            objDocumentoVentaDet.fechaVcto = documento.documentoventaAbarrotes.fechaDoc ' txtFecha.Value
            objDocumentoVentaDet.estadoEntrega = TipoEntrega
            objDocumentoVentaDet.cantidadEntrega = CDec(r.GetValue("cantEntregar"))
            objDocumentoVentaDet.salidaCostoMN = CDec(r.GetValue("costoMN")) ' Math.Round(CDec(i.Cells(6).Value()) * CDec(i.Cells(5).Value()), 2)
            objDocumentoVentaDet.salidaCostoME = CDec(r.GetValue("costoME")) 'Math.Round(CDec(i.Cells(28).Value()) * CDec(i.Cells(5).Value()), 2)
    ...
    Private Sub LimpiarControles()
        ...
        DigitalGauge1.Text = "0.00"
        DigitalGauge1.Value = "0.00"
...
#Region "Events"
        ...
        Try
            ...
            If tmpConfigInicio.FormatoVenta = "MKT" Then
                ...
                If ManipulacionEstado = ENTITY_ACTIONS.UPDATE AndAlso inicioComprobante = "PROFORMA" Then
                    EditarCotizacion()
                Else
                    Dim f As New FormConfirmaVentaV2(dgvCompra, TotalesXcanbeceras)
                    ...
                    f.lblTotalPercepcion.DecimalValue = lblTotalPercepcion.DecimalValue
    ...
    Private Sub ToolStripButton1_Click(sender As Object, e As EventArgs) Handles ToolStripButton1.Click
        ...
        With FormInventarioCanastaTotaledSI
        ...
        'frmCanastaInventary = New FormCanastaTotalesServVer2(cboalmacen.SelectedValue)
    ...
    Private Sub ToolStripButton2_Click(sender As Object, e As EventArgs) Handles ToolStripButton2.Click
        If dgvCompra.Table.CurrentRecord IsNot Nothing Then
            Dim f As New FormModificarPecio
            f.monedaSel = cboMoneda.Text
            f.txtPrecio.Select()
            f.txtPrecio.Select(0, f.txtPrecio.Text.Length)
            f.StartPosition = FormStartPosition.CenterParent
            f.ShowDialog(Me)
        End If
    End Sub
    ...
    Private Sub FormVentaGeneral_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        DigitalGauge1.ForeColor = Color.DarkViolet
        ...
        'AddHandler Me.dgvCompra.TableControlCurrentCellKeyDown, AddressOf dgvCompra_TableControlCurrentCellKeyDown
    End Sub
    ...
    Private Sub dgvCompra_TableControlCurrentCellKeyDown(sender As Object, e As GridTableControlKeyEventArgs) Handles dgvCompra.TableControlCurrentCellKeyDown
        ...
        ElseIf e.Inner.KeyCode = Keys.Up Or e.Inner.KeyCode = Keys.Down Then
            ...
            'ElseIf e.Inner.KeyCode = Keys.Enter Then
            '    'move one control to another control
            ...
            '    Me.dgvCompra.TableControl.CurrentCell.MoveTo(cc.RowIndex, cc.ColIndex + 1, GridSetCurrentCellOptions.SetFocus)
        End If
        ...
        '    ' setting focus to the next cell.
        '    Me.gridGroupingControl1.TableControl.CurrentCell.MoveTo(cc.RowIndex, cc.ColIndex + 1, GridSetCurrentCellOptions.SetFocus)
        'End If
        ''End If
    ...
    Private Sub FormVentaGeneral_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
        ...
        ElseIf (e.KeyCode = Keys.F4) Then
            TXTcOMPRADOR.Focus()
            TXTcOMPRADOR.Select(0, TXTcOMPRADOR.Text.Length)
        End If
    End Sub
    ...
    Private Sub RBProforma_CheckedChanged(sender As Object, e As EventArgs) Handles RBProforma.CheckedChanged
        If RBProforma.Checked = True Then
            GetResetCantidades()
        End If
    End Sub

    Private Sub TextMenorLeft_TextChanged(sender As Object, e As EventArgs) Handles TextMenorLeft.TextChanged
    ...
    Private Sub Label29_Click(sender As Object, e As EventArgs) Handles LabelCliente.Click

    End Sub

    Private Sub GroupBar2_GroupBarItemSelected(sender As Object, e As EventArgs) Handles GroupBarMKT.GroupBarItemSelected

    End Sub

    Private Sub GroupBar1_GroupBarItemSelected(sender As Object, e As EventArgs)
    ...
    Private Sub TextMenor_MouseDoubleClick(sender As Object, e As MouseEventArgs) Handles TextMenor.MouseDoubleClick
        Dim r As Record = dgvCompra.Table.CurrentRecord
        If r IsNot Nothing Then

            Select Case cboMoneda.Text
                Case "NACIONAL"
                    dgvCompra.Table.CurrentRecord.SetValue("pumn", TextMenor.DecimalValue)
                Case "EXTRANJERA"
                    dgvCompra.Table.CurrentRecord.SetValue("pume", TextMenor.DecimalValue)
            End Select
            Me.dgvCompra.Table.CurrentRecord.SetValue("tipoPrecio", 1)
            dgvCompra.Refresh()
            Calculos()
    ...
    Private Sub TextMayor_MouseDoubleClick(sender As Object, e As MouseEventArgs) Handles TextMayor.MouseDoubleClick
        Dim r As Record = dgvCompra.Table.CurrentRecord
        If r IsNot Nothing Then

            Select Case cboMoneda.Text
                Case "NACIONAL"
                    dgvCompra.Table.CurrentRecord.SetValue("pumn", TextMayor.DecimalValue)
                Case "EXTRANJERA"
                    dgvCompra.Table.CurrentRecord.SetValue("pume", TextMayor.DecimalValue)
            End Select
    ...
    Private Sub TextGMayor_MouseDoubleClick(sender As Object, e As MouseEventArgs) Handles TextGMayor.MouseDoubleClick
        Dim r As Record = dgvCompra.Table.CurrentRecord
        If r IsNot Nothing Then
            Select Case cboMoneda.Text
                Case "NACIONAL"
                    dgvCompra.Table.CurrentRecord.SetValue("pumn", TextGMayor.DecimalValue)
                Case "EXTRANJERA"
                    dgvCompra.Table.CurrentRecord.SetValue("pume", TextGMayor.DecimalValue)
            End Select
            Me.dgvCompra.Table.CurrentRecord.SetValue("tipoPrecio", 3)
            dgvCompra.Refresh()
            Calculos()
    ...
    Private Sub cboMoneda_SelectedValueChanged(sender As Object, e As EventArgs) Handles cboMoneda.SelectedValueChanged
        If cboMoneda.Text = "NACIONAL" Then
            ...
            '    .GridTotales.Table.Records.DeleteAll()
            'End With
            'dgvCompra.TableDescriptor.Columns("pumn").Width = 75
            'dgvCompra.TableDescriptor.Columns("vcmn").Width = 0 '65
            'dgvCompra.TableDescriptor.Columns("igvmn").Width = 0 '65
            'dgvCompra.TableDescriptor.Columns("totalmn").Width = 75
        ...
        ElseIf cboMoneda.Text = "EXTRANJERA" Then
            ...
            'dgvCompra.TableDescriptor.Columns("pume").Width = 75
            'dgvCompra.TableDescriptor.Columns("vcme").Width = 0
            'dgvCompra.TableDescriptor.Columns("igvme").Width = 0
            'dgvCompra.TableDescriptor.Columns("totalme").Width = 75
        End If
    End Sub

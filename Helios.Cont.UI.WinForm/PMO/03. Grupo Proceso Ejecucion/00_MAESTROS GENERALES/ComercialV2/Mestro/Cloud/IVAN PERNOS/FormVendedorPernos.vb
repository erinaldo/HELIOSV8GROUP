...
Imports SE = Helios.Seguridad.Business.Entity
Imports Syncfusion.Drawing
Imports Syncfusion.Grouping
Imports Syncfusion.Windows.Forms
Imports Syncfusion.Windows.Forms.Grid
Imports Syncfusion.Windows.Forms.Grid.Grouping
Public Class FormVendedorPernos
...
#Region "Fields"
    ...
    Public Property FormInventarioCanastaTotales As FormCanastaTotalesServ
...
#Region "Methods"
    ...
    Public Function VerificarUsuario(ByVal codigo As String, ByVal lista As List(Of SE.Usuario)) As Boolean
    ...
    Sub GrabarVentaDuplex()
        ...
        Dim ListProductosVendidos = GetDetalleVenta(Nothing)
        ...
        If ListProductosVendidos.Where(Function(o) o.GetSustento = True).Count > 0 Then
            Dim DocComprobante =
            CType(GetGrabarVentaComprobante(ListProductosVendidos.Where(Function(o) o.GetSustento = True).ToList(), Nothing), documento)
...
#Region "Events"
    ...
    Private Sub dgvCompra_TableControlCellClick(sender As Object, e As GridTableControlCellClickEventArgs) Handles dgvCompra.TableControlCellClick
        ...
        If style3.Enabled Then
            If style3.TableCellIdentity.Column.Name = "item" Then
                ...
                FormInventarioCanastaTotales = New FormCanastaTotalesServ(cboalmacen.SelectedValue, nomproduct)
    ...
    Private Sub ToolStripButton1_Click(sender As Object, e As EventArgs) Handles ToolStripButton1.Click
        FormInventarioCanastaTotales = New FormCanastaTotalesServ(cboalmacen.SelectedValue)
        FormInventarioCanastaTotales.validaStocks = True
        FormInventarioCanastaTotales.StartPosition = FormStartPosition.CenterScreen
        FormInventarioCanastaTotales.Show(Me)
        ...
        Try
            ...
            Else
                ...
                With dgvCompra.Table
                    ...
                    .CurrentRecord.SetValue("idProducto", productoBE.idItem)
                    .CurrentRecord.SetValue("item", productoBE.descripcion)
                    .CurrentRecord.SetValue("um", productoBE.unidadMedida)
    ...
    Private Sub FormVendedorPernos_Load(sender As Object, e As EventArgs) Handles Me.Load
        dgvCompra.TableDescriptor.Columns("pumn").Width = 60
        dgvCompra.TableDescriptor.Columns("vcmn").Width = 65
        dgvCompra.TableDescriptor.Columns("igvmn").Width = 65
        dgvCompra.TableDescriptor.Columns("totalmn").Width = 70

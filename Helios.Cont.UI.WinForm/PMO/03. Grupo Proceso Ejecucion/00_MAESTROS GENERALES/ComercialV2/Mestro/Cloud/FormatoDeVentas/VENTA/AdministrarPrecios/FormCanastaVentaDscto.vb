...
Public Class FormCanastaVentaDscto
    Public Property UCEstructuraCabeceraVenta As UCEstructuraCabeceraVentaV2
    Public Property FormDsctoAmarresModal As FormDsctoAmarresModal
...
#Region "Constructors"
    ...
    Public Sub New(ucVenta As UCEstructuraCabeceraVentaV2, frmModalDescuentos As FormDsctoAmarresModal)
        ...
        FormDsctoAmarresModal = frmModalDescuentos
                        ...
                        Select Case cc.MoveToColIndex
                            Case 6
                                ...
                                ElseIf e.Inner.PopupCloseType = Syncfusion.Windows.Forms.PopupCloseType.Done Then
                                    ...
                                    Dim inp = 1 'CDec(formCantidad.Tag) 'InputBox("Ingreser cantidad", "Atención", "")
                                    '   If inp IsNot Nothing Then
                                    If IsNumeric(inp) Then
                                        If (inp) > 0 Then
                                            ...
                                            Dim objventaItem = UCEstructuraCabeceraVenta.AgregarProductoDetalleVentaPorAmarre(inp, codiProducto, precioventaFormula, Unidades, cat.idCatalogo)
                                            Tag = objventaItem
                                            ' FormDsctoAmarresModal.ItemsVentaDescontados = objventaItem
                                            '  FormDsctoAmarresModal.AgregarCanastaDescuentos()
                                            Close()

...
Public Class UserControlCanastaInventario

    Public Property UCEstructuraCabeceraVenta As FormSalidasInventarioVenta

    Public Sub New(ucVenta As FormSalidasInventarioVenta)
...
#Region "Events"
        ...
        If cc.ColIndex > -1 Then
            ...
            If style.TableCellIdentity.Column.Name = "cboEquivalencias" Then
                ...
                If style.TableCellIdentity.Table.CurrentRecord IsNot Nothing Then
                    ...
                    '    If UCEstructuraCabeceraVenta.ChVentaLote.Checked = True Then Exit Sub
                    ...
                    If style.TableCellIdentity.Column.Name = "cboEquivalencias" Then
                        ...
                        If IsNumeric(inp) Then
                            If (inp) > 0 Then
                                ...
                                stock = Decimal.Parse(GridTotales.Table.CurrentRecord.GetValue("cantidad"))

                                UCEstructuraCabeceraVenta.AgregarProductoDetalleVenta(inp, codiProducto, objEQ, stock)
                                'End If
                        ...
                        If Me.GridTotales.Table.CurrentRecord IsNot Nothing Then
                            ...
                            If IsNumeric(inp) Then
                                If (inp) > 0 Then
                                    ...
                                    UCEstructuraCabeceraVenta.AgregarProductoDetalleVenta(inp, idProducto, objEQ, stock)
                                    UCEstructuraCabeceraVenta.LoadCanastaVentas(UCEstructuraCabeceraVenta.ListaproductosVendidos)
    ...
    Private Sub GridTotales_QueryCellFormattedText(sender As Object, e As GridCellTextEventArgs) Handles GridTotales.QueryCellFormattedText
                ...
                If IsNumeric(inp) Then
                    If (inp) > 0 Then
                        ...
                        Else
                            stock = Decimal.Parse(GridTotales.Table.CurrentRecord.GetValue("cantidad"))
                        End If
                        UCEstructuraCabeceraVenta.AgregarProductoDetalleVenta(inp, codiProducto, objEQ, stock, lote)
                        'End If

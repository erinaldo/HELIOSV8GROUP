...
Public Class UCPagoVenta
#Region "Attributes"
    Public Property FormVenta As FormVentaNueva
    Public UCPagoCompletoDocumento As UCPagoVentaCompleto
    Public UCCronogramaPagos As UCCronogramaPagos
#End Region

#Region "Constructors"
    Public Sub New(FormCrearventa As FormVentaNueva)
        ...
        ' Add any initialization after the InitializeComponent() call.
        UCPagoCompletoDocumento = New UCPagoVentaCompleto(FormCrearventa)
        UCCronogramaPagos = New UCCronogramaPagos(FormCrearventa) With {.Dock = DockStyle.Fill}

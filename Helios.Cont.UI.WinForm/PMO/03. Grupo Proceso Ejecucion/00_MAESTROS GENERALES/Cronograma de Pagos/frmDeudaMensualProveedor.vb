...
Public Class frmDeudaMensualProveedor
    Inherits frmMaster
...
#End Region
    ...
    Private Sub ProgramacionObligaciones(idprov As Integer, tipoprov As String)
        ...
        documentoLibro = documentoVentaSA.UbicarCronogramaPorEntidad(idprov, tipoprov)
    ...
    Private Sub frmDeudaMensualProveedor_Load(sender As Object, e As EventArgs) Handles MyBase.Load

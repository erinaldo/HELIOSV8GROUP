...
Public Class frmGastoCostoModulo
    Inherits frmMaster
    ...
    Private Sub LoadCombos()
        ...
        ListadoCuentasContables = cuentaSA.CuentasCostoGastoSinModulo(Gempresas.IdEmpresaRuc)
    End Sub
    ...
    Sub Grabar()
        ...
        For Each i In ListaAsientos
            ...
            For Each mov In consultaMov
                ...
                objDocumentoLibroDet.tipoCosto = "PRE"
...
#End Region
    ...
    Private Sub txtCuentaSel_TextChanged(sender As Object, e As EventArgs) Handles txtCuentaSel.TextChanged

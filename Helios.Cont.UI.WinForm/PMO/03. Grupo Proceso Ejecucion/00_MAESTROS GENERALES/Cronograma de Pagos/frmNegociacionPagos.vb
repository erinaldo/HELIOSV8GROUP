...
Public Class frmNegociacionPagos
    Inherits frmMaster
        ...
        Try
            For Each i As Record In dgvPagosProgramados.Table.Records
                ...
                If i.GetValue("pago") > 0 Then
                    ...
                    obj.glosa = "PAGO ASIENTO MANUAL"
                    obj.tipoRazon = txtTipoProv.Text
                    obj.nrocuota = i.GetValue("cuota")
        ...
        Try
            For Each i As Record In dgvPagosProgramados.Table.Records
                ...
                If i.GetValue("pago") > 0 Then
                    ...
                    obj.montoAutorizadoMN = CDec(i.GetValue("pago"))
                    obj.montoAutorizadoME = CDec(i.GetValue("pagome"))
                    obj.glosa = "PAGO A" & " " & txtCliente.Text
                    'obj.tipoRazon = i.GetValue("tipoProv")
                    obj.tipoRazon = "PR"
...
#End Region
            ...
            If txtdiaspago.Value >= 0 Then
                ...
                If txtImporteCompramn.Value > 0 Or txtImporteComprame.Value > 0 Then
                    ...
                    For x = 0 To txtCuotas.Value - 1
                        ...
                        Me.dgvPagosProgramados.Table.CurrentRecord.SetValue("fechaPago", fechaModo.Date)
    ...
    Private Sub chkSunat_CheckedChanged(sender As Object, e As EventArgs) Handles chkSunat.CheckedChanged
        txtCliente.Text = "SUNAT"
        txtCliente.Tag = 26315
        txtTipoProv.Text = "PR"
        txtRuc.Text = "12345678"
    End Sub

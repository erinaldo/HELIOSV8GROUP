...
#Region "Metodos"
    ...
    Function asientoCajaModulo() As asiento
        ...
        For Each i As Record In dgvPagosVarios.Table.Records
            ...
            If CDec(i.GetValue("pago")) > 0 Then
                nAsiento.movimiento.Add(AS_HaberCliente(i.GetValue("cuenta"), i.GetValue("detalle"), i.GetValue("pago"), i.GetValue("pagome")))
                nAsiento.movimiento.Add(AS_DebeCaja(cuentaFinacieraSA.GetUbicar_estadosFinancierosPorID(cajaSeleccionada.depositohijo).cuenta, cajaSeleccionada.CajaNombre, i.GetValue("pago"), i.GetValue("pagome")))
                ...
                Case 1 '    nacional
                    ...
                    If txtmonedaprog.Text = "EXTRANJERO" Then
                        If (CDec(r.monto > 0)) Then
                            ...
                            nAsiento.movimiento.Add(AS_DebeCajaDiferencia(cajaSeleccionada.cuenta, cajaSeleccionada.CajaNombre, sumaAsientocajaMN, 0.0, ASIENTO_CONTABLE.UBICACION.HABER))
...
#End Region
    ...
    Private Sub frmCobrosAsiento_FormClosing(sender As Object, e As FormClosingEventArgs) Handles Me.FormClosing
        Dispose()
    End Sub

    Private Sub frmCobrosAsiento_Load(sender As Object, e As EventArgs) Handles MyBase.Load

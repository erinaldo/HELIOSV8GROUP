...
#Region "Metodos"
        ...
        Try
            ...
            For Each k In ListaSecuencia
                If Not k.percepcionMN > 0 Then
                    ...
                    Me.dgvMov.Table.CurrentRecord.SetValue("cboMov", "9921")
    ...
    Sub AsientoNotaCreditoNormal(consultaAsiento As List(Of documentocompradetalle))
        ...
        For Each i In consultaAsiento
            ...
            nMovimiento.descripcion = "IGV - R?GIMEN DE PERCEPCIONES"
            nMovimiento.tipo = "D"
    ...
    Sub Grabar()
        ...
        With nDocumentoCompra
            ...
            .destino = TIPO_COMPRA.PERCEPCION
            .glosa = txtGlosa.Text.Trim
            ...
            .tipoCompra = TIPO_COMPRA.PERCEPCION
        ...
        For Each r As Record In dgvMov.Table.Records
            ...
            objDocumentoCompraDet.NumDoc = txtNumero.Text
            objDocumentoCompraDet.Serie = txtSerie.Text
            objDocumentoCompraDet.TipoDoc = "40"
        ...
        Dim xcod As Integer = CompraSA.GrabarPercepcion(ndocumento, DocCaja)
...
#End Region
    ...
    Private Sub frmNotasDebito_FormClosing(sender As Object, e As FormClosingEventArgs) Handles Me.FormClosing
        Dispose()
    End Sub

    Private Sub frmNotasDebito_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub dgvCompra_TableControlCurrentCellControlDoubleClick(sender As Object, e As GridTableControlControlEventArgs) Handles dgvCompra.TableControlCurrentCellControlDoubleClick
        ...
        Else
            ...
            UbicarCompraDetalle(dgvCompra.Table.CurrentRecord.GetValue("idDocumento"))
        End If
    ...
    Private Sub txtMon_TextChanged(sender As Object, e As EventArgs) Handles txtMon.TextChanged

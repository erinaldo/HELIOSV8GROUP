...
#Region "Metodos"
    ...
    Sub Grabar()
        ...
        With nDocumentoCompra
            ...
            .tipoVenta = TIPO_VENTA.RETENCION
            .glosa = txtGlosa.Text.Trim
        ...
        For Each r As Record In dgvMov.Table.Records
            ...
            objDocumentoCompraDet.TipoDoc = "20"
        ...
        Dim xcod As Integer = CompraSA.SaveRetencion(ndocumento)
        'Dim xcod As Integer = CompraSA.SaveVentaNotaCredito2(ndocumento, DocCaja, documentoSaldo)
        lblEstado.Text = "Retencion registrada!"
        Dispose()
    End Sub
                        ...
                        Select Case dgvMov.Table.CurrentRecord.GetValue("estadoPago")
                            ...
                            Case Else
                                ...
                                If valAbonomn > saldoCompramn Then
                                    ...
                                    dgvMov.Table.CurrentRecord.SetValue("ValDevme", 0)
                                    Calculos()
                                    Throw New Exception("El importe supera al saldo, " & saldoCompramn.ToString("N2"))
                                End If
                        ...
                        Select Case dgvMov.Table.CurrentRecord.GetValue("estadoPago")
                            ...
                            Case Else
                                ...
                                If valAbonomn > saldoCompramn Then
                                    ...
                                    dgvMov.Table.CurrentRecord.SetValue("ValDevme", 0)
                                    Calculos()
                                    Throw New Exception("El importe supera el saldo, " & saldoCompramn.ToString("N2"))
                                End If
                        ...
                        Select Case dgvMov.Table.CurrentRecord.GetValue("estadoPago")
                            ...
                            Case Else
                                ...
                                If valAbonomn > saldoCompramn Then
                                    ...
                                    dgvMov.Table.CurrentRecord.SetValue("ValDevme", 0)
                                    Calculos()
                                    Throw New Exception("El importe de la nota supera al importe de venta, " & saldoCompramn.ToString("N2"))
                                End If

...
Public Class frmResumenMovByOperacion
    Inherits frmMaster

    Public Sub New(intIdEstablecimiento As Integer, fecha As DateTime, Operacion As String)

        ' This call is required by the designer.
        InitializeComponent()

        ' Add any initialization after the InitializeComponent() call.
        GetMovPorFecha(intIdEstablecimiento, fecha, Operacion)
        Me.CaptionLabels(1).Text = "Registro: " & DiaLaboral
    End Sub

#Region "Métodos"
    Private Sub GetMovPorFecha(intIdEstablecimiento As Integer, fecha As DateTime, Operacion As String)
        ...
        Dim str As String
        For Each i As documentocompra In DocumentoCompraSA.GetListarMvimientosAlmacenPorDia(Gempresas.IdEmpresaRuc, intIdEstablecimiento, Operacion, fecha, StatusTipoConsulta.XUNIDAD_ORGANICA)
...
#End Region
    ...
    Private Sub frmResumenMovByOperacion_Load(sender As Object, e As EventArgs) Handles MyBase.Load

...
Public Class frmContabilidadMaestro

#Region "Attributes"
    Property Model As New MDIPrincipalModelContabilidad
...
#Region "Methods"
    Private Sub ConfiguracionInicio()
        ...
        lblEmpresa.Text = Space(15) & "Gestión Contable - ERP" '  & Gempresas.IdEmpresaRuc & ", " & Gempresas.NomEmpresa

...
Public Class FormCompraAfecto
#Region "Attributes"
    Public UCEstructuraDocumentocabecera As UCAfectocabeceraCompra
...
#Region "Constructors"
    Public Sub New(IdDocumento As Integer)
        ...
        UCEstructuraDocumentocabecera = New UCAfectocabeceraCompra(Me)
...
#Region "Methods"
    ...
    Private Sub VerCabeceraDocumento(venta As documentocompra, ent As entidad)
        ...
        With UCEstructuraDocumentocabecera
            .TxtDia.DecimalValue = DateTime.Now.Day 'venta.fechaDoc.Value.Day
            .cboMesCompra.SelectedValue = String.Format("{0:00}", DateTime.Now.Month) ' String.Format("{0:00}", venta.fechaDoc.Value.Month)
            .TextAnio.DecimalValue = DateTime.Now.Year  'venta.fechaDoc.Value.Year
            .txtHora.Value = DateTime.Now 'venta.fechaDoc.Value
            ...
            .txtSerie.Text = ""
            .txtNumero.Text = ""
            .txtCompraAfectada.Text = venta.serie & "-" & venta.numeroDoc
            .txtCompraAfectada.Tag = venta.idDocumento
    ...
    Private Sub BunifuFlatButton15_Click(sender As Object, e As EventArgs) Handles BunifuFlatButton15.Click, BunifuFlatButton2.Click, BunifuFlatButton1.Click
        ...
        Select Case btn.Text
            ...
            Case "CONDICIONES DE PAGO"
                ...
                UCEstructuraDocumentocabecera.Visible = False
                If UCCondicionesPago IsNot Nothing Then
                    UCCondicionesPago.UCPagoCompletoDocumento.TextCompraTotal.DecimalValue = UCEstructuraDocumentocabecera.txtTotalPagar.DecimalValue
    ...
    Private Function ValidarForm() As Boolean
        ...
        If UCEstructuraDocumentocabecera.txtTotalPagar.DecimalValue <= 0 Then
            ErrorProvider1.SetError(UCEstructuraDocumentocabecera.txtTotalPagar, "La compra debe ser mayor a cero")
            listaErrores += 1
        Else
            ErrorProvider1.SetError(UCEstructuraDocumentocabecera.txtTotalPagar, Nothing)
        End If
    ...
    Private Sub GrabarCompra()
        ...
        If obj.documentocompra.documentocompradetalle.Where(Function(o) o.importe.GetValueOrDefault = 0).Count > 0 Then
            ...
            Exit Sub
        End If
        compraSA.GrabarCompraVinculada(obj)
    ...
    Private Sub MappingDocumentoCompraCabecera(be As documento)
        ...
        Select Case ComboComprobante.Text
            ...
            Case "COMPRA VINCULADA"
                TIPOCOMPRA = TIPO_COMPRA.COMPRA_VINCULADA
                glosa = "Compra vinculada"
        End Select
        ...
        Select Case be.moneda
            Case "1"
                ...
                base1ME = Math.Round(UCEstructuraDocumentocabecera.txtTotalBase.DecimalValue / UCEstructuraDocumentocabecera.txtTipoCambio.DecimalValue, 2)
                base2ME = Math.Round(UCEstructuraDocumentocabecera.txtTotalBase2.DecimalValue / UCEstructuraDocumentocabecera.txtTipoCambio.DecimalValue, 2)
                iva1 = UCEstructuraDocumentocabecera.txtTotalIva.DecimalValue
                iva1ME = Math.Round(UCEstructuraDocumentocabecera.txtTotalIva.DecimalValue / UCEstructuraDocumentocabecera.txtTipoCambio.DecimalValue, 2)

                total = UCEstructuraDocumentocabecera.txtTotalPagar.DecimalValue
                totalME = Math.Round(UCEstructuraDocumentocabecera.txtTotalPagar.DecimalValue / UCEstructuraDocumentocabecera.txtTipoCambio.DecimalValue, 2)
            Case "2"

                base1ME = UCEstructuraDocumentocabecera.txtTotalBase.DecimalValue
                base2ME = UCEstructuraDocumentocabecera.txtTotalBase2.DecimalValue

                base1 = Math.Round(UCEstructuraDocumentocabecera.txtTotalBase.DecimalValue * UCEstructuraDocumentocabecera.txtTipoCambio.DecimalValue, 2)
                base2 = Math.Round(UCEstructuraDocumentocabecera.txtTotalBase2.DecimalValue * UCEstructuraDocumentocabecera.txtTipoCambio.DecimalValue, 2)

                iva1ME = UCEstructuraDocumentocabecera.txtTotalIva.DecimalValue
                iva1 = Math.Round(UCEstructuraDocumentocabecera.txtTotalIva.DecimalValue * UCEstructuraDocumentocabecera.txtTipoCambio.DecimalValue, 2)

                totalME = UCEstructuraDocumentocabecera.txtTotalPagar.DecimalValue
                total = Math.Round(UCEstructuraDocumentocabecera.txtTotalPagar.DecimalValue * UCEstructuraDocumentocabecera.txtTipoCambio.DecimalValue, 2)
        End Select
        ...
        .idPadre = UCEstructuraDocumentocabecera.txtCompraAfectada.Tag,
        .bi01 = base1,
        .bi02 = base2,
        .bi03 = 0,
        .bi04 = 0,

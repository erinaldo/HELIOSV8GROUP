...
Public Class FormGestionNotasCompra
#Region "Varables"
    Dim compraSA As New DocumentoCompraSA
    Public Property TabLG_Recientes As TabLG_RecientesNC
    Public Property TabLG_PendienteCR As TabLG_PendienteCRNC
    Public Property TabLG_RechazadosCR As TabLG_RechazadosCRNC
    Public Property TabLG_Escaneadas As TabLG_EscaneadasNC
    Public Property TabLG_CRapidaPeriodo As TabLG_CRapidaPeriodoNC
#End Region
...
#Region "Methods"
    ...
    Public Sub GetStatusEscaneadas()
        ...
        Dim compraSA As New DocumentoCompraSA
        Dim statusList = compraSA.GetEscaneadasConteoNotaCompra(
            New Business.Entity.documentocompra With
            {
            .idEmpresa = Gempresas.IdEmpresaRuc,
            .idCentroCosto = GEstableciento.IdEstablecimiento,
    ...
    Private Sub GetListAprobacion(status As String)
        ...
        Select Case status
            Case "N"
                TabLG_PendienteCR = New TabLG_PendienteCRNC(Me) With {
                    .Dock = DockStyle.Fill
                }
                TabLG_PendienteCR.BringToFront()
                PanelBody.Controls.Add(TabLG_PendienteCR)
            Case "R"
                TabLG_RechazadosCR = New TabLG_RechazadosCRNC(Me) With {
                    .Dock = DockStyle.Fill
                }
...
#Region "Events"
    ...
    Private Sub ToolRecientes_Click(sender As Object, e As EventArgs) Handles ToolRecientes.Click
        PanelBody.Controls.Clear()
        TabLG_Recientes = New TabLG_RecientesNC(Me, ToolStripButton10.Text) With {
            .Dock = DockStyle.Fill
        }
    ...
    Private Sub Tool30_Click(sender As Object, e As EventArgs) Handles Tool30.Click
        PanelBody.Controls.Clear()
        TabLG_Escaneadas = New TabLG_EscaneadasNC(Me, "30") With {
                        .Dock = DockStyle.Fill
        }
    ...
    Private Sub Tool60_Click(sender As Object, e As EventArgs) Handles Tool60.Click
        PanelBody.Controls.Clear()
        TabLG_Escaneadas = New TabLG_EscaneadasNC(Me, "60") With {
            .Dock = DockStyle.Fill
        }
        TabLG_Escaneadas.BringToFront()
        PanelBody.Controls.Add(TabLG_Escaneadas)
    ...
    Private Sub Tool61_Click(sender As Object, e As EventArgs) Handles Tool61.Click
        PanelBody.Controls.Clear()
        TabLG_Escaneadas = New TabLG_EscaneadasNC(Me, "61") With {
            .Dock = DockStyle.Fill
        }
        TabLG_Escaneadas.BringToFront()
        PanelBody.Controls.Add(TabLG_Escaneadas)
    ...
    Private Sub ToolStripButton6_Click(sender As Object, e As EventArgs) Handles ToolStripButton6.Click
        PanelBody.Controls.Clear()
        TabLG_CRapidaPeriodo = New TabLG_CRapidaPeriodoNC() With {
            .Dock = DockStyle.Fill
        }

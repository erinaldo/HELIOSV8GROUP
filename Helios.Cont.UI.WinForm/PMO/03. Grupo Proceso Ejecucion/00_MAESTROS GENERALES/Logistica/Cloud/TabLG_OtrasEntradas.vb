...
Public Class TabLG_OtrasEntradas
...
#Region "Fields"
    ...
    Dim listaOperacion As List(Of tabladetalle)
#End Region
...
#Region "Methods"
    Private Sub GetCombos()
        ...
        ComboOperacion.DisplayMember = "descripcion"
        ComboOperacion.ValueMember = "codigoDetalle"
        ComboOperacion.DataSource = listaOperacion
    End Sub
    ...
    Private Sub GetMovPorPeriodo(intIdEstablecimiento As Integer, strPeriodo As String)
        ...
        Dim str As String
        For Each i As documentocompra In DocumentoCompraSA.GetListarPorPeriodoEntradas(Gempresas.IdEmpresaRuc, intIdEstablecimiento, strPeriodo, TIPO_COMPRA.OTRAS_ENTRADAS, StatusTipoConsulta.XUNIDAD_ORGANICA).Where(Function(o) o.tipoCompra = TIPO_COMPRA.OTRAS_ENTRADAS).ToList
    ...
    Private Sub GetMovPorPeriodoOperacion(intIdEstablecimiento As Integer, strPeriodo As String, tipoOperVal As String)
        Dim DocumentoCompraSA As New DocumentoCompraSA
        Dim dt As New DataTable("Movimientos")
        dt.Columns.Add(New DataColumn("idDocumento", GetType(Integer)))
        dt.Columns.Add(New DataColumn("destino", GetType(String)))
        ...
        Dim str As String
        For Each i As documentocompra In DocumentoCompraSA.GetListarPorPeriodoEntradas(Gempresas.IdEmpresaRuc, intIdEstablecimiento, strPeriodo, TIPO_COMPRA.OTRAS_ENTRADAS, StatusTipoConsulta.XUNIDAD_ORGANICA).Where(Function(o) o.tipoCompra = TIPO_COMPRA.OTRAS_ENTRADAS And o.tipoOperacion = tipoOperVal).ToList
            Dim dr As DataRow = dt.NewRow()
            str = Nothing
            str = CDate(i.fechaDoc).ToString("dd-MMM hh:mm tt ")
            dr(0) = i.idDocumento
...
#Region "Events"
    ...
    Private Sub ToolStripButton7_Click(sender As Object, e As EventArgs) Handles ToolStripButton7.Click
        ...
        If AutorizacionRolSA.TienePermiso(AsegurablesSistemaPOS.NUEVA_ENTRADA_Botón___, AutorizacionRolList) Then
    ...
    Private Sub ToolStripButton5_Click(sender As Object, e As EventArgs) Handles ToolStripButton5.Click
        ...
        If AutorizacionRolSA.TienePermiso(AsegurablesSistemaPOS.EDITAR_ENTRADA_Botón___, AutorizacionRolList) Then
    ...
    Private Sub ToolStripButton2_Click(sender As Object, e As EventArgs) Handles ToolStripButton2.Click
        Cursor = Cursors.WaitCursor
        Try
            If AutorizacionRolSA.TienePermiso(AsegurablesSistemaPOS.NUEVO_APORTE_Botón___, AutorizacionRolList) Then
                If cboMes.Text.Trim.Length > 0 Then
                    'validarCierreAnterior()
                    'ValidarCierreActual()
                    Dim f As New FormOtrasEntradasAlmacen ' frmMovOtrasEntradas
    ...
    Private Sub ButtonAdv18_Click(sender As Object, e As EventArgs) Handles ButtonAdv18.Click
        Cursor = Cursors.WaitCursor
        GetMovPorPeriodoOperacion(GEstableciento.IdEstablecimiento, cboMes.SelectedValue & "/" & cboAnio.Text, ComboOperacion.SelectedValue)
        Cursor = Cursors.Default
    End Sub
#End Region

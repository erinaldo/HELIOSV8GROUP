...
Public Class TabLG_NotasCredito
...
#Region "Methods"
    ...
    Sub ElimnarDoc()
        ...
        If Not IsNothing(Me.dgvCompras.Table.CurrentRecord) Then
            If Me.dgvCompras.Table.CurrentRecord.GetValue("tipoCompra") = TIPO_COMPRA.NOTA_CREDITO Then
...
#Region "Events"
    ...
    Private Sub ToolStripButton2_Click(sender As Object, e As EventArgs) Handles ToolStripButton2.Click
        'If AutorizacionRolSA.TienePermiso(AsegurablesSistemaPOS.VER_NOTA_Botón___, AutorizacionRolList) Then
    ...
    Private Sub ToolStripButton4_Click(sender As Object, e As EventArgs) Handles ToolStripButton4.Click
        Try
            'If AutorizacionRolSA.TienePermiso(AsegurablesSistemaPOS.ELIMINAR_ANULAR_NOTA_Botón___, AutorizacionRolList) Then
            If dgvCompras.Table.Records.Count > 0 Then
                    If Not IsNothing(dgvCompras.Table.CurrentRecord) Then

...
Public Class frmResumenContableCompras
...
#Region "Methods"
    Private Sub GetHojaTrabajoCompras(dtpPeriodoAnio As Integer, dtpPEriodoMes As Integer)
        ...
        For Each i As usp_HojaTrabajoCompras_Result In cierreSA.GetHojaTrabajCompras(New asiento With {.idEmpresa = Gempresas.IdEmpresaRuc, .periodo = String.Format("{0:00}", dtpPEriodoMes) & "/" & dtpPeriodoAnio})
            ...
            Else
                ...
                dr(0) = i.cuenta
                dr(1) = cuentasa.ObtenerCuentaPorID(Gempresas.IdEmpresaRuc, i.cuenta).descripcion

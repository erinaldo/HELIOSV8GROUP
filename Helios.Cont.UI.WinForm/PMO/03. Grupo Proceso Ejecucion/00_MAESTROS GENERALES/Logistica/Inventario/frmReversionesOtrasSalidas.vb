...
Public Class frmReversionesOtrasSalidas
    Inherits frmMaster
...
#Region "Metodos"
    ...
    Sub Grabar()
        ...
        With nDocumentoCompra
            ...
            .fechaActualizacion = DateTime.Now
            .sustentado = Notas_Credito.BOF_REDUC_COSTO_IGUAL_COMPRA 'strTipoNota
            .aprobado = "N"
            ' .aprobado = "N"
        ...
        Dim xcod As Integer = CompraSA.SaveReversionOtraSalida(ndocumento, DocCaja, Nothing)

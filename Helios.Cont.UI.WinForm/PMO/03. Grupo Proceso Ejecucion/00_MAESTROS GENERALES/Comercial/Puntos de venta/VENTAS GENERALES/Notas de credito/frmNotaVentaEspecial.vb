...
Public Class frmNotaVentaEspecial
    Inherits frmMaster
...
#Region "Metodos"
    ...
    Sub Grabar()
        ...
        For Each r As Record In dgvMov.Table.Records
            ...
            'objDocumentoCompraDet.TipoDoc = "87"
        ...
        Next
        '---------------------------------------------------------------------------------
        ndocumento.documentoventaAbarrotes.tipoOperacion = StatusTipoOperacion.VENTA
...
#End Region
    ...
    Private Sub dgvMov_TableControlCurrentCellActivated(sender As Object, e As GridTableControlEventArgs) Handles dgvMov.TableControlCurrentCellActivated

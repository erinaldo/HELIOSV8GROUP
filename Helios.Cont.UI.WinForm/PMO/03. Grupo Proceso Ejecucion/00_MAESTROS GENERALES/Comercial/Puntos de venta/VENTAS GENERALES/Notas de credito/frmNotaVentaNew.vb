...
#Region "Metodos"
    ...
    Function CrearReceptor() As Contribuyente
        ...
        Emisor.TipoDocumento = txtDocCliente.Text
        ...
        Emisor.NombreLegal = txtCliente.Text
    ...
    Public Sub generarFactNotaCredito()

        Dim NombreDelTXT As String
        Dim archivo As StreamWriter
        Dim Linea As String = Nothing

        Dim NombreDelTXTDET As String
        Dim LineaDet As String = Nothing
        Dim archivoDET As StreamWriter
        Dim fechaStr As String = ""

        Dim SerieDocumento As String = String.Format("{0:00}", txtSerie.Text)
        Dim NumeroDocumento As String = String.Format("{0:00000000}", txtNumero.Text)

        Dim documentoId As String = SerieDocumento & "-" & NumeroDocumento

        Try

            NombreDelTXT = txtRuc.Text & "-" & "07" & "-" & documentoId & ".not"
            ...
            archivo = New StreamWriter("c:/FACTURANEW/" & NombreDelTXT)

            fechaStr = txtFecha.Value.Year & "-" & String.Format("{0:00}", txtFecha.Value.Month) & "-" & String.Format("{0:00}", txtFecha.Value.Day)
            ...
            Linea = fechaStr & "|" &
                        ...
                        txtCliente.Text & "|" &
                        "PEN" & "|" &
                        "0.00" & "|" &    'total otros cargos 
                        "0.00" & "|" &  'TOTAL GRAVADO
                        "0.00" & "|" &  'TOTAL INAFECTAS
                        "0.00" & "|" &  'TOTAL EXONERADA
                         txtTotalIva.Text & "|" &   'TOTAL IVA
                         "0.00" & "|" &   'TOTAL ISC
                         "0.00" & "|" &    'TOTAL OTROS TRIBUTOS
                         txtTotalPagar.Text & "|"
            ...
            'INICIO DETALLE
            NombreDelTXTDET = txtRuc.Text & "-" & "07" & "-" & documentoId & ".det"

            archivoDET = New StreamWriter("c:/FACTURANEW/" & NombreDelTXTDET)
            ...
            For Each r As Record In dgvMov.Table.Records
                ...
                LineaDet = "KGM" & "|" &
                      ...
                      r.GetValue("item") & "|" & 'DESCRIPCION PROD
                      r.GetValue("pumn") & "|" & 'VALOR UNITARIO
                      "0.00" & "|" &  'DESCUENTO
                      r.GetValue("ivamn") & "|" &
                      "10" & "|" &  'AFEXTACION AL IGVPOR ITEM
                      "0.00" & "|" & 'MONTO ISC
                      "01" & "|" &  'TIPO ISC
                      r.GetValue("pmMN") & "|" &  'PRECIO DE VENTA UNITARIO
                      r.GetValue("vcmn") & "|"

                archivoDET.WriteLine(LineaDet)
    ...
    Sub Grabar()
        ...
        For Each r As Record In dgvMov.Table.Records
            ...
            Select Case r.GetValue("cboMov")
                ...
                Case "3", "DEVOLUCION DE EXISTENCIAS" '"DEVOLUCION DE EXISTENCIAS"
                    ...
                    objDocumentoCompraDet.salidaCostoMN = CDec(r.GetValue("canDev")) * CDec(r.GetValue("pmMN"))
                    objDocumentoCompraDet.salidaCostoME = CDec(r.GetValue("canDev")) * CDec(r.GetValue("pmME"))
        ...
        Dim xcod As Integer = CompraSA.SaveVentaNotaCredito2(ndocumento, DocCaja, documentoSaldo)
    ...
    Sub TotalTalesXcolumna()
        ...
        lblmontogravado.DecimalValue = bs1
    ...
    Public Sub UbicarDetalle(intIddocumento As Integer)
        ...
        Try
            ...
            dt.Columns.Add("dineroDev", GetType(Decimal)) '39 dinero por devolver pro item
            dt.Columns.Add("dineroDevme", GetType(Decimal)) '40 dinero por devolver pro item me
            dt.Columns.Add("unidad", GetType(String)) '41 unidad de medida
        ...
        dr(5) = KardexActualizado
        dr(6) = KardexActualizadoME
        ...
        dr(23) = saldoCantidad
        dr(24) = 0
        dr(25) = KardexActualizado
        dr(26) = KardexActualizadoME


        If saldoCantidad > 0 AndAlso KardexActualizado > 0 Then
            dr(27) = (KardexActualizado * porcentajeIgv).ToString("N2")
            dr(28) = (KardexActualizadoME * porcentajeIgv).ToString("N2")
        ElseIf saldoCantidad = 0 Then
            dr(27) = (KardexActualizado * porcentajeIgv).ToString("N2")
            dr(28) = (KardexActualizadoME * porcentajeIgv).ToString("N2")
        Else
            dr(27) = 0
        ...
        dr(30) = cTotalActme
            ...
            Case TIPO_VENTA.PAGO.COBRADO
                dr(33) = "Pagado"
                dr(34) = i.MontoPagadoSoles - detalle.montoDevuelto
                dr(35) = i.MontoPagadoUSD - detalle.montoDevueltome
        ...
        dr(39) = i.MontoPagadoSoles - detalle.montoDevuelto
        dr(40) = i.MontoPagadoUSD - detalle.montoDevueltome
                    ...
                    Case 18
                        ...
                        Select Case dgvMov.Table.CurrentRecord.GetValue("estadoPago")
                            ...
                            Case Else
                                ...
                                Dim DineroDevolucion As Decimal = 0
                                Dim DineroDevolucionME As Decimal = 0
                                ...
                                DineroDevolucion = CDec(dgvMov.Table.CurrentRecord.GetValue("dineroDev"))
                                DineroDevolucionME = CDec(dgvMov.Table.CurrentRecord.GetValue("dineroDevme"))
                                ...
                                'saldoFinalmn = valAbonomn - DineroDevolucion
                                'saldoFinalme = valAbonome - DineroDevolucionME
                                ...
                                'If DineroDevolucion = 0 Then
                                '    dgvMov.Table.CurrentRecord.SetValue("ValDevmn", 0)
                                '    dgvMov.Table.CurrentRecord.SetValue("ValDevme", 0)
                                '    dgvMov.Table.CurrentRecord.SetValue("action", "inactivo")
                                'Else

                                '    If DineroDevolucion >= valAbonomn Then
                                '        dgvMov.Table.CurrentRecord.SetValue("ValDevmn", valAbonomn)
                                '        dgvMov.Table.CurrentRecord.SetValue("ValDevme", valAbonome)
                                '        dgvMov.Table.CurrentRecord.SetValue("action", "activo")
                                '    ElseIf DineroDevolucion <= valAbonomn Then
                                '        dgvMov.Table.CurrentRecord.SetValue("ValDevmn", DineroDevolucion)
                                '        dgvMov.Table.CurrentRecord.SetValue("ValDevme", DineroDevolucionME)
                                '        dgvMov.Table.CurrentRecord.SetValue("action", "activo")

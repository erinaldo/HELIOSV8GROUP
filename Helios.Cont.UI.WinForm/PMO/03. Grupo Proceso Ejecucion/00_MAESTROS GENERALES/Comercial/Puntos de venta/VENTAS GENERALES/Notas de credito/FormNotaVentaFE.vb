...
#Region "Metodos"
    ...
    Sub TotalTalesXcolumna()
        ...
        For Each r As Record In dgvMov.Table.Records
            ...
            inafectas += CDec(r.GetValue("Devexonerado"))
            igv += CDec(r.GetValue("Devinafecto"))
        ...
        txtBonifica.Text = total.ToString("N2")
        ...
        Try
            ...
            For Each i As documentoCajaDetalle In objLista.ObtenerCuentasPorCobrarPorDetails(intIddocumento)
                ...
                Select Case i.TipoExistencia
                    ...
                    Case Else
                        If IsNothing(detalle) Then
                            Me.dgvMov.Table.CurrentRecord.SetValue("antcant", 0)
                        Else
                            'dr(7) = i.CantidadCompra   ' detalle.monto1
                ...
                Select Case i.TipoExistencia
                    ...
                    Case Else
                        If IsNothing(detalle) Then
                            Me.dgvMov.Table.CurrentRecord.SetValue("cantidad", 0)
                        Else
                            Me.dgvMov.Table.CurrentRecord.SetValue("cantidad", saldoCantidad) ' i.CantidadCompra - detalle.monto1)
                            ...
                            End If
                            Me.dgvMov.Table.CurrentRecord.SetValue("Devcantidad", saldoCantidad) 'i.CantidadCompra - detalle.monto1)
                            End If
                End Select

                If i.destino = 1 Then

                    Me.dgvMov.Table.CurrentRecord.SetValue("gravado", KardexActualizado)
                    Me.dgvMov.Table.CurrentRecord.SetValue("exonerado", 0)

                    Me.dgvMov.Table.CurrentRecord.SetValue("Devgravado", KardexActualizado)
                    Me.dgvMov.Table.CurrentRecord.SetValue("Devexonerado", 0)
                ...
                ElseIf i.destino = 2 Then
                    ...
                    Me.dgvMov.Table.CurrentRecord.SetValue("Devexonerado", KardexActualizado)
                End If
                ...
                Me.dgvMov.Table.CurrentRecord.SetValue("igv", igvAct) 'i.montoIgv)
                ...
                Select Case i.EstadoCobro
                    Case TIPO_VENTA.PAGO.COBRADO
                        ...
                        Me.dgvMov.Table.CurrentRecord.SetValue("DevCobro", i.MontoPagadoSoles - detalle.montoDevuelto)
                    Case Else
                ...
                Me.dgvMov.Table.CurrentRecord.SetValue("Devigv", i.montoIgv)
                Me.dgvMov.Table.CurrentRecord.SetValue("Devtotal", cTotalActmn)
                ...
                '    dr(27) = cTotalActmn - KardexActualizado '(KardexActualizado * porcentajeIgv).ToString("N2")
                '    dr(28) = cTotalActme - KardexActualizadoME ' (KardexActualizadoME * porcentajeIgv).ToString("N2")

...
Public Class frmPedidoPendienteEspecial
    Inherits frmMaster
...
#Region "Métodos"
    ...
    Private Sub GetListaVentasPorPeriodo()
        ...
        Dim str As String
        For Each i As documentoventaAbarrotes In DocumentoVentaSA.GetListarAllVentasPeriodoPendienteEspecial(GEstableciento.IdEstablecimiento, PeriodoGeneral).OrderBy(Function(o) o.fechaDoc).ToList
...
#End Region
    ...
    Private Sub OtrasFormasPago(c As List(Of documentoCaja))
        ...
        ventaSA.CobrarVentaRapidaEspecal(documento)
    ...
    Private Sub CobroDirecto()
        ...
        ventaSA.CobrarVentaEspecial(documento)

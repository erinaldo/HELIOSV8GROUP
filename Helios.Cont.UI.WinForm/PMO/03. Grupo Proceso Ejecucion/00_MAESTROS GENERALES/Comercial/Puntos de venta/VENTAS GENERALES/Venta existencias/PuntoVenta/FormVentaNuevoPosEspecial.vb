...
Public Class FormVentaNuevoPosEspecial
...
#Region "Fields"
    ...
    Private FormCanastaTotalesServ As FormCanastaTotalesServ
...
#Region "Methods"
    ...
    Sub Grabar()
        Dim codigoAsignado = InputBox("Ingrese código vendedor", "Identificar Usuario", "")

        If codigoAsignado.Trim.Length > 0 Then
            If VerificarUsuario(codigoAsignado, UsuariosList) Then
                ...
                If ListaDetalle.Where(Function(o) o.monto1 = 0).Count = 0 Then
                    ...
                    GetImpresionTicketsEspecialNota(idDocumentoGrabado)
                Else
                    Throw New Exception("Debe verificar que las celdas esten completas!")
                End If
            Else
                MessageBox.Show("No existe código asignado", "Autorización", MessageBoxButtons.OK, MessageBoxIcon.Warning)
            End If
        Else
    ...
    Private Function AdditemDetalleVenta(TipoEntrega As String, r As Record) As documentoventaAbarrotesDet
        ...
        objDocumentoVentaDet.salidaCostoMN = 0 'CDec(r.GetValue("costoMN")) ' Math.Round(CDec(i.Cells(6).Value()) * CDec(i.Cells(5).Value()), 2)
        objDocumentoVentaDet.salidaCostoME = 0 'CDec(r.GetValue("costoME")) 'Math.Round(CDec(i.Cells(28).Value()) * CDec(i.Cells(5).Value()), 2)
    ...
    Private Function Part_DocumentoVenta(proveedor As String, idProveedor As Integer, TipoCobro As String, TipoEntrega As String) As documentoventaAbarrotes
        Return New documentoventaAbarrotes With {
                          ...
                          .tipoVenta = TIPO_VENTA.VENTA_NOTA_PEDIDO_ESPECIAL,
...
#Region "Events"
    ...
    Private Sub BackgroundWorker1_DoWork(sender As Object, e As DoWorkEventArgs) Handles BackgroundWorker1.DoWork
        ...
        configuracionModuloV2(Gempresas.IdEmpresaRuc, "VT1", "", GEstableciento.IdEstablecimiento)
    End Sub
    ...
    Private Sub ToolStripButton1_Click(sender As Object, e As EventArgs) Handles ToolStripButton1.Click
        FormCanastaTotalesServ = New FormCanastaTotalesServ(cboalmacen.SelectedValue)
        FormCanastaTotalesServ.validaStocks = True
        FormCanastaTotalesServ.StartPosition = FormStartPosition.CenterScreen
        FormCanastaTotalesServ.Show(Me)
    End Sub

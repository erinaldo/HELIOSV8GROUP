...
Public Class FormVentaNota
    Implements IForm, IPrecio, IListaInventario
...
#Region "Methods"
    ...
    Private Function GetGrabarNotaVenta(DetalleVenta As List(Of documentoventaAbarrotesDet)) As documento
        ...
        For Each i In DetalleVenta
            ...
            objDocumentoVentaDet.codigoLote = i.codigoLote
            ...
            objDocumentoVentaDet.Glosa = "Nota de venta"
    ...
    '        objDocumentoVentaDet.NomMarca = r.GetValue("marca")
    ...
    Sub Grabar()
        ...
        nDocumentoVenta = New documentoventaAbarrotes With {
                  ...
                  .estadoEntrega = TipoEntrega,
                  .terminos = "CONTADO",
                  .glosa = "Por ventas con nota de venta",
                  .fechaVcto = txtFecha.Value,
                  .usuarioActualizacion = usuario.IDUsuario,
                  .fechaActualizacion = DateTime.Now}
        'tipoEstado,
        ...
        If ListaDetalle.Where(Function(o) o.monto1 = 0).Count = 0 Then
            ndocumento.asiento = ListaAsientonTransito
            idDocuentoGrabado = VentaSA.Grabar_VentaNota(ndocumento)
            If MessageBox.Show("Desea imprimir la nota de venta ?", "Atención", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = DialogResult.Yes Then
    ...
    Public Function ListaPagosCajas(lista As List(Of documentoCaja), ventaDetalle As List(Of documentoventaAbarrotesDet)) As List(Of documento)
        ...
        For Each i In lista
            ...
            nDocumentoCaja.tipoDoc = "9907" ' cbotipoDocPago.SelectedValue
            nDocumentoCaja.fechaProceso = txtFecha.Value
            nDocumentoCaja.nroDoc = "NOTA"
            ...
            End If
            objCaja.TipoDocumentoPago = "9907" 'cbotipoDocPago.SelectedValue
            objCaja.codigoLibro = "1"
            objCaja.tipoDocPago = "9907"
            ...
            objCaja.estado = "1"
            objCaja.glosa = "Por ventas con notas"
    ...
    Function ListaDocumentoCaja() As List(Of documento)
        ...
        objCaja.estado = "1"
        objCaja.glosa = "Por ventas con nota"
        objCaja.entregado = "SI"
    ...
    Sub GuiaRemisionGenerico(beDocumento As documento)
        ...
        For Each r In beDocumento.documentoventaAbarrotes.documentoventaAbarrotesDet.ToList
            If r.tipoExistencia <> "GS" Then
                documentoguiaDetalle = New documentoguiaDetalle
                beDocumento.documentoGuia.serie = GConfiguracion.Serie
                beDocumento.documentoGuia.numeroDoc = GConfiguracion.Serie
                documentoguiaDetalle.idDocumento = 0
    ...
    Sub TotalTalesXcolumna()
        ...
        For Each r As Record In dgvCompra.Table.Records
            ...
            If r.GetValue("marca") = "Not." Then
                totalNotaMN += CDec(r.GetValue("totalmn"))
                totalNotaME += CDec(r.GetValue("totalme"))
            ElseIf r.GetValue("marca") = "Doc." Then
...
#Region "Events"
    ...
    Private Sub FormVentaNota_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        ContextMenuStrip.Items.Add("Modificar precio")

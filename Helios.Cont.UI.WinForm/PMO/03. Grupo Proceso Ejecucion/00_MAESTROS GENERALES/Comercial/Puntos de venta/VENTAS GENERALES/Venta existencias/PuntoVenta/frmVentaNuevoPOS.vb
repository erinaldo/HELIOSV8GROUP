...
#Region "Events"
    ...
    Private Sub frmVentaNuevoPOS_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        dgvCompra.Refresh()
        GetSummaryColumn()
        'dgvCompra.TableModel.CellModels.Add("MyLinkLabel", New LinkLabelCellModel(dgvCompra.TableModel))
        'dgvCompra.TableDescriptor.Columns("item").Appearance.AnyRecordFieldCell.CellType = "MyLinkLabel"
    ...
    Sub EnvioProductoSolo(productoBE As totalesAlmacen)
        ...
        Try
            ...
            'Dim existeEnCanasta = VerificarItemDuplicadoV2(CDec(cantidad), productoBE.codigoLote, productoBE.idItem, productoBE.tipoConfiguracion)

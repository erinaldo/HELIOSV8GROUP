...
#Region "Métodos"
    ...
    Sub AsientoVenta()
        ...
        nAsiento.tipo = ASIENTO_CONTABLE.HABILITADO.DISABLED
        nAsiento.tipoAsiento = ASIENTO_CONTABLE.Venta_Existencia
        nAsiento.glosa = "ASIENTO x VENTA PAGADA"
    ...
    Function ComprobanteCaja() As documento
        ...
        End If
        nDocumentoCaja.tipoDoc = txtIdComprobante.Text
        ...
        'End If
        objCaja.TipoDocumentoPago = txtIdComprobante.Text
        objCaja.tipoDocPago = txtIdComprobante.Text
    ...
    Sub Grabar()
        ...
        With nDocumentoVenta
            ...
            .tipoVenta = TIPO_VENTA.VENTA_PAGADA
        ...
        Dim xcod As Integer = VentaSA.SaveVentaPagada(ndocumento, ListaTotales, DocCaja, cajaUsarioBE)
        lblEstado.Text = "venta registrada!"
        lblEstado.Image = My.Resources.ok4

        Dim n As New ListViewItem(xcod)
        n.SubItems.Add("01").BackColor = Color.FromArgb(225, 240, 190)
        ...
        n.SubItems.Add(TIPO_VENTA.VENTA_PAGADA)
    ...
    Sub UpdateVenta()
        ...
        AsientoVenta()
        ndocumento.asiento = ListaAsientonTransito
        Dim xcod As Integer = VentaSA.UpdateVentaPagada(ndocumento, ListaTotales, ListaDeleteEO, DocCaja,
...
AndAlso (e.Value IsNot Nothing) Then
    ...
    Private Sub txtCaja_KeyDown(sender As Object, e As System.Windows.Forms.KeyEventArgs) Handles txtCaja.KeyDown
        If e.KeyCode = Keys.Enter Or e.KeyCode = Keys.Tab Then
            e.SuppressKeyPress = True
    ...
    Private Sub txtCaja_TextChanged(sender As System.Object, e As System.EventArgs) Handles txtCaja.TextChanged

    End Sub

    Private Sub frmVentaGPagada_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        Me.Cursor = Cursors.WaitCursor
    ...
    Private Sub LinkComprobanteCaja_LinkClicked(sender As System.Object, e As System.Windows.Forms.LinkLabelLinkClickedEventArgs) Handles LinkComprobanteCaja.LinkClicked
        ...
        '        glosa()
        '        txtNumCompCaja.Focus()
        '        txtNumCompCaja.Select()
        '    End If
        'End With
        Me.Cursor = Cursors.Arrow
    End Sub

    Private Sub txtComprobanteCaja_KeyDown(sender As Object, e As System.Windows.Forms.KeyEventArgs) Handles txtComprobanteCaja.KeyDown
        If e.KeyCode = Keys.Enter Or e.KeyCode = Keys.Tab Then
            e.SuppressKeyPress = True
            txtNumCompCaja.Select()
            txtNumCompCaja.Focus()
    ...
    Private Sub txtComprobanteCaja_TextChanged(sender As System.Object, e As System.EventArgs) Handles txtComprobanteCaja.TextChanged

    End Sub

    Private Sub txtEstablecimientoCaja_KeyDown(sender As Object, e As System.Windows.Forms.KeyEventArgs) Handles txtEstablecimientoCaja.KeyDown
        If e.KeyCode = Keys.Enter Or e.KeyCode = Keys.Tab Then
            e.SuppressKeyPress = True
            txtCaja.Select()
            txtCaja.Focus()
    ...
    Private Sub txtEstablecimientoCaja_TextChanged(sender As System.Object, e As System.EventArgs) Handles txtEstablecimientoCaja.TextChanged
    ...
    Private Sub txtCliente_KeyDown(sender As Object, e As System.Windows.Forms.KeyEventArgs) Handles txtCliente.KeyDown
        If e.KeyCode = Keys.Enter Or e.KeyCode = Keys.Tab Then
            e.SuppressKeyPress = True
            txtComprobanteCaja.Focus()
            txtComprobanteCaja.Select()
        End If
    End Sub
    ...
    Private Sub txtNumCompCaja_KeyDown(sender As Object, e As System.Windows.Forms.KeyEventArgs) Handles txtNumCompCaja.KeyDown
        If e.KeyCode = Keys.Enter Or e.KeyCode = Keys.Tab Then
            e.SuppressKeyPress = True
            txtEstablecimientoCaja.Select()
            txtEstablecimientoCaja.Focus()
        End If
    End Sub

    Private Sub txtNumCompCaja_TextChanged(sender As System.Object, e As System.EventArgs) Handles txtNumCompCaja.TextChanged
    ...
    Private Sub Timer2_Tick(sender As System.Object, e As System.EventArgs) Handles Timer2.Tick
        glosa()
        fecha = New DateTime(fecha.Year, fecha.Month, fecha.Day, DateTime.Now.Hour, DateTime.Now.Minute, DateTime.Now.Second)
    End Sub

...
Public Class frmReporteDocumentoVentas
    Inherits frmMaster
    ...
    Private Sub frmReporteDocumentoVentas_FormClosing(sender As System.Object, e As System.Windows.Forms.FormClosingEventArgs) Handles MyBase.FormClosing
        Dispose()
    End Sub
End Class
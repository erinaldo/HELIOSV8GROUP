...
Public Class frmCotizacion
    ...
    Public Sub New()
        ...
        ConfiguracionInicio()
        GetTableGrid()
        txtFecha.Value = New DateTime(AnioGeneral, MesGeneral, DateTime.Now.Day, DateTime.Now.Hour, DateTime.Now.Minute, 0)
...
#End Region
    ...
    Public Sub UbicarDocumento(ByVal intIdDocumento As Integer)
        ...
        Try
            ...
            With objDocCompra.GetUbicar_documentoventaAbarrotesPorID(intIdDocumento)
                ...
                txtIva.DecimalValue = .tasaIgv / 100
                txtGlosa.Text = .glosa
                txtTerminos.Text = .terminos
            End With

            'DETALLE DE LA COMPRA
            dgvCompra.Table.Records.DeleteAll()
            PanelCanasta.Visible = True
    ...
    Sub ConfiguracionInicio()
        ...
        txtIva.DecimalValue = TmpIGV / 100
    ...
    Sub TotalTalesXcolumna()
        ...
        For Each r As Record In dgvCompra.Table.Records
            Select Case chImpuestos.Checked
                Case True
                    ...
                    total += CDec(r.GetValue("vcmn"))
                    totalme += CDec(r.GetValue("vcmn"))
                    'End If
...
#Region "Métodos"
    ...
    Sub Grabar()
        ...
        VentaSA.GrabarCotizacion(ndocumento)
        Dispose()
    End Sub
    ...
    Public Sub AgregarAcanasta(r As Record)
        ...
        With productoSA.InvocarProductoID(r.GetValue("idItem"))
            ...
            Me.dgvCompra.Table.CurrentRecord.SetValue("igvmn", 0)
            Me.dgvCompra.Table.CurrentRecord.SetValue("igvme", 0)
            Me.dgvCompra.Table.CurrentRecord.SetValue("tipoExistencia", cboTipoExistencia.SelectedValue)
            Me.dgvCompra.Table.CurrentRecord.SetValue("marca", Nothing)
...
#End Region
    ...
    Private Sub frmCotizacion_FormClosing(sender As Object, e As FormClosingEventArgs) Handles Me.FormClosing
        Dispose()
    End Sub
    ...
    Private Sub frmCotizacion_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        bannerTextInfo2.Text = "Selec almacén"
        bannerTextInfo2.Visible = True
        'Associate the BannerTextProvider with ComboBoxAdv.
        Me.BannerTextProvider1.SetBannerText(Me.cboAlmacen, bannerTextInfo2)
    ...
    Private Sub popupControlContainer1_CloseUp(sender As Object, e As PopupClosedEventArgs) Handles popupControlContainer1.CloseUp
        If e.PopupCloseType = PopupCloseType.Done Then
            If lsvProveedor.SelectedItems.Count > 0 Then
                ...
                If txtCliente.Text.Trim.Length > 0 Then
                    txtGlosa.Text = "Por la cotización " & Space(1) & Space(1) & "del cliente " & txtCliente.Text.Trim
                End If
            End If
        End If
    ...
    Private Sub btGrabar_Click(sender As Object, e As EventArgs) Handles btGrabar.Click
        ...
        Try
            ...
            If Not txtCliente.Tag.Trim.Length > 0 Then
                lblEstado.Text = "Ingresar el cliente"
                Timer1.Enabled = True
                PanelError.Visible = True
                TiempoEjecutar(10)
    ...
    Private Sub chImpuestos_CheckedChanged(sender As Object, e As EventArgs) Handles chImpuestos.CheckedChanged
        TotalTalesXcolumna()
    End Sub
End Class
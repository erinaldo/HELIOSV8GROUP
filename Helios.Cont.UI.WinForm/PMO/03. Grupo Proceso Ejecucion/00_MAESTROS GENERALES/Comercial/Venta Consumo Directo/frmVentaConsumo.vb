...
#Region "Métodos"
    ...
    Sub Grabar()
        ...
        nDocumentoVenta = New documentoventaAbarrotes With {
            ...
            .notaCredito = StatusVentaMatizados.PorPreparar,
        ...
        For Each r As Record In dgvCompra.Table.Records
            ...
            objDocumentoVentaDet.idAlmacenOrigen = cboalmacen.SelectedValue
    ...
    Public Sub AgregarAcanasta(i As detalleitems)
        ...
        Me.dgvCompra.Table.CurrentRecord.SetValue("idProducto", i.codigodetalle)
            ...
            Case Else
                ...
                Select Case colDestinoGravado
                    Case 1
                        ...
                        Me.dgvCompra.Table.CurrentRecord.SetValue("percepcionMN", 0)
                        Me.dgvCompra.Table.CurrentRecord.SetValue("percepcionME", 0)
                        Me.dgvCompra.Table.CurrentRecord.SetValue("costoMN", totalMN)
                        Me.dgvCompra.Table.CurrentRecord.SetValue("costoME", 0)
                    Case 2
                        Me.dgvCompra.Table.CurrentRecord.SetValue("vcmn", totalMN.ToString("N2"))
                        Me.dgvCompra.Table.CurrentRecord.SetValue("vcme", totalME.ToString("N2"))
...
#End Region
    ...
    Private Sub frmVentaConsumo_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub ToolStripButton1_Click(sender As Object, e As EventArgs) Handles ToolStripButton1.Click
        Dim valPUmn As Decimal = 0
        Dim valPUme As Decimal = 0
        With frminfoInventario
            .StartPosition = FormStartPosition.CenterParent
            .ShowDialog()
            If Not IsNothing(.Tag) Then
                Dim c = CType(.Tag, totalesAlmacen)
                valPUmn = c.PMprecioMN
                valPUme = c.PMprecioME

                'With productoSA.InvocarProductoID(r.GetValue("idItem"))
                Me.dgvCompra.Table.AddNewRecord.SetCurrent()
                Me.dgvCompra.Table.AddNewRecord.BeginEdit()
                Me.dgvCompra.Table.CurrentRecord.SetValue("codigo", 0)
                Me.dgvCompra.Table.CurrentRecord.SetValue("gravado", c.origenRecaudo)
                Me.dgvCompra.Table.CurrentRecord.SetValue("idProducto", c.idItem)
                Me.dgvCompra.Table.CurrentRecord.SetValue("item", c.descripcion)
                Me.dgvCompra.Table.CurrentRecord.SetValue("um", c.idUnidad)
                Me.dgvCompra.Table.CurrentRecord.SetValue("cantidad", 0)
                Me.dgvCompra.Table.CurrentRecord.SetValue("canDisponible", c.cantidad)
                Me.dgvCompra.Table.CurrentRecord.SetValue("vcmn", 0.0)
                Me.dgvCompra.Table.CurrentRecord.SetValue("totalmn", 0)
                ...
                Me.dgvCompra.Table.CurrentRecord.SetValue("puKardex", c.importeSoles / c.cantidad)
                Me.dgvCompra.Table.CurrentRecord.SetValue("pukardeme", c.importeDolares / c.cantidad)
                ...
                Me.dgvCompra.Table.CurrentRecord.SetValue("tipoPrecio", c.tipoConfiguracion)

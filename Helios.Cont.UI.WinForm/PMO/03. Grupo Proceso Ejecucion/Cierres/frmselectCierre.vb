...
#Region "Constructors"
    ...
    Public Sub New(VerificaCierrex As String)
...
#Region "Events"
    Private Sub cboMesCompra_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cboMesCompra.SelectedIndexChanged
        If Not IsNothing(cboMesCompra.SelectedValue) Then
            ...
            fechaSeleccionadaCierre = New DateTime(cboAnio.Text, CInt(cboMesCompra.SelectedValue), txtDia.Value.Day, Date.Now.Hour, Date.Now.Minute, Date.Now.Second)
        End If
    End Sub
    ...
    Private Sub frmselectCierre_FormClosing(sender As Object, e As FormClosingEventArgs) Handles Me.FormClosing

    End Sub

    Private Sub frmselectCierre_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub LinkLabel5_LinkClicked(sender As Object, e As LinkLabelLinkClickedEventArgs) Handles LinkLabel5.LinkClicked
        Dim f As New frmMaestroCierre 'frmMasterCierres
        f.StartPosition = FormStartPosition.CenterParent
        f.ShowDialog()
    End Sub
    ...
    Private Sub bg_DoWork(sender As Object, e As DoWorkEventArgs) Handles bg.DoWork
        ...
        'CierreInventario()
        'cierreCuentasFinancieras()
        'CerraCuentasContables()
    End Sub
    ...
    Private Sub bg_RunWorkerCompleted(sender As Object, e As RunWorkerCompletedEventArgs) Handles bg.RunWorkerCompleted
        ...
        If VerificaCierre = "Cerrado" Then
            Close()
        End If
        '  MessageBox.Show("Período: " & fechaSeleccionadaCierre.Month & "/" & fechaSeleccionadaCierre.Year & vbCrLf & "cerrado correctamente", "Hecho", MessageBoxButtons.OK, MessageBoxIcon.Information)
    End Sub
    ...
    Private Sub Cerrar_Click(sender As Object, e As EventArgs) Handles Cerrar.Click
        Try
            ...
            If (Not IsNothing(ListaCajasActivas)) Then

...
Public Class frmNuevaExistenciaEspecial
    Inherits frmMaster
...
#End Region
    ...
    Private Sub btOperacion_Click(sender As Object, e As EventArgs) Handles btOperacion.Click
        ...
        If (chClasificacion.Checked = True) Then
            ...
            '    MessageBox.Show("Ingrese la sub clasificación", "Atención!", MessageBoxButtons.OK, MessageBoxIcon.Warning)
            '    Me.Cursor = Cursors.Arrow
            '    Exit Sub
            'End If
            ...
            '        MessageBox.Show("Verificar el ingreso correcto de la sub-clasificación", "Atención!", MessageBoxButtons.OK, MessageBoxIcon.Warning)

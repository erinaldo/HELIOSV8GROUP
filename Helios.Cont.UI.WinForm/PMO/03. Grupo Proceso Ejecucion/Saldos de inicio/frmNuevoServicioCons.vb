...
Public Class frmNuevoServicioCons
    Inherits frmMaster
...
#Region "Métodos"
    ...
    Public Sub UbicarProducto(intIdItem As Integer)
        ...
        Try
            ...
            With itemSA.GetUbicaServicioID(intIdItem)
                txtProductoNew.Text = .descripcion
                txtProductoNew.Tag = .idServicio
                ...
                Dim codMarca = .subCategoria
                If Not IsNothing(.idServicio) Then
                    Dim codFamili = .idServicio


                    With categoriaSA.UbicarCategoriaServicioPorID(codFamili)
                        txtCategoria.Text = .descripcion
                        txtCategoria.Tag = .idItemServicio
                ...
                'Productoshijos()
                With categoriaSA.UbicarCategoriaServicioPorID(codMarca)
                    txtSubCategoria.Text = .descripcion
                    txtSubCategoria.Tag = .idItemServicio
                    txtSubCategoria.ForeColor = Color.FromKnownColor(KnownColor.HotTrack)
                End With



                cboTipoExistencia.SelectedValue = .tipoExist
                'txtUm.Text = .unidad1
                cboUnidades.SelectedValue = .unidadMedida
    ...
    Public Sub EditarItemEstablec()
        ...
        Try
            'Se asigna cada uno de los datos registrados
            objitem.idServicio = CInt(txtProductoNew.Tag)
            objitem.idItemServicio = txtCategoria.Tag    ' Trim(txtCodigoDocumento.Text)
            objitem.categoria = txtCategoria.Text
            objitem.idEmpresa = Gempresas.IdEmpresaRuc
            objitem.idEstablecimiento = GEstableciento.IdEstablecimiento   ' frmCanastaExistencias.cboEstablecimiento.SelectedValue
            objitem.cuenta = Nothing
            objitem.subCategoria = txtSubCategoria.Tag
            objitem.subCategoria = txtSubCategoria.Text
            objitem.descripcion = txtProductoNew.Text.Trim
            'objitem.presentacion = txtPresentacion.ValueMember
            '  objitem.presentacion = cboPresentacion.SelectedValue
            'objitem.cantMax = nudCantMax.Value
            'objitem.cantMinima = nudCantMin.Value
            ' objitem.unidad1 = txtNomUnidad.ValueMember
            objitem.unidadMedida = cboUnidades.SelectedValue
            objitem.codigo = txtCodigoBarra.Text
            'objitem.unidad2 = txtSubCategoria.Tag
            ...
            objitem.tipoExist = cboTipoExistencia.SelectedValue
            Select Case cboIgv.Text
                Case "1 - GRAVADO"
            ...
            itemSA.updateItemServicio(objitem)
            Me.lblEstado.Text = "Servicio registrado!"
            c.Cuenta = "Grabado"
...
#End Region
    ...
    Private Sub AutoComplete1_AutoCompleteItemBrowsed(sender As Object, args As Tools.AutoCompleteItemEventArgs) Handles AutoComplete1.AutoCompleteItemBrowsed
    ...
    Private Sub AutoComplete1_AutoCompleteItemSelected(sender As Object, args As Tools.AutoCompleteItemEventArgs) Handles AutoComplete1.AutoCompleteItemSelected
        Dim itemText As String = args.ItemArray(1).ToString()
    ...
    Private Sub AutoComplete2_AutoCompleteItemBrowsed(sender As Object, args As Tools.AutoCompleteItemEventArgs) Handles AutoComplete2.AutoCompleteItemBrowsed
        Dim itemText As String = args.ItemArray(1).ToString()
        Dim eventlogmessage As String = [String].Format("Event: {0} Item: {1}", "AutoCompleteItemBrowsed", itemText)
    End Sub

    Private Sub AutoComplete2_AutoCompleteItemSelected(sender As Object, args As Tools.AutoCompleteItemEventArgs) Handles AutoComplete2.AutoCompleteItemSelected
        Dim itemText As String = args.ItemArray(1).ToString()
        Dim eventlogmessage As String = [String].Format("Event: {0} Item: {1}", "AutoCompleteItemSelected", itemText)
    ...
    Private Sub ButtonCategoria_Click(sender As Object, e As EventArgs)
    ...
    Private Sub txtProductoNew_TextChanged(sender As Object, e As EventArgs)
    ...
    Private Sub cboMarca_Click(sender As Object, e As EventArgs)

    End Sub

    Private Sub cboMarca_SelectedIndexChanged(sender As Object, e As EventArgs)

    End Sub

    Private Sub txtNomUnidad_TextChanged(sender As Object, e As EventArgs)

    End Sub

    Private Sub txtUm_TextChanged(sender As Object, e As EventArgs)
    ...
    Private Sub ChVenta_OnChange(sender As Object, e As EventArgs) Handles ChVenta.OnChange

    End Sub

    Private Sub cboPresentacion_Click(sender As Object, e As EventArgs) Handles cboPresentacion.Click

    End Sub

    Private Sub pcSubCategoria_ClientSizeChanged(sender As Object, e As EventArgs) Handles pcSubCategoria.ClientSizeChanged

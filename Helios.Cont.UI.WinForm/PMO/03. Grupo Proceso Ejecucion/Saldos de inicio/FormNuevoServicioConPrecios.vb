...
Public Class FormNuevoServicioConPrecios
...
#Region "Métodos"
    ...
    Public Sub GrabarItemEstablec()
        ...
        Try
            ...
            If (txtProductoNew.Text = "") Then
                Throw New Exception("Debe ingresar una descripcion")
            Else
                objitem.descripcion = txtProductoNew.Text
            End If

            Select Case cboIgv.SelectedValue
                Case "1"
            ...
            objitem.CustomPrecios.Add(New configuracionPrecioProducto With {.fecha = DateTime.Now, .tipo = 1,
                                      .idPrecio = 1, .descripcion = "Precio por Menor", .precioMN = TextMenor.Text, .precioME = 0.00, .tipoModalidad = "GS"})

            objitem.CustomPrecios.Add(New configuracionPrecioProducto With {.fecha = DateTime.Now, .tipo = 1,
                                      .idPrecio = 2, .descripcion = "Precio por Mayor", .precioMN = TextMayor.Text, .precioME = 0.00, .tipoModalidad = "GS"})

            objitem.CustomPrecios.Add(New configuracionPrecioProducto With {.fecha = DateTime.Now, .tipo = 1,
                                      .idPrecio = 3, .descripcion = "Precio por Gran Mayor", .precioMN = TextGmayor.Text, .precioME = 0.00, .tipoModalidad = "GS"})



            Dim codxIdtem As Integer = itemSA.InsertItemServicioSimple(objitem)

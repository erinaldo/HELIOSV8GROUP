...
Public Class FormNuevoCalzado
    ...
    Public Property ucNuevoCalzado As ucNuevoCalzado
    ...
    Public Sub New()
        ...
        ucNuevoCalzado = New ucNuevoCalzado(Me)
    ...
    Public Sub New(CodigoItem As Integer)
        ...
        ucNuevoCalzado = New ucNuevoCalzado(CodigoItem, Me)
        PanelBody.Controls.Add(ucNuevoCalzado)
...
#Region "Métodos"
    ...
    Public Sub GrabarItemEstablec()
        ...
        Try
            ...
            objitem.idItem = ucNuevoCalzado.txtCategoria.Tag
            ...
            objitem.marcaRef = ucNuevoCalzado.txtSubCategoria.Tag
            ...
            objitem.unidad2 = ucNuevoCalzado.txtSubCategoria.Tag
            ...
            objitem.productoRestringido = ucNuevoCalzado.CBProductoRestringido.Checked
...
#End Region
    ...
    Private Sub BunifuThinButton23_Click(sender As Object, e As EventArgs) Handles btOperacion.Click
        ...
        If Not ucNuevoCalzado.txtSubCategoria.Text.Trim.Length > 0 Then
        ...
        If ucNuevoCalzado.txtSubCategoria.Text.Trim.Length > 0 Then
            If ucNuevoCalzado.txtSubCategoria.ForeColor = Color.Black Then
                MessageBox.Show("Verificar el ingreso correcto de la marca", "Atención!", MessageBoxButtons.OK, MessageBoxIcon.Warning)
                ucNuevoCalzado.txtSubCategoria.Select()
                Me.Cursor = Cursors.Arrow
                Exit Sub
            End If
        End If

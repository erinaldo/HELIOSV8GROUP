...
#Region "Métodos"
    ...
    Public Sub UbicarDocumento(ByVal intIdDocumento As Integer)
        ...
        Try
            ...
            With objDoc.UbicarDocumento(intIdDocumento)
                ...
                '    txtIdComprobante = .codigoDetalle
    ...
    Sub Grabar()
        ...
        'statusForm.Show()
        Dim xcod As Integer = VentaSA.SaveVentaNormalAlCredito(ndocumento, ListaTotales)
    ...
    Sub UpdateVenta()
        ...
        ndocumento.asiento = ListaAsientonTransito
        VentaSA.UpdateVentaNormal(ndocumento, ListaTotales, ListaDeleteEO)
...
#End Region
    ...
    Private Sub frmVentaNormal_FormClosing(sender As Object, e As FormClosingEventArgs) Handles Me.FormClosing
        Dispose()
    End Sub

    Private Sub frmVentaNormal_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub pcAlmacen_BeforePopup(sender As Object, e As System.ComponentModel.CancelEventArgs)
...
#End Region
    ...
    Private Sub txtNumero_LostFocus(sender As Object, e As EventArgs) Handles txtNumero.LostFocus
        Try
            ...
            End If
        Catch ex As Exception
            MessageBox.Show("Error de formato!", "Atención", Nothing, MessageBoxIcon.Error)
            txtNumero.Clear()
            txtNumero.Select()
        End Try
    End Sub
    ...
    Private Sub pcAlmacen_CloseUp(sender As Object, e As PopupClosedEventArgs) Handles pcAlmacen.CloseUp
        If e.PopupCloseType = PopupCloseType.Done Then
            If lstAlmacen.SelectedItems.Count > 0 Then
                'If QRibbonInputBox1.SelectedItem.count > 0 Then
    ...
    Private Sub lstAlmacen_MouseHover(sender As Object, e As EventArgs) Handles lstAlmacen.MouseHover
    ...
    Private Sub txtFiltrar_FontChanged(sender As Object, e As EventArgs) Handles txtFiltrar.FontChanged
    ...
    Private Sub ButtonAdv1_Click_1(sender As Object, e As EventArgs)
...
#End Region
    ...
    Private Sub QRibbonInputBox1_KeyDown(sender As Object, e As KeyEventArgs) Handles QRibbonInputBox1.KeyDown

    End Sub

    Private Sub QRibbonInputBox1_TextChanged(sender As Object, e As EventArgs) Handles QRibbonInputBox1.TextChanged

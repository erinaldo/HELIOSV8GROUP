...
Public Class frmInfSourceMovimiento
    Inherits frmMaster
    ...
    Public Sub New(strTipoMov As String, intIdDocumento As Integer, estado As String)

        ' This call is required by the designer.
        InitializeComponent()

        UbicarDocumentoXIdDocumentoFlujoCaja(strTipoMov, intIdDocumento)
...
#Region "Métodos"
    ...
    Private Sub UbicarDocumentoXIdDocumentoFlujoCaja(strTipoMov As String, intIdDocumento As Integer)
        Dim tablaSA As New tablaDetalleSA
        Dim documentoCompraSA As New DocumentoCompraSA
        Dim documentoVentaSA As New documentoVentaAbarrotesSA
        Dim saldoSA As New saldoInicioSA
        ...
        Try
            Select Case strTipoMov
                Case "COMPRA", "OTRAS ENTRADAS A ALMACEN",
                    "TRANSFERENCIA ENTRE ALMACENES", "OTRAS SALIDAS DE ALMACEN",
                    "NC-DISMINUIR CANTIDAD", "NC-DISMINUIR IMPORTE",
                    "NC-DISMINUIR CANTIDAD E IMPORTE", "NC-DEVOLUCION DE EXISTENCIAS", "PAGO A PROVEEDOR"
                ...
                Case "VENTA", "VENTA TICKET BOLETA", "VENTA TICKET FACTURA", "COBRO A CLIENTES"

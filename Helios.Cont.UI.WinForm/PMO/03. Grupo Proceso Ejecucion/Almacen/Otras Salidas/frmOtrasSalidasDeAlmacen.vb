...
Public Class frmOtrasSalidasDeAlmacen
    Inherits frmMaster
    ...
    Sub GrabarDefault()
        ...
        If dgvMov.Table.Records IsNot Nothing AndAlso dgvMov.Table.Records.Count > 0 Then
            For Each r As Record In dgvMov.Table.Records
                ...
                '    Else
                '        objDocumentoCompraDet.idCosto = cboCosto.SelectedValue
                '    End If
                'Else
                '    objDocumentoCompraDet.tipoCosto = Nothing
                '    objDocumentoCompraDet.idCosto = Nothing
                'End If
                ...
                If GroupBox2.Visible Then
                    ...
                    '                '------------------------------------------------------------------------
                    '                'costoSA.GetCostoById(New recursoCosto With {.idCosto = cboCosto.SelectedValue}).codigo,
                    '                nMovimiento = New movimiento With {
                    '                    .cuenta = "911",
                    '                    .descripcion = r.GetValue("item"),
                    '                    .tipo = "D",
    ...
    Private Sub pcPersonas_CloseUp(sender As Object, e As PopupClosedEventArgs) Handles pcPersonas.CloseUp
        If e.PopupCloseType = PopupCloseType.Done Then
            If lstPersonas.SelectedItems.Count > 0 Then
                TextPersona.Tag = DirectCast(Me.lstPersonas.SelectedItem, Personal).Id
    ...
    Private Sub txtBuscarProducto_KeyDown(sender As Object, e As KeyEventArgs) Handles txtBuscarProducto.KeyDown
        ...
        If e.KeyCode = Keys.Enter Then
            ...
            If txtBuscarProducto.Text.Trim.Length > 0 Then
                ...
                ProgressBar1.Visible = True
                ProgressBar1.Style = ProgressBarStyle.Marquee
                Dim thread As System.Threading.Thread = New System.Threading.Thread(New System.Threading.ThreadStart(Sub() ObtenerListadoPreciosLiked(cboAlmacen.SelectedValue, cboTipoExistencia.SelectedValue, txtBuscarProducto.Text.Trim)))
                thread.Start()

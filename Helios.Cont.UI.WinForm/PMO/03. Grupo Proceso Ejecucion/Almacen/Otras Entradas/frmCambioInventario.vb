...
Public Class frmCambioInventario
    Inherits frmMaster
    ...
    Public Sub New()
        ...
        'dockingManager1.SetDockLabel(pnExistencias, "Canasta existencias")
        'dockingManager1.SetDockLabel(Panel3, "Canasta fsdfsdfsds")
        ...
        CargarListas()
        'dgvTransferencia.DataSource = GetTableGrid2()
        GridCFG(dgvCompra)
...
#Region "Asientos"
    ...
    Private Function GetTableGrid2() As DataTable
        ...
        dt.Columns.Add("importeME", GetType(Decimal))
        dt.Columns.Add("descripcion", GetType(String))
        dt.Columns.Add("cambioTipoExistencia", GetType(String))
        dt.Columns.Add("nombreTEOrigen", GetType(String))
        Return dt
    End Function
...
#Region "Métodos"
    ...
    Private Sub Docking()
        ...
        Me.dockingManager1.DockControl(Me.pnExistencias, Me, Syncfusion.Windows.Forms.Tools.DockingStyle.Right, 461)
        dockingManager1.DockControlInAutoHideMode(pnExistencias, Syncfusion.Windows.Forms.Tools.DockingStyle.Right, 461)
    ...
    Public Sub UbicarDocumento(IdDocumento As Integer)
        ...
        '    cargarDatosCuenta(cboEstablecimiento.SelectedValue)
        '    cboalmacenDestino.SelectedValue = listaDocumentoCompra(0).almacenDestino
        'End If

        cboTipoExistencia.SelectedValue = listaDocumentoCompra(0).tipoExistencia

        If ((listaDocumentoCompra(0).idEntidad) <> 0) Then
        ...
        txtSerie.Text = listaDocumentoCompra(0).Serie
        txtNumero.Text = listaDocumentoCompra(0).NumDoc
        TotalesCabeceras()
    ...
    '            almacenDestino = almacenSA.GetListar_almacenExceptAV(idEstable)
    ...
    Sub GetTableGrid()
        ...
        dt.Columns.Add("nombreTEOrigen", GetType(String))
        dt.Columns.Add("cambioTipoExistencia")
...
#Region "ASIENTOS"
    ...
    Function HaberTransferenciaMOv(r As Record) As movimiento
        ...
        nMovimiento = New movimiento
        Select Case r.GetValue("cambioTipoExistencia")
            Case "01"
                cuentaMascara = cuentaMascaraSA.UbicarCuentaXmoduloXitem(Gempresas.IdEmpresaRuc, "01", "ITEM", "ALM01.1")
                nMovimiento.cuenta = cuentaMascara.cuentaEspecifica
                'Case "02"
...
#End Region
    ...
    Sub Grabar()
        ...
        With nDocumentoCompra
            ...
            .tasaRegimen = 0
            .nroRegimen = Nothing
            .estadoEntrega = TipoEntregado.Entregado
            .importeTotal = CDec(txtTotalmn.Text)
            .importeUS = CDec(txtTotalme.Text)

            .destino = TIPO_COMPRA.MOVIMIENTO_ALMACEN.CAMBIO_TIPO_INVENTARIO
            ...
            .tipoCompra = TIPO_COMPRA.MOVIMIENTO_ALMACEN.CAMBIO_TIPO_INVENTARIO
        ...
        For Each r As Record In dgvTransferencia.Table.Records
            ...
            objDocumentoCompraDet.IdEstablecimiento = GEstableciento.IdEstablecimiento 'almacenSA.GetUbicar_almacenPorID(cboalmacenDestino.SelectedValue).idEstablecimiento ' i.Cells(19).Value()
            ...
            objDocumentoCompraDet.Editable = r.GetValue("TipoExistencia")
            objDocumentoCompraDet.tipoExistencia = r.GetValue("cambioTipoExistencia")
            ...
            objDocumentoCompraDet.almacenDestino = CInt(r.GetValue("colIdAlmacenOrigen"))  ' CDec(i.Cells(17).Value())
        ...
        CompraSA.GrabarCambioTipoInventario(ndocumento)
    ...
    Public Sub CargarListas()
        ...
        cboTipoExistencia.DataSource = tablaSA.GetUbicarTablaexistenciaCambioInventario() ' tablaSA.GetListaTablaDetalle(5, "1")
        ...
        'ListadoDestinatarios = entidadSA.ObtenerListaEntidad(TIPO_ENTIDAD.TRANSPORTE_CONDUCTOR, Gempresas.IdEmpresaRuc)
...
#End Region
    ...
    Public Function GetTableAlmacen() As DataTable
        ...
        Dim tablaSA As New tablaDetalleSA
        'Dim dt As New DataTable()
        comboTableP = New DataTable("Tipo_Existencias")
        comboTableP.Columns.Add("codigoDetalle", GetType(String))
        comboTableP.Columns.Add("descripcion", GetType(String))

        For Each i In tablaSA.GetUbicarTablaexistenciaCambioInventario()

            Dim dr As DataRow = comboTableP.NewRow()
            dr(0) = i.codigoDetalle
            dr(1) = i.descripcion
            comboTableP.Rows.Add(dr)

            'comboTableP.Rows.Add(New Object() {i.codigoDetalle, i.descripcion})
        Next
    ...
    Private Sub frmMovimientoAlmacen_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        'ggcStyle7.DisplayMember = "descripcionCuenta"gdv
        'ggcStyle7.DropDownStyle = GridDropDownStyle.AutoComplete


        comboTableP = Me.GetTableAlmacen
        Dim ggcStyle As GridTableCellStyleInfo = dgvTransferencia.TableDescriptor.Columns(24).Appearance.AnyRecordFieldCell
            ...
            If lsvExistencias.SelectedItems.Count > 0 Then
                ...
                Select Case lblMovimiento.Text
                    Case "CAMBIO TIPO INVENTARIO"
                        ...
                        Me.dgvTransferencia.Table.CurrentRecord.SetValue("nombreTEOrigen", cboTipoExistencia.Text)
                        'Me.dgvTransferencia.Table.CurrentRecord.SetValue("cambioTipoExistencia", )
    ...
    Private Sub dgvNuevoDoc_EditingControlShowing(sender As Object, e As DataGridViewEditingControlShowingEventArgs)
    ...
    Private Sub txtNumero_TextChanged_1(sender As Object, e As EventArgs)
            ...
            Select Case ColIndex
                Case 7 ' cantidad
                    ...
                    Else
                        ...
                        dgvTransferencia.Table.CurrentRecord.SetValue(("ImporteUS"), colMN.ToString("N2"))
    ...
    Private Sub dgvTransferencia_TableControlCurrentCellEditingComplete(sender As Object, e As GridTableControlEventArgs) Handles dgvTransferencia.TableControlCurrentCellEditingComplete
        'Dim colDestinoGravado As Decimal = 0
        'Dim colPrecUnit As Decimal = 0
        'Dim colCantidad As Decimal = 0
        'Dim colPM As Decimal = 0
    ...
    Private Sub txtRuc2_TextChanged(sender As Object, e As EventArgs)
    ...
    Private Sub dgvTransferencia_TableControlCurrentCellCloseDropDown(sender As Object, e As GridTableControlPopupClosedEventArgs) Handles dgvTransferencia.TableControlCurrentCellCloseDropDown

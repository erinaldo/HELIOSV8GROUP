...
Public Class frmMasterModelReporte
    ...
    Private Sub LinkLabel34_LinkClicked_1(sender As Object, e As LinkLabelLinkClickedEventArgs) Handles LinkLabel34.LinkClicked

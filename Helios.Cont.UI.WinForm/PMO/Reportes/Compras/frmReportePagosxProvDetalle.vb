...
Public Class frmReportePagosxProvDetalle
    Inherits frmMaster
...
#Region "Métodos"
    ...
    Public Sub ConsultaReporte(fecINic As DateTime, fecHasta As DateTime, idProv As Integer, MetodoPago As String)
        ...
        Me.reportName = "Helios.Cont.Presentation.WinForm.rpvPagosProvDetallado.rdlc"
        Me.reportData = DocumentoCompraSA.ReportePagosDetalladoPorProveedor(fecINic, fecHasta, idProv, MetodoPago)
        Me.nombreMainDS = "DSPagosProv"

...
Public Class frmrentabilidadXMes
    Inherits frmMaster
...
#Region "Métodos"
    ...
    Private Sub GetCostoVenta(anio As Integer, mes As Integer, dia As Integer)
        ...
        For Each al In almacenes
            ...
            listaInventario = inventario.GetRentabilidadV2(New InventarioMovimiento With {.idAlmacen = al.idAlmacen, .fecha = New DateTime(anio, mes, 1)}, txtFecha.Value, txtFecha.Value, "Mes")
    ...
    Public Sub ConsultaReporte()
        ...
        Dim reporte As New ReportDataSource(nombreMainDS, reportData)
        ReportViewer2.KeepSessionAlive = True
        ReportViewer2.Reset()
        ReportViewer2.LocalReport.DataSources.Add(reporte)
        ReportViewer2.LocalReport.Refresh()
        ReportViewer2.LocalReport.SetBasePermissionsForSandboxAppDomain(New PermissionSet(PermissionState.Unrestricted))
        ReportViewer2.LocalReport.ReportEmbeddedResource = reportName
        Dim oParams As New List(Of ReportParameter)
        ...
        ReportViewer2.LocalReport.SetParameters(oParams)

...
Public Class frmReporteCobrosxClie
...
#Region "Métodos"
    ...
    Public Sub ConsultaReporte(fecINic As DateTime, fecHasta As DateTime, idProv As Integer, MetodoPago As String)
        ...
        Me.reportName = "Helios.Cont.Presentation.WinForm.rpvCobrosPorClie.rdlc"
        Me.reportData = DocumentoCompraSA.ReporteCuentasPorCobrarPorCliente(fecINic, fecHasta, idProv, MetodoPago)
        Me.nombreMainDS = "DSCobrosClie"
...
#End Region
    ...
    Private Sub frmReporteCobrosxClie_FormClosing(sender As Object, e As FormClosingEventArgs) Handles Me.FormClosing
        Dispose()
    End Sub

    Private Sub frmReporteCobrosxProv_Load(sender As Object, e As EventArgs) Handles MyBase.Load

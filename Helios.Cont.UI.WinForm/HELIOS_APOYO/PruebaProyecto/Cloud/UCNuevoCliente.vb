...
#Region "Methods"
    ...
    Private Sub Grabar()
        ...
        Dim tipoCreacion As String = String.Empty

        If (rbUnidGeneral.Checked = True) Then
            tipoCreacion = "GR"
        ElseIf (rbUnidManual.Checked = True) Then
            tipoCreacion = "MN"
        End If
...
#Region "ARBOL DE ORGANIGRAMA"
    ...
    Private Sub TrOrganigrama_AfterSelect(sender As Object, e As TreeViewEventArgs)

    End Sub

    Private Sub txtPeriodoCierre_ValueChanged(sender As Object, e As EventArgs) Handles txtPeriodoCierre.ValueChanged

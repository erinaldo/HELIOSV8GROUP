...
Public Class frmListaCargosAll
...
#Region "Metodos"
    ...
    Public Sub GETORGANIZACION()
        ...
        listaOr = ORGSA.GetRolesXEstablecimiento(New Rol With {.idEmpresa = UnidadOrgID, .control = "GR"})
    ...
    Private Sub BunifuFlatButton2_Click(sender As Object, e As EventArgs) Handles BunifuFlatButton2.Click
        Try
            For Each Record In GridGroupingControl1.Table.Records
                Dim perfilAnexosa As New perfilAnexoSA
                Dim ID = UnidadOrgID
                Dim IDRol = (Record.GetValue("ID"))
                Dim nombre = (Record.GetValue("descripcion"))

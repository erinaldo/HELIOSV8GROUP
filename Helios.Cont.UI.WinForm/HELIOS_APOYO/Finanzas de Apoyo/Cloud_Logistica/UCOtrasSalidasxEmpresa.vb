...
Public Class UCOtrasSalidasxEmpresa
...
#Region "Attributes"
    ...
    Dim listaEstablecimientos As New List(Of centrocosto)
#End Region
...
#Region "Methods"
    ...
    Public Sub ListarUnidOrganicas()
        Try
            ...
            listaEstablecimientos.Add(centroCostosBE)
            listaEstablecimientos.AddRange(sa.GetObtenerEstablecimiento(Gempresas.IdEmpresaRuc).Where(Function(o) o.TipoEstab = "UN").ToList)

            cboUnidOrg.ValueMember = "idCentroCosto"
            cboUnidOrg.DisplayMember = "nombre"
            cboUnidOrg.DataSource = listaEstablecimientos
    ...
    Private Sub GetMovDia(fechaLab As Date, idEstable As Integer)
        ...
        Select Case cboUnidOrg.Text
            ...
            Case "TODO"
                For Each i As documentocompra In CompraSA.GetListarMvimientosAlmacenPorDia(Gempresas.IdEmpresaRuc, idEstable, TIPO_COMPRA.OTRAS_SALIDAS, fechaLab).ToList
            ...
            Case Else
                For Each i As documentocompra In CompraSA.GetListarMvimientosAlmacenPorDia(Gempresas.IdEmpresaRuc, idEstable, TIPO_COMPRA.OTRAS_SALIDAS, fechaLab).ToList
                    ...
                    End If
                    dr(15) = If(i.aprobado = "S", "-SI-", "-NO-")
                    dr(16) = listaEstablecimientos.Where(Function(o) o.idCentroCosto = idEstable).First.nombre
                    dt.Rows.Add(dr)
                Next
        End Select
    ...
    Private Sub GetMovPorPeriodo(intIdEstablecimiento As Integer, strPeriodo As String)
        ...
        Select Case cboUnidOrg.Text
            ...
            Case "TODO"
                For Each i As documentocompra In CompraSA.GetListarPorPeriodoEntradas(Gempresas.IdEmpresaRuc, Nothing, strPeriodo, TIPO_COMPRA.OTRAS_SALIDAS, StatusTipoConsulta.XEmpresa).Where(Function(o) o.tipoCompra = TIPO_COMPRA.OTRAS_SALIDAS).ToList
                    Dim dr As DataRow = dt.NewRow()
                    str = Nothing
                    str = CDate(i.fechaDoc).ToString("dd-MMM hh:mm tt ")
                    dr(0) = i.idDocumento
                    ...
                    dr(15) = If(i.aprobado = "S", "-SI-", "-NO-")
                    dr(16) = listaEstablecimientos.Where(Function(o) o.idCentroCosto = intIdEstablecimiento).First.nombre
                    dt.Rows.Add(dr)
                Next

            Case Else
                For Each i As documentocompra In CompraSA.GetListarPorPeriodoEntradas(Gempresas.IdEmpresaRuc, intIdEstablecimiento, strPeriodo, TIPO_COMPRA.OTRAS_SALIDAS, StatusTipoConsulta.XEmpresa).Where(Function(o) o.tipoCompra = TIPO_COMPRA.OTRAS_SALIDAS).ToList
                    Dim dr As DataRow = dt.NewRow()
                    str = Nothing
                    str = CDate(i.fechaDoc).ToString("dd-MMM hh:mm tt ")
                    dr(0) = i.idDocumento
    ...
    Private Sub GetListaVentasPorTipo(period As String, tipo As String)
        ...
        Select Case cboUnidOrg.Text
            ...
            Case "TODO"
                For Each i As documentoventaAbarrotes In DocumentoVentaSA.GetListarVentasPeriodoXTipo(Gempresas.IdEmpresaRuc, Nothing, period, tipo, StatusTipoConsulta.XEmpresa)
                    Dim dr As DataRow = dt.NewRow()
                    str = Nothing
                    str = CDate(i.fechaDoc).ToString("dd-MMM hh:mm tt ")
                    dr(0) = i.idDocumento
            ...
            Case Else
                For Each i As documentoventaAbarrotes In DocumentoVentaSA.GetListarVentasPeriodoXTipo(Gempresas.IdEmpresaRuc, GEstableciento.IdEstablecimiento, period, tipo, StatusTipoConsulta.XUNIDAD_ORGANICA)
                    ...
                    dr(18) = i.fechaDoc
                    dr(19) = listaEstablecimientos.Where(Function(o) o.idCentroCosto = cboUnidOrg.SelectedValue).First.nombre
        ...
        Select Case cboUnidOrg.Text
            ...
            Case Else
                ...
                For Each i As documentoventaAbarrotes In DocumentoVentaSA.GetListarVentasPorDiaEstablecimiento(New documentoventaAbarrotes With {.idEstablecimiento = idEstable, .fechaDoc = fechaLaboral, .tipoVenta = tipo})
                    ...
                    dr(17) = i.EnvioSunat
                    dr(18) = i.fechaDoc
                    dr(19) = listaEstablecimientos.Where(Function(o) o.idCentroCosto = idEstable).First.nombre

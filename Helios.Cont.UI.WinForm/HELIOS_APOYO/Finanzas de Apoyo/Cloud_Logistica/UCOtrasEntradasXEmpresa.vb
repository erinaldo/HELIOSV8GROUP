...
Public Class UCOtrasEntradasXEmpresa
#Region "Attributes"
...
#Region "Methods"
    ...
    Private Sub GetMovDia(fechaLab As Date, idEstable As Integer)
        ...
        dt.Columns.Add(New DataColumn("nombreUnidOrg", GetType(String)))
        ...
        Select Case cboUnidOrg.Text
            ...
            Case "TODO"
                For Each i As documentocompra In CompraSA.GetListarMvimientosAlmacenPorDia(Gempresas.IdEmpresaRuc, idEstable, TIPO_COMPRA.OTRAS_ENTRADAS, StatusTipoConsulta.XEmpresa, fechaLab).ToList
    ...
    Private Sub GetMovPorPeriodo(intIdEstablecimiento As Integer, strPeriodo As String)
        ...
        Select Case cboUnidOrg.Text
            ...
            Case "TODO"
                ...
                For Each i As documentocompra In CompraSA.GetListarPorPeriodoEntradas(Gempresas.IdEmpresaRuc, Nothing, strPeriodo, TIPO_COMPRA.OTRAS_ENTRADAS, StatusTipoConsulta.XEmpresa).Where(Function(o) o.tipoCompra = TIPO_COMPRA.OTRAS_ENTRADAS).ToList
...
#Region "Events"
    Private Sub BunifuFlatButton5_Click(sender As Object, e As EventArgs) Handles BunifuFlatButton5.Click
        ...
        If f.Tag IsNot Nothing Then
            ...
            GetMovPorPeriodo(cboUnidOrg.SelectedValue, GetPeriodo(periodoSel, True))
        End If
    End Sub
    ...
    Private Sub BunifuFlatButton3_Click(sender As Object, e As EventArgs) Handles BunifuFlatButton3.Click
        ...
        If f.Tag IsNot Nothing Then
            ...
            PictureLoad.Visible = True
            BunifuFlatButton5.Enabled = False
            GetMovDia(FechaSel, cboUnidOrg.SelectedValue)
        End If
    End Sub

...
Public Class UCInventarioXEmpresa
...
#Region "Constructors"
    Public Sub New()
        ...
        FormatoGridAvanzado(dgvKardexVal, False, False, 9.0F)
...
#Region "Events"
                ...
                If IsNumeric(codAlmacen) Then
                    If txtBuscarDetalle.Text.Trim.Length > 0 Then
                        ...
                        Select Case cboUnidOrg.Text
                            ...
                            Case Else
                                Dim t As New totalesAlmacen With {.idEmpresa = Gempresas.IdEmpresaRuc,
                                    .idEstablecimiento = cboUnidOrg.SelectedValue,
                                    .tipoConsulta = StatusTipoConsulta.XUNIDAD_ORGANICA, .idAlmacen = cboAlmacen.SelectedValue,
                                                          .tipoExistencia = cboTipoExistencia.SelectedValue,
                                                          .descripcion = txtBuscarDetalle.Text,
                                                          .InvAcumulado = True}
    ...
    Private Sub BunifuFlatButton4_Click(sender As Object, e As EventArgs) Handles BunifuFlatButton4.Click
        If cboAlmacen.SelectedIndex > -1 Then
            ...
            If IsNumeric(codAlmacen) Then
                ...
                Select Case cboUnidOrg.Text
                    Case "TODO"
                        Dim thread As System.Threading.Thread = New System.Threading.Thread(New System.Threading.ThreadStart(Sub() GetInventario(New totalesAlmacen With {.idEmpresa = Gempresas.IdEmpresaRuc, .idEstablecimiento = Nothing, .tipoConsulta = StatusTipoConsulta.XEmpresa, .idAlmacen = codAlmacen, .tipoExistencia = tipoExistencia, .InvAcumulado = True})))
                        thread.Start()
                    Case Else
                        Dim thread As System.Threading.Thread = New System.Threading.Thread(New System.Threading.ThreadStart(Sub() GetInventario(New totalesAlmacen With {.idEmpresa = Gempresas.IdEmpresaRuc, .idEstablecimiento = cboUnidOrg.SelectedValue, .tipoConsulta = StatusTipoConsulta.XUNIDAD_ORGANICA, .idAlmacen = codAlmacen, .tipoExistencia = tipoExistencia, .InvAcumulado = True})))
                        thread.Start()
                End Select
    ...
    Private Sub cboUnidOrg_SelectionChangeCommitted(sender As Object, e As EventArgs) Handles cboUnidOrg.SelectionChangeCommitted
        Try
            ...
            cboAlmacen.DataSource = almacenSA.GetListar_almacenExceptAV(cboUnidOrg.SelectedValue)

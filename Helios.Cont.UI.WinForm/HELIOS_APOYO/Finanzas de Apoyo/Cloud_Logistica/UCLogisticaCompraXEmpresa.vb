Public Class UCLogisticaCompraXEmpresa

#Region "Attributes"
    Public Property UCCompras As UCComprasXEmpresa
...
#Region "Constructors"
    Public Sub New(form As FormRepositoryLogisticaApoyo)

        ' This call is required by the designer.
        InitializeComponent()
        FormRepositoryLogistica = form
        ' Add any initialization after the InitializeComponent() call.
        UCCompras = New UCComprasXEmpresa(Me)

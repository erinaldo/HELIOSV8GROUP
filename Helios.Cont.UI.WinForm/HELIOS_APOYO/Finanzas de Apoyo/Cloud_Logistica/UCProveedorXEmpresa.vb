...
Public Class UCProveedorXEmpresa
...
#Region "Constructors"
    Public Sub New()
        ...
        ListarUnidOrganicasALL()
    End Sub
#End Region

#Region "Methods"

    Public Sub ListarUnidOrganicasALL()
        Try
            ...
            cboUnidOrg.DataSource = ListaUnidadOrganica.Where(Function(o) o.TipoEstab = "UN").ToList
    ...
    Private Sub GetProveedores(empresa As String)
        ...
        Select Case cboUnidOrg.Text
            Case "TODO"
                For Each i In entidadsa.GetListarEntidad(New entidad With {.tipoEntidad = TIPO_ENTIDAD.PROVEEDOR, .idEmpresa = Gempresas.IdEmpresaRuc, .idOrganizacion = Nothing, .tipoConsulta = StatusTipoConsulta.XEmpresa})
                    ...
                    dr(5) = i.direccion
                    dr(6) = i.telefono
                    dr(7) = ListaUnidadOrganica.Where(Function(o) o.idCentroCosto = i.idOrganizacion).First.nombre
                    dt.Rows.Add(dr)
                Next
            Case Else
                For Each i In entidadsa.GetListarEntidad(New entidad With {.tipoEntidad = TIPO_ENTIDAD.PROVEEDOR, .idEmpresa = Gempresas.IdEmpresaRuc, .idOrganizacion = cboUnidOrg.SelectedValue, .tipoConsulta = StatusTipoConsulta.XUNIDAD_ORGANICA})
                    Dim dr As DataRow = dt.NewRow()
                    dr(0) = i.idEntidad
                    Select Case i.tipoDoc
                        Case "6"

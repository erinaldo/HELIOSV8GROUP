...
Public Class UCComprasXEmpresa

#Region "Attributes"
    Dim filter As New GridExcelFilter()
    Friend Delegate Sub SetDataSourceDelegate(ByVal table As DataTable)
    Public Property Logistica As UCLogisticaCompraXEmpresa
    Dim Alert As Alert
...
#Region "Constructors"
    Public Sub New(UCLogisticaCompra As UCLogisticaCompraXEmpresa)
...
#Region "Methods"
    ...
    Private Sub GetComprasPorCriterio(PeriodoSel As String, intIdEstable As Integer, serie As String, numero As String, idproveedor As String, Opcion As String)
        ...
        Select Case Opcion
            Case "PROVEEDOR"
                ...
                .idCentroCosto = cboUnidOrg.SelectedValue,
            ...
            Case "TODO"
                ...
                For Each i As documentocompra In ListaCompras
                    ...
                    Else
                        dr(20) = "NO"
                    End If
                    dr(21) = ListaUnidadOrganica.Where(Function(o) o.idCentroCosto = i.idCentroCosto).First.nombre
                    dt.Rows.Add(dr)
                Next
            Case Else
                ListaCompras = DocumentoCompraSA.GetComprasCriterio(obj).Where(Function(o) o.tipoCompra <> TIPO_COMPRA.COMPRA_ANULADA).ToList
    ...
    Private Sub GetComprasPorMes(PeriodoSel As String, intIdEstable As Integer)
        ...
        Select Case cboUnidOrg.Text
            Case "TODO"
                ListaCompras = DocumentoCompraSA.GetListarComprasPorPeriodoGeneral_CONT_CONTADO((New documentocompra With {.idEmpresa = Gempresas.IdEmpresaRuc, .idCentroCosto = Nothing}), PeriodoSel).Where(Function(o) o.tipoCompra <> TIPO_COMPRA.COMPRA_ANULADA).ToList
                ...
                For Each i As documentocompra In ListaCompras
                    ...
                    dr(22) = i.bi02
                    dr(23) = i.igv01
                    dr(24) = ListaUnidadOrganica.Where(Function(o) o.idCentroCosto = i.idCentroCosto).First.nombre

                    dt.Rows.Add(dr)
                Next
            Case Else
                ListaCompras = DocumentoCompraSA.GetListarComprasPorPeriodoGeneral_CONT_CONTADO((New documentocompra With {.idEmpresa = Gempresas.IdEmpresaRuc, .idCentroCosto = cboUnidOrg.SelectedValue}), PeriodoSel).Where(Function(o) o.tipoCompra <> TIPO_COMPRA.COMPRA_ANULADA).ToList
    ...
    Private Sub GetComprasPorDia(fechaSel As Date?, idEstablecimiento As Integer?)
        ...
        Select Case cboUnidOrg.Text
            Case "TODO"
                'ListaCompras = DocumentoCompraSA.GetListarComprasPorDia_CONT(idEstablecimiento, fechaSel).Where(Function(o) o.tipoCompra <> TIPO_COMPRA.COMPRA_ANULADA).ToList
                ListaCompras = DocumentoCompraSA.GetListarComprasPorDia_CONT(New documentocompra With {.idEmpresa = Gempresas.IdEmpresaRuc, .idCentroCosto = Nothing, .tipoConsulta = StatusTipoConsulta.XEmpresa, .fechaDoc = fechaSel}).Where(Function(o) o.tipoCompra <> TIPO_COMPRA.COMPRA_ANULADA).ToList
                Dim str As String
                For Each i As documentocompra In ListaCompras
                    Dim dr As DataRow = dt.NewRow()
                    str = Nothing
                    ...
                    dr(21) = ListaUnidadOrganica.Where(Function(o) o.idCentroCosto = cboUnidOrg.SelectedValue).First.nombre

                    dt.Rows.Add(dr)
                Next

            Case Else
                ListaCompras = DocumentoCompraSA.GetListarComprasPorDia_CONT(New documentocompra With {.idEmpresa = Gempresas.IdEmpresaRuc, .idCentroCosto = cboUnidOrg.SelectedValue, .tipoConsulta = StatusTipoConsulta.XUNIDAD_ORGANICA, .fechaDoc = fechaSel}).Where(Function(o) o.tipoCompra <> TIPO_COMPRA.COMPRA_ANULADA).ToList

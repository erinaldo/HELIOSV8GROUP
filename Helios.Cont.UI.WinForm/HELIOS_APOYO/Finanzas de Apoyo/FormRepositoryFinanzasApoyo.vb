Public Class FormRepositoryFinanzasApoyo

#Region "Attributes"
    Public UCAdministrarCuentas As UCAdministrarCuentasXEmpresa
...
#Region "Constructors"
    Public Sub New()
        ...
        UCAdministrarCuentas = New UCAdministrarCuentasXEmpresa With {.Dock = DockStyle.Fill}

...
Public Class UCPagoVentaCompletoCalzado

#Region "Attributes"
    Public Property FormVentaPrincipal As FormVentaCalzados
    Private listaActivas As List(Of cajaUsuario)
    Private listaCuentasGrid As List(Of estadosFinancierosConfiguracionPagos)
#End Region

    Public Sub New(FormVenta As FormVentaCalzados)
...
#Region "Methods"
    ...
    Public Sub GetLoadGridCajas(idCaja As Integer)
        ...
        For Each i In listaCuentasGrid ' ListaCuentasFinancierasConfiguradas.Where(Function(o) o.IDFormaPago <> "9991").ToList
            ...
            Select Case FormVentaPrincipal.ucEstructuraCalzado.cboMoneda.SelectedValue
                Case "2"
                    ...
                    'If i.FormaPago = "EFECTIVO" And CDec(FormVentaPrincipal.ucEstructuraCalzado.DigitalME.Value) > 0 Then
                    '    dt.Rows.Add(i.IDFormaPago, $"{i.FormaPago} - {If(i.moneda = "1", "Nuevo Sol", "Moneda extranjera")}", i.identidad, i.entidad, "VOUCHER", String.Empty, String.Empty, 0, "", 0, 0, 3, i.moneda)
                    'Else
                    '    dt.Rows.Add(i.IDFormaPago, $"{i.FormaPago} - {If(i.moneda = "1", "Nuevo Sol", "Moneda extranjera")}", i.identidad, i.entidad, "VOUCHER", String.Empty, String.Empty, 0.0, "", 0, 0, 3, i.moneda)
                    'End If

                Case Else
                    If i.FormaPago = "EFECTIVO" And CDec(FormVentaPrincipal.txtTotalPagar.Value) > 0 Then
                        dt.Rows.Add(i.IDFormaPago,
                                    ...
                                    String.Empty,
                                    String.Empty,
                                    If(i.moneda = "1", CDec(FormVentaPrincipal.txtTotalPagar.Value), 0),
                                    "",
                                    0,
                                    0,
                                    3,
                    ...
                    If style.TableCellIdentity.Column.Name = "monto" Then
                        ...
                        Select Case FormVentaPrincipal.ucEstructuraCalzado.cboMoneda.SelectedValue
                            ...
                            Case "1"
                                ...
                                If pagos > CDec(FormVentaPrincipal.txtTotalPagar.Value) Then
                                    MessageBox.Show("El pago no debe exceder el valor de la venta", "Atención", MessageBoxButtons.OK, MessageBoxIcon.Warning)
                                    GridCompra.Table.CurrentRecord.SetValue("montoME", 0)
                                    GridCompra.Table.CurrentRecord.SetValue("monto", 0)
                                    'TextSaldo.DecimalValue = TextCompraTotal.DecimalValue '- CDec(SumaPagosME())

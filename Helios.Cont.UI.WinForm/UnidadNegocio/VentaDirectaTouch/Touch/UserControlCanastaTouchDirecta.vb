...
Public Class UserControlCanastaTouchDirecta
    Public Property UCEstructuraCabeceraVenta As UCVentaTouchDirecta
    Private UCPreciosCanastaVenta As UCPreciosCanastaVenta
    Public Event OKEvent()
    Public Sub New(ucVenta As UCVentaTouchDirecta)

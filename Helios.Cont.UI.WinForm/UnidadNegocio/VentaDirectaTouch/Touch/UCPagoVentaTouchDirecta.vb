...
Public Class UCPagoVentaTouchDirecta
#Region "Attributes"
    Public Property FormVenta As FormVentaTouchDirecta
    Public UCPagoCompletoDocumento As UCPagoVentaTouchCompletoDirecta
    Public UCCronogramaPagos As UCCronogramaPagosTouchDirecta
#End Region

#Region "Constructors"
    Public Sub New(FormCrearventa As FormVentaTouchDirecta)
        ...
        ' Add any initialization after the InitializeComponent() call.
        UCPagoCompletoDocumento = New UCPagoVentaTouchCompletoDirecta(FormCrearventa)
        UCCronogramaPagos = New UCCronogramaPagosTouchDirecta(FormCrearventa) With {.Dock = DockStyle.Fill}

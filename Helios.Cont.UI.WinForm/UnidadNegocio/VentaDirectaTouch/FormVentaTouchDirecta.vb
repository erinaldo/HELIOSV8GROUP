...
Public Class FormVentaTouchDirecta
...
#Region "Attributes"
    ...
    Public UCEstructuraCabeceraVentaV2 As UCVentaTouchDirecta
    Public UCCondicionesPago As UCPagoVentaTouchDirecta
...
#Region "Constructors"
    ...
    Public Sub New(CodigoProforma As String)
        ...
        'GetComboPrincipal()
        Me.KeyPreview = True
        UCEstructuraCabeceraVentaV2 = New UCVentaTouchDirecta(Me)
        UCCondicionesPago = New UCPagoVentaTouchDirecta(Me)
...
'// case 333333333333333333333
    ...
    Public Function ListaPagosCajas(venta As documentoventaAbarrotes, ventaDetalle As List(Of documentoventaAbarrotesDet), envio As EnvioImpresionVendedorPernos) As List(Of documento)
        ...
        For Each i In UCCondicionesPago.UCPagoCompletoDocumento.GridCompra.Table.Records
            If Decimal.Parse(i.GetValue("monto")) > 0 Then
                ...
                objCaja.tipoCambio = TmpTipoCambioTransaccionVenta  'Decimal.Parse(i.GetValue("tipocambio"))
                objCaja.montoUsd = 0.0 ' Decimal.Parse(i.GetValue("montoME"))
                ...
                Else
                    objCaja.entidadFinancieraDestino = i.GetValue("idCuenta")
                    objCaja.NombreEntidad = i.GetValue("Cuenta")
    ...
    Private Function ValidarForm() As Boolean
        ...
        Select Case ComboComprobante.Text
            ...
            Case Else
                If UCEstructuraCabeceraVentaV2.DigitalMN.Value <= 0 Then
                    ErrorProvider1.SetError(UCEstructuraCabeceraVentaV2.DigitalMN, "La venta debe ser mayor a cero")
                    listaErrores += 1
                Else
                    ErrorProvider1.SetError(UCEstructuraCabeceraVentaV2.DigitalMN, Nothing)
                End If
        End Select
    ...
    Private Sub MappingDocumentoPedidoCabecera(be As documento)
        ...
        Select Case be.moneda
            Case "1"
                ...
                total = UCEstructuraCabeceraVentaV2.DigitalMN.Value
                totalME = Math.Round(UCEstructuraCabeceraVentaV2.DigitalMN.Value / UCEstructuraCabeceraVentaV2.txtTipoCambio.DecimalValue, 2)
            Case "2"
                ...
                totalME = UCEstructuraCabeceraVentaV2.DigitalMN.Value
                total = Math.Round(UCEstructuraCabeceraVentaV2.DigitalMN.Value * UCEstructuraCabeceraVentaV2.txtTipoCambio.DecimalValue, 2)
        End Select
    ...
    Private Sub Grabarventa()
        ...
        Try
            ...
            If validarCanastaDeVentas(obj) Then
                'obj.AfectaInventario = True ' SwitchInventario.Value
...
#End Region
    ...
    Private Function MappingDocumento() As documento
        ...
        nroComprobante = "0"
        'Else
        '    nroComprobante = $"{UCEstructuraCabeceraVentaV2.TextSerie.Text.Trim}-{UCEstructuraCabeceraVentaV2.TextNumber.Text.Trim}"
        'End If
        ...
        .nroDoc = nroComprobante,'$"{UCEstructuraCabeceraVentaV2.txtSerie.Text}-{UCEstructuraCabeceraVentaV2.txtNumero.Text}",
        .idOrden = 0,
...
#Region "Events"
    ...
    Sub IrPago()
        ...
        If UCCondicionesPago IsNot Nothing Then
            UCCondicionesPago.UCPagoCompletoDocumento.TextCompraTotal.DecimalValue = UCEstructuraCabeceraVentaV2.DigitalMN.Value
            ...
            ElseIf UCCondicionesPago.RBCronograma.Checked = True Then
                UCCondicionesPago.UCCronogramaPagos.TextImporte.DecimalValue = UCEstructuraCabeceraVentaV2.DigitalMN.Value
            End If
            ...
            Case "CONDICIONES DE PAGO"
                ...
                If UCCondicionesPago IsNot Nothing Then
                    If UCEstructuraCabeceraVentaV2.cboMoneda.Text = "NUEVO SOL" Then
                        UCCondicionesPago.UCPagoCompletoDocumento.TextCompraTotal.DecimalValue = CDec(UCEstructuraCabeceraVentaV2.DigitalMN.Value)
                        ...
                        UCCondicionesPago.UCPagoCompletoDocumento.LabelTotalCobrarCliente.Text = CDec(UCEstructuraCabeceraVentaV2.DigitalMN.Value)
                    Else
                        UCCondicionesPago.UCPagoCompletoDocumento.TextCompraTotal.DecimalValue = CDec(UCEstructuraCabeceraVentaV2.DigitalMN.Value)
                        UCCondicionesPago.UCPagoCompletoDocumento.TextCompraTotalME.DecimalValue = CDec(UCEstructuraCabeceraVentaV2.DigitalME.Value)
                    ...
                    ElseIf UCCondicionesPago.RBCronograma.Checked = True Then
                        If UCEstructuraCabeceraVentaV2.cboMoneda.Text = "NUEVO SOL" Then
                            UCCondicionesPago.UCCronogramaPagos.TextImporte.DecimalValue = CDec(UCEstructuraCabeceraVentaV2.DigitalMN.Value)
                        Else
    ...
    Private Sub ComboComprobante_SelectedValueChanged(sender As Object, e As EventArgs) Handles ComboComprobante.SelectedValueChanged
        ...
        If UCEstructuraCabeceraVentaV2 IsNot Nothing Then
            ...
            'UCEstructuraCabeceraVentaV2.ComboTerminosPago.Enabled = False
            UCEstructuraCabeceraVentaV2.DigitalMN.Value = True
        ...
        Select Case ComboComprobante.Text
            ...
            Case "OTRA SALIDA DE ALMACEN"
                If UCEstructuraCabeceraVentaV2 IsNot Nothing Then
                    ...
                    btGrabar.Text = "Guardar"
                    UCEstructuraCabeceraVentaV2.DigitalMN.Value = False

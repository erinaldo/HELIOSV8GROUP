...
Public Class FormCalculadoraTouch
    Public Sub New()
    ...
    Private Function EnviarUsuario() As documentoventaabarrotesdet
        EnviarUsuario = Nothing
        Dim usuario As String = TextCodigoVendedor.Text
        If usuario.ToString.Trim.Length > 0 Then

            Dim ventaDoc As New documentoventaAbarrotesDet
            ventaDoc.monto1 = TextCodigoVendedor.Text
            ventaDoc.precioUnitario = TextCodigoVendedor.Text

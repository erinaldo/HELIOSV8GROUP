...
Public Class FormReporteEncomiendas
    ...
    Public Sub ConsultaReporte(programacion_id As Integer)
        Try
            ...
            Dim lista = ventaSA.GetEncomiendasByProgramacion(New documentoventaTransporte With {.programacion_id = programacion_id, .tipoVenta = General.TIPO_VENTA.VENTA_ENCOMIENDAS})

            Me.reportName = "Helios.Cont.Presentation.WinForm.rdlc_EncomiendasPorEnviar.rdlc"
            Me.reportData = lista
            Me.nombreMainDS = "DSEncomiendas"

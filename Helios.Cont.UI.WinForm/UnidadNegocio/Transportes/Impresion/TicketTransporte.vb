...
Public Class TicketTransporte
    ...
    Private Sub DibujaLaSubCabeceraIzquierda()
        ...
        For Each Cabecera As String In LineasDeEncabezadoIzquierda
            ...
            gfx.DrawString("FECHA DE COMPRA: " & CadenaPorEscribirEnLinea, FuenteImpresaEncabezado, Brushes.Black, R112, StringFormat)
            lineaEspacio += 3

            '/RUTA/
            Dim R113 As New RectangleF(1, lineaEspacio, 60, 25)

            CadenaPorEscribirEnLinea = ordTot.ObtenerHabitacion(Cabecera)
            gfx.DrawString("AGENCIA: " & CadenaPorEscribirEnLinea, FuenteImpresaEncabezado, Brushes.Black, R113, StringFormat)
            lineaEspacio += 3
            ...
            gfx.DrawString("RUTA: " & RUTA, FuenteImpresaEncabezado, Brushes.Black, R11, StringFormat)
            lineaEspacio += 3

            '//
            Dim R1 As New RectangleF(1, lineaEspacio, 60, 25)

            CadenaPorEscribirEnLinea = ordTot.OrdernarfechaEmision(Cabecera)

            gfx.DrawString("FECHA: " & CadenaPorEscribirEnLinea, FuenteImpresaEncabezado, Brushes.Black, R1, StringFormat)
            lineaEspacio += 3
            ...
            CadenaPorEscribirEnLinea = CStr("RAZON SOCIAL: " & ordTot.ObtenerdireccionEntrega(Cabecera))
            ...
            'se SERCIO
            Dim R22 As New RectangleF(1, lineaEspacio, 60, 25)
            CadenaPorEscribirEnLinea = ordTot.ObtenerFechaIN(Cabecera)
            gfx.DrawString("ORIGEN: " & CadenaPorEscribirEnLinea, FuenteImpresaEncabezado, Brushes.Black, R22, StringFormat)
            lineaEspacio += 3

            ''se ASIENTO
            'Dim R33 As New RectangleF(1, lineaEspacio, 60, 25)
            'CadenaPorEscribirEnLinea = ordTot.ObtenerFechaON(Cabecera)
            'gfx.DrawString("SERVICIO: " & CadenaPorEscribirEnLinea, FuenteImpresaEncabezado, Brushes.Black, R33, StringFormat)
            'lineaEspacio += 3

            'se SERCIOS
            Dim R66 As New RectangleF(1, lineaEspacio, 60, 25)
            CadenaPorEscribirEnLinea = ordTot.ObtenerDias(Cabecera)
            gfx.DrawString("DESTINO: " & DIRECIONEMBAR, FuenteImpresaEncabezado, Brushes.Black, R66, StringFormat)
            lineaEspacio += 3
        Next
    End Sub
    ...
    Private Sub DibujaElementosFactura()
        ...
        For Each Item As String In LineasElementosFactura
            ...
            If (total <= 29) Then
                saltodeLineaNombre = saltodeLineaNombre * 3
                Dim R15 As New RectangleF(20, lineaEspacio, 40, saltodeLineaNombre)
                'se captura NumeroRuc del Array
            ...
            'se crea un rectangulo para manipular texto dentro del rectangulo
            Dim R5 As New RectangleF(15, lineaEspacio + 3, 15, +5)
            'Colocar la cantidad a la derecha.
            ...
            '//DESCUENTO
            'se crea un rectangulo para manipular texto dentro del rectangulo
            Dim R10 As New RectangleF(35, lineaEspacio + 3, 15, +5)
            ...
            DescuentoTotal += FormatNumber(ordTot.ObtenerDescuento(Item), 2)
    ...
    Private Sub DibujaTotalFacturaFinal()
        ...
        gfx.DrawString(CadenaPorEscribirEnLinea, FuenteImpresaEncabezadoTexto, ColorDeLaFuente, 15, lineaEspacio + 3, New StringFormat())
        ...
        gfx.DrawString(CadenaPorEscribirEnLinea, FuenteImpresaEncabezadoTexto, ColorDeLaFuente, 15, lineaEspacio + 12, New StringFormat())
        ...
        gfx.DrawString(CadenaPorEscribirEnLinea, FuenteImpresaEncabezadoTexto, ColorDeLaFuente, 15, lineaEspacio + 18, New StringFormat())

        'CadenaPorEscribirEnLinea = "MONTO RECIBIDO"
        'gfx.DrawString(CadenaPorEscribirEnLinea, FuenteImpresaEncabezadoTexto, ColorDeLaFuente, 15, lineaEspacio + 23, New StringFormat())

        'CadenaPorEscribirEnLinea = "VUELTO"
        'gfx.DrawString(CadenaPorEscribirEnLinea, FuenteImpresaEncabezadoTexto, ColorDeLaFuente, 15, lineaEspacio + 26, New StringFormat())
        ...
        For Each Elemento As String In LineasTotalFactura
            Dim R5 As New RectangleF(35, lineaEspacio + 3, 5, +5)

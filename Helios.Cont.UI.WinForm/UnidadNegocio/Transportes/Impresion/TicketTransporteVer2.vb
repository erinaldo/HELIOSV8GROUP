...
Public Class TicketTransporteVer2
    ...
    Public Property DESTINO As String = String.Empty
    ...
    Private Sub DibujaLaSubCabeceraIzquierda()
        ...
        For Each Cabecera As String In LineasDeEncabezadoIzquierda
            ...
            '/RUTA/
            Dim R112 As New RectangleF(11, lineaEspacio, 60, 25)
            ...
            '/RUTA/
            Dim R11 As New RectangleF(11, lineaEspacio, 60, 25)
            ...
            Dim R4 As New RectangleF(11, lineaEspacio, 60, 25)
            'documkentop
            ...
            CadenaPorEscribirEnLinea = CStr("PAS: " & ordTot.ObtenerNombre(Cabecera))
            ...
            If (DIRECIONEMBAR = "RUC") Then


                '//SI EXISTE RUC

                Dim R44 As New RectangleF(11, lineaEspacio, 60, 25)
                'documkentop
                CadenaPorEscribirEnLinea = ordTot.Obtenerdireccion(Cabecera)
                gfx.DrawString("RUC. : " & CadenaPorEscribirEnLinea, FuenteImpresaEncabezado, Brushes.Black, R44, StringFormat)
                lineaEspacio += 3

                CadenaPorEscribirEnLinea = CStr("RAZON SOCIAL: " & ordTot.Obtenermoneda(Cabecera))
                total = CStr(CadenaPorEscribirEnLinea).Length
                Dim saltodeLineaNombre2 As Integer = 1
                If (total <= 30) Then
                    saltodeLineaNombre2 = saltodeLineaNombre2 * 3
                    Dim R55 As New RectangleF(11, lineaEspacio, 60, saltodeLineaNombre2)
                    'se captura NumeroRuc del Array
            ...
            'se SERCIO
            Dim R22 As New RectangleF(11, lineaEspacio, 60, 25)
            CadenaPorEscribirEnLinea = ordTot.ObtenerFechaIN(Cabecera)
            gfx.DrawString("ASIENTO: " & CadenaPorEscribirEnLinea, FuenteImpresaEncabezado2, Brushes.Black, R22, StringFormat)
            lineaEspacio += 3


            'se SERCIOS
            Dim R66 As New RectangleF(11, lineaEspacio, 60, 25)
            CadenaPorEscribirEnLinea = ordTot.OrdernarfechaEmision(Cabecera)
            gfx.DrawString("F. VIAJE: " & CadenaPorEscribirEnLinea, FuenteImpresaEncabezado2, Brushes.Black, R66, StringFormat)
            lineaEspacio += 3

            Dim R666 As New RectangleF(11, lineaEspacio, 60, 25)
            CadenaPorEscribirEnLinea = ordTot.ObtenerTipoHabitacion(Cabecera)
            gfx.DrawString("H. VIAJE: " & CadenaPorEscribirEnLinea, FuenteImpresaEncabezado2, Brushes.Black, R666, StringFormat)
            lineaEspacio += 3
        Next
    ...
    Private Sub DibujaElementosFactura()
        ...
        For Each Item As String In LineasElementosFactura
            ...
            'se crea un rectangulo para manipular texto dentro del rectangulo
            Dim R6 As New RectangleF(40, lineaEspacio, 20, +5)
            'Colocar la cantidad a la derecha.
    ...
    Private Sub DibujaTotalFacturaFinal()
        ...
        If (DESTINO = "1") Then
            ...
            gfx.DrawString(CadenaPorEscribirEnLinea, FuenteImpresaEncabezadoTexto, ColorDeLaFuente, 1, lineaEspacio + 9, New StringFormat())
    ...
    Private Sub DibujaDatosComplementarios()
        ...
        gfx.DrawString("-----------------------ZONA DE CORTE----------------------------------", FuenteImpresaEncabezado, Brushes.Black, R777, StringFormatGeneral)

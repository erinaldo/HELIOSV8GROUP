...
Public Class TickeTransporteLiquidacion
    ...
    Private Sub DibujaLaSubCabeceraIzquierda()
        ...
        For Each Cabecera As String In LineasDeEncabezadoIzquierda
            ...
            gfx.DrawString(CadenaPorEscribirEnLinea, FuenteImpresaEncabezado, Brushes.Black, R11, StringFormat)
            ...
            If (nombreArticlo.Length > 50) Then
                ...
                Dim R3 As New RectangleF(1, lineaEspacio, 30, 9)
                CadenaPorEscribirEnLinea = nombreArticlo
                gfx.DrawString("CONDUCTOR: " & CadenaPorEscribirEnLinea, FuenteImpresaEncabezado, Brushes.Black, R3, StringFormat)
    ...
    Private Sub DibujaElementosFactura()
        ...
        gfx.DrawString("ASIENTO     │     SERIE-NUMERO    │       IMPORTE", FuenteImpresaEncabezado, Brushes.Black, REncabezado, StringFormatLinea)
        lineaEspacio += 3
        ...
        For Each Item As String In LineasElementosFactura
            ...
            'se crea un rectangulo para manipular texto dentro del rectangulo
            Dim R3 As New RectangleF(16, lineaEspacio, 60, +10)
            Dim total As Integer
            Dim nombreArticlo As String
            'Dim enviarNombre As String
            ...
            'se crea un rectangulo para manipular texto dentro del rectangulo
            Dim R6 As New RectangleF(43, lineaEspacio, 20, +5)
            'Colocar la cantidad a la derecha.
    ...
    Private Sub DibujaTotalFacturaFinal()
        ...
        CadenaPorEscribirEnLinea = "TOTAL BOLETO"

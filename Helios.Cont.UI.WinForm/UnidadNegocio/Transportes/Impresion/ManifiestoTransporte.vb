...
Public Class ManifiestoTransporte
    ...
    Public Sub ImprimeTicket(ByVal impresora As String)
        ...
        '//es para poner la hoja vertical
    ...
    Private Sub DibujaLaCabecera()
        ...
        For Each Cabecera As String In LineasDeLaCabeza
            'se crea un rectangulo para manipular texto dentro del rectangulo
            Dim R2 As New RectangleF(5, lineaEspacioPagina, 200, 40)
    ...
    Private Sub DibujaElementosFactura(i As ArrayList)
        ...
        gfx.DrawString("     N°         SERIE-NUMERO.     TIPO VENTA              IMPORTE                    N°          SERIE-NUMERO      TIPO VENTA                IMPORTE", FuenteImpresaEncabezado, ColorDeLaFuente, 6, 26, New StringFormat())
        'crear rectangulo d e la cabecera
        gfx.DrawRectangle(blackPen, 5, 25, 195, 7)
        'crear la fila GUIA DE REMISION
        gfx.DrawRectangle(blackPen, 5, 25, 15, 100)
        'crear la fila REMITENTE
        gfx.DrawRectangle(blackPen, 20, 25, 25, 100)
        ''crear la fila CONSIGANADO
        gfx.DrawRectangle(blackPen, 45, 25, 20, 100)
        'crear la fila CONMTENIDO
        gfx.DrawRectangle(blackPen, 65, 25, 35, 100)

        gfx.DrawRectangle(blackPen, 100, 25, 15, 100)

        gfx.DrawRectangle(blackPen, 115, 25, 25, 100)

        gfx.DrawRectangle(blackPen, 140, 25, 25, 100)

        gfx.DrawRectangle(blackPen, 165, 25, 35, 100)
        ...
        For Each Item As String In i
            '//////////////////////////////////////////////////////////////////////////////////////////////////
            'se crea un rectangulo para manipular texto dentro del rectangulo
            Dim R0 As New RectangleF(5, lineaEspacio, 15, 130)
            'Colocar la cantidad a la derecha.
            Dim StringFormat As New StringFormat
            StringFormat.Alignment = StringAlignment.Center
            'imprime el numero de guia de remiision
            ...
            '//////////////////////////////////////////////////////////////////////////////////////////////////
            'se crea un rectangulo para manipular texto dentro del rectangulo
            Dim R2 As New RectangleF(50, lineaEspacio, 10, 130)
            ...
            '//////////////////////////////////////////////////////////////////////////////////////////////////
            'se crea un rectangulo para manipular texto dentro del rectangulo
            Dim R5 As New RectangleF(70, lineaEspacio, 25, 3)
            'Colocar la cantidad a la derecha.
            Dim StringFormatPrecioUnit As New StringFormat
            ...
            '//////////////////////////////////////////////////////////////////////////////////////////////////
            'se crea un rectangulo para manipular texto dentro del rectangulo
            Dim R6 As New RectangleF(105, lineaEspacio, 65, 3)
            'Colocar la cantidad a la derecha.
            Dim StringFormatTotal As New StringFormat
            ...
            '//////////////////////////////////////////////////////////////////////////////////////////////////
            'se crea un rectangulo para manipular texto dentro del rectangulo
            Dim R7 As New RectangleF(165, lineaEspacio, 15, 130)
            'Colocar la cantidad a la derecha.
            Dim StringFormatImporte As New StringFormat
            StringFormatImporte.Alignment = StringAlignment.Far
            elemento = String.Empty
            ...
            '//////////////////////////////////////////////////////////////////////////////////////////////////
            'se crea un rectangulo para manipular texto dentro del rectangulo
            Dim R1 As New RectangleF(21, lineaEspacio, 60, 130)
            ...
            '//////////////////////////////////////////////////////////////////////////////////////////////////
            'se crea un rectangulo para manipular texto dentro del rectangulo
            Dim R11 As New RectangleF(145, lineaEspacio, 60, 130)
            Codigo = ordTot.ObtenerFecha(Item)
            'Colocar la cantidad a la derecha.
            Dim StringFormat11 As New StringFormat
            StringFormatCodigo.Alignment = StringAlignment.Center
            'imprime el remitente 

            CadenaPorEscribirEnLinea = Codigo
            gfx.DrawString(CadenaPorEscribirEnLinea, FuenteImpresaDetalle, Brushes.Black, R11, StringFormat11)

            '//////////////////////////////////////////////////////////////////////////////////////////////////
            'se crea un rectangulo para manipular texto dentro del rectangulo
            Dim R111 As New RectangleF(115, lineaEspacio, 60, 130)
            Codigo = ordTot.OptenerRemitente(Item)
            'Colocar la cantidad a la derecha.
            Dim StringFormat111 As New StringFormat
            StringFormatCodigo.Alignment = StringAlignment.Center
            'imprime el remitente 

            CadenaPorEscribirEnLinea = Codigo
            gfx.DrawString(CadenaPorEscribirEnLinea, FuenteImpresaDetalle, Brushes.Black, R111, StringFormat111)
            ...
            '''CadenaPorEscribirEnLinea = "_ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ "
    ...
    Private Sub DibujaDatosComplementarios()
        ...
        For Each Item As String In LineasDatosComplementario
            Dim R111 As New RectangleF(115, lineaEspacio, 60, 130)

            'Colocar la cantidad a la derecha.


            Dim R7 As New RectangleF(50, 125, 60, 5)
            Dim StringFormatGeneral As New StringFormat
            StringFormatGeneral.Alignment = StringAlignment.Center
            gfx.DrawString("TOTAL: " & ordTot.ObtenerAdministracion(Item), FuenteImpresaEncabezado, Brushes.Black, R7, StringFormatGeneral)
        Next
        '//////////////////////////////////////////////////////////////////////////////////////////////////
        'se crea un rectangulo para manipular texto dentro del rectangulo

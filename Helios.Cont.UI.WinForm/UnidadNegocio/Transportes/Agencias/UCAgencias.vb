...
Public Class UCAgencias
#Region "Attributes"
    Dim agenciaSA As New establecimientoSA

    Dim listaAgencias As New List(Of centrocosto)
...
#Region "Methods"
    ...
    Private Sub getCargarCombos()
        ...
        Dim NuevoUnidad As New centrocosto

        NuevoUnidad.idEmpresa = Gempresas.IdEmpresaRuc
        NuevoUnidad.nombre = "TODO"
        NuevoUnidad.tipo = "TR"
        NuevoUnidad.TipoEstab = "SE"
        NuevoUnidad.idCentroCosto = 0

        unidad.Add(NuevoUnidad)
        unidad.AddRange(centroCostosSA.ObtenerListaEstablecimientos(Gempresas.IdEmpresaRuc))

        If unidad IsNot Nothing Then
            ComboTipoEstab.DataSource = unidad.Where(Function(o) o.TipoEstab = "SE" And o.tipo = "TR").ToList
            ComboTipoEstab.ValueMember = "idCentroCosto"
            ComboTipoEstab.DisplayMember = "nombre"
            ComboTipoEstab.ReadOnly = False
        End If
    End Sub

    Private Sub getAgenciaFull()
        listaAgencias = agenciaSA.ObtenerListaEstablecimientos(Gempresas.IdEmpresaRuc)
        ...
        For Each i In Transporte.ListaAgencias.Where(Function(o) o.TipoEstab = "UN" And o.tipo = "TR" And o.estado = "A")
            If i.estado = "A" Then
                statusBaja = False
            ElseIf i.TipoEstab = "C" Then
                statusBaja = True
            End If
    ...
    Private Sub getAgenciaFull(ID As Integer)
        ...
        If (ID = 0) Then
            For Each i In Transporte.ListaAgencias.Where(Function(o) o.TipoEstab = "UN" And o.tipo = "TR" And o.estado = "A").ToList
                If i.estado = "A" Then
                    statusBaja = False
                ElseIf i.TipoEstab = "C" Then
                    statusBaja = True
            ...
            Next
        Else
            For Each i In Transporte.ListaAgencias.Where(Function(o) o.TipoEstab = "UN" And o.tipo = "TR" And o.estado = "A" And o.idpadre = ID).ToList
                If i.estado = "A" Then
                    statusBaja = False
                ElseIf i.TipoEstab = "C" Then
                    statusBaja = True
    ...
    Private Sub ComboTipoEstab_SelectionChangeCommitted(sender As Object, e As EventArgs) Handles ComboTipoEstab.SelectionChangeCommitted
        Try

            getAgenciaFull(ComboTipoEstab.SelectedValue)

...
Public Class TicketA4_ResumenVenta
...
#Region "variables"
    ...
    Dim lineaEspacioDatosEmpresa As Integer = 15
    ...
    Public lineaEspacio As Integer = 82
        ...
        Select Case PosicionLogo
            Case "CT"
                ...
                For Each Item As String In LineasDatosEmpresa
                    ...
                    Dim R0 As New RectangleF(5, lineaEspacioDatosEmpresa, 240, 100)
                    ...
                    '//se crea un rectangulo para manipular texto dentro del rectangulo
                    Dim R1 As New RectangleF(5, lineaEspacioDatosEmpresa, 240, 3)
                    '//STRING FORMAT DEL TEXTO PARA LA POSICION
                    ...
                    '//se crea un rectangulo para manipular texto dentro del rectangulo
                    Dim R2 As New RectangleF(5, lineaEspacioDatosEmpresa, 240, 3)
                    '//STRING FORMAT DEL TEXTO PARA LA POSICION
                    ...
                    '//FUENTE DE IMPRESION
                    '//se crea un rectangulo para manipular texto dentro del rectangulo
                    Dim R3 As New RectangleF(5, lineaEspacioDatosEmpresa, 240, 3)
                    '//STRING FORMAT DEL TEXTO PARA LA POSICION
                    'Dim StringFormatDireccion As New StringFormat
                    ...
                    '//FUENTE DE IMPRESION
                    '//se crea un rectangulo para manipular texto dentro del rectangulo
                    Dim R4 As New RectangleF(5, lineaEspacioDatosEmpresa, 240, 3)
                    '//STRING FORMAT DEL TEXTO PARA LA POSICION
            ...
            Case Else
                ...
                For Each Item As String In LineasDatosEmpresa
                    ...
                    '//se crea un rectangulo para manipular texto dentro del rectangulo
                    Dim R0 As New RectangleF(10, lineaEspacioDatosEmpresa, 190, 100)
                    '//STRING FORMAT DEL TEXTO PARA LA POSICION
                    Dim StringFormat As New StringFormat
                    StringFormat.Alignment = StringAlignment.Center
                    CadenaPorEscribirEnLinea = ordTot.ObtenerRazonSocial(Item)
                    ...
                    '//se crea un rectangulo para manipular texto dentro del rectangulo
                    Dim R1 As New RectangleF(10, lineaEspacioDatosEmpresa, 190, 6)
                    '//STRING FORMAT DEL TEXTO PARA LA POSICION
                    Dim StringFormatNombrecomercial As New StringFormat
                    StringFormatNombrecomercial.Alignment = StringAlignment.Center
                    CadenaPorEscribirEnLinea = ordTot.ObtenerNombreComercial(Item)
                    ...
                    '//se crea un rectangulo para manipular texto dentro del rectangulo
                    Dim R2 As New RectangleF(10, lineaEspacioDatosEmpresa, 190, 6)
                    '//STRING FORMAT DEL TEXTO PARA LA POSICION
                    Dim StringFormatDireccion As New StringFormat
                    StringFormat.Alignment = StringAlignment.Near
                    CadenaPorEscribirEnLinea = ordTot.ObtenerDireccionPrincipal(Item)
                    ...
                    '//FUENTE DE IMPRESION
                    '//se crea un rectangulo para manipular texto dentro del rectangulo
                    Dim R3 As New RectangleF(10, lineaEspacioDatosEmpresa, 190, 6)
                    '//STRING FORMAT DEL TEXTO PARA LA POSICION
                    'Dim StringFormatDireccion As New StringFormat
                    'StringFormatDireccion.Alignment = StringAlignment.Near
                    CadenaPorEscribirEnLinea = ordTot.ObtenerDireccionAnexo(Item)
                    ...
                    '//FUENTE DE IMPRESION
                    '//se crea un rectangulo para manipular texto dentro del rectangulo
                    Dim R4 As New RectangleF(10, lineaEspacioDatosEmpresa, 190, 6)
                    '//STRING FORMAT DEL TEXTO PARA LA POSICION
                    CadenaPorEscribirEnLinea = ordTot.ObtenerTelefono(Item)
                    gfx.DrawString(CadenaPorEscribirEnLinea, FuenteImpresionDireccion, Brushes.Black, R4, StringFormatDireccion)
...
#Region "DATOS DEL CLIENTE"
    ...
    Private Sub DibujaLaSubCabeceraIzquierda()
        ...
        Dim blackPen As New Pen(Color.Black, 0)
        gfx.DrawRectangle(blackPen, 7, 43, 193, 18)

        '//SE IMPRIME LOS DATOS
        For Each Cabecera As String In LineasDeEncabezadoIzquierda
            '//SE CREA UN RECTANGULO
            Dim R2 As New RectangleF(28, 44, 180, 25)
            CadenaPorEscribirEnLinea = ordTot.OrdernarfechaEmision(Cabecera)
            gfx.DrawString("FECHA", FuenteImpresaEncabezado, ColorDeLaFuente, 8, 44, New StringFormat())
            gfx.DrawString(":", FuenteImpresaEncabezado, ColorDeLaFuente, 27, 44, New StringFormat())
            gfx.DrawString(CadenaPorEscribirEnLinea, FuenteImpresaEncabezado, Brushes.Black, R2, StringFormat)

            'se crea un rectangulo para manipular texto dentro del rectangulo
            Dim R5 As New RectangleF(28, 48, 180, 25)
            'direccioon
            NuevoCaracter = ordTot.Obtenerdireccion(Cabecera)

            CadenaPorEscribirEnLinea = ordTot.Obtenerdireccion(Cabecera)
            gfx.DrawString("AGENCIA", FuenteImpresaEncabezado, ColorDeLaFuente, 8, 56, New StringFormat())
            gfx.DrawString(":", FuenteImpresaEncabezado, ColorDeLaFuente, 27, 56, New StringFormat())
            ...
            'se crea un rectangulo para manipular texto dentro del rectangulo
            Dim R3 As New RectangleF(28, 52, 180, 25)
            CadenaPorEscribirEnLinea = NuevoCaracter
            gfx.DrawString("RESPONSABLE", FuenteImpresaEncabezado, ColorDeLaFuente, 8, 48, New StringFormat())
            gfx.DrawString(":", FuenteImpresaEncabezado, ColorDeLaFuente, 27, 48, New StringFormat())
            gfx.DrawString(CadenaPorEscribirEnLinea, FuenteImpresaEncabezado, Brushes.Black, R3, StringFormat)

            'se crea un rectangulo para manipular texto dentro del rectangulo
            Dim R4 As New RectangleF(28, 56, 180, 20)
            'documkentop
            CadenaPorEscribirEnLinea = ordTot.ObtenerdocIdentidad(Cabecera)
            gfx.DrawString("DOC. IDENTIDAD", FuenteImpresaEncabezado, ColorDeLaFuente, 8, 52, New StringFormat())
            gfx.DrawString(":", FuenteImpresaEncabezado, ColorDeLaFuente, 27, 52, New StringFormat())
            gfx.DrawString(CadenaPorEscribirEnLinea, FuenteImpresaEncabezado, Brushes.Black, R4, StringFormat)



            '''se crea un rectangulo para manipular texto dentro del rectangulo
            ''Dim R6 As New RectangleF(26, 60, 180, 25)
            ...
            ''se crea un rectangulo para manipular texto dentro del rectangulo
            'Dim R7 As New RectangleF(26, 64, 180, 25)
            'CadenaPorEscribirEnLinea = ordTot.Obtenermoneda(Cabecera)
            'gfx.DrawString(":", FuenteImpresaEncabezado, ColorDeLaFuente, 25, 64, New StringFormat())
...
#Region "DATOS COMPLEMEMTARIOS"
    ...
    Private Sub DibujaDatosComplemnetarios()
        ...
        '    '//SE CREA UN RECTANGULO
        '    Dim R1 As New RectangleF(6, 78, 35, 3)
        ...
        '    '//SE CREA UN RECTANGULO
        '    Dim R3 As New RectangleF(45, 78, 35, 3)
        ...
        '    '//SE CREA UN RECTANGULO
        '    Dim R5 As New RectangleF(84, 78, 35, 3)
        ...
        '    '//SE CREA UN RECTANGULO
        '    Dim R7 As New RectangleF(122, 80, 35, 3)
        ...
        Dim FuenteImpresaComplemeneto = New Font("Segoe UI", 14, FontStyle.Bold)
        gfx.DrawString("                                                RESUMEN DE VENTAS", FuenteImpresaComplemeneto, ColorDeLaFuente, 5, 64, New StringFormat())
        ...
        gfx.DrawRectangle(blackPen, 7, 62, 193, 10)
...
#Region "DATOS DETALLE DE VENTA"
    ...
    Private Sub DibujaElementosFactura(i As ArrayList)
        ...
        gfx.DrawString("      N°            TIPO           SERIE-NUMERO         FECHA                                         CLIENTE                                               TOTAL", FuenteImpresaEncabezado, ColorDeLaFuente, 6, 74, New StringFormat())

        '//SE CREA EL CUADRO O TABLAS DE LOS DETALLES
        gfx.DrawRectangle(blackPen, 7, 73, 193, 7)
        'crear la fila codigo
        gfx.DrawRectangle(blackPen, 7, 73, 13, 200)
        'crear la fila descrpcion
        gfx.DrawRectangle(blackPen, 20, 73, 20, 200)
        'crear la fila um
        gfx.DrawRectangle(blackPen, 40, 73, 30, 200)
        ''crear la fila cantidad
        gfx.DrawRectangle(blackPen, 70, 73, 20, 200)
        '''crear la fila PRECIO UNITARIO
        gfx.DrawRectangle(blackPen, 90, 73, 80, 200)
        '''crear la fila Venta Total
        gfx.DrawRectangle(blackPen, 170, 73, 30, 200)
        ...
        For Each Item As String In i
            ...
            'se crea un rectangulo para manipular texto dentro del rectangulo
            Dim R1 As New RectangleF(7, lineaEspacio, 14, 130)
            Codigo = 0.0
            ...
            '//CODIGO DEL UM
            'se crea un rectangulo para manipular texto dentro del rectangulo
            Dim R4 As New RectangleF(20, lineaEspacio, 20, 130)
            'Colocar la cantidad a la derecha.
            ...
            '//CODIGO DEL CANTIDAD
            'se crea un rectangulo para manipular texto dentro del rectangulo
            Dim R2 As New RectangleF(40, lineaEspacio, 30, 130)
            Cantidad = 0.0
            ...
            'se crea un rectangulo para manipular texto dentro del rectangulo
            Dim R5 As New RectangleF(70, lineaEspacio, 20, 130)
            'Colocar la cantidad a la derecha.
            Dim StringFormatPrecioUnit As New StringFormat
            StringFormatPrecioUnit.Alignment = StringAlignment.Center
            'PrecioVenta = ordTot.ObtenerPrecioVenta(Item)
            CadenaPorEscribirEnLinea = ordTot.ObtenerPrecioVenta(Item)
            ...
            'se crea un rectangulo para manipular texto dentro del rectangulo
            Dim R6 As New RectangleF(170, lineaEspacio, 30, 130)
            'Colocar la cantidad a la derecha.
            ...
            'se crea un rectangulo para manipular texto dentro del rectangulo
            Dim R3 As New RectangleF(91, lineaEspacio, 80, 130)
    ...
    Private Sub lineasTotal()
        ...
        For Each Item As String In LineasElementosFactura
            ...
            AnadirLineaElementosFacturaXPagina("", Codigo, ordTot.ObtenerDescripcion(Item), ordTot.ObtenerCantidad(Item), ordTot.ObtenerUM(Item), ordTot.ObtenerPrecioVenta(Item), CDec(FormatNumber(ordTot.ObtenerVentaTotal(Item), 2)))
...
#Region "DATOS DETALLE TOTALES"
    ...
    Private Sub DibujaTotalFactura()
        ...
        gfx.DrawRectangle(blackPen, 139, 275, 61, 5)
        ...
        gfx.DrawString(CadenaPorEscribirEnLinea, FuenteImpresaEncabezadoTexto, ColorDeLaFuente, 140, contadorGeneral + 276, New StringFormat())
        ...
        For Each Elemento As String In LineasTotalFactura
            ...
            CadenaPorEscribirEnLinea = AlineaTextoaLaDerecha(CadenaPorEscribirEnLinea.Length) + CadenaPorEscribirEnLinea
            gfx.DrawString(CadenaPorEscribirEnLinea, FuenteImpresaEncabezadoTexto, ColorDeLaFuente, 155, contadorGeneral + 276, New StringFormat())

            CadenaPorEscribirEnLinea = "0.00"
            CadenaPorEscribirEnLinea = AlineaTextoaLaDerecha(CadenaPorEscribirEnLinea.Length) + CadenaPorEscribirEnLinea
            gfx.DrawString(CadenaPorEscribirEnLinea, FuenteImpresaEncabezado, ColorDeLaFuente, 173, contadorGeneral + 276, New StringFormat())
            contadorGeneral += 5

...
Public Class TickeTransporteResumen
        ...
        Try
            ...
            If (Not IsNothing(headerImageQR.Width)) Then
                If (headerImageQR.Width <> 0) Then
                    Dim destRect As New Rectangle(20, lineaEspacio + 10, 30, 30)
    ...
    Private Sub DibujaLaSubCabeceraIzquierda()
        ...
        For Each Cabecera As String In LineasDeEncabezadoIzquierda
            ...
            gfx.DrawString("AGENCIA: " & CadenaPorEscribirEnLinea, FuenteImpresaEncabezado, Brushes.Black, R10, StringFormat)
            ...
            CadenaPorEscribirEnLinea = nombreArticlo
            gfx.DrawString("CAJERO: " & CadenaPorEscribirEnLinea, FuenteImpresaEncabezado, Brushes.Black, R3, StringFormat)
        ...
        Dim RLINEA As New RectangleF(1, lineaEspacio, 70, 3)
        gfx.DrawString("---------------------------------------------------------------------", FuenteImpresaEncabezado, Brushes.Black, RLINEA, StringFormatLinea)
        lineaEspacio += 3

        Dim StringFormatTitulo As New StringFormat
        StringFormatTitulo.Alignment = StringAlignment.Center
        Dim FuenteImpresaTitulo = New Font("Tahoma", 10, FontStyle.Regular)
        Dim R11 As New RectangleF(1, lineaEspacio, 60, 5)
        gfx.DrawString("RESUMEN DE VENTA", FuenteImpresaTitulo, Brushes.Black, R11, StringFormatTitulo)
        lineaEspacio += 2
    ...
    Private Sub DibujaElementosFactura()
        ...
        gfx.DrawString("NUMERO    │ SERIE - NUMERO                 │ IMPORTE", FuenteImpresaEncabezado, Brushes.Black, REncabezado, StringFormatLinea)
        lineaEspacio += 3

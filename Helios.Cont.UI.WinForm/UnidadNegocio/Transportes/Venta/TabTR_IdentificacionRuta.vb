...
Public Class TabTR_IdentificacionRuta
...
#End Region
    ...
    Private Sub ToolStripButton2_Click(sender As Object, e As EventArgs) Handles ToolStripButton2.Click
        Try
            ...
            If FormPurchase.FormMeaestroRutas IsNot Nothing Then
                FormPurchase.FormMeaestroRutas.Visible = True
                FormPurchase.FormMeaestroRutas.BringToFront()
                FormPurchase.FormMeaestroRutas.Show()
            End If

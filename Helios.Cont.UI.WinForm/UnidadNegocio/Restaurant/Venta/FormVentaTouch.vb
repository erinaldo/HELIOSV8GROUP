...
Public Class FormVentaTouch

#Region "Attributes"
    Private FormImpresionNuevo As FormImpresionEquivalencia ' FormImpresionNuevo
    Private FormImpresionPrecuenta As FormImpresionPrecuenta ' FormImpresionNuevo

    '  Public UCEstructuraCabeceraVentaV2 As UCEstructuraCabeceraVentaV2
    Public UCEstructuraCabeceraVentaV2 As UCVentaRestaurantTouch
    Public UCCondicionesPago As UCPagoVentaTouchRestaurant
    Public Property cajaUsuaroSA As New cajaUsuarioSA
    Public Property venta As documentoventaAbarrotes

    Public Property ManipulacionEstado As String

    Public Property VENTADIRECTA As Boolean = False
...
#Region "Constructors"
    ...
    Public Sub New(CodigoProforma As String)
        ...
        'GetComboPrincipal()
        Me.KeyPreview = True
        UCEstructuraCabeceraVentaV2 = New UCVentaRestaurantTouch(Me)
        UCCondicionesPago = New UCPagoVentaTouchRestaurant(Me)
    ...
    Public Function ListaPagosCajas(venta As documentoventaAbarrotes, ventaDetalle As List(Of documentoventaAbarrotesDet), envio As EnvioImpresionVendedorPernos) As List(Of documento)
        ...
        For Each i In UCCondicionesPago.UCPagoCompletoDocumento.GridCompra.Table.Records
            If Decimal.Parse(i.GetValue("monto")) > 0 Then
                ...
                nDocumentoCaja.IDCajaUsuario = envio.IDCaja
        ...
        Try
            ...
            If validarCanastaDeVentas(obj) Then
                        ...
                        If Gempresas.ubigeo > 0 Then
                            ...
                            If (VENTADIRECTA = True) Then
                                ...
                                If (Not IsNothing(comprobante)) Then
                                    VENDEDOR = UsuariosList.Where(Function(o) o.IDUsuario = comprobante.usuarioActualizacion).SingleOrDefault.Full_Name
                                End If

                                ImprimirTicketPedido("TICKET", doc.idDocumento, "3", LISTA, comprobante.numeroVenta, VENDEDOR)
                ...
                ElseIf UCEstructuraCabeceraVentaV2.cboTipoDoc.Text = "PRE VENTA" Then
                    ...
                    'FormImpresionNuevo.StartPosition = FormStartPosition.CenterScreen
                    'FormImpresionNuevo.ShowDialog(Me)
                    FormImpresionPrecuenta = New FormImpresionPrecuenta(doc.idDocumento, True)  ' frmVentaNuevoFormato
                    ...
                    FormImpresionPrecuenta.tienda = UCEstructuraCabeceraVentaV2.txtInfraestructura.Text
                    FormImpresionPrecuenta.FormaPago = "1"
                    FormImpresionPrecuenta.Email = doc.CustomNumero '.Replace("0", "")
                    ...
                    'ImprimirTicketPedido("\\192.168.1.2\VENTA", doc.idDocumento, "3", LISTA, comprobante.numeroVenta, VENDEDOR)
                    'ImprimirNumeracion("VENTA", doc.idDocumento, "3", comprobante.ImporteNacional, comprobante.numeroVenta, VENDEDOR)
                ...
                ElseIf UCEstructuraCabeceraVentaV2.cboTipoDoc.Text = "PEDIDO" Then
                    ...
                    FormImpresionPrecuenta.tienda = UCEstructuraCabeceraVentaV2.txtInfraestructura.Text
                    FormImpresionPrecuenta.FormaPago = "1"
                    FormImpresionPrecuenta.Email = doc.CustomNumero
                    FormImpresionPrecuenta.StartPosition = FormStartPosition.CenterScreen
                    FormImpresionPrecuenta.ShowDialog(Me)
...
#Region "IMPRESION"
    Sub ImprimirTicketPedido(imprimir As String, intIdDocumento As Integer, formato As String, ListaProductos As List(Of documentoventaAbarrotesDet), nombreCliente As String, VENDEDOR As String)
        ...
        a.AnadirLineaEmpresa("MESA N° " & nombreCliente)
    ...
    Sub ImprimirNumeracion(imprimir As String, intIdDocumento As Integer, formato As String, importeTotal As Decimal, numeracion As Integer, VENDEDOR As String)

        Dim a As Ticket_NumeroPedido = New Ticket_NumeroPedido
        ...
        a.tipoEncabezado = False
        a.AnadirLineaEmpresa("PEDIDO")
        a.AnadirLineaEmpresa(numeracion)
        a.AnadirLineaEmpresa(VENDEDOR)

        a.AnadirDatosGenerales("S/", String.Format("{0:0.00}", importeTotal))

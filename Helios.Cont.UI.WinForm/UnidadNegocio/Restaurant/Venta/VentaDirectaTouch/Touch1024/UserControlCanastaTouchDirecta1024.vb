...
Public Class UserControlCanastaTouchDirecta1024
    Public Property UCEstructuraCabeceraVenta As UCVentaTouchDirecta1024
    Private UCPreciosCanastaVenta As UCPreciosCanastaVenta
    Public Event OKEvent()
    Public Sub New(ucVenta As UCVentaTouchDirecta1024)

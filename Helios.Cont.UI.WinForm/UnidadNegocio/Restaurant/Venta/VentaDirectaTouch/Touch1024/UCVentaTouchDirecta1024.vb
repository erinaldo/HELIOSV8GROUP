...
Public Class UCVentaTouchDirecta1024
...
#Region "Attributes"
    ...
    Public Property usercontrol As UserControlCanastaTouchDirecta1024
    ...
    Public Property FormPurchase As FormVentaTouchDirecta1024
    ...
    Private Property UCbeneficiosCanastaVenta As UCbeneficiosCanastaVentaTouchDirecta1024
...
#Region "Constructors"
    Public Sub New(formventaNueva As FormVentaTouchDirecta1024)
        ...
        ' Add any initialization after the InitializeComponent() call.
        FormatoGridTouch(GridCompra, False, False, 12.0F)
        ...
        usercontrol = New UserControlCanastaTouchDirecta1024(Me)
        popup = New Popup(usercontrol)
        popup.Resizable = True
        UCPreciosCanastaVenta = New UCPreciosCanastaVenta With {.Dock = DockStyle.Fill}
        UCbeneficiosCanastaVenta = New UCbeneficiosCanastaVentaTouchDirecta1024(Me.FormPurchase) With {.Dock = DockStyle.Fill, .Visible = False}
    ...
    Sub DibujarDEtalleItems(consulta As List(Of detalleitems))
        Try
            ...
            For Each items In consulta
                ...
                b.FlatStyle = System.Windows.Forms.FlatStyle.Flat
                b.ForeColor = System.Drawing.Color.White
                b.Size = New System.Drawing.Size(120, 115)
                b.Tag = items

...
Public Class UCPagoVentaTouchDirecta1024
#Region "Attributes"
    Public Property FormVenta As FormVentaTouchDirecta1024
    Public UCPagoCompletoDocumento As UCPagoVentaTouchCompletoDirecta1024
    Public UCCronogramaPagos As UCCronogramaPagosTouchDirecta1024
#End Region

#Region "Constructors"
    Public Sub New(FormCrearventa As FormVentaTouchDirecta1024)
        ...
        ' Add any initialization after the InitializeComponent() call.
        UCPagoCompletoDocumento = New UCPagoVentaTouchCompletoDirecta1024(FormCrearventa)
        UCCronogramaPagos = New UCCronogramaPagosTouchDirecta1024(FormCrearventa) With {.Dock = DockStyle.Fill}

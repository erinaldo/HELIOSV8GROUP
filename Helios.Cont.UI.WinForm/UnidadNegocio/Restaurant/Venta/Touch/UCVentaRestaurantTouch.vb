...
Public Class UCVentaRestaurantTouch
...
#Region "Attributes"
    ...
    Public Property usercontrol As UserControlCanastaTouchRestaurant
    ...
    Public Property FormPurchase As FormVentaTouch
    ...
    Private Property UCbeneficiosCanastaVenta As UCbeneficiosCanastaVentaRestTouch
...
#Region "Constructors"
    Public Sub New(formventaNueva As FormVentaTouch)
        ...
        usercontrol = New UserControlCanastaTouchRestaurant(Me)
        popup = New Popup(usercontrol)
        popup.Resizable = True
        UCPreciosCanastaVenta = New UCPreciosCanastaVenta With {.Dock = DockStyle.Fill}
        UCbeneficiosCanastaVenta = New UCbeneficiosCanastaVentaRestTouch(Me.FormPurchase) With {.Dock = DockStyle.Fill, .Visible = False}
...
#Region "PRODCUTOS"
    Public Sub CargarCategorias()
        ...
        listaItem = itemSA.GetListaItemPorEstable(GEstableciento.IdEstablecimiento, Gempresas.IdEmpresaRuc).Where(Function(O) O.tipo = "S").ToList
    ...
    Private Sub Butto2(sender As Object, e As EventArgs)
        ...
        listaProductos = ProductoSA.GetProductosWithEquivalenciasXCat(New detalleitems With {.idItem = c.idItem, .idEmpresa = Gempresas.IdEmpresaRuc, .idEstablecimiento = GEstableciento.IdEstablecimiento})
...
#End Region
    ...
    Public Sub GetTotalesDocumento()
        ...
        txtTotalPagar.DecimalValue = sumaTotal - descuento + sumaIcbper

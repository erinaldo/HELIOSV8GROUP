...
Public Class UserControlCanastaTouchRestaurant
    Public Property UCEstructuraCabeceraVenta As UCVentaRestaurantTouch
    Private UCPreciosCanastaVenta As UCPreciosCanastaVenta
    Public Event OKEvent()
    Public Sub New(ucVenta As UCVentaRestaurantTouch)

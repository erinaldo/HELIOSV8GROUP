...
Public Class UCPagoVentaTouchRestaurant
#Region "Attributes"
    Public Property FormVenta As FormVentaTouch
    Public UCPagoCompletoDocumento As UCPagoVentaTouchCompletoRestaurant
    Public UCCronogramaPagos As UCCronogramaPagosTouchRestaurant
#End Region

#Region "Constructors"
    Public Sub New(FormCrearventa As FormVentaTouch)
        ...
        ' Add any initialization after the InitializeComponent() call.
        UCPagoCompletoDocumento = New UCPagoVentaTouchCompletoRestaurant(FormCrearventa)
        UCCronogramaPagos = New UCCronogramaPagosTouchRestaurant(FormCrearventa) With {.Dock = DockStyle.Fill}

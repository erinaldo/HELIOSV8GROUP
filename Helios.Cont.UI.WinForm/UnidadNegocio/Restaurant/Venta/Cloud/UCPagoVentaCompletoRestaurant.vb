...
Public Class UCPagoVentaCompletoRestaurant


#Region "Attributes"
    Public Property FormVentaPrincipal As FormVentaNuevaRestaurant
    Private listaActivas As List(Of cajaUsuario)
    Private listaCuentasGrid As List(Of estadosFinancierosConfiguracionPagos)
#End Region

#Region "Constructors"
    Public Sub New(FormVenta As FormVentaNuevaRestaurant)

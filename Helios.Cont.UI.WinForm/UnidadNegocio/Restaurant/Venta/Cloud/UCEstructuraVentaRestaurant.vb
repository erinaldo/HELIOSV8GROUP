...
Public Class UCEstructuraVentaRestaurant
...
#Region "Attributes"
    ...
    Public Property usercontrol As UserControlCanastaRestaurant
    ...
    Public Property FormPurchase As FormVentaNuevaRestaurant
    ...
    Private Property UCbeneficiosCanastaVenta As UCbeneficiosCanastaVentaTouch
...
#Region "Constructors"
    Public Sub New(formventaNueva As FormVentaNuevaRestaurant)
        ...
        usercontrol = New UserControlCanastaRestaurant(Me)
        popup = New Popup(usercontrol)
        popup.Resizable = True
        UCPreciosCanastaVenta = New UCPreciosCanastaVenta With {.Dock = DockStyle.Fill}
        UCbeneficiosCanastaVenta = New UCbeneficiosCanastaVentaTouch(Me.FormPurchase) With {.Dock = DockStyle.Fill, .Visible = False}

...
Public Class Ticket_NumeroPedido
    ...
    Private Sub DibujaTotalFacturaFinal()
        ...
        Dim ordTot As OrdernarTotalFactura = New OrdernarTotalFactura()
        'Fuente de la impresion
        Dim FuenteImpresaEncabezado = New Font("Tahoma", 10, FontStyle.Regular)
        Dim FuenteImpresaEncabezadoTexto = New Font("Tahoma", 10, FontStyle.Regular)
        ...
        gfx.DrawString(CadenaPorEscribirEnLinea, FuenteImpresaEncabezadoTexto, ColorDeLaFuente, 5, lineaEspacio + 3, New StringFormat())
        ...
        For Each Elemento As String In LineasTotalFactura
            ...
            Dim R6 As New RectangleF(38, lineaEspacio + 3, 15, +5)
            'CadenaPorEscribirEnLinea = ordTot.ObtenerTotalNombre(Elemento)
    ...
    Private Sub DibujaDatosNombrePropietario()
        ...
        'Fuente de la impresion
        Dim FuenteImpresaEncabezado = New Font("Tahoma", 15, FontStyle.Regular)

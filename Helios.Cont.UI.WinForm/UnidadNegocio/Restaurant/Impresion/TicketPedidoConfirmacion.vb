...
Public Class TicketPedidoConfirmacion
    ...
    Private Sub DibujaLaCabecera()
        ...
        Dim FuenteImpresaEncabezadoIzquierda = New Font("Tahoma", 9, FontStyle.Bold)
    ...
    Private Sub DibujaElementosFactura()
        ...
        gfx.DrawString("CANT        │ ARTICULO  │        P.U.   │ IMPORTE", FuenteImpresaEncabezado, Brushes.Black, REncabezado, StringFormatLinea)
        lineaEspacio += 3
    ...
    Private Sub DibujaDatosComplementarios()
        ...
        gfx.DrawString("GRACIAS POR SU PREFERENCIA", FuenteImpresaEncabezado, Brushes.Black, R7, StringFormatGeneral)

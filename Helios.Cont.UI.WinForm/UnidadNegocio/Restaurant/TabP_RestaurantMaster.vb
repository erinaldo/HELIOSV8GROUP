...
Public Class TabP_RestaurantMaster
...
#End Region
    ...
    Private Sub RoundButton22_Click_1(sender As Object, e As EventArgs) Handles RoundButton22.Click
        Dim f As New FormConfiguracionRestaurant
        f.StartPosition = FormStartPosition.CenterParent
        f.Show(Me)
    End Sub
End Class

...
Public Class FormCajeroIndependienteV2
...
#Region "Variables"
    ...
    Public Property nombremesa As String = String.Empty
    Public Property DocumentoVentaLista As List(Of documentoventaAbarrotes)
...
#Region "Methods"
    ...
    Public Sub CargarPagos()
        ...
        CalculosMontos()
        cliventa = DocumentoVentaLista(0).CustomEntidad '  entidadSA.UbicarEntidadPorID(DocumentoVenta.idCliente).FirstOrDefault
...
#End Region
    ...
    Private Sub GetClientes(tipo As String, empresa As String)
        ...
        'lista.AddRange(entidadSA.GetListarEntidad(tipo, empresa, GEstableciento.IdEstablecimiento))
    ...
    'Public Function ConfigurarComprobanteVenta(strIdModulo As String, strIDEmpresa As String, intIdestablecimiento As Integer) As GConfiguracionModulo
    '    Dim numeracionSA As New NumeracionBoletaSA
    '    Dim TablaSA As New tablaDetalleSA
    '    Dim almacenSA As New almacenSA
    '    Dim cajaSA As New EstadosFinancierosSA
    ...
    Private Sub btOperacion_Click(sender As Object, e As EventArgs) Handles btOperacion.Click
        ...
        Try
            ...
            If (CDec(TextTotalPagosCliente.Text) < CDec(txtTotalPagar.Text)) Then
                btOperacion.Enabled = True
                TextTotalPagosCliente.Text = "0.00"
                TextTotalPagosCliente.Select()
                TextTotalPagosCliente.Focus()
                MessageBox.Show("DEBE INGRESAR IGUAL O MAYOR AL IMPORTE CONSUMIDO")
                Exit Sub
            End If
            ...
            ElseIf ChPagoAvanzado.Checked = True Then
                ...
                If pagos > 0 AndAlso pagos < txtTotalPagar.DecimalValue Then
                    btOperacion.Enabled = True
                    'If MessageBox.Show("Está realizando una cobranza parcial, error?", "Pagar venta", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = DialogResult.No Then
                    '    '        objPleaseWait.Close()
                    '    Exit Sub
                    'End If
                    MessageBox.Show("No se puede realizar pagos parciales", "Atención", MessageBoxButtons.OK, MessageBoxIcon.Warning)
                    Exit Sub
        ...
        Try
            ...
            If usuarioSel IsNot Nothing Then
                ...
                If ChPagoAvanzado.Checked = True Then
                    ...
                    Dim usuarioPedido = UsuariosList.Where(Function(o) o.IDUsuario = DocumentoVentaLista(0).usuarioActualizacion).SingleOrDefault
                ...
                MappingDocumentoCompraCabeceraVariosDoc(obj)
                MappingDocumentoCompraCabeceraDetalleVariosDoc(obj)

                Select Case obj.tipoDoc
                    Case "03", "01", "9907"
                        MappingPagos(envio, obj)
                        obj.IDCajaUsuario = envio.IDCaja
                ...
                distribucionInfraestructuraBE.idDistribucion = obj.documentoventaAbarrotes.documentoventaAbarrotesDet(0).idDistribucion
                distribucionInfraestructuraBE.estado = "L"
                distribucionInfraestructuraSA.updateDistribucionXCondicion(distribucionInfraestructuraBE)
                ...
                If cboTipoDoc.Text = "FACTURA" Or cboTipoDoc.Text = "BOLETA" Then
                    If EstadoRed("138.128.171.106") = True Then
                        ...
                        If Gempresas.ubigeo > 0 Then
                            ...
                            FormImpresionNuevo.nombremesa = nombremesa
                            FormImpresionNuevo.DocumentoID = doc.idDocumento
                            FormImpresionNuevo.Email = ""
                            FormImpresionNuevo.VUELTO = CStr(CDec(LabelVueltoCliente.Text))
                            FormImpresionNuevo.RECIBIDO = CStr(CDec(TextTotalPagosCliente.Text))
                            FormImpresionNuevo.FechaPedido = DocumentoVentaLista(0).fechaDoc
    ...
    Private Sub MappingDocumentoCompraCabeceraDetalleVariosDoc(obj As documento)
        Dim objDet As documentoventaAbarrotesDet


        For Each item In DocumentoVentaLista
            For Each i In item.documentoventaAbarrotesDet.ToList

                If (i.tipoVenta <> "KIT") Then
                    ...
                    ElseIf (i.tipoExistencia = TipoExistencia.ServicioGasto) Then
                        objDet = New documentoventaAbarrotesDet With
                                {
    ...
    Private Sub MappingDocumentoCompraCabeceraVariosDoc(be As documento)
        ...
        For Each ID In DocumentoVentaLista
            If (conteo = 0) Then
                ListaID = ID.idDocumento
                conteo += 1
            Else
                ListaID += "," & ID.idDocumento
                conteo += 1
            End If
            ListaIDRef.Add(ID.idDocumento)
        Next
        ...
        '//////////// ojo el DocumentoVentaLista(0) esta provicional para preguntar
        ...
        .moneda = be.moneda,
        .tasaIgv = DocumentoVentaLista(0).tasaIgv,
    ...
    Private Function MappingDocumentoVariosDoc() As documento
        ...
        MappingDocumentoVariosDoc = New documento With
        {
         .TipoEnvio = "PREVENTA",
        .idEmpresa = Gempresas.IdEmpresaRuc,
        ...
        .usuarioActualizacion = usuario.IDUsuario,' usuario.IDUsuario,
        .fechaActualizacion = Date.Now,
...
#End Region
    ...
    Public Function ListaPagosCajas(venta As documentoventaAbarrotes, ventaDetalle As List(Of documentoventaAbarrotesDet), envio As EnvioImpresionVendedorPernos) As List(Of documento)
        ...
        For Each i In dgvCuentas.Table.Records
            If Decimal.Parse(i.GetValue("abonado")) > 0 Then
                ...
                nDocumentoCaja.usuarioActualizacion = DocumentoVentaLista(0).usuarioActualizacion ' usuario.IDUsuario
                ...
                objCaja.usuarioModificacion = DocumentoVentaLista(0).usuarioActualizacion ' usuario.IDUsuario
            ...
            If montoPago > 0 Then
                If i.MontoSaldo > 0 Then
                    ...
                    GetDetallePago.Add(New documentoCajaDetalle With
                                   ...
                                   .usuarioModificacion = DocumentoVentaLista(0).usuarioActualizacion, ' usuario.IDUsuario,
                                   .documentoAfectado = DocumentoVentaLista(0).idDocumento,
    ...
    Sub CalculosMontos()
        For Each CalculoMont In DocumentoVentaLista
            txtTotalBase.DecimalValue += CalculoMont.bi01.GetValueOrDefault
            txtTotalBase2.DecimalValue += CalculoMont.bi02.GetValueOrDefault
            txtTotalBase3.DecimalValue = 0
            txtTotalIcbper.DecimalValue += CalculoMont.icbper.GetValueOrDefault
            txtTotalIva.DecimalValue += CalculoMont.igv01.GetValueOrDefault
            TextSubTotal.DecimalValue += CalculoMont.ImporteNacional.GetValueOrDefault + CalculoMont.importeCostoMN.GetValueOrDefault
            txtTotalPagar.DecimalValue = TextSubTotal.DecimalValue - CalculoMont.importeCostoMN.GetValueOrDefault

            'LabelTotalCobrarCliente.Text += CDEC(TextSubTotal.DecimalValue - CalculoMont.importeCostoMN.GetValueOrDefault)
            TextTotalDescuentos.DecimalValue += CalculoMont.importeCostoMN.GetValueOrDefault
        Next
        LabelTotalCobrarCliente.Text = CDec(txtTotalPagar.Text)
    End Sub
    ...
    Sub Getclientepedido()
        Dim vendedor = UsuariosList.Where(Function(o) o.IDUsuario = DocumentoVentaLista(0).usuarioActualizacion).SingleOrDefault

        If vendedor IsNot Nothing Then
            TextCodigoVendedor.Text = vendedor.Full_Name
        End If

        TextComprador.Text = DocumentoVentaLista(0).nombrePedido
        'Label15.Text = $"{"Pedido Nro:"} {DocumentoVenta.serieVenta}-{DocumentoVenta.numeroVenta}"
        Label15.Text = $"{"Pedido Nro:"} {"000"}"
        Select Case DocumentoVentaLista(0).tipoDocumento
            Case "01"
        ...
        Select Case DocumentoVentaLista(0).moneda
            Case "1"
        ...
        If cliventa IsNot Nothing Then
            ...
            If RadioButton2.Checked Then
                TextProveedor.Text = DocumentoVentaLista(0).nombrePedido
            End If
        End If
        'VUELTO
        TextTotalPagosCliente.DecimalValue = 0
    ...
    Private Sub DgvCuentas_TableControlCurrentCellChanged(sender As Object, e As GridTableControlEventArgs) Handles dgvCuentas.TableControlCurrentCellChanged
        ''Dim idProducto As Decimal = Decimal.Parse(dgvCuentas.Table.currenrecord.GetValue("abonado"))
    ...
    Private Sub TextTotalPagosCliente_KeyDown(sender As Object, e As KeyEventArgs) Handles TextTotalPagosCliente.KeyDown
        Try

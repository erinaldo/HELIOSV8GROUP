...
Public Class TabListaHospedados
    ...
    Private Sub GetTableDetalle()
        Try
            ...
            For Each i In personaBeneficioSA.ListarPersonaBeneficioXHabitacion(personaBeneficioBE) '.Where(Function(o) tables.Contains(o.idtabla)).ToList

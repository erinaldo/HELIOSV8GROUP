...
Public Class UCPagoVentaRecepcion
#Region "Attributes"
    Public Property FormVenta As FormVentaRecepcionCliente
    Public UCPagoCompletoDocumento As UCPagoVentaCompletoRecepcion
    'Public UCCronogramaPagos As UCCronogramaPagosTouch
#End Region

#Region "Constructors"
    Public Sub New(FormCrearventa As FormVentaRecepcionCliente)
        ...
        ' Add any initialization after the InitializeComponent() call.
        UCPagoCompletoDocumento = New UCPagoVentaCompletoRecepcion(FormCrearventa)
        'UCCronogramaPagos = New UCCronogramaPagosTouch(FormCrearventa) With {.Dock = DockStyle.Fill}

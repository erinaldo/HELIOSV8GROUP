...
Public Class UCPagoVentaCompletoRecepcion


#Region "Attributes"
    Public Property FormVentaPrincipal As FormVentaRecepcionCliente
    Private listaActivas As List(Of cajaUsuario)
    Private listaCuentasGrid As List(Of estadosFinancierosConfiguracionPagos)
#End Region

#Region "Constructors"
    Public Sub New(FormVenta As FormVentaRecepcionCliente)

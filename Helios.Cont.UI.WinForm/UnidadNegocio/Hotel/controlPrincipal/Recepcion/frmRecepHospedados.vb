...
Public Class frmRecepHospedados
    Inherits frmMaster
    ...
    Public Sub New(formventaNueva As UCEstructuraRecepcionCliente, idPadre As Integer)
...
#Region "Metodo"
    ...
    Public Sub CARGARFECHAS(INFecha As DateTime)
        txtCheckIn.MinDate = INFecha
    ...
    Public Sub AgregarEntidad()
        Try
            ...
            If (FormPurchase.ListaPersonasHospedadas.Count > 0) Then

                For Each ITEM In FormPurchase.ListaPersonasHospedadas
                    If (ITEM.nroDocumento = TextNumIdentrazon.Text) Then
                        MessageBox.Show("ya Existe un cliente registrado con el documento")
                        Exit Sub
                    End If
                Next
        ...
        Try
            ...
            If (dgvCompras.Table.Records.Count > 0) Then
                For Each item In dgvCompras.Table.Records
                    ...
                    'entidad.FechaIngreso = txtCheckIn.Value
                    'entidad.FechaSalida = txtCheckOn.Value
                    'entidad.dias = CInt(txtdias.Text)
                    ListaEntidad.Add(entidad)

                    For Each I In (FormPurchase.ListaPersonasHospedadas.Where(Function(O) O.distribucionID = idPadreDoc)).ToList
                        FormPurchase.ListaPersonasHospedadas.Remove(I)
                    Next

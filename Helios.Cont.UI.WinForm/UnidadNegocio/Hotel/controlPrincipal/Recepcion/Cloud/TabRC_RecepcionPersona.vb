...
Public Class TabRC_RecepcionPersona
...
#Region "Metodos"
    ...
    Public Sub GetCargarFechas()
        ...
        txtdias.ForeColor = Color.FromKnownColor(KnownColor.HotTrack)
        textBox1.ForeColor = Color.FromKnownColor(KnownColor.HotTrack)
        textBox2.ForeColor = Color.FromKnownColor(KnownColor.HotTrack)
    End Sub
    ...
    Private Sub MappingDocumentoCompraCabeceraDetalle(obj As documento)
        ...
        For Each i In listaInfra
            ...
            importeTotal += i.menor.GetValueOrDefault
            ImporteUnit += i.menor.GetValueOrDefault
        Next
    End Sub
    ...
    Private Sub BtnRetorno_Click(sender As Object, e As EventArgs) Handles btnRetorno.Click
        Try
            If (btnRetorno.Tag = 1) Then
                ...
                If (TabRC_RecepcionHuesped.listaDistribucion.Count <= 0) Then
                ...
                For Each ITEM In TabRC_RecepcionHuesped.listaDistribucion.Where(Function(o) o.estado <> "U" And o.estado <> "A").ToList
                    ...
                    distribucionInfraestructuraBE.idDistribucion = (ITEM.idDistribucion)
                    distribucionInfraestructuraBE.estado = "U"
                    distribucionInfraestructuraBE.menor = ITEM.mayor
                    LISTAPreVenta.Add(distribucionInfraestructuraBE)
                    LISTAiDdISTRIBUCION.Add((ITEM.numeracion))
                Next

                listaInfra = infraSA.updateDistribucionRecepcionMasivo(LISTAPreVenta) 'infraSA.updateDistribucionRecepcionMasivo(LISTAPreVenta)
                ...
                FormPurchase.TabP_IdentificacionCliente.TextNumIdentrazon.Clear()
                FormPurchase.TabP_IdentificacionCliente.TextProveedor.Clear()
                FormPurchase.TabP_IdentificacionCliente.lblEstadoCliente.Text = "ESTADO"
                FormPurchase.TabP_IdentificacionCliente.lblEstadoCliente.Visible = False
                ...
                notifyIcon1.BalloonTipText = "PEDIDO CONFIRMADO"
            ...
            ElseIf (btnRetorno.Tag = 0) Then
                ...
                If TabRC_RecepcionHuesped IsNot Nothing Then
                    ...
                    TabRC_RecepcionHuesped.BGHoteles.RunWorkerAsync()
    ...
    Private Sub Txtdias_Click(sender As Object, e As EventArgs)
        Try
            txtdias.Tag = 1
    ...
    Private Sub TextTelefono_KeyDown(sender As Object, e As KeyEventArgs) Handles TextNumIdentrazon.KeyDown
        Dim nombres = String.Empty
        Try
    ...
    Private Sub Txtdias_TextChanged_1(sender As Object, e As EventArgs) Handles txtdias.TextChanged
        Dim nombres = String.Empty
        Try
    ...
    Private Sub Txtdias_KeyDown_1(sender As Object, e As KeyEventArgs) Handles txtdias.KeyDown
        Dim nombres = String.Empty
        Try
            'TextNumIdentrazon.Enabled = False
            If e.KeyCode = Keys.Enter Then

...
Public Class FormVentaNuevaTouch
...
#Region "Attributes"
    ...
    Public UCEstructuraCabeceraVentaV2 As UCEstructuraCabeceraVentaTouch
    Public UCCondicionesPago As UCPagoVentaTouch
...
#Region "Constructors"
    ...
    Public Sub New(CodigoProforma As String)
        ...
        GetComboPrincipal()
        Me.KeyPreview = True
        UCEstructuraCabeceraVentaV2 = New UCEstructuraCabeceraVentaTouch(Me)
        UCCondicionesPago = New UCPagoVentaTouch(Me)
...
#End Region
                ...
                Select Case i.tipoExistencia
                    Case TipoExistencia.ServicioGasto
                        ...
                        objDet = New documentoventaAbarrotesDet With
                            ...
                            .idDistribucion = CInt(UCEstructuraCabeceraVentaV2.txtInfraestructura.Tag),
                    ...
                    Case TipoExistencia.Infraestructura
                        ...
                        For Each ite In UCEstructuraCabeceraVentaV2.ListaPersonasHospedadas.ToList
    ...
    Private Sub MappingDocumentoPedidoCabeceraDetalle(obj As documento)
        Dim objDet As documentoventaAbarrotesDet
        Dim precUnitEquivalencia As Decimal = 0
        Dim listaHospedados As New List(Of personaBeneficio)
        Dim listaOcuapcion As New List(Of ocupacionInfraestructura)
        ...
        Try
            ...
            Select Case ComboComprobante.Text
                Case "PEDIDO"
                    ...
                    Dispose()
                    Exit Sub
                Case "OTRA SALIDA DE ALMACEN", "PROFORMA"
...
#Region "Events"
    ...
    Private Sub ToolStripButton1_Click(sender As Object, e As EventArgs) Handles ToolStripButton1.Click
        Dim f As New FormCanstaVentaEquivalenciaTouch(Me.UCEstructuraCabeceraVentaV2)
        f.StartPosition = FormStartPosition.CenterParent
        f.ShowDialog(Me)
    End Sub

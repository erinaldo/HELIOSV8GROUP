...
Public Class UCPagoVentaTouch
#Region "Attributes"
    Public Property FormVenta As FormVentaNuevaTouch
    Public UCPagoCompletoDocumento As UCPagoVentaCompletoTouch
    Public UCCronogramaPagos As UCCronogramaPagosTouch
#End Region

#Region "Constructors"
    Public Sub New(FormCrearventa As FormVentaNuevaTouch)
        ...
        ' Add any initialization after the InitializeComponent() call.
        UCPagoCompletoDocumento = New UCPagoVentaCompletoTouch(FormCrearventa)

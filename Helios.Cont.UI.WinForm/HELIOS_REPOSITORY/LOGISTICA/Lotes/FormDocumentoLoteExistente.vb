...
Public Class FormDocumentoLoteExistente
#Region "Attributes"
    Public UCEstructuraDocumentocabecera As UCDocumentoLoteExistente
...
#Region "Constructors"
    Public Sub New(IdDocumento As Integer)
        ...
        UCEstructuraDocumentocabecera = New UCDocumentoLoteExistente(Me)

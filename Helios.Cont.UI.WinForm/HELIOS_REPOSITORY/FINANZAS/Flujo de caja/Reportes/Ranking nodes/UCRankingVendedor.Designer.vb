...
Partial Class UCRankingVendedor
    ...
    Private Sub InitializeComponent()
        ...
        GridColumnDescriptor8.HeaderText = "VENDEDOR"
        GridColumnDescriptor8.MappingName = "vendedor"
        GridColumnDescriptor8.SerializedImageArray = ""
        GridColumnDescriptor8.Width = 200
        Me.GridRentabilidad.TableDescriptor.Columns.AddRange(New Syncfusion.Windows.Forms.Grid.Grouping.GridColumnDescriptor() {GridColumnDescriptor1, GridColumnDescriptor2, GridColumnDescriptor3, GridColumnDescriptor4, GridColumnDescriptor5, GridColumnDescriptor6, GridColumnDescriptor7, GridColumnDescriptor8})
        ...
        Me.GridRentabilidad.TableDescriptor.VisibleColumns.AddRange(New Syncfusion.Windows.Forms.Grid.Grouping.GridVisibleColumnDescriptor() {New Syncfusion.Windows.Forms.Grid.Grouping.GridVisibleColumnDescriptor("vendedor"), New Syncfusion.Windows.Forms.Grid.Grouping.GridVisibleColumnDescriptor("Cliente"), New Syncfusion.Windows.Forms.Grid.Grouping.GridVisibleColumnDescriptor("tipodoc"), New Syncfusion.Windows.Forms.Grid.Grouping.GridVisibleColumnDescriptor("nrodoc"), New Syncfusion.Windows.Forms.Grid.Grouping.GridVisibleColumnDescriptor("tipo"), New Syncfusion.Windows.Forms.Grid.Grouping.GridVisibleColumnDescriptor("ventasiniva"), New Syncfusion.Windows.Forms.Grid.Grouping.GridVisibleColumnDescriptor("iva"), New Syncfusion.Windows.Forms.Grid.Grouping.GridVisibleColumnDescriptor("ventaconiva")})

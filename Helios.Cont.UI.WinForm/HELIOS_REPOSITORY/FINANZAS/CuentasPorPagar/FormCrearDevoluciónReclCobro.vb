...
Public Class FormCrearDevoluciónReclCobro
...
#Region "Constructor"
    ...
    Sub New(be As entidad, idDocumento As Integer)
        ...
        GetDocumentoBaseCompra(idDocumento)
    End Sub
...
#Region "Metodos"
    ...
    Sub GetDocumentoBaseCompra(idDocumento As Integer)
...
#End Region
    ...
    Private Sub FormCrearDevoluciónReclCobro_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub GrabarDocumento()
        Try
            ...
            ventaSA.GrabarDocumentoCajaDevolucionCobro(documento)

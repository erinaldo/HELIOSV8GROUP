...
Public Class FormCrearDevoluciónAnt
#Region "Attributes"
...
#Region "Constructors"
    Public Sub New(be As entidad, idDocumento As Integer)
...
#Region "Methods"
    ...
    Private Sub GetMappingColumnsGrid(idCaja As Integer)
        ...
        'Dim listaCuentas = SA.GetConfigurationPayCajaSaldo(New estadosFinancierosConfiguracionPagos With
        '                                         {
...
#Region "Events"
    ...
    Private Sub FormCrearDevoluciónAnt_Load(sender As Object, e As EventArgs) Handles MyBase.Load

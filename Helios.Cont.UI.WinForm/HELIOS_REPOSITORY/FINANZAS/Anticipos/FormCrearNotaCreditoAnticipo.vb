...
Public Class FormCrearNotaCreditoAnticipo
#Region "Attributes"
...
#Region "Constructors"
    Public Sub New(idAnticipo As Integer, ent As entidad) ', form As FormMaestroModuloAnticipos)
...
#Region "Methods"
    ...
    Private Sub GetAnticipo(idAnticipo As Integer, ent As entidad)
        ...
        Dim anticipo = anticipoSA.ObtenerSaldoAnticipoV2(idAnticipo)
    ...
    Sub Grabar(EstadoPago As String)
        ...
        objDocumentoVentaDet.nombreItem = "RECLAMACION POR ANTICIPO"
...
#Region "Events"
    ...
    Private Sub FormCrearNotaCreditoAnticipo_Load(sender As Object, e As EventArgs) Handles MyBase.Load

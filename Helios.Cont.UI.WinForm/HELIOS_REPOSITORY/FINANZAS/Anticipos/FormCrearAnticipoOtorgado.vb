...
Public Class FormCrearAnticipoOtorgado
...
#Region "Entidad"
    ...
    Private Sub threadClientes()
        Dim tipo = General.TIPO_ENTIDAD.PROVEEDOR
...
#Region "Methods"
    ...
    Private Sub Grabar()
        ...
        .tipoOperacion = StatusTipoOperacion.ANTICIPOS_OTORGADOS,
        .tipoAnticipo = Anticipo.Tipo.otorgado,
    ...
    Function GetComprobanteCaja(be As documentoAnticipo) As documento
        ...
        objCaja = New documentoCaja With
        {
            ...
            .tipoOperacion = be.tipoOperacion,
            .movimientoCaja = "AO",
            .idCajaUsuario = 0,'GFichaUsuarios.IdCajaUsuario.GetValueOrDefault,
            .estado = "1",
            .usuarioModificacion = usuario.IDUsuario,
        ...
        objCajaDetalle.idCajaUsuario = 0 'GFichaUsuarios.IdCajaUsuario.GetValueOrDefault
...
#End Region
    ...
    Private Sub FormCrearAnticipoOtorgado_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub ComboCuentaFinanciera_SelectedValueChanged(sender As Object, e As EventArgs) Handles ComboCuentaFinanciera.SelectedValueChanged
        Dim valor = ComboCuentaFinanciera.Text
        If valor.Length > 0 Then

            Dim valor2 = ComboCuentaFinanciera.SelectedValue
            If ComboCuentaFinanciera.SelectedItem IsNot Nothing Then 'valor2 > 0 Then
                Try
                    Dim estadoSA = New EstadosFinancierosConfiguracionPagosSA

                    Dim SaldoCaja = estadoSA.GetPaySaldoCaja(New estadosFinancierosConfiguracionPagos With
                    {
                    .idEmpresa = Gempresas.IdEmpresaRuc,
                    .idEstablecimiento = GEstableciento.IdEstablecimiento,
                    .fecha = DateTime.Now,
                    .identidad = ComboCuentaFinanciera.SelectedValue})

                    If SaldoCaja IsNot Nothing Then



                        txtSaldoCaja.Text = SaldoCaja.MontoCaja
                    End If
    ...
    Private Sub TextValorPrestamo_TextChanged(sender As Object, e As EventArgs) Handles TextValorPrestamo.TextChanged
        If Not txtSaldoCaja.Text = "" Then

            If CDec(txtSaldoCaja.Text) > 0 Then

                If CDec(TextValorPrestamo.Text) > CDec(txtSaldoCaja.Text) Then
                    TextValorPrestamo.Text = 0
                Else
                    GetCalculo()
                End If

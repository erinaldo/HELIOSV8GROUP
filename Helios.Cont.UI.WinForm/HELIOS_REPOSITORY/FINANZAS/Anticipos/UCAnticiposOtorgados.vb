...
Public Class UCAnticiposOtorgados
...
#Region "Constructors"
    Public Sub New()
        ...
        TabFN_Reclamaciones = New TabFN_Reclamaciones(Anticipo.Estado.NotaCredito, Anticipo.Tipo.otorgado) With {.Dock = DockStyle.Fill, .Visible = True}
        TabFN_AnticipoReclamacionStatus = New TabFN_AnticipoReclamacionStatus(Anticipo.EstadoCobroNotaCredito.Pendiente, Anticipo.Tipo.otorgado) With {.Dock = DockStyle.Fill, .Visible = False}
        TabFN_DevolucionNotaCreditoAnt = New TabFN_DevolucionNotaCreditoAnt(Anticipo.EstadoCobroNotaCredito.SolicitudDevolucion, Anticipo.Tipo.otorgado) With {.Dock = DockStyle.Fill, .Visible = False}
        TabFN_DevolucionNotaSeguimiento = New TabFN_DevolucionNotaSeguimiento(Anticipo.EstadoCobroNotaCredito.DevolucionTramitePendiente, Anticipo.Tipo.otorgado) With {.Dock = DockStyle.Fill, .Visible = False}
...
#Region "Events"
    ...
    Private Sub BunifuFlatButton5_Click(sender As Object, e As EventArgs) Handles BunifuFlatButton5.Click
        ...
        Dim FormCrearAnticipo As New FormCrearAnticipoOtorgado()

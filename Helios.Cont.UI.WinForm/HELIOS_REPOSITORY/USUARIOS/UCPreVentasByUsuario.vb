...
Imports System.IO
Public Class UCPreVentasByUsuario
#Region "Attributes"
...
#Region "Methods"
    ...
    Private Sub GetListaVentasPorTipo(period As String, tipo As String)
        ...
        Dim dt As New DataTable("Pre ventas de - " & period)
    ...
    Private Sub GetListaVentasPorDia(fechaLaboral As Date, idEstable As Integer, tipo As String)
        ...
        Dim dt As New DataTable("Pre ventas del día - " & fechaLaboral)
        dt.Columns.Add(New DataColumn("idDocumento", GetType(Integer)))
        dt.Columns.Add(New DataColumn("tipoCompra", GetType(String)))
        dt.Columns.Add(New DataColumn("fechaDoc", GetType(String)))
        dt.Columns.Add(New DataColumn("pedido", GetType(String)))
...
#Region "Events"
    Private Sub BunifuFlatButton5_Click(sender As Object, e As EventArgs) Handles BunifuFlatButton5.Click
        ...
        If f.Tag IsNot Nothing Then
            ...
            Dim thread As System.Threading.Thread = New System.Threading.Thread(New System.Threading.ThreadStart(Sub() GetListaVentasPorTipo(GetPeriodo(periodoSel, True), TIPO_VENTA.VENTA_NOTA_PEDIDO)))
            thread.Start()
        End If
    End Sub
    ...
    Private Sub BunifuFlatButton3_Click(sender As Object, e As EventArgs) Handles BunifuFlatButton3.Click
        ...
        If f.Tag IsNot Nothing Then
            ...
            Dim thread As System.Threading.Thread = New System.Threading.Thread(New System.Threading.ThreadStart(Sub() GetListaVentasPorDia(FechaSel, GEstableciento.IdEstablecimiento, TIPO_VENTA.VENTA_NOTA_PEDIDO)))
            thread.Start()
    ...
    Private Sub BunifuFlatButton1_Click(sender As Object, e As EventArgs) Handles BunifuFlatButton1.Click
        ...
        If r IsNot Nothing Then
            If MessageBox.Show("Desea eliminar el pedido?", "Atención", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = DialogResult.Yes Then

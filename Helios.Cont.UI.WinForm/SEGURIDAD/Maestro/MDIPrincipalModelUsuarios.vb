Public Class MDIPrincipalModelUsuarios
    ...
    Private Sub ModulosComercial()
        ...
        Modulos.Add(New Modulo With {.IDModulo = 14, .TipoModulo = Modulo.ModuloTipo.Nivel, .Descripcion = "Lista detallado de Modulos",
                                   .IDModuloPadre = Nothing, .IDCategoria = 3, .Orden = 1, .Formulario = "frmListaModulosSistema"})

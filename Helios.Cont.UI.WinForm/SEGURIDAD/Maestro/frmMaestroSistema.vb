...
Public Class frmMaestroSistema
#Region "Attributes"
    Property Model As New MDIPrincipalSistema
...
#Region "Methods"
    Private Sub ConfiguracionInicio()
        ...
        lblEmpresa.Text = Space(15) & "Permisos y Roles - Usuario" '  & Gempresas.IdEmpresaRuc & ", " & Gempresas.NomEmpresa
    ...
    Private Sub rbnPrincipal_Click(sender As Object, e As EventArgs) Handles rbnPrincipal.Click

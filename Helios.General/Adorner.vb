...
Public Module Adorner
    ...
    'Sub SetClickAction(ByVal ctl As Control, ByVal action As Action(Of Control))
    '    Dim badge As Badge = GetBadge(ctl)
    '    If badge IsNot Nothing Then badge.ClickEvent = action
    'End Sub
    ...
    Class Badge
        ...
        Private BackColor As Color = Color.WhiteSmoke
        Private ForeColor As Color = Color.DimGray
        Private font As Font = New Font("Tahoma", 7.5F)
        Public ClickEvent As Action(Of Control)

...
namespace Helios.Retail
{
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new ScriptBundle("~/bundles/sps")              
                .Include("~/Scripts/ui/jquery-1.10.2.js")
                .Include("~/Scripts/ui/jquery-ui.js")
                .Include("~/Scripts/ui/jquery-ui-1.10.4.custom.min.js")
                .Include("~/Scripts/General/stringformat-1.16.1.js")
                .Include("~/Scripts/sweetalert/sweetalert.js"));



            //Added for toaster Script
            bundles.Add(new ScriptBundle("~/bundles/toastr").Include(
                       "~/Scripts/toastr.js",
                       "~/Scripts/toastr.min.js"));

            //.Include(ltecomponents + "font-awesome/css/font-awesome.min.css", new CssRewriteUrlTransformFixed())

            bundles.Add(new StyleBundle("~/Content/css")
                .Include("~/Content/bootstrap.css")
                .Include("~/Content/ui/jquery-ui.css")
                .Include("~/Content/ui/jquery-ui-1.10.4.custom.min.css")
                .Include("~/Content/toastr.css")
                .Include(ltecomponents + "bootstrap/dist/css/bootstrap.min.css")
                .Include("~/Content/font-awesome.min.css", new CssRewriteUrlTransformFixed())              
                .Include(ltecomponents + "Ionicons/css/ionicons.min.css", new CssRewriteUrlTransformFixed())
                ...
                .Include("~/Content/sweetalert/sweetalert.css"));


            // Boorstrap dropdown select
            bundles.Add(new ScriptBundle("~/bundles/bootstrap-select")
                .Include("~/Scripts/select/bootstrap-select.js")
                .Include("~/Scripts/select/script-bootstrap-select.js")
                .Include("~/Scripts/select/bootstrap-select.min.js"));

            // Bootstrap dropdown select
            bundles.Add(new StyleBundle("~/Content/Bootstrap-Select/css")
                .Include("~/Content/select/bootstrap-select.css")
                .Include("~/Content/select/bootstrap-select.min.css"));


            //bundles.Add(new ScriptBundle("~/bundles/entities-js")
            //    .Include("~/Scripts/General/orderJS.js"));
        }
    }
}

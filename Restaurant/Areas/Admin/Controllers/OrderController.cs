    ...
    public class OrderController : Controller
    {
        ...
        public ActionResult ConsultarSeleccionMesa(int ID, string nombreMesa, string numeroMesa)
        {
            ...
            else
            {
                ...
                List<BE.item> listaItem = CatSA.GetListaItemPorEstable(ModelGeneralBE.establecimientoID , ModelGeneralBE.empresaID ).ToList();
        ...
        {
            //Creating List    
            var ListaProducts = productSA.GetProductosWithEquivalenciasXCat(new BE.detalleitems { idItem = id, idEmpresa = ModelGeneralBE.empresaID , idEstablecimiento = ModelGeneralBE.establecimientoID  });
            return Json(ListaProducts, JsonRequestBehavior.AllowGet);
        }
        ...
        public ActionResult LoadOrders(string mesa)
        {
            ...
            documentoBE.idEmpresa = ModelGeneralBE.empresaID ;
            documentoBE.idEstablecimiento = ModelGeneralBE.establecimientoID ;
        ...
        public JsonResult EliminarPedido(int idDocumento, int secuencia, int idmesa)
        {
            if (Session["username"] != null)
            {
                ...
                documentoventaBE.IdEmpresa = ModelGeneralBE.empresaID ;
